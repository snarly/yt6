...
(function () {
  ...
  var FORMAT_TYPE={'5':'flv','6':'flv','17':'3gp','18':'mp4','22':'mp4','34':'flv','35':'flv','36':'3gp','37':'mp4','38':'mp4','43':'webm','44':'webm','45':'webm','46':'webm','84':'mp4','83':'mp4','82':'mp4','133':'mp4','134':'mp4','135':'mp4','137':'mp4','138':'mp4','139':'m4a','140':'m4a','141':'m4a','160':'mp4','264':'mp4','100':'webm','101':'webm','102':'webm','171':'webm','172':'webm','242':'webm','243':'webm','244':'webm','245':'webm','246':'webm','247':'webm','248':'webm','271':'webm','272':'webm',};
  var FORMAT_ORDER=['38','46','37','85','45','102','22','84','44','83','43','101','100','18','82','35','34','6','5','36','17','138','272','264','271','137','248','136','247','135','246','245','244','134','243','133','242','160','141','172','140','171','139'];
//['5','18','34','43','35','135','44','22','45','37','46','264','38','139','140','141'];
  var FORMAT_RULE={'flv':'max','mp4':'all','webm':'max','m4a':'max'};
...
function run() {
  ...
  function addFromManifest(oldFormat, newFormat) { // find newFormat URL in manifest
    if (videoManifestURL && videoURL[newFormat]==undefined && SHOW_DASH_FORMATS && FORMAT_RULE['m4a']=='max') {
      ...
      if (matchSig) {
        var decryptedSig=decryptSignature(matchSig,alert);
        if (decryptedSig) {
  ...
  function getDecodeRules(rules) {
    var storageCode=getPref(STORAGE_CODE);    alert(storageCode)
  ...
  function decryptSignature(sig,alert) {
    function swap(a,b){var c=a[0];a[0]=a[b%a.length];a[b]=c;return a};
    function decode(sig, arr) { if (alert) {alert(sig + '----' + arr)};// encoded decryption
