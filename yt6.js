...
//}//cw
  ...
  if (yt6.force_flash) {
	...
	if (!(yt6.layout == 12 && yt6.block)) { relocate_mep() } else document.getElementById('player-api').appendChild(bm0)
...
//	}
	...
	if (p) {
	  ...
	  if (z == 'function') { var z = 'playerState_' + z } else { var z = 'playerState_null' }
