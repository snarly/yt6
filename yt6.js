					  ...
					  if (player1.options.loop1) {
					    ...
					    try { yt6.player1.pause(); yt6.player2.pause(); Seek = 1;
					     ...
					     if (yt6.A_V[itag(me.src)] || yt6.A_[itag(me.src)]) { me.play() }//for looping singular streams in player1 only
						  ...
						  if (yt6.md && (yt6.layout == 12 || yt6.mobile) && yt6.x && yt6.browser_tab == 'hidden') { // mobile sleep mode hack
						    try {
...
//                            e.preventDefault();
	...
	var mep_reload = yt6.mep_reload = function(){ //console.log('mep_reload '+yt6.age.count)
	    ...
	    if (yt6.md && typeof yt6.x_ == 'number') try { yt6.player1.setVolume(yt6.x_) } catch(e){}
