...
yt6.userprefV = [397,244,134,43,18]
...
;(function(){
  ...
  for(i=0; i<yt6.fmts_fallback.V.h264.length;i++){
    if (yt6.fmts_fallback.V.h264[i] || yt6.fmts_fallback.V.webm[i] || yt6.fmts_fallback.V.av1[i]) {
      ...
      yt6.fmts_fallback.V.uniq.all[i] = yt6.fmts_fallback.V.uniq.h264[i] || yt6.fmts_fallback.V.uniq.webm[i] || yt6.fmts_fallback.V.uniq.av1[i]
	  yt6.fmts_fallback.V.uniq.dash[i] = yt6.fmts_fallback.V.uniq.h264[i] || yt6.fmts_fallback.V.uniq.av1[i];
    }
    ...
    if (yt6.fmts_fallback.A.uniq.aac[i] || yt6.fmts_fallback.A.uniq.webm[i]) yt6.fmts_fallback.A.uniq.all[i] = yt6.fmts_fallback.A.uniq.aac[i] || yt6.fmts_fallback.A.uniq.webm[i]
    ...
    if (yt6.fmts_fallback.V3D.uniq.h264[i] || yt6.fmts_fallback.V3D.uniq.webm[i]) yt6.fmts_fallback.V3D.uniq.all[i] = yt6.fmts_fallback.V3D.uniq.h264[i] || yt6.fmts_fallback.V3D.uniq.webm[i]
  };
  ...
  for (i=0; i<z.length; i++) {
    ...
    yt6.fmts_fallback.V.dash.push.apply(yt6.fmts_fallback.V.dash, yt6.fmts_fallback.A.webm)
...
yt6.cdn_ = function(){
  ...
  yt6.cdn2 = shuffle(yt6.cdns.splice(1,2))
      ...
      .forEach(function(x){/*console.log(eid)*/;\
		z = unescape(unescape(oc[x]));\
	  	if (z.indexOf('videoplayback?') > -1){\
	  	  ...
	  	  if (eid) { eid = eid.substring(0,19); if (!(yt6d.current.eid.includes(eid))) yt6d.current.eid.push(eid); }\
	  	}\
...
yt6d.mep_renew = function() {
	...
	if (yt6.userprefV[0] !== yt6.userprefA[0]) {
	  pool0 = yt6.userprefV
	  pool1 = yt6.fmts_fallback.V
	  pool2 = yt6.fmts_fallback.V.uniq[yt6.prefer_fmt]; pool2.push.apply(pool2, yt6.fmts_fallback.A.uniq[yt6.prefer_fmt])
	} else {
	    pool0 = yt6.userprefA
	    pool1 = yt6.fmts_fallback.A
	    var x = (yt6.prefer_fmt == 'webm') ? 'dash' : 'webm'
	    pool2 = yt6.fmts_fallback.A.uniq[yt6.prefer_fmt]; pool2.push.apply(pool2, yt6.fmts_fallback.A.revers[x])
	  }


	//if (yt6.yt_otf.length) {
	//  for(i=0;i < yt6.afmts.length;i++) { 
	//    if (pool0.indexOf(yt6.afmts[i]) == -1 || yt6.V_.indexOf(yt6.afmts[i]) > -1) pool0.unshift(yt6.afmts[i])
	//  }
	//}
	...
	//for(i=0;i<pool0.length;i++){
	    for(j=0;j<yt6.fmts_fallback.A[alt_pool].length;j++){
	      if (yt6.fmts_fallback.A[alt_pool][j] == parseInt(yt6.userprefV[i]) && sotf(yt6.fmts_fallback.A[alt_pool][j]) && yt6.yt_otf.indexOf(pool1[yt6.prefer_fmt][j]) == -1 && gid(mep + '_sourcechooser_' + yt6.fmts_fallback.A1[alt_pool][j]) ){//&& !(yt6.prefer_fmt !== 'all' && !gid(mep + '_sourcechooser_' + pool1[alt_pool][j]) ) ) {
	...
	if (!fmt_pool && pool0.length > i) continue
	  ...
	  for(j=index;j<fmt_pool.length;j++){
	    ...
	    if (i == yt6.userprefV.length-1 && j == fmt_pool.length-1 && !z && yt6.prefer_fmt != 'all') { find = true; var itagx = (yt6.prefer_fmt == 'webm') ? '18' : '43';
		...
		if ((yt6.fmts_fallback.V.uniq[yt6.prefer_fmt].indexOf(1*itagx) == -1 || z.parentNode.parentNode.children.length < 3) && yt6.userprefV.length > 2) { no_default(itagx, 'V') }
		/*if ( yt6.browser_tab == 'hidden') {
		  ...
		  z.setAttribute('checked','checked'); z.checked = 'true'
		  yt6.player1.setSrc(yt6.linx[itagx])
		  if ((1 * itagx != 1 * yt6.userprefV[i] || yt6.fmts_fallback.V.uniq[yt6.prefer_fmt].indexOf(1*itagx) == -1 || z.parentNode.parentNode.children.length < 3) && yt6.userprefV.length > 2) { no_default(itagx, 'V') }
	...
	if (yt6.prefer_fmt == 'all') {
	  ...
	  for(i=0;i<yt6.userprefA.length;i++){
	    for(j=0;j<yt6.fmts_fallback.A[x].length;j++){
	      var z = gid(mep + '_sourcechooser_' + yt6.userprefA[i])//, y = (z && yt6.userprefV.indexOf(yt6.userprefA[i]) > -1) ? gid(mep + '_sourcechooser_' + yt6.userprefV[yt6.userprefV.indexOf(yt6.userprefA[i])] ) : null
	  ...
	  //if (Aindex && Afmt_pool) console.log(Afmt_pool[Aindex])

	  if (!Afmt_pool) { //console.log('2')
	    var alt_pool = (yt6.prefer_fmt == 'webm') ? 'aac' : 'webm'
	    for(i=0;i<yt6.userprefA.length;i++){
	      for(j=0;j<yt6.fmts_fallback.A[alt_pool].length;j++){ //console.log(yt6.fmts_fallback.A[alt_pool][j] + ' '+yt6.userprefA[i])
	  ...
	  for(i=0;i<yt6.userprefA.length;i++){
	    for(j=Aindex;j<Afmt_pool.length;j++){
	      ...
	      if (z && find == true
		    ...
		    && parseInt(yt6.userprefA[i]) == parseInt(Afmt_pool[j]) //&& i != yt6.userprefA.length-1
		 ) {//&& !(yt6.userprefA[i] != Afmt_pool[Aindex] && gid(mep + '_sourcechooser_' + Afmt_pool[Aindex]))
		//if (z && parseInt(yt6.userprefA[i]) == parseInt(Afmt_pool[j]) && i != yt6.userprefA.length-1) {
		  var itagx = Afmt_pool[j]//(!(yt6.userprefA[i] != Afmt_pool[Aindex] && gid(mep + '_sourcechooser_' + Afmt_pool[Aindex]))) ?  : Afmt_pool(Aindex)
		//} //else var itagx = 140
...
*/
      ...
      if (yt6d.ad) { delete yt6d.ad; } //yt6d.mep_reload() }
	...
	if (yt6.ytg || yt6.ytm) {
	  ...
	  if (yt6.ytm) {
		...
		if (yt6 && yt6.playlist_scroller) {
		  var x = yt6.playlist_scroller.getElementsByTagName('ytd-playlist-panel-video-renderer').length || 0, start, end
		  start = yt6.playlist_scroller.getElementsByTagName('ytd-playlist-panel-video-renderer')[0].querySelector('#index').innerHTML * 1;
		  end = yt6.playlist_scroller.getElementsByTagName('ytd-playlist-panel-video-renderer')[x-1].querySelector('#index').innerHTML * 1;
	    ...
	    function() {
	      var x = yt6.playlist_scroller.getElementsByTagName('ytd-playlist-panel-video-renderer').length || 0, start, end, elementHeight //(!yt6.pl_previous || (yt6.vid && gid('player1') && yt6.vid == yt6d.init)) ? 0 : 1;
	      if (x) try {
		elementHeight = clone(yt6.playlist_scroller.getElementsByTagName('ytd-playlist-panel-video-renderer')[0].offsetHeight + 0)// - 1.9
		...
		var offset = (yt6.pl_index - start)// - Math.round(yt6.pl_index/224)) * 1.066
		//if (yt6.pl_index > 224 && yt6.pl_index < 232) offset = offset - (Math.round(yt6.pl_index/224) * 17) //0.22
		elementHeight = yt6.playlist_scroller.scrollHeight / (end - start); offset = offset - 0.5
			//yt6.scrollT.firstChild.nextSibling.children.length * elementHeight
		//console.log(start +' '+ end +' '+ offset);
		//console.log(elementHeight); console.log( yt6.playlist_scroller.scrollTop +' '+ elementHeight * offset )
		//if (64 >= Math.abs(yt6.playlist_scroller.scrollTop - 64 * offset) ) {
...
function buildObject(ytplayer){ //console.log('build')
  ...
  if (yt6.mobile && yt6d.ad) location.href = window.location.href//browserName == 'Yandex' && 
...
*/
  ...
  var ft = [args.url_encoded_fmt_stream_map, args.adaptive_fmts || yt6.adaptive_fmts ],
      fn, a_r, ad = 0, dur, durA1 = [], durA2 = [], durL1 = [], durL2 = [], avg1, avg2, length_seconds = args.length_seconds
...
'			};');
	    ...
	    if (yt6.yt_otf.length && x.indexOf('p ') > -1) yt6.afmts.push(1*itag_)
	      ...
	      if (href.indexOf('yt_live_broadcast') == -1 && (m == 'V' || m == 'A')) { yt6.yt_otf.push(1*itag_) }//m == 'V'; //console.log(m +' '+itag_); 
...
if (gid("bm1")) {
  ...
  yt6.select_fmt = function(fmt) {
    ...
    yt6.prefer_fmt = fmt
    if (fmt != 'all' && a && !isNaN(a['a']) ) {
      if (yt6.fmts_fallback.V.uniq[fmt].indexOf(yt6.userprefV[0]) == -1) {
	yt6.userprefV.splice(yt6.userprefV.indexOf(1 * a['a']), 1)
	yt6.userprefV.unshift(1 * a['a'])
      }
      if (yt6.userprefA[0] == yt6.userprefV[0] && yt6.fmts_fallback.A.uniq[fmt].indexOf(yt6.userprefA[0]) == -1) {
	yt6.userprefA.splice(yt6.userprefV.indexOf(1 * a['a']), 1)
	yt6.userprefA.unshift(1 * a['a'])
      }
      //console.log(yt6.userprefV +'\n'+yt6.userprefA )
    }
  }
					...
					addEL(me, 'error', function(e) { ev = '1error'; //ev_log(ev); //console.log(ev)
					  ...
					  if (me.networkState == 1 || me.networkState == 3) {
						...
						if (!yt6.ytg) {
						  if (sauce != undefined && sauce.length != 0) {
						    for (i=0;i<sauce.length;i++) {
						      if (sauce[i].time != '1') { //console.log(sauce[i].parentNode)
					    ...
					    yt6.failed_itags.push(yt6.current)


					    var limit = sauce || getElementsByAttribute(document,'input','name', mep + '_sourcechooser')
					    ...
					    if ( yt6.retry >= limit) if (yt6.failed_itags2 < 5) { yt6.retry = 0; yt6.failed_itags = []; yt6.failed_itags2++ } else { }//autoplay(false) && // || (yt6.retry >= 0 && yt6.current == 242 && yt6.failed_itags.toString().split('0').length >= 3)
					    if ( yt6.retry < limit && yt6.failed_itags2 < 5 && !(yt6.retry >= Math.round(limit / 4) && yt6.failed_itags2 > 1 && yt6.failed_itags.length >= 4) &&//(gid('ytassetsjs') || yt6.ytg ) &&
						...
						function uniq(a) {
						    ...
						    return a.filter(function(item) {
						        var z = (( (yt6.failed_itags2 < 3 && yt6.md && yt6.browser_tab == 'hidden' && (item == 18 || item == 22 || item == 43)) //||
								 ...
								 ) && yt6.yt_otf.indexOf(item) == -1 // leave out unplayable links
								) ? false
								 : (seen[item] = true); //console.log(z);
							return z
						    });
						}
						...
						yt6.fmts_fallback_uniq = (!yt6.errcount) ? uniq(yt6.fmts_fallback.V.uniq[yt6.prefer_fmt]) : uniq(yt6.fmts_fallback.V.revers[yt6.prefer_fmt]) //uniq()
						if (yt6.prefer_fmt == 'webm') fmt = 'dash'
						if (yt6.prefer_fmt == 'dash') fmt = 'webm'
						if (fmt) {
						  yt6.fmts_fallback_uniq.push.apply(yt6.fmts_fallback_uniq, yt6.fmts_fallback.V.revers[fmt]); //console.log(yt6.fmts_fallback_uniq)
						}
						yt6.fmts_fallback_uniq.push.apply(yt6.fmts_fallback_uniq, yt6.fmts_fallback.A.all)
						var x = yt6.userprefV[0]
					      } else {
						  yt6.fmts_fallback_uniq = (!yt6.errcount) ? uniq(yt6.fmts_fallback.A.uniq[yt6.prefer_fmt]) : uniq(yt6.fmts_fallback.A.revers['all']) //uniq()
						  if (yt6.prefer_fmt == 'webm') fmt = 'dash'
						  if (yt6.prefer_fmt == 'dash') fmt = 'webm'
						  if (fmt) {
						...
						if (typeof itag_ != 'number') itag_ = yt6.userprefV[0]
					      ...
					      for(j=(yt6.fmts_fallback_uniq.indexOf(itag_)); j<yt6.fmts_fallback_uniq.length; j++){
						...
						if ( (qual[itag_] && qual[itag_]['m'].indexOf('webm') > -1 && yt6.prefer_fmt == 'dash') ||
						  ...
						  if (yt6.failed_itags2 == 1 || yt6.failed_itags2 == 3) {
						    ...
						    for(k=Math.max(j,0);k<yt6.fmts_fallback_uniq.length;k++){ //console.log(yt6.failed_itags2 + ' ' +k +' '+yt6.retry +' / '+ limit+' --  '+yt6.failed_itags)//k=Math.max(j+1,0) //.indexOf(1)
						      var itag_ = yt6.fmts_fallback_uniq[k]; if (itag_ == 241) itag_ = 278; if (itag_ == 160) itag_ = 132; //console.log(k +' '+ itag_)
						...
						//	if (!fmt) dash = gid(mep_x('mep_') + '_sourcechooser_' + qual[itag_]['a'])
							...
							yt6.failed_itags.push(0); break
						      } else if (!yt6.failed_itags.includes(itag_)) { yt6.failed_itags.push(itag_) }
						    }
						    if (!(yt6.failed_itags2 > 1 && yt6.A_[itag_] )) { break; } else { yt6.failed_itags2++ }

						  } else //if (yt6 && !yt6)
							if (yt6.failed_itags2 == 2 || yt6.failed_itags2 == 4) { // continue searching in reverse order (from lowest resolution to highest)
						...
						if (!(yt6.navigation && !yt6.linx[itag_]) || (yt6.navigation && (!yt6.linx.length || (yt6.linx.length && 3 >= yt6.linx.length))) ) {
						  no_default(itag_, 'V'); if (yt6.A_.indexOf(itag_) > -1) no_default(itag_, 'A'); yt6.retry++
...
*/
					...
					addEL(me, 'loadedmetadata', function() { ev = '1loadedmetadata'; //ev_log(ev); //console.log(ev)
					  ...
					  if (mep) if (yt6.A_[itag(me.src)] || (itag(me.src) >= 103 && yt6.fmts_fallback.A.all[itag(me.src)])) {
					    ...
					    if (itag_ && 1 * itag_ != yt6.userprefA[0]) {
					      if (!yt6.no_default) {
						if (yt6.userprefA.indexOf(1 * itag_) > -1) yt6.userprefA.splice(yt6.userprefA.indexOf(1 * itag_), 1)
						yt6.userprefA.unshift(1 * itag_)
						delete yt6.userprefA[20]
						if (yt6.userprefV.indexOf(1 * itag_) > -1) { yt6.userprefV.splice(yt6.userprefV.indexOf(1 * itag_), 1); delete yt6.userprefV[20] }
					  ...
					  if (itag_ && 1 * itag_ != yt6.userprefV[0]) {
						...
						if (yt6.userprefV.indexOf(1 * itag_) > -1) yt6.userprefV.splice(yt6.userprefV.indexOf(1 * itag_), 1)
						yt6.userprefV.unshift(1 * itag_)
					...
					addEL(me, 'loadeddata', function() { ev = '1loadeddata'; //ev_log(ev); //console.log(ev)
					  ...
					  if (yt6.ads_eid && me.src.indexOf(yt6.ads_id) > -1) { yt6d.mep_reload(); autoplay(true) } //!(yt6.mobile && yt6.browser_tab == 'hidden') && 
					...
					addEL(me, 'pause', function() { ev = '1pause'; //ev_log(ev); //console.log(ev)
					  ...
					  if (yt6.retry < (yt6.limit || 8) && yt6.player2) {
		  ...
		  success: function(me) {  $('#audio-type').html( me.pluginType);
					...
					addEL(me, 'ended', function() { ev = '2ended'; //ev_log(ev); //console.log(ev)
					  ...
					  if (player1.options.loop1) {
						...
						try {
						  //yt6.player2.setSrc('https://www.youtube.com/ptracking'); yt6.player2.load()
...
addEL(window, 'yt-navigate-start', yt6.body.yt_navigate_start, false)
  ...
  // end of touchemulator
	...
	} else if (yt6.mobile && yt6.pls && !yt6.x && !(yt6.wna && yt6.wna.parentNode)) {
		scrollToCurrentVideo()
		set_controls()
	  }
...
//
	...
	if (ads && ads != ads0) { //&& (yt6.x || yt6.ytm || yt6.mobile || (yt6.x && yt6.md && yt6.browser_tab == 'hidden') )) {
...
//      if (Math.abs(p1.style.height.replace('px','') - Math.floor(p1.style.height.replace('px','') / 2) * 2) < Math.abs(p1.style.height.replace('px','') - Math.ceil(p1.style.height.replace('px','') / 2) * 2)) { p1.style.height = Math.floor(p1.style.height.replace('px','') / 2) * 2 + 2 + 'px' } else { p1.style.height = Math.ceil(p1.style.height.replace('px','') / 2) * 2 + 'px' }
  ...
  if (!yt6.mobile) {
    ...
    if (c || !yt6.flexy || (yt6.flexy && !c && yt6.osw.offsetWidth >= w )) a.style.width = w + 'px'; // triggers a superfluous repositioning of the flexible player in default view mode
    a.style.height = h + 'px'
...
if (yt6.flexy) {
  if (windowwidth < 1000 || !(document.getElementsByTagName('ytd-watch-flexy')[0] && document.getElementsByTagName('ytd-watch-flexy')[0].hasAttribute('is-two-columns_'))) {
	...
	//yt6.inf.style.marginTop = '293px'
	    ...
	    if (yt6.api && yt6.api.getAttribute('id') == 'container') yt6.api.style.width = '0px'
...
function deldiv(){
  ...
  if (yt6.api && yt6.api.getAttribute('id') == 'container') yt6.api.style.width = ''
