...
// mobile device
if (typeof window.matchMedia == 'function' && (yt6.mobile || ('ontouchstart' in window) || ('onmsgesturechange' in window)) &&
...
yt6.brands = function() {
  if (navigator.userAgentData && navigator.userAgentData.brands) {
    var b = navigator.userAgentData.brands, c = 'Chromium', g = 'Google Chrome', n = 'Not', d = 'Brand', e = 'Brave'

    if (b) {
      var b0 = (b[0]) ? b[0].brand : '', b1 = (b[1]) ? b[1].brand : '', b2 = (b[2]) ? b[2].brand : ''
	yt6.ua_brands = b.length +'\nb0="'+ b0 +'"\nb1="'+ b1 +'"\nb2="'+ b2 +'"\n"'+ ((b[3]) ? b[3].brand : '') +'"'; //ev_log(yt6.ua_brands)
      if (b2) {
	if (b0 == n+'_A '+d && b1 == c) {
	  if (b2 == g) return (window.sharedStorage && window.sharedStorage.worklet) ? 'Chrome' : ('Vivaldi' || 'Edge')
	  if (b2 == e) return e
	}
	if (b0 == e || b0 == n+'/A)'+d) {
	  if (b1 == g) return 'Chrome'
	  if (b0 == n+'/A)'+d)  if (b1 == c && b2 == e) return e//if (b2 == g) { return 'Chrome' } else
	  if (b1 == 'Microsoft Edge') return 'Edge'
	  if (b0 == e || b1 == e) return e
	}
	if ((b[3] && b[3].brand == 'Vivaldi')
	 || (b0 == n+'.A/'+d && b1 == c)
	 || (b0 == c && ((b1 == n+')A;'+d && b2 == g) || (b1 == g && b2 == n+'-A.'+d)) )
	   ) { return 'Vivaldi' }
	if (b0 == c && ((b1 == g && b2 == n+'=A?'+d) || (b1 == n+'(A:'+d && b2 == g)) ) return (window.sharedStorage && window.sharedStorage.worklet) ? 'Chrome' : 'Vivaldi'
	if (b0 == ' '+n+' A;'+d && b1 == c && b2 == 'Opera') return 'Opera'
	if (b0 == g && b1 == c && b2 == n+'.A/'+d) return 'Chrome'
      } else if (b0 == n+'_A '+d && b1 == c) return (yt6.md) ? 'Kiwi' : 'Ungoogled '+c
      if (b1) {
	if (b0 == c) {
	  if (b1 == n+'/A)'+d) return 'Chromium'
	  if (b1 == n+'-A.'+d || b1 == n+'.A/'+d) return 'Comodo Dragon'
	  if (b1 == n+'(A:'+d) return 'Ecosia'
	  if (b1 == n+'?A_'+d && !b2) return ((yt6.md) ? 'Ecosia' : 'Comodo Dragon')
	}
	if (b1 == c) {
	  if (b0 == ' '+n+' A;'+d) return 'Ungoogled '+c
	  if (b0 == n+')A;'+d) return 'Kiwi'
	  if (b0 == n+'.A/'+d) return 'Yandex'
	  if (b0 == n+':A-'+d) return 'Chromium'
	}
      }
    }
  } else return ''
    ...
    var browserName = "undefined", fcnm;


    // Chrome 1+
    if (window.chrome && (window.chrome.app || navigator.userAgent.indexOf(' Mobile') > -1 || window.chrome.webstore)) {
	...
	if (navigator.plugins.length == 0 || (navigator.plugins.length >= 2 && (navigator.plugins[0].name && (navigator.plugins[0].name.indexOf('Chromium') == 0 || (navigator.plugins[1][0] && navigator.plugins[1][0].type == 'application/x-google-chrome-pdf')) ))) {
	  browserName = "Chromium";
        } else if ( yt6.brands() == 'Chrome' || (navigator.plugins[0].name === "Chrome PDF Plugin" && navigator.plugins[1].name === "Chrome PDF Viewer") )
	  browserName = "Chrome";
      }
    }
	
    // Edge 20+
    if ( (yt6.brands() == 'Edge') || navigator.userAgent.indexOf(' Edg') > -1 || (!(document.documentMode) && window.StyleMedia) )
	browserName = "Edge";
    ...
    // Brave
    if ( (navigator.brave) || //window.Brave && (is undefined when Shields are down)
	...
	if (browserName != 'Edge' && browserName != 'Opera') {
	  ...
	  if (browserName != 'Vivaldi' && yt6.brands() != 'Kiwi' && !(navigator.plugins[2] && navigator.plugins[2][0] && navigator.plugins[2][0].type == 'application/pdf')) browserName = "Brave"
	}
...
;(function (window) {
    ...
    if ((browserName == "Chromium" || browserName == "undefined") && yt6.brands()) browserName = yt6.brands()
	...
	if (browserName == "undefined") {
	  ...
	  if (navigator.userAgent.indexOf('Mobile DuckDuckGo/') > -1 || navigator.userAgent.indexOf('; K) AppleWebKit') > -1) { browserName = "DuckDuckGo" }
	}
    }
...
var pseudoSrc = 'https://www.youtube.com/ptracking'
function clear_mep(y) {
  if (typeof yt6 == 'object' && typeof y == 'object' && typeof y.setSrc == 'function' && typeof y.load == 'function') { y.pause(); y.setSrc(pseudoSrc); y.load(); y.isLoaded = false }
}
...
function gclass(className, tag, elm){
	...
	for(i=0; i<length; i++){
		current = elements[i];
		if(typeof current.className == 'string' && testClass.test(current.className)){
...
function gc(elem, scope) {

  var z = document//(scope === 1) ? document : scope
  if (z && typeof z.getElementsByClassName == 'function') {
    var z = z.getElementsByClassName(elem)
  } else var z = gclass(elem)

 return z
}

function gt(elem, scope) {
  var z = (scope === 1) ? document : scope
  return ((z) ? z.getElementsByTagName(elem) : z)
}
...
var noads = setInterval(function(){
  ...
  ads = gc('ytm-bottom-sheet-overlay-container')[0]; if (ads) ads.parentNode.removeChild(ads);
  ads = gc(' modern-overlay bottom-sheet-overlay-scrim')[0]; if (ads) ads.parentNode.removeChild(ads)
...
yt6.userprefV = (!yt6.mobile) ? [397,244,134,396,243,133,43,18] : [396,243,133,43,18]; yt6.userprefV_bak = []
...
yt6.prev_media = []
  ...
  var qual = {
    ...
    249: {'t':'48k WebM Opus','a':'250',		'q':'tiny','m':'audio/webm; codecs="opus"'},
    250: {'t':'64k WebM Opus','a':'251',		'q':'tiny','m':'audio/webm; codecs="opus"'},
    ...
    600: {'t':'30k WebM Opus','a':'249',		'q':'tiny','m':'audio/webm; codecs="opus"'},
    ...
    779: {'t':'720p WebM VP9','a':'136',		'q':'hd720','m':'video/webm; codecs="vp9"'},
    780: {'t':'720p WebM VP9','a':'136',		'q':'hd720','m':'video/webm; codecs="vp9"'}
  };
...
var f = yt6.fmts_fallback = {};
  ...
  f.V.av1 = [,,,,401,,,,,,400,,,,,,,,399,,,,,,,,,398,,,,,,,,,397,,,,,,,,,,,,396,,,,,,,395,,,,394,,,,,,,,,,,,,,,,,,,,,1
  ]
  f.V.uniq.av1 = clone(f.V.av1)

  f.V.webm = [,272,,337,,315,,313,,336,,308,,271,,335,303,,,248,,170,46,,334,302,,,780,779,247,,169,45,,333,,246,245,244,,219,218,168,44,,,332,,243,,167,43,,331,,242,,330,,278,241,,,598,,
  278,,
  ]
  f.V.uniq.webm = clone(f.V.webm)

  f.V.h264 = [138,,38,,,,305,,266,,,,304,,264,,,299,,,137,,,37,,,298,,,,,136,,,22,,,,,,135,,,,,78,59,,,,134,,,18,,,,133,,,,,132,160,,597,
  ,132,
  ]
  f.V.uniq.h264 = clone(f.V.h264)

  f.A.webm = [,,,,251,172,171,250,249,,600,,1]
  f.A.uniq.webm = clone(f.A.webm)

  f.A.aac = [258,256,141,140,,,,,,139,,599,1]
  f.A.dash = f.A.h264 = f.A.aac
  f.A.uniq.dash = f.A.uniq.h264 = f.A.uniq.aac = clone(f.A.aac)

  f.V3D.dash = f.V3D.h264 = [85,,84,,,82,83,1]
  f.V3D.uniq.h264 = clone(f.V3D.dash)

  f.V3D.webm = [,102,,101,100,,,1]
  f.V3D.uniq.webm = clone(f.V3D.webm)

  f.other = [35,34,6,5,36,17,13]
  f.other.uniq = clone(f.other)
  ...
  for(i=0; i<f.V.h264.length;i++){
    if (f.V.h264[i] || f.V.webm[i] || f.V.av1[i]) {
      f.V.all[i] = clone(f.V.h264[i] || f.V.webm[i] || f.V.av1[i])
	  f.V.dash[i] = clone(f.V.h264[i] || f.V.av1[i])
      f.V.uniq.all[i] = clone(f.V.uniq.h264[i] || f.V.uniq.webm[i] || f.V.uniq.av1[i])
	  f.V.uniq.dash[i] = clone(f.V.uniq.h264[i] || f.V.uniq.av1[i]);
    }

    if (f.A.aac[i] || f.A.webm[i]) f.A.all[i] = clone(f.A.aac[i] || f.A.webm[i])
    if (f.A.uniq.aac[i] || f.A.uniq.webm[i]) f.A.uniq.all[i] = clone(f.A.uniq.aac[i] || f.A.uniq.webm[i])

    if (f.V3D.h264[i] || f.V3D.webm[i]) f.V3D.all[i] = clone(f.V3D.h264[i] || f.V3D.webm[i])
    if (f.V3D.uniq.h264[i] || f.V3D.uniq.webm[i]) f.V3D.uniq.all[i] = clone(f.V3D.uniq.h264[i] || f.V3D.uniq.webm[i])
  };

	f.A.revers = {}
	f.V.revers = {}
	f.V3D.revers = {}
	f.A.revers.webm = clone(f.A.uniq.webm)
	f.A.revers.aac = clone(f.A.uniq.aac)
	f.A.revers.all = clone(f.A.uniq.all)
	f.V.revers.webm = clone(f.V.uniq.webm)
	f.V.revers.h264 = clone(f.V.uniq.h264)
	f.V.revers.av1 = clone(f.V.uniq.av1)
	f.V.revers.dash = clone(f.V.uniq.dash)
	f.V.revers.all = clone(f.V.uniq.all)
	f.V3D.revers.webm = clone(f.V3D.uniq.webm)
	f.V3D.revers.h264 = clone(f.V3D.uniq.h264)
	f.V3D.revers.all = clone(f.V3D.uniq.all)
  ...
  var z = [
	...
	f.V3D.webm,
	f.V.all,
	f.A.all, // mirroring this may cause audio-only playback to falter when falling back from webm to aac (on mobile)
	f.V3D.all
  ]
  for (i=0; i<z.length; i++) {
    z[i].push.apply(z[i], reverseArr(z[i]))
    if (z[i] == f.V.webm) z[i].push.apply(z[i], f.A.webm)
    if (z[i] == f.V.h264) z[i].push.apply(z[i], f.A.aac)
    if (z[i] == f.V.dash) z[i].push.apply(z[i], f.A.aac)
    if (z[i] == f.V.all) z[i].push.apply(z[i], f.A.all)
    //if (z[i] == f.A.webm || z[i] == f.A.aac || z[i] == f.A.all) { z[i].push(18) }//; z[i].push(17)
  }
    //f.V.webm.push.apply(f.V.webm, f.V.dash)
    //f.V.dash.push.apply(f.V.dash, f.V.webm)
  ...
  for (i=0; i<z.length; i++) {
    z[i].push.apply(z[i], reverseArr(z[i]))
    //if (z[i] == f.A.uniq.webm || z[i] == f.A.uniq.aac || z[i] == f.A.uniq.all) { z[i].push(18) }//; z[i].push(17)
  }
  ...
  for(i=0; i<z.length; i++) {
    ...
    if (z[i] == f.A.revers.webm || z[i] == f.A.revers.aac || z[i] == f.A.revers.all) { z[i].push(18) }//; z[i].push(17)
  }
})();
...
function itag(me_src){
  if (typeof me_src == 'string') {
    ...
    if (me_src.indexOf('itag/') > -1) itagx = me_src.split('itag/')[1].split('/')[0]
    if (itagx) { if (itagx == '278') itagx = 241; if (itagx == '160') itagx = 132; return (1*itagx) } else { return 999 }
  } else return 999
}
...
function hid(x) {
  if (!x) return (yt6.browser_tab == 'hidden')
  if (x == 'v') yt6.browser_tab = 'visible'
  if (x == 'h') yt6.browser_tab = 'hidden'
}
...
(function() {
  ...
  window.onchange = function (evt) {
    ...
    if (evt.type && evt.type.indexOf('visibilitychange') != -1) {
      if ( (hid() && (this[hidden] == false || typeof this[hidden] == 'undefined' )) || (!hid() && (this[hidden] == true || typeof this[hidden] == 'undefined' )) ) {

          yt6.browser_tab = this[hidden] ? 'hidden' : 'visible';

      } else {
	      if (hid()) { hid('v') } else if (this[hidden]) { hid('h') }
	    }
    } else if (evt.type in evtMap) {
	      yt6.browser_tab = evtMap[evt.type];
	    } else if (evt.type == 'change') {
	        if (typeof this[hidden] == 'undefined') {
	          if (yt6.browser_tab != 'visible') { hid('h') }
	        } else {
	          }
	      } else {
		  //yt6.browser_tab = yt6.browser_tab
		}
    if (!yt6.browser_tab) hid('v')
    ...
    if (yt6.player1 && yt6.player1.media) {
	  ...
	  if (pv == 'hidden' && !hid()) { //ev_log(';h->v;')
	    if (yt6.x && yt6.md && !(yt6.layout == 16 && !yt6.mobile && !yt6.ytm)) { yt6.Seek = 6 } else
		...
		if (yt6.x) {
		  if (typeof t1 == 'number' && typeof t2 == 'number' && Math.abs(t1 - t2) > 0.3) {
		    if (!(yt6.audiox && t1 > yt6.player2.media.duration)) {
		      yt6.ct = yt6.player1.media.currentTime = (t2 > t1) ? t2 : t1; yt6.player2.media.currentTime = (t2 > t1) ? t2 : t1
		    }
		  }
	    ...
	    if (yt6.mobile && typeof window.onchange == 'function') {
	      if (yt6.pls) {
		if (!restore_cp(yt6.pls)) scrollToCurrentVideo()
		//yt6d.orientation = (yt6d.orientation == 0) ? 90 : 0
	      }
	//      set_controls()

	    }
	    if (yt6.x) try { yt6.player1.showControls(false)
		var bp = gc('mejs-overlay-play')[0]; if (bp) bp.style.visibility = 'hidden'
		if (!yt6.player1.options.alwaysShowControls) setTimeout(function(){ yt6.player1.hideControls(true) }, 5000)
	    } catch(e){}
	  }

	  if (pv == 'visible' && hid()) { yt6d.hid = true; //ev_log(';v->h;')
	    if (t0) {
	    ...
	    } else if (yt6.mobile) try { yt6.player2.media.currentTime = yt6.ct = yt6.player1.media.currentTime } catch(e){}
	  ...
	  if (yt6.me_flash_) {
	    ...
	    if ((!hid() && !yt6.navigation) && z[0] && z[0].style.display == 'block') for(var i=0;i<z.length;i++) z[i].style.display = 'none'
	  }
    }

  }; var ev = {}; ev.type = 'blur'; window.onchange(ev);

  // visibilitychange events won't fire in Brave (?)
  var z = (browserName !== 'Brave' && browserName !== 'Vivaldi' && !(yt6.md && !yt6d.hid && browserName == 'Chromium')) ? true : false
  // Standards:
  ...
  if( document[hidden] !== undefined )
	...
	function(){
	  if (t == 'V') { if (1 * yt6.userprefV[0] == 1 * _itag) yt6.userprefV.splice(0,1); if (1 * yt6.userprefV[yt6.userprefV.length-1] == 1 * _itag) yt6.userprefV.splice(yt6.userprefV[yt6.userprefV.length-1],1) }; //if (yt6.audiosauce && yt6.userprefV[0] != yt6.audiosauce) yt6.userprefV.unshift(yt6.audiosauce)
	  if (t == 'A') { if (1 * yt6.userprefA[0] == 1 * _itag) yt6.userprefA.splice(0,1); if (1 * yt6.userprefA[yt6.userprefA.length-1] == 1 * _itag) yt6.userprefA.splice(yt6.userprefA[yt6.userprefA.length-1],1) }; //if (yt6.audiosauce && yt6.userprefA[0] != yt6.audiosauce) yt6.userprefA.unshift(yt6.audiosauce)
	},
	500,5000
      )
...
yt6.cdn_ = function(){
  yt6.cdns = ['//cdn.rawgit.com/snarly/yt6/','//cdn.jsdelivr.net/gh/snarly/yt6@','//rawcdn.githack.com/snarly/yt6/']
  ...
  if (yt6.cdn == '//cdn.rawgit.com/snarly/yt6/') yt6.cdns = cdns.splice(cdns.indexOf('//cdn.jsdelivr.net/gh/snarly/yt6@',1))
  if (yt6.cdn == '//cdn.jsdelivr.net/gh/snarly/yt6@') yt6.cdns = cdns.splice(cdns.indexOf('//cdn.rawgit.com/snarly/yt6/',1))
...
function swfbin4(){
  ...
  yt6.flash.swfbin4 = gt('ytg-app', 1)[0]
...
function find_key(rpt){
  ...
  if (rpt.indexOf("function fcnm(") != -1) {
    ...
    eval(rpt);
    if (typeof window.fcnm == 'undefined') {
      window.fcnm = (typeof fcnm == 'function') ? fcnm : new Function("a", fcn.substring(17,findClosingBracketMatchIndex(fcn,fcn.indexOf('{'))) )
    }
    return window.fcnm
  }


  //  var fcn = rpt.match(/signature=([^(]+)/)[1];
  //  var fcn = rpt.match(/dashmpd.[^]*signature\/"\+(.|[\s\S].\)\)\;)/)[0];//+ 2ik_1ez&

  function fcnm2() {
	var fcn = rpt.split('set("signature",')[1]
	if (fcn) {
	  fcn = fcn.split('(')[0]
	  fcn = fcn.split("\n").join("").split("\r").join("");
	}
  ...
  var fcn = rpt.split('dashmpd,')[1]
  if (!fcn) fcn = rpt.split('.dashmpd')[1]
  if (fcn) {
    fcn = fcn.split('));')[0];
    if (document.location.href.indexOf('/base.js') == document.location.href.length-8 && fcn.indexOf('&amp;') != -1) fcn = fcn.split('&amp;').join('&')
    var i = fcn.split('\"/signature/\"\+')[1]
    if (i) {
      i = i.split(")")[0].split("\n").join("").split("\r").join("").split(" ").join("");
      var j = fcn.split("&&("+i+"=")[1] || fcn.split("&amp;&amp;("+i+"=")[1];
      if (j) { fcn = j.substring(0,2) } else if (i) {
	var j = fcn.split('\"/signature/\"\+')[0].split('');
	for(k=j.length;k>0;k--){
	  if (j[k] == i && j[k+1] == '=' && (j[k+2]+j[k+3]+j[k+4]+j[k+5]+j[k+6]).indexOf('.') == -1) { fcn = j[k+2] + j[k+3]; break }//.substring(k+2,k+4); break }
	}

      } else var fcn = fcnm2()
    } else {//2018 variant
	//var i = fcn.split('"signature":"sig"')[1]
	//if (i) { fcn = i.split('=')[1].split('(')[0]
	//} else {//2018/09
	    //(\w+)\s*=\s*function\((\w+)\){\s*\2=\s*\2\.split\(""\)\s*;

	    //var regex = new RegExp('^(?!(?:=function(a){a=a.split("");+\\w+\\s)$)', 'g');
	    fcn = rpt.split('=function(a){a=a.split("")')[0]; fcn = (fcn) ? fcn.substr(fcn.length-2, 3) : null
	...
	// =function(a){a=a.split("");ot.Iq(a,8);ot.bw(a,21);ot.h0(a,2);ot.bw(a,32);ot.h0(a,1);ot.bw(a,34);ot.Iq(a,59);ot.h0(a,2);return a.join("")};
	  ...
	  function getFunctionName(str){
	    ...
	    var fcn, array = rpt.split(str)//'=function(a){a=a.split("")'
		...
		fcn = null; continue
		  ...
		  if (x) {
		    if (x.length == 2) {
		      fcn = x.substr(x.length-2,3) // 2-letters long
		    } else
		      fcn = x.substr(x.length-3,4) // 3-letters long func name
		    
		  } else { x = null; y = null }
		  break
		}
	    }
	    return (!fcn || (typeof fcn == 'string' && 1 >= fcn.replace(/(\r\n|\n|\r)/gm," ").split(' ').join('').length )) ? '' : fcn

	  }

	var fcn = getFunctionName('=function(a){a=a.split("")')
	var n = getFunctionName('=function(a){var b=a.split(""),c=') //old
	if (!n) n = getFunctionName('=function(a){var b=String.prototype.split.call(a,') //new #1 //""),c= //("","")),c=
	if (!n) n = getFunctionName('=function(a){var b=a.split(a.slice(0,0)') //new #2
	//console.log(fcn); console.log(n)
  ...
  try {
      //console.log(fcn)
      var fs = new RegExp(    sprintf('function %s[^}]+}[^}]+}', fcn.replace('$', '\\$'))  );
      if (rpt.match(fs) == null) {
	var fs = new RegExp(    sprintf('var %s=function[^}]+};', fcn.replace('$', '\\$'))  );
	if (rpt.match(fs) == null) {
	  var fs = new RegExp(    sprintf('[^\\w.]+%s=function[^}]+}', fcn.replace('$', '\\$'))  );//\\W does not suffice, have to exclude the possibility of a leading dot as well
	}
      }
    //console.log('fs='+rpt.match(fs))
    //var fs = new RegExp('function ' + fcn.replace('\$','\\$') + '[^}]+}[^}]+}');
    ...
    try {yt6.tmp3 = rpt
      ...
      if (n2) {
	nreg = null; n2 = n2[0]; n2 = n2.split(n2.split('.join("")};')[1])[0]
      } else {
	  nreg = new RegExp(	sprintf('%s=function[^}]+[^}].*return\ b\.join[\(]""[\)]', n.replace('$', '\\$'))	)
	  n2 = rpt.match(nreg); if (n2) n2 = n2[0].split('return b.join("")')[0] + 'return b.join("")};'
	}
	if (n2) eval('yt6d.ndec = ' + n2.replace(n +'=',''))
    } catch(e) {}
      ...
      if (!fcn) {
		...
		fcn = null; continue
		  ...
		  fcn = (x) ? x.substr(x.length-2,3) : null; x = null; y = null; break
		}
	    }
      }
      var fs = fcn + '=function(a){a=a.split("")'; fs = fs + rpt.split(fs)[1].split('};')[0];
...
function msg_box0(id, text, color, bgcolor){
	...
	if (!gid('msg-box1')) {
	  ...
	  z.id = 'msg-box1'
	  yt6.appendChild(z)
	  z.setAttribute('style','position: fixed; z-index: 601; border: background-color: transparent; width: 0px; height: 0px;')
	}
...
yt6.recharge = function() {
		    ...
		    yt6.osw = (!yt6.ytm) ? gid('placeholder-player') || gid('player') : gt('ytmusic-player', 1)[0]
		...
		if (feed || (!feed && fcnm && typeof fcnm.toString == 'function' && fcnm.toString().indexOf('dekrypt0') > -1)) {
		  if (!window.yt6_video_source) { yt6.recharge() } else yt6.source_needed()
			...
			if (gid(\'setjs\').value.indexOf(\'function()\') != -1 || gid(\'setjs\').value.indexOf(\'function fcnm(\') != -1) {\
			  ...
			  gt(\'body\', 1)[0].appendChild(scpt);\
			  var scpt = gid(\'ytassetsjs\');\
			  var z = gid(\'snarls_player\');\
			  yt6.tmp = gt(\'script\', yt6)[0]; yt6d.src = (yt6.tmp && yt6.tmp.src) ? clone(yt6.tmp.src) : clone(yt6.src);\
...
/*if ((gid(\'setjs\') && gid(\'setjs\')[yt6.txt] == \'\') || (gid(\'movie_player\') && typeof gid(\'movie_player\').getPlayerState == \'function\')) { try {\
     ...
     var errorText = '<span><b><strong>ERROR:</strong></b> Automatic processing failed. Manually maybe possible.<br><br>If the new pop-up window or tab was denied, <br><b><strong>click the Transformer-icon next to the YouTube logo.</strong></b><br><br>It will open a wall of text -- part of the YouTube Player\'s own code -- starting with something like \"var _yt_player\".<br><b><strong>Try to run the bookmarklet on that page too in order to reduce the huge text size to the few lines needed.</strong></b><br><br><b><strong>SELECT & COPY its content,<br>then PASTE it into the "Code input" field here.<br>If done, press ENTER.</strong></b></span>'
...
function player_api_div() {
	if (!gid('player-api') && (yt6.layout == 16 || yt6.ytp.embed) ) {
	  if (gid('player')) {
	    var z = document.createElement("div")
	    z.id = 'player'
	    ...
	    if (gid('player') == z && !yt6.skeleton) z.id = 'player-null'
	  }
...
if (!gid('video-hide')) {
   (function(){
	...
	var a = gc('alerts-wrapper')[0]; if (a && !gt('body', 1)[1]) a.setAttribute('hidden','')
	delete z;
    })();
}
...
function store_ytp_currentTime() {
	if (yt6.ytp.strState != 4) {
	  if (yt6.ytp.strCt < 2 && player() && !(yt6.ytm && yt6.p.tagName == 'EMBED')) {
	  ...
	  if (typeof yt6.ytp.strCt2 == 'number') yt6.ytp.strCt = clone(yt6.ytp.strCt2)
	}
}
...
// currently loaded or were previously selected by the user on the native YT player)	path.indexOf('mediaElement') > -1

//missing sparams:
//aitags,bui,vprv,mime,gir,clen,dur,lmt
//added sparams:
//sabr
...
"yt6.flatten = function(src, path, seen) { \
  ...
  var key, value, oc, pt;\
  if ( yt6.ytm || (c && c.name != 'Symbol' && cts.indexOf('function Window()') != 0 && cts.indexOf('function(){return') != 0 && cts.indexOf('function HTMLIframeElement()') != 0 && \
	(   ( cts.indexOf('function Object()') != 0 /*&& !(path.length >= 17 && path.indexOf('streamingData') != 16)*/ ) || yt6.dummy\
	 || ( yt6.xhr.async && cts.indexOf('function Object()') == 0 && yt6d.previous.video_id && ( cts.indexOf('function Object()') != 0 && path.length < 3 || (cts.indexOf('function Object()') == 0 && path.length >= 3 && path.indexOf('app') == 2 && (!(path.length == 4 && path.indexOf('config') == 3) && !(path.length == 5 && path.indexOf('args') == 4)) ) ) \
	    )\
	) && path.indexOf('yt6') == -1 && path.indexOf('subscriptions_') == -1 && path.indexOf('playlist') == -1 && path.indexOf('listeners') == -1 && path.indexOf('events') == -1 && path.indexOf('contextMenu') == -1 && path.indexOf('logger') == -1 && path.indexOf('__shady') == -1 && path.indexOf('videoData') == -1 && path.indexOf('mediaElement') == -1 && path.indexOf('element') == -1 /*&& path.indexOf('contents') == -1 && path.indexOf('suggestions') == -1 && path.indexOf('contents') == -1 && path.indexOf('responseContext') == -1 && path.indexOf('endscreen') == -1 && path.indexOf('adPlacements') == -1 && path.indexOf('playerOverlays') == -1 && path.indexOf('engagementPanels') == -1 && path.indexOf('topbar') == -1*/\
  ) ) \
  try {\
  for (let [key,value] of Object.entries(src)) {\
	...
	var a = [], i, j, k, l, m, n, o, _itag, url, pot, list = {}, audio = [], video = [], piece = '', vi, vij, vik, n_decoded;\
	if ([...path, key].indexOf('policy') > -1 || (key == 'subscriptions_' && typeof value == 'object')) { for (i in value) { vi = value[i]; if (vi && typeof vi == 'object') { if (typeof vi.csiPageType == 'string' || typeof vi.app == 'object') for (j in vi) { vij = vi[j]; if (vij && typeof vi.csiPageType == 'string') yt6.potObj = vi;\
	  if (typeof vij == 'string') {\
	    if (!pot && vij.match(/^[A-Za-z0-9_\\-=%]+$/g)) { if (vij.length > 135) { pot = '&pot='+ vij; yt6.pot = pot; break; break } }\
	  } else if (!pot && vij && typeof vij == 'object' && vij.appState)\
	      for (k in vij) if (typeof vij[k] == 'object') for (l in vij[k]) if (typeof vij[k][l] == 'object') { if (vij[k][l] && typeof vij[k][l].csiPageType == 'string') { yt6.potObj = vij[k][l]; for (m in vij[k][l]) \
		if (typeof vij[k][l][m] == 'string' && vij[k][l][m].match(/^[A-Za-z0-9_\\-=%]+$/g)) { if (vij[k][l][m].length > 135) { pot = '&pot='+ vij[k][l][m]; yt6.pot = pot; break; break; break; break } } }\
	    };\
	} } } };\
	if ([path,key,value.toString()].indexOf('manifest') > -1) { /*console.log(path+'_'+key+'_');console.log(value)*/;\
	  var ok = false;\
	  for(i in value) { vi = value[i]; if (typeof vi == 'object') { \
	    _itag = 0; \
	    for(j in vi) { vij = vi[j];\
	      if (_itag) { ok = false; }; if (vij && typeof vij === 'object' && typeof vij.resource === 'object') { ok = true } else if (!ok) { continue };\
	      for (k in vi) { vik = vi[k]; if (typeof vik == 'object' && vik.resource) for (l in vik.resource) if (typeof vik.resource[l] == 'object' && typeof vik.info == 'object' && vik.info.itag) { _itag = vik.info.itag; list[_itag] = clone(vik.resource[l]); break } }; yt6.list = list;\
	      for (k=0;k<1000;k++) { if (list[k]) { _itag = k, a = [], url = '', n_decoded = false;\
		for(l in list[k]) { m = list[k][l]; if (typeof m == 'string' && m.indexOf('http') != 0 && m.indexOf('googlevideo.com') > -1 && a.join('').indexOf('googlevideo.com') == -1) { a[0] = 'https://'+ m + '/videoplayback?'; n_decoded = true }; };\
		try { for(l in list[k]) { m = list[k][l]; if (!a[0] && typeof m == 'string' && m.indexOf('http') == 0 && m.indexOf('googlevideo.com') > -1) a[0] = m;\
		  if (typeof m == 'object') {\
		    for(n in m) if (typeof m[n] == 'string') {\
			piece = n +'='+ m[n] +'&'; if (a[a.length-1] && a[a.length-1].slice(-1) != '&') piece = '&'+ piece; a.push(piece);\
		    };\
		    url = a.join(''); url = url + ((typeof pot == 'string') ? pot : '');\
		    if (url.indexOf('/videoplayback?') > -1) {\
			list[k].url = url;\
			if (n_decoded)\
			if (!yt6.ytp.A && yt6.fmts_fallback.A.all.indexOf(_itag || itag(url)) > -1) {\
			  yt6.ytp.Aobj = m; yt6.ytp.A = url; yt6.ytp.Aobj.url = url;\
			} else\
			  if (!yt6.ytp.V && yt6.fmts_fallback.V.all.indexOf(_itag || itag(url)) > -1) {\
			    yt6.ytp.Vobj = m; yt6.ytp.V = url; yt6.ytp.Vobj.url = url; };\
		    };\
		  }\
  ...
  if (!path.length) {\
    var op = {}, eid, nuff = 0, z, zy = 0, piece = ''; if (!yt6.age.sc && !yt6.age.dl) yt6.ttsurl = [];\
    for (let [oc,pt] of seen) {\
      ...
      .forEach(function(x){/*console.log(eid)*/;\
		z = unescape(unescape(oc[x]));\
	  	if (z.indexOf('videoplayback?') > -1 || zy){\
		  /*if ((z.indexOf('itag=251') > -1 && z.length < 4500) || zy) { ev_log('ITAG=251 '+z.length +' '+z.indexOf('&sig=')+' '+z.indexOf('/sig/') +' '+z.indexOf('%26sig%3D')); if (z.length < 900) piece = piece + z; zy++ }; if (zy >= 5) zy = 0; if (zy) ev_log('\\n\\n\\n'+ zy+' : '+z);*/\
	  	  eid = z.split('&id=')[1] || z.split('?id=')[1];\
	  	  if (eid) { eid = eid.split('&')[0].split('?')[0];\/\*.substring(0,19);\*\/ \
		    if (cts.indexOf('function Object()') == 0) yt6d.eid = eid;\
		    if (!(yt6d.current.eid.includes(eid))) {\
		      yt6d.current.eid.push(eid);\
		    }\
		    if (z.indexOf(eid) > -1) {\
		      if ([...pt, x].toString().indexOf('mediaSource') > -1 && [...pt, x].toString().indexOf('url') > -1) { yt6d.eid = eid;\
...
"var durl = Object.values(ypsi).filter(\
  x => ((x.includes('videoplayback?') || x.includes('videoplayback%253F') || x.includes('videoplayback%3F') || (!yt6.manifest.mpd && x.includes('manifest.googlevideo'))) && !x.includes('{'))\
);\
return durl }"; eval(yt6.tmp)//!x.includes('range=') && 
...
function test_4(peek) {
  ...
  if (yt && yt.player) {
    ...
    if ( yt.player.Application && (gid('player-api') || pcont()) && ( (yt6.oldbrowser || yt6.html5_fail || typeof Object.entries == 'undefined' || (typeof Object.entries == 'function' && Object.entries.toString().indexOf('[native code]') == -1) || typeof yt6.flatten == 'undefined' || typeof ypsi == 'undefined') ) ) {
	...
	if (!Array.isArray(durl)) durl = []
	if (typeof yt6.list == 'object')
	for (i=0;i<999;i++) { if (yt6.list[i] && typeof yt6.list[i].url == 'string') {
	  durl[durl.length] = clone(yt6.list[i].url)
	}}
	...
	var signame, ampersand, fmts, type, itag, lmt, clen, quality, sp, s, bgf, pot, length = 0, url, i, j, k, l, dur, size, fps, bitrate, init, index, quality_label, projection_type;
	//for (var eurl of durl) {
	if (typeof yt6.list == 'object' && yt6.pot)
	  for (i in yt6.list) if (typeof yt6.list[i].url == 'string') { j = yt6.list[i].url
	   if (j.indexOf(yt6.pot) > -1 && j.split('&sig=')[1] && durl.indexOf(j.split('&sig=')[1].split('&')[0]) == -1) durl.push(j)
	  }
	var test_itags = []
	durl.sort(function(x,y) { return y.length - x.length }) // according to length in descending order
	for (k=0;k < durl.length;k++) { test_itags.push(durl[k].length) }
	test_itags.sort(function(x,y) { return y > x })
	for (k=1;k < test_itags.length;k++) { //ev_log(test_itags[k])
	  length = (length + test_itags[k])
	}
	length = (!yt6.blocked_m && test_itags[0] > length) ? 1 : durl.length; //console.log('LENGTH='+length)
	test_itags = []

	for (k=0;k < length;k++) {
	  var eurl = durl[k], furl, trunc; 
	  var c = conf('args')
	    ...
	    for(l=1;l < (Math.ceil(eurl.length/1000) + 1); l++) {
	      itag = eurl.split('itag=')[l] || eurl.split('itag/')[l] || eurl.split('itag%3D')[l]
	      itag = (itag) ? 1 * (itag.split('&')[0].split('&amp;')[0]) : null
	      if (typeof itag == 'number' && !isNaN(itag)) { //furl = clone(eurl)
		furl = 'itag='+ (eurl.split('itag=')[l] || eurl.split('itag/')[l] || eurl.split('itag%3D')[l]).split(',')[0]//.split('%2C')[0]
		// if truncated
		if (furl.indexOf('googlevideo.com') == -1) { trunc = (eurl.split('itag=')[l-1] || eurl.split('itag/')[l-1] || eurl.split('itag%3D')[l-1]).split('itag=')[0]; if (trunc && trunc.split(',')[1]) trunc = trunc.split(',')[1]; furl = trunc + furl }

		itag = 1 * (furl.split('itag=')[1].split('&')[0])
		pot = (yt6.pot && typeof yt6.pot == 'string') ? true : false
		if (test_itags.indexOf(itag) > -1 && !pot) continue;
		if (!yt6.blocked_m) test_itags.push(itag); if (furl.indexOf('&sig=') == -1 && eurl.indexOf('itag=') == eurl.lastIndexOf('itag=')) { furl = eurl }//; ev_log('ITAG='+itag +'\n')

		if (furl.indexOf('range=') > -1) { s = 'range='+ furl.split('range=')[1].split('&')[0]; s = furl.split('range=')[0] + furl.split(s)[1]
		  if (s) {
		    // the ump=1 parameter makes the content become unplayable in progressive download mode
		    if (s.indexOf('&ump=1') > -1) { s = s.replace('ump=1','ump=0') }
		    furl = s; //ev_log('RANGE='+ itag)
		    if (yt6.fmts_fallback.A.all.indexOf(itag) > -1 && !yt6.ytp.A) { yt6.ytp.A = s } else if (!yt6.ytp.V) yt6.ytp.V = s;
		  }
		}


		if (yt6d.init && !yt6.ytm && !pot && (itag == a || itag == v)) continue; // updating formats which are currently in use by the original player could break it, better skip those
		signame = (signame) ? signame : (furl.split('lsig=')[1] || furl.split('lsig%3D')[1]) ? 'sig' : 'signature'
		fmts = (itag < 103) ? 'url_encoded_fmt_stream_map' : 'adaptive_fmts';
		if (!ytplayer.config.args[fmts]) bgf = true
		if ( (yt6.ytp.video_id && window.location.href.indexOf(yt6.ytp.video_id) > -1)
		      || pot || bgf)
		  {

		  if (yt6 && furl.indexOf('http') == 0) {
		    var z = qual[itag]
		    if (fmts == 'url_encoded_fmt_stream_map') { // reconstruct stream_map from plain url
		      ...
		      var x = (furl.indexOf('https://') == -1) ? protocol() : ''
		      furl = 'sp=' + signame + '&type=' + type + '&quality=' + quality + '&itag=' + itag + '&url=' + encodeURIComponent(x + furl.split('&' + signame)[0].split('&title=')[0])
		    }
		    if (fmts == 'adaptive_fmts') { // reconstruct adaptive_fmts list from plain url
		      if (z) {
			quality = qual[itag]['q']
			type = encodeURIComponent(qual[itag]['m'].split(' ').join('+'))
			s = furl.split('lsig=').join('').split(signame +'=')[1] || furl.split('&s=')[1]
			if (s) { s = s.split('&')[0] } else s = ''
			lmt = (furl.split('lmt=')[1]) ? furl.split('lmt=')[1].split('&')[0] : ''
			clen = (furl.split('clen=')[1]) ? furl.split('clen=')[1].split('&')[0] : ''
			var x = (furl.indexOf('https://') == -1) ? protocol() : ''
			//dur = (furl.split('dur=')[1]) ? furl.split('dur=')[1].split('&')[0] : ''
			//size = (furl.split('size=')[1]) ? furl.split('size=')[1].split('&')[0] : ''
			//quality_label = (furl.split('quality_label=')[1]) ? furl.split('quality_label=')[1].split('&')[0] : ''
			//fps = (furl.split('fps=')[1]) ? furl.split('fps=')[1].split('&')[0] : ''
			bitrate = (furl.split('bitrate=')[1]) ? furl.split('bitrate=')[1].split('&')[0] : ''
			init = (furl.split('init=')[1]) ? furl.split('init=')[1].split('&')[0] : ''
			index = (furl.split('index=')[1]) ? furl.split('index=')[1].split('&')[0] : ''
			projection_type = (furl.split('projection_type=')[1]) ? furl.split('projection_type=')[1].split('&')[0] : 'RECTANGULAR'
		      }
		      var dL = (furl.indexOf('u0026') == -1) ? '&' : '\\u0026'
		      furl = 'itag=' + itag + dL +'sp=' + signame + dL +'s=' + s + dL + 'type=' + type + dL + 'quality=' + quality + dL +'lmt=' + lmt + dL + 'clen=' + clen + dL + 
			'bitrate=' + bitrate + dL + 'init=' + init + dL + 'index=' + index + dL + 'projection_type=' + projection_type + dL + 
			'url=' + encodeURIComponent(furl)
		    }
		  }

		  if (furl.length > 800 && furl.indexOf('googlevideo.com') > -1) {
		    if (c[1] && !c[1][fmts]) ytplayer.config.args[fmts] = furl + ','
		    if (c[1] && c[1][fmts] && !c[1][fmts].includes(furl)) {
		      ytplayer.config.args[fmts] = furl + ',' + ytplayer.config.args[fmts] 
		    }
		  }

		}
		ampersand = (furl.split('\\u0026sp=')[1] || furl.split('\\u0026s=')[1]) ? '\\u0026' : '&'
		if (furl.length < 1500){
		if (fmts == 'url_encoded_fmt_stream_map') {
		  var obj = {}
		  var ft = furl.split(ampersand)
		  ...
		  furl = obj.url
		  if (obj.s && obj.sp) { yt6.encrypted = true; furl = furl + '&' + obj.sp + '=' + dc(obj.s).split('D3%').join('') } //else yt6.encrypted = false
		} else {
	 ...
	 if (yt6 && !yt6) {//obsolete
	  eurl = clone(ytplayer.config.args.url_encoded_fmt_stream_map) + ','+ clone(ytplayer.config.args.adaptive_fmts)
	  if (eurl) {
	    var lsig0, sig0
  ...
  var c = conf('args')
//  if (!yt6.pre_ad) {
    if (c[1] && (c[1].url_encoded_fmt_stream_map || c[1].adaptive_fmts)) {
      if (!c[0].loaded_from) ytplayer.config.loaded_from = 'player_object'
    }
    player_response()
  //}
...
function relocate_mep(hide) { if (shorts()) return void 0
    ...
    if (yt6.layout == 16) {
	var fmp = gt('OBJECT', yt6.api)[0]
	if (!fmp) fmp = gt('OBJECT', yt6.api.parentNode)[0]
  ...
  if (hide || (typeof p != 'undefined' && (p.parentNode.getAttribute('id') == 'player-api' || p.parentNode.getAttribute('id') == 'ytd-player' || p.parentNode.getAttribute('id') == 'player-container')) ) {
	...
	if (!hide) {
	  if (p && p.getAttribute('time')) {
		...
		} else yt6.api = (!yt6.ytm) ? gt('ytd-player', 1)[0] || pcont() : gc('player-wrapper style-scope ytmusic-player')[0]
		...
		if (yt6.api && p && !yt6.flash.forced) { yt6.api.insertBefore(p, yt6.api.firstChild); p.setAttribute('id','movie_player') }
	...
	if (z) {
	  for(var i in z.childNodes) {
		...
		} else { yt6.api = (!yt6.ytm && !yt6.ytp.embed) ? gt('ytd-player', 1)[0] || pcont() : gc('player-wrapper style-scope ytmusic-player')[0], bc = (!yt6.ytm) ? pcont() : yt6.api }
		...
		if (bm0 && (gid('movie_player1' || (p && p.parentNode.getAttribute('id') != 'player-api' && p.parentNode.getAttribute('id') != 'ytd-player' && p.parentNode.getAttribute('id') != 'player-container'))) ) {
		  ...
		  gid('player-api').appendChild(bm0)
		      ...
		      bc = (!yt6.ytp.embed) ? ((!yt6.ytm) ? gt('ytd-player', 1)[0] || pcont() : gc('player-wrapper style-scope ytmusic-player')[0]) : yt6.api
...
function open_outside_of_playlist() {
			...
			index = (index) ? 1 * index.split('&')[0].split('#')[0] : 2
...
function player_response() { //if (yt6.xhr.t == 3 && !yt6.blocked_m && !yt6.blocked && yt6.player1 && yt6.player1.media && yt6.player1.media.currentTime) { delete yt6.xhr.t; return void 0 }//ev_log('RETURN ');
	  ...
	  if (!(yt6.status == 'unplayable' && yt6.reason) && y) {
		...
		if (formats) {
		  ...
		  if (url) {
		    ...
		    if (yt6.layout == 16 && !yt6.ytm && !yt6.mobile && yt6.pls && yt6.newin && (yt6.age.blocked || yt6.age.count)) yt6.age.blocked = true
		  }
		  s = x[i].split('ipher":"')[1] || ''
		  if (s) { yt6.encrypted = true
		    s = s.split('"')[0]
...
*/
  ...
  //if (yt6.encrypted && yt6d.init) { delete yt6d.init; ajax1(true); buildObject(ytplayer); return true }

  var ytm = (yt6.ytm && !(ytplayer.config.args.adaptive_fmts || ytplayer.config.args.url_encoded_fmt_stream_map) && !yt6d.init) ? true : false

  if (ytplayer.config.args.adaptive_fmts || ytplayer.config.args.url_encoded_fmt_stream_map ) {
    if (!yt6.blocked_m) yt6.pr = clone(yt6.vid)
    if ( ((yt6.blocked_m || yt6.blocked === 0) && !yt6.blocked_m2)) {
      //if ((yt6.x && hid())) {
	var c = conf('args')
        if ( yt6.blocked === 0 && !yt6.blocked_m) { 
	  //ev_log('1st=')//+(c[1] && c[1].video_id == yt6.vid)+'/'+yt6.vid+'/'+ yt6.ytp.video_id)// && c[1] && c[1].video_id != yt6.vid) {//&& location.href.indexOf(yt6.vid) > -1) {
	  if (!yt6.ads_noskip) { c[1].video_id = clone(yt6.vid) } else { yt6.player1.pause(); clear_mep(yt6.player2); var z = clone(yt6d.previous.video_id); yt6.vid = z; yt6d.current.video_id = z
	    yt6.title = (yt6.title.length > 0 && yt6.title.substring(yt6.title.length-1, yt6.title.length) == '`') ? yt6.title.substring(0, yt6.title.length-1) : yt6.title + '`'
	    //yt6.nav2 = true
	  }
	} else
	//if ( !( yt6.blocked === 0 && !yt6.blocked_m) || (yt6.mobile && !yt6.mobile_nav))
	  if (yt6.blocked_m || yt6.ytm) { //ev_log('2nd')
		yt6.blocked_m2 = (yt6.pre_ad != true) ? true : false // to ensure this part runs only once
		buildObject(ytplayer)
		redo_dl_button(  yt6.args,  yt6.html,  yt6.href)
		yt6d.mep_up(); yt6.at = 0; yt6.sync_timer = 0
		yt6d.mep_renew(); yt6.loaded_vid = clone(yt6.vid) || '.'; yt6.age.check()
	  }

      //}
      if (yt6.ytm || yt6.blocked_m) try { gt('ytm-player-error-message-renderer', 1)[0].setAttribute('hidden','') } catch(e){}
	if (yt6.blocked_m) delete yt6.blocked_m
    }
    return false //yt6.missing_source = false
      ...
      if (yt6.mobile) try { gt('ytm-player-error-message-renderer', 1)[0].removeAttribute('hidden','') } catch(e){}
    }
...
function load_from_page_source(x, source) {
	...
	function fetch_data(src) {
		...
		if (1 * y.indexOf('url_encoded_fmt_stream_map') > -1 || y.indexOf('"formats\\":[{') > -1 || y.indexOf('"formats":[{') > -1 || y.indexOf('"adaptiveFormats":[{' || y.indexOf('"adaptiveFormats\\":[{')) > -1) { eval(y) }
		  else if ((yt6.pre_ad || yt6.loaded_vid != yt6.vid) && hid()) {
	...
	xhr2.onerror = function() { try { yt6.xhr.abort = true } catch(e){}; xhr2.abort() }
...
function poster_resize(w, h, mep) {
 ...
 var poster = gc('mejs-poster mejs-layer')[0] || getElementsByAttribute(mep,'div','class','mejs-poster mejs-layer')[0]
  if (typeof poster != 'undefined') {
    var poster_img = yt6.poster.img = gt('img', poster)[0]
...
function v_(a) { return (a && a.tagName == 'DIV' && a.firstChild && gt('video', a)[0]) ? gt('video', a)[0] : null }
...
var highlight_text = function(wa) {
	...
	try {//to highlight the address
	  if (browserName == 'IE') {
	    ...
	    range.select()
	  } else if (bs.indexOf(browserName) > -1) {
...
function tipping() {
	...
	z.id = 'msg-box1'
	yt6.appendChild(z)
	z.setAttribute('style','position: fixed; z-index: 601; background-color: transparent; width: 0px; height: 0px;')
      }
      var a = gid('msg-box1')
      a.title = ''
      var mhp = gmhp()
	...
	var cdn = (yt6.cdn.indexOf('rawgit.com') == -1) ? yt6.cdn : '//cdn.jsdelivr.net/gh/snarly/yt6@';
	...
	function qrCode(addr) {
	  try {
	    var img = $('#qr-code').qrcode({ size: iconsize(), fill: '#000', radius: 0.3, text: addr, render: 'image'}); var img = gt('img', qr)[0]; img.id = 'qr-img'; if (img.src.indexOf('youtube.com') > -1 || (img.src.indexOf('data:image') == 0 && img.src.length < 2000)) { img.parentNode.removeChild(img); qrcode_failed() }
	  } catch(e){ //console.log(e)
	...
	var x = ['c1' , 'c2', 'c3', 'c4'], t = 'https://snarly.github.io/yt6'
	...
	b.innerHTML = '<div id="tip1"><div style="background: #fff; overflow: hidden"><div style="display: inline-block; font-size: '+Math.ceil(s/6)+'px"><div><a style="color: black; text-decoration: none; cursor: pointer" '+ ((!yt6.mobile) ? 'href="'+t+'"' : '') + ' onclick="window.open(\''+ (t || yt6.poster.src) +'\', \'_blank\').focus(); return false">Version: <h2 style="background: yellow; color: brown;">'+ yt6.version +'</h2> <div style="text-decoration: underline; font-size: '+Math.ceil(s/6)+'px"><b><strong>'+t+'</strong></b></div></a></div><p style="font-size: '+Math.ceil(s/10)+'px; color: black; cursor: pointer" onclick="var z = gid(\'tip4\'); if (z) z.style.visibility = (z.style.visibility == \'visible\') ? \'hidden\' : \'visible\'; return false;"><a>Donations</a>'+
	'</p></div><h1 class="snarl-button yt-uix-button-text" style="padding: 0 4px 0 4px; background-color: red; color: white; float: right" onclick="(function(){ var close = gid(\'tip0\'); if (close) close.parentNode.removeChild(close); })()">X</h1></div><div id="tip4" style="visibility: hidden"></div></div>'

	z = gid('tip4')
	if (z) for(i in x) {
	  z.innerHTML = z.innerHTML + '<button class="snarl-button yt-uix-button-text" style="width: '+s+'px; height: '+s+'px; background-size: '+s+'px '+s+'px; background-image: url(' + c[x[i]]['i'] + ')" onclick="this.parentNode.parentNode.parentNode.donate(\''+x[i]+'\');"><div style="font-size: '+Math.ceil(s/6)+'px">' + c[x[i]]['n'] +'</div></button>'
	}
...
function video_id(skip_update) {
  ...
  if ( (( !(yt6.vid && typeof yt6.vid == 'string' && yt6.vid.indexOf(vid[0]) != -1) ) || yt6.ytp.embed|| yt6.ad_skipped == 2) && player() && typeof yt6.p.getVideoUrl == 'function') {
	...
	if (yt6.layout == 16 && hid() && yt6.navigation && yt6.pls) try { var s = gpst(pobj[i]); if (s != 1) pobj[i].playVideo() } catch(e){}
        yt6.vid = ytvid.split('&')[0].split('#')[0]
...
yt6d.init = video_id()[0] || ((location.href.indexOf('.com/playlist') > -1) ? 'om/playlist' : undefined)


function find_playlist() {

  if (!yt6.mobile) {
    yt6.pls = (yt6.layout == 16) ? gid('playlist') || gid('queue') : gid('watch-appbar-playlist')
    if (yt6.layout == 16 && yt6.pls && yt6.pls.id == 'playlist' && typeof yt6.pls.className == 'string' && yt6.pls.className.indexOf('ytd-watch') == -1) {
	var z = gt(yt6.pls.tagName, 1)
	if (z) for(i=0;i<z.length;i++) if (z[i].className.indexOf('miniplayer') == -1) { yt6.pls = z[i]; break }
    }
  } else { yt6.pls = gc('playlist-content section')[0]
      if (!yt6.pls) {
	var panel = gt('panel-container', 1)[0], ae = document.activeElement
	if (panel && panel.style.opacity != '1') panel.style.opacity = (typeof ae.className == 'string' && ae.className.indexOf('compact-media-item-') == 0) ? '' : '0.99'
	yt6.pls = gc('ytm-playlist-panel-renderer-v2')[0]
	if (yt6.pls) { yt6.pls.on = (panel && panel.firstChild) ? true : false } else yt6.pls = gt('ytm-playlist-engagement-panel', 1)[0]
	if (yt6.pls) yt6.pl23 = true
      }
    }
    if (yt6.layout == 16 && yt6.pls && ((!yt6.pls.firstElementChild && !yt6.pls.__shady_native_firstElementChild) || yt6.pls.hasAttribute('hidden')) ) yt6.pls = null
...
function clear_pls(x) {
  ...
  if (x && yt6d.playlist.list != x && !yt6.navigation) {
...
function iframe() {
		...
		if (!iframe_) {
		  ...
		  z.name = 're-embed2'
		  y.appendChild(z) //gt('head', 1)[0].appendChild(z)//yt6.api.insertBefore(z, yt6.api.firstChild)
		  z.block = yt6.blocked
		...
		if (!(window.yt6.embed && window.yt6.embed.control)) {
		  ...
		  if (!window.yt6.embed.active)
			...
			var c = conf('args')
			if (c[1] && location.href.split('list=')[1]) {
			  c[1].list = location.href.split('list=')[1].split('&')[0].split('/')[0]; clear_pls(clone(c[1].list))
			}
		  ...
		  (function ytp_id(){
			...
			function(){
			  ...
			  if (player()) {
			    ...
			    if (yt6.layout == 16) {
			      var x = gt('YTD-PLAYER', 1)[0]; if (x) yt6.api = x
			      var c = yt6.api.children; 
...
function ageless_verification(spfpc, ios) {
  ...
  if (vid || yt6.oldbrowser) {
	...
	function post_xhr1(){
	  ...
	  if ((!ytplayer.config && !yt6.rpt && xhr1.responseText) ) {
	...
	//page crash on Brave/Windows if x == false
	var x = (browserName == 'Brave' || (yt6.x && hid() && !yt6.blocked)) ? true : (((yt6.layout == 12 && !yt6.body2) || yt6.blocked || yt6.flash.forced || yt6.ytm) ? false : yt6.xhr.async)
	...
	xhr1.onreadystatechange = function() {
	  if (vid && xhr1.readyState == 4 && xhr1.status == 200) {
		...
		if (z && c[0]) {
	      ...
	      try { if (xhr1.done != false) xhr1.done = true; yt6.rpt = 1; } catch(e){}
	    }
	  }; post_xhr1()
	}

	if (!(yt6d.init && ios)) {
	 if ( !yt6.mobile && !yt6.ytm && !(!yt6d.previous.linx.length && c[1] && c[1].url_encoded_fmt_stream_map && c[1].adaptive_fmts)) {
	...
	if (location.href.split('list=')[1]) {
	  //ytplayer.config.args.list = location.href.split('list=')[1].split('&')[0].split('/')[0]
	}
	...
	if ( (yt6.api && yt6.api.parentNode &&
	  ...
	  if (yt6.layout == 16 && !gt('YTD-PLAYER', 1)[0]) {
	    var z = document.createElement('ytd-player')
	    z.id = 'ytd-player'
	    yt6.api.insertBefore(z, yt6.api.firstChild)
	    z.setAttribute('class','style-scope ytd-watch-'+yt6.flexy)
	  }
	  ...
	  if ( (player() && yt6.flashplugin() &&
		( (yt6.html5_fail && !(yt6.p.tagName == 'DIV' && (yt6.status == 'unplayable' || yt6.status == 'ok') && yt6.reason)) || (yt6.p.tagName == 'EMBED' && yt6.p.getAttribute('flashvars') == '') ) || 
		  (yt6.p.tagName == 'EMBED' && yt6.blocked && (yt6.p.getAttribute('flashvars') == '' || typeof yt6.p.getPlayerState == 'function'))
	       ) || yt6.skeleton ) {


	    if (player().getAttribute('name') != 're-embed2') yt6.p.setAttribute('name','movie_player')

	    if (yt6.html5_fail || yt6.p.getAttribute('flashvars') == '' || yt6.flash.forced || (yt6.p && yt6.p.tagName == 'DIV' && !(yt6.p.firstChild && yt6.p.firstChild.nextSibling))) {//' '
		...
		if (!yt6.flash.forced) {
		  ...
		  if (yt6.new_ytplayer.tagName != 'IFRAME') {
			...
			if (yt6d.x && yt6d.x != yt6.x) { switch_players() } else set_controls(6)
		  }
	      },200,6000);
		...
		if (z && z.hasAttribute('player-unavailable')) {
		  ...
		  var z = gt('ytd-playability-error-supported-renderers', 1)[0]
	      ...
	      if (yt6.status != 'unplayable' && yt6.reason && gid('movie_player') &&
			...
			function(){
			  if (yt6.new_ytplayer) {
			    ...
			    if (yt6.new_ytplayer.tagName != 'IFRAME') {
			     ...
			     }; if (yt6d.x && yt6d.x != yt6.x) { switch_players() } else { set_controls(7) }
			},200,6000);
	...
	//page crash on Brave/Windows if x == false
	var x = (browserName == 'Brave' || (yt6.x && hid() && !yt6.blocked)) ? true : ((yt6.layout == 12 || yt6.layout == 16 || yt6.blocked || yt6.flash.forced || yt6.ytm) ? false : yt6.xhr.async)
	...
	xhr3.onreadystatechange = function() {
	  ...
	  if (xhr3.readyState == 4 && xhr3.status == 200 && xhr3.responseText) {
		...
		if (obj && obj.videoDetails && obj.videoDetails.lengthSeconds) {
		  ...
		  if (!isNaN(yt6.real_media_duration_m) && !yt6.real_dur) yt6.real_dur = clone(yt6.real_media_duration_m)
		}
		if (yt6.blocked || yt6.blocked_m || (yt6.blocked === 0 && !yt6.blocked_m)) { yt6.xhr.t = 3
		  player_response(); //ev_log('xhr3 '+ yt6.pre_ad +' '+ yt6.age.blocked +' '+ yt6.ad_skipped)
		  if ((yt6.blocked || yt6.blocked_m) && !yt6d.mreload //&& (yt6.pre_ad == true || (yt6.pre_ad !== true && typeof yt6.ad_skipped == 'number'))
			 && yt6.real_media_duration_m && (yt6.ytp.dur || yt6.age.blocked) && Math.abs(yt6.real_media_duration_m - yt6.ytp.dur) > 1.5) { //ev_log('RELOAD '+yt6.pre_ad +' '+ yt6.ad_skipped) 
		    yt6d.mreload = true // attempt this only once per video
		    buildObject(window.ytplayer); redo_dl_button(  yt6.args,  yt6.html,  yt6.href); yt6d.mep_up(); yt6.at = 0; yt6.failed_itags = []; yt6d.mep_renew();
		  }
		}
		if (yt6.blocked) { alt_yt() } // patch
	      } catch(e){}
	...
	//if (!yt6.mobile && yt6.mobile && hid())
	if ( !yt6.ytm && (!(c[0] && c[0].loaded_from == 'video_info')) &&
	     (!(c[1] && c[1].adaptive_fmts) || yt6.blocked || (yt6.p && yt6.p.tagName == 'DIV' && !(yt6.p.firstChild && yt6.p.firstChild.nextSibling)) )
	   ) {
	  var quot = (yt6d.init && c[1].video_id && c[1].video_id != yt6d.init) ? '"' : ''
	  var params =
'{'+
'	"context": {'+
'		"client": {'+
...
((!yt6.blocked && !yt6.blocked_m)
	?	'	"clientName": '+ ((ios) ? '"IOS"' : ( quot + ((yt6.md) ? "M" : "") +'WEB') + quot ) +',\
			"clientVersion": '+ ((ios) ? '"19.29.1"' : ((yt && yt.config_ && yt.config_.INNERTUBE_CLIENT_VERSION) ? ('"'+ yt.config_.INNERTUBE_CLIENT_VERSION +'"') : "7.20240724.13.00") ) +','
...
'	},'+
'	"videoId": "' + vid +'",\
	"playbackContext": {"contentPlaybackContext": {"html5Preference": "HTML5_PREF_WANTS", "signatureTimestamp": ' + ((yt && yt.config_ && yt.config_.STS) ? yt.config_.STS : '19935') +'}},\
...
'}'
	...
	if ( (yt6.p && yt6.p.tagName == 'DIV' && (!v_(yt6.p) || (v_(yt6.p) && !v_(yt6.p).parentNode.nextSibling))) ) {
	  ...
	  if (p01[1] && typeof p01[1].getPlayerState == 'function') {
	    if (yt6.layout == 16 && gpst(p01[1]) == -1 && !yt6.x) {
		try { player().stopVideo(); yt6.p.playVideo() } catch(e){}
	  ...
	  if (!yt6.ytp.embed && c[1] && !c[1].reason && !yt6.flash.forced && ((c[1].status == 'ok' && !c[1].title) || yt6.status == 'unplayable') && !c[1].url_encoded_fmt_stream_map && !c[1].adaptive_fmts) {
	    if (!(yt6.layout == 12 && c[1].status == 'ok')) { // "get the best youtube experience" = all videos behaved like age-restricted ones till an accept or decline
...
function slowmd() {
  if (yt6.mobile && typeof yt6.speed_bak == 'number') { try { yt6.player1.media.playbackRate = yt6.speed; yt6.player2.media.playbackRate = yt6.speed } catch(e){ yt6.ytp.speed() }; yt6.speed = clone(yt6.speed_bak); delete yt6.speed_bak; yt6.ytp.speed() }
}
...
function me_flash_up(file, ib){
  ...
  yt6.age.check = function() {
	  ...
	  if (yt6.age.t) if (yt6.age.t.__data && yt6.age.t.__data.data && yt6.age.t.__data.data.playerErrorMessageRenderer.reason && yt6.age.t.__data.data.playerErrorMessageRenderer.reason.simpleText) {
	    yt6.age.t = yt6.age.t.__data.data.playerErrorMessageRenderer.reason.simpleText;
	  } else if (yt6.age.t[yt6.txt]) yt6.age.t = yt6.age.t[yt6.txt]
	...
	if (yt6.layout == 16 && !(yt6.ytm && yt6.flash.forced)) try { 
		...
		if (vid && vid2 != vid && window.location.href.indexOf(vid) > -1) {
		  yt6.blocked = false; yt6.age.count = 0//(yt6.age.count >= 1) ? 0 : (yt6.age.count + 1)
			...
			r = gt('yt-player-error-message-renderer', 1)[0]; var s = -1;
			if (yt6.p == p0 && vid == vid2) s = gpst(p0)
			...
			if ( ( !(yt6.p.tagName == 'DIV' && yt6.p.firstChild && yt6.p.firstChild.nextSibling && (!yt6.p.getElementsByClassName('ytp-error')[0] && (p0 == yt6.p && s > 0)) && !yt6.ytm) || yt6.p.getElementsByClassName('ytp-error')[0] || (!vid && s == -1) ) && // a 'ytp-error' div should indicate if the video is truly unplayable, but may still identify it wrongly as an age-restricted/geo-blocked one in browsers which have limited html5 video / codec support
			  ...
			  if (!yt6.ytm ) {
			    ...
			    yt6.age.count = (!yt6.age.count) ? 1 : (yt6.age.count)// + 1
			      ...
			      r = gt('yt-formatted-string', r.querySelector('#info'))[0]
	...
	if ((yt6.layout == 12 && yt6.blocked) || (yt6.layout == 16 && ((yt6.age.count == 1) || yt6.age.count == 111))) { //&& (yt6.age.count < 5
	  if (!yt6.html5swap) {
	  ...
	  } else if (yt6.layout == 16 && !yt6.ytm && !yt6.mobile && yt6.pls) {
	    ...
	    if (!yt6.age.blocked) {
	      ...
	      if (yt6.layout == 16 && !(yt6.p && yt6.p.tagName == 'IFRAME' && yt6.embed && yt6.embed.player && gpst(yt6.embed.player) > -1)) { yt6.age.blocked = false; undo_iframe() }
	    }
	  }

	if (yt6.p && (yt6.p.tagName == 'IFRAME' || (!yt6.blocked || yt6.age.blocked)) && p0 && yt6.p != p0 && !(yt6.ytm && yt6.flash.forced) && gpst(p0) == 1) try { p0.pauseVideo(); p0.seekTo(0) } catch(e){}

	if (yt6.mobile) {
	  r = gc('playability-status-signin-button')[0] || gc('playability-status-message playability-reason')[0]
	  if ((hid() && !r) || yt6.pre_ad) { //yt6.blocked_m = true;
	    yt6.blocked = 0 // on a backgrounded mobile tab, r will be undefined on first try
	  }
...
// Music layout
yt6.ytm = gt('ytmusic-player-page', 1)[0];
...
function ajax1(update){
  ...
  var ytassetsjs = gid('ytassetsjs')
    ...
    function setProxy(){
      ...
      xhr.done = false;
      if (yt6.ytm) proxiez = ['//www.youtube.com']
	...
	try {
	  ...
	  xhr.onreadystatechange = function() {
	    if (xhr.status == 403) { xhr.abort(); return void 0 }
	  ...
	  if (base_js) xhr.send('')
		...
		if ((e.toString().indexOf('"Access to restricted URI denied"  code: "1012"') > -1) || (e.toString().indexOf('ReferenceError: Security violation') > -1) || (xhr.responseText.indexOf('403 Forbidden') > -1) || (e.toString().indexOf('XMLHttpRequest Exception 101') > -1)) {
		  ...
		  hand_axe()
		    ...
		    if (!yt6.ytm && !yt6.html5_fail) { hand_axe() } else { relocate_mep(); yt6.flash.call = 'ajax1' ;forceFlashplayerObject() }
...
function back2html5() {
			...
			if (y) {
			  ...
			  for(i=0;i<y.length;i++) {
				...
				if ((!vid && !vid2 && gpst(x) == 5) && i != y.length-1) { if (!maybe) maybe = x; continue }
				if ( ((vid2 != vid ) || (vid2 && window.location.href.indexOf(vid2) > -1 && gpst(x) == 2)) && i != y.length-1) { maybe = x; continue }
				 x = (maybe) ? maybe : x;
				...
				if (yt6.layout == 12) {
				  ...
				  if (bm0) bc.insertBefore(bm0, bc.firstChild)
				    ...
				    bc = (!yt6.ytm && !yt6.mobile) ? gt('ytd-player', 1)[0] || pcont() : yt6.api
				...
				if (yt6.mp_)
				  if (yt6.html5_fail) {
				    switch_players(); if (p && p.tagName == 'EMBED') p.parentNode.removeChild(p); set_controls(8)
				  }
		      ...
		      if (yt6.blocked && !vid && !vid2 && gpst(x) == 5) {
			...
			if (location.href.indexOf(vid2) == -1 || !vid2) {
			  ...
			  if (!yt6.blocked) {
				...
				c[1].list = 'PL' + location.href.split('list=')[1].split('&')[0].split('/')[0]; clear_pls(clone(c[1].list))
				p.cuePlaylist({
				  listType: 'playlist',
				  list: c[1].list,
				  index: yt6.pl_index,
			...
			$waitUntil(function(){ if (player() && typeof yt6.p.getCurrentTime == 'function' && yt6.p.getCurrentTime() > 0 && !yt6.pre_ad) { return true } },
			  ...
			  500,5000)
			if (!yt6.x //|| (yt6.layout == 16 && !yt6.mobile && !yt6.ytm && hid())
...
yt6.tmp = (yt6.layout == 12) ? gid('player-api') : pcont()


if (yt6.layout == 16 && !yt6.ytp.embed) {
  if (!yt6.tmp) {
    yt6.api = gt('ytd-page-manager', 1)[0]
...
if ( gclass('ytd-playability-error-supported-renderers-0')[0] && (!gclass('ytd-playability-error-supported-renderers-0')[0].style.display != 'none' || pcont().hasAttribute('hidden') ) ) {
  ageless_verification()
...
if (typeof window.DOMParser != "undefined") {
  ...
  function fix_Width() {
    ...
    if (z.getAttribute('id') != 'player') {
      ...
      var z = z.firstChild
    } else if (yt6.wide) z = (!yt6.document_fragment) ? yt6.api.parentNode : pcont().firstElementChild

    if (z) { var o; try { o = z.getAttribute('style') } catch(e){} } else return '-1px'; if (o) { try { z.style = '' } catch(e){}; z.removeAttribute('style') }
    //if (z.getAttribute('id') != 'player') {
      var y; try { y = z.currentStyle || window.getComputedStyle(z, null) } catch(e){}
      if (!y || (!yt6.mobile && y && y.width == 'auto' && typeof z.offsetWidth == 'number')) {//    } else {
	var y = {}
...
if ( !wide_view() || (yt6.wide && yt6.size == 'default' ) ) {
  w_base = y.width
    ...
    if (typeof z.getAttribute == 'function' && z.getAttribute('id') != 'player') {
  ...
  function fix_Height() {
    ...
    //if (z.getAttribute('id') != 'player') {
      var y; try { y = z.currentStyle || window.getComputedStyle(z, null) } catch(e){}
      if (!y || (!yt6.mobile && y.height == 'auto' && typeof z.offsetHeight == 'number')) {//    } else {
	var y = {}
	y.width = z.offsetWidth + 'px'
	y.height = z.offsetHeight + 'px'
	y.left = z.offsetLeft + 'px'
...
if ( !wide_view() || (yt6.wide && (yt6.size == 'default') ) ) {
  ...
  if (o != null) z.setAttribute('style', o)
    ...
    if (yt6.mobile) {
	if (h_base == '0px') h_base = (gid('player-container-id').offsetHeight || gid('player-container-id').offsetWidth / (16/9)) + 'px'
	if (yt6.xhr.async && yt6.s && yt6.s.height) h_base = clone(yt6.s.height) + 'px'
    }
...
function set_controls(x){ //ev_log(x)
...
if (player()) {
  ...
  var Sync = function(newState) {
	...
	if (yt6 && (!yt6.x || hid() || (yt6.x && yt6.navigation && !hid()) || (yt6.mobile && yt6.x) )) {
	  ...
	  if (yt6.md) if (yt6.x && hid()) { try { yt6.ytp.strCt2 = yt6.p.getCurrentTime() } catch(e){} } else yt6.ytp.strCt2 = 0

	  switch (newState) {
		case -1: if (yt6.x && yt6.navigation && !hid()) try { yt6.p.pauseVideo() } catch(e){}; break //unstarted
		case 0: if (p2()) player2.pause(); resync(); break //ended
		case 1: if (yt6.x && yt6.navigation && !hid()) try { yt6.p.pauseVideo(); } catch(e){}; //playing
			if (yt6.x && hid() && p1()) {
			  if (yt6.player1 && yt6.player1.media) {
			    var dur, vid, ct
				...
				ct = (!(yt6.mute_on && yt6.ad_muted) || (yt6.md && browserName == 'Firefox' && hid())) ? yt6.p.getCurrentTime() : 0
		...
		case 2: if (!yt6.x ) {
			  $waitUntil(function(){ if (hid()) return true },
			    function(){ var p = player()
			      if (!yt6.x && p && typeof p.getPlayerState == 'function' && browserName != 'Yandex') try { setTimeout(function(){ if (!yt6.x && hid()) p.playVideo() },500) } catch(e) {}
			...
			if (hid() && yt6.Seek != 3 && p1()) {
			  if (yt6.player1 && yt6.player1.media) {
		        ...
		        break
		case 3: if (!yt6.x) { if (!hid() && 2 >= yt6.speed && p2() && yt6.player2 && yt6.player2.media && !yt6.player2.media.paused) { player2.pause(); resync() } } else if (yt6.navigation && !hid()) try { yt6.p.pauseVideo() } catch(e){}; 
		  break //buffering
		case 5: if (!yt6.x && !hid() && p2() && yt6.player2 && yt6.player2.media && !yt6.player2.media.paused) { player2.pause(); }; if (yt6.x && yt6.navigation && !hid()) try { yt6.p.pauseVideo() } catch(e){}; break //stopped/cued
	  }
  ...
  var Mqch = function() {
	...
	if (player() && typeof yt6.p.getPlayerState == 'function') {
	  $waitUntil(
	    function() { var x = gpst(player()); if ( x == 3 || x == -1 || yt6.flash.forced ) { return true } else { yt6d.timers.media++ } },
	    function() {
...
function chk_src(me) {
  if (yt6) {
	...
	if (z) z = z.split('//')[1]
	if ((yt6 && yt6.timer == 999999999) || me.src == pseudoSrc || y != z) {
	  if (y != z && y != pseudoSrc && yt6 && yt6.timer != 999999999) {
	    clear_mep(yt6.player2); clear_mep(yt6.player1)
	  }
	  z = false
	} else z = true
    return z
...
function button_state(a) { var y = 24, pn = 'parentNode'

	if (a && a[pn]) { if (a[pn].toString() == '[object DocumentFragment]') pn = '__shady_native_parentNode' } else return void 0
	if (yt6.btn.autoplay == a) {
	  var d = gt('path', a)[0]; if (d) d = d.getAttribute('d'); if (typeof d == 'string' && (d.indexOf("M21") !== 0 || (d.indexOf("M20") == 0 && !yt6.autoplay))) { yt6.autoplay = true; y = 23; }
	}
	var state = (a[pn] && a[pn][pn] && (
		(a[pn][pn][pn] && a[pn][pn][pn].__dataHost && a[pn][pn][pn].__dataHost.__data && a[pn][pn][pn].__dataHost.__data.currentState) || //24
		(a[pn][pn].parentComponent && typeof a[pn][pn].parentComponent.__compute__currentState == 'function' && a[pn][pn].parentComponent.__compute__currentState()) //22
	))
	if (state) { yt6.autoplay = (state !== "PLAYLIST_LOOP_STATE_NONE") ? true : false; y = (a[pn][pn].parentComponent) ? 22 : 24 }
	return [state, y]

}


function set_arrow_buttons() {

	var x = '', z = ['autoplay','shuffle'], pn = 'parentNode', n = "PLAYLIST_LOOP_STATE_NONE"
	if (yt6.pls) {
	  if (yt6.layout == 12) {
	    for (var i in z) if (yt6.btn && yt6.btn[z[i]]) if (yt6.btn[z[i]].getAttribute('class').indexOf('yt-uix-button-toggled') == -1 && yt6[z[i]] == true) { yt6.btn[z[i]].click() }
	  } else {
	      for (var i in z) if (yt6.btn && yt6.btn[z[i]]) {
		if (z[i] == 'autoplay' && yt6[z[i]] == true) {
		  if (yt6.btn[z[i]][pn] && yt6.btn[z[i]][pn].toString() == '[object DocumentFragment]') pn = '__shady_native_parentNode'
		  if (button_state(yt6.btn[z[i]])[0] == n || (yt6.btn[z[i]].__dataHost && !yt6.btn[z[i]].__dataHost.__data.pressed)) yt6.btn[z[i]].click(); yt6[z[i]] = true
		}
		if (z[i] == 'shuffle' && yt6[z[i]] == true) {
		  if ( (yt6.btn[z[i]][pn] && yt6.btn[z[i]][pn].__dataHost && yt6.btn[z[i]][pn].__dataHost.data && !yt6.btn[z[i]][pn].__dataHost.data.isToggled)
			 || (yt6.btn[z[i]].__dataHost && !yt6.btn[z[i]].__dataHost.__data.pressed) ) yt6.btn[z[i]].click()
		}
	      }
	    }
	}
...
if (yt6.pls) {
  if (yt6.layout == 12) {
    ...
    if (yt6.layout == 16 && !yt6.mobile && !yt6.ytm && typeof yt6.pls == 'object' && yt6.pls.parentNode) {
      var pls = gt('ytd-toggle-button-renderer', yt6.pls)[0]
      var shuff = gt('ytd-toggle-button-renderer', yt6.pls)[1]; if (shuff && shuff.parentNode && shuff.parentNode.parentNode && shuff.parentNode.parentNode.tagName.indexOf('META') > -1) shuff = null
      if (pls && !shuff) {
	shuff = pls
	pls = gt('ytd-playlist-loop-button-renderer', yt6.pls)[0]
      }
      var text = (pls && pls.tagName == 'YTD-TOGGLE-BUTTON-RENDERER') ? 'autoplay' : 'shuffle'
    }

    if (yt6.btn && yt6.btn.autoplay) {
      var pn = 'parentNode'; if (yt6.btn.autoplay.parentNode && yt6.btn.autoplay.parentNode.toString() == '[object DocumentFragment]') pn = '__shady_native_parentNode'
      if (yt6.autoplay == true && yt6.btn.autoplay.__dataHost && !yt6.btn.autoplay.__dataHost.__data.pressed
      //if (yt6.btn.autoplay.parentNode.getAttribute('aria-pressed') == 'false'
	// || (gt('path', yt6.btn.autoplay)[0] && typeof gt('path', yt6.btn.autoplay)[0].getAttribute('d') == 'string' && gt('path', yt6.btn.autoplay)[0].getAttribute('d').indexOf('M21,') == 0)
	) { yt6.btn.autoplay.click()
      }
    }
    if (yt6.shuffle == true && yt6.btn && yt6.btn.shuffle) {
      //if (yt6.btn.shuffle[pn].getAttribute('aria-pressed') == 'false')
      if (yt6.btn.shuffle.__dataHost && !yt6.btn.shuffle.__dataHost.__data.pressed) yt6.btn.shuffle.click()
    }
...
if (!yt6.ytp.embed) {
var autoplay = (yt6.body2 || yt6.layout == 16) ? gid('watch-appbar-playlist') : null
if (!(yt6.body2 && yt6.layout == 16) && autoplay != null) {
  ...
  if (autoplay != undefined) {
	...
	var shuffle = yt6.btn.shuffle = gt('button', autoplay)[1]
	...
	var autoplay = yt6.btn.autoplay = gt('button', autoplay)[0]
  ...
  var autoplay2 = gclass('playlist-mix-icon yt-sprite')
    ...
    if (yt6.osw.getAttribute('id') == 'player' && autoplay && !autoplay.hasAttribute('hidden')) {
      ...
      if (autoplay_) {
	var pls = gt('ytd-toggle-button-renderer', autoplay_)[0]
	var shuff = gt('ytd-toggle-button-renderer', autoplay_)[1]
	if (pls && !shuff) {
	  shuff = pls
	  pls = gt('ytd-playlist-loop-button-renderer', autoplay_)[0]
	}
      }

      if (autoplay_ || yt6.mobile) { var autoplay22 = false, autoplay23 = false, autoplay0 = [], autoplay1 = [], n = 0;

	// since Jun '22 these classNames refer only to the shuffle button
	var ocn = 'style-scope ytd-toggle-button-renderer'
	if (gc(ocn).length) {
	  var autoplay0 = gc(ocn +' style-grey-text'),
	    autoplay1 = gc(ocn +' style-default-active'),
	    n = 0, ie = false;

	  if (!autoplay0[0] && !autoplay1[0] && !yt6.mobile) { // classnames are different in IE
	    autoplay0 = gc(ocn +' x-scope yt-icon-button-2 style-grey-text')
	...
	} else { autoplay23 = true }

	if (!yt6.mobile)
	if (!autoplay0[0] && !autoplay1[0]) {
	  autoplay0 = gt('ytd-playlist-loop-button-renderer', autoplay_)
	  if (autoplay0[0] && typeof autoplay0[0].__compute__currentState == 'function') { autoplay22 = true }
	  if (!autoplay1[0] && autoplay_) { //24
	    autoplay1 = autoplay_.getElementsByClassName('style-scope ytd-menu-renderer')
	  }
	}

	function check_(obj1, obj2, pn) {
	  if (obj1 && obj2) {// && !yt6.document_fragment
	    if (
		(obj1[pn][pn][pn][pn][pn][pn][pn][pn][pn][pn][pn] == obj2 // initially on playlist
		||
		obj1[pn][pn][pn][pn][pn][pn][pn][pn][pn] == obj2)	// returned to playlist or '22 variant
		&&
		obj1[pn][pn][pn][pn][pn][pn][pn][pn][pn][pn][pn][pn][pn][pn] !== obj2 // if true, object is miniplayer
	...
	if (el.length) {
	  for(n=0;n < el.length; n++) {
	    var pn = 'parentNode'; if (el[n].parentNode && el[n].parentNode.parentNode && el[n].parentNode.parentNode.toString() == '[object DocumentFragment]') pn = '__shady_native_parentNode'
	    if ( check_(autoplay0[n], yt6.mpb, pn) || check_(autoplay1[n], yt6.mpb, pn) ) { // not good
	    } else if ( check_(autoplay0[n], autoplay, pn) || check_(autoplay1[n], autoplay, pn) ) { break }
	  }
	}
	...
	if (//autoplay0[0].parentNode.parentNode.parentNode.id == 'top-level-buttons'
	    (check_(autoplay0[n], autoplay, pn) && !autoplay0[n][pn][pn][pn][pn].hasAttribute('hidden')) ||
	    (check_(autoplay1[n], autoplay, pn) && !autoplay1[n][pn][pn][pn][pn].hasAttribute('hidden'))
	  ) {

	  var text = ''

	  if (!autoplay22 && !autoplay23) {//pre-22


	  text = (pls && pls.tagName == 'YTD-TOGGLE-BUTTON-RENDERER') ? 'autoplay' : 'shuffle'

	  buttons = []
	  if (autoplay0[n]) buttons[0] = gt('BUTTON', autoplay0[n])[0]
	  if (autoplay1[n]) buttons[1] = gt('BUTTON', autoplay1[n])[0]
	  for(i=0;i<2;i++) {
	    var a = buttons[i]; if (a && (a[pn][pn][pn] == pls || a[pn][pn][pn] == shuff)) { yt6.btn[text] = a } else a = null
	  ...
	  if (text == 'autoplay') {
	    buttons = []
	    if (autoplay0[n+1]) buttons[0] = gt('BUTTON', autoplay0[n+1])[0]
	    if (autoplay1[n+1]) buttons[1] = gt('BUTTON', autoplay1[n+1])[0]
	    for(i=0;i<2;i++) {
	      var a = buttons[i]; if (a && a[pn][pn][pn] == shuff) { yt6.btn.shuffle = a } else a = null
	      if (a && (!a.getAttribute('onclick') || (a.getAttribute('onclick') && a.getAttribute('onclick').indexOf('yt6') == -1)) ) {
		...
		buttons[i].setAttribute('onclick', b)
	      ...
	      var a = gt('BUTTON', pls)[0]; if (a && (a[pn][pn][pn][pn][pn] == pls || (autoplay23 && a[pn][pn][pn][pn] == pls)) ) { yt6.btn.autoplay = a } else a = null
	      if (a) {
		if (!a.getAttribute('onclick') || (a.getAttribute('onclick') && a.getAttribute('onclick').indexOf('yt6') == -1)) {
		  var b = ';var yt6 = gid("snarls_player"); if (yt6) if (gt("path", this)[0]) { var d = gt("path", this)[0].getAttribute("d"); if (typeof d == "string") { if (d.indexOf("M13,") == 0) { yt6.autoplay = false } else { yt6.autoplay = true }; }; }; return false;'
		  a.setAttribute('onclick', b)
		}
		//if (gt('path', a)[0] && typeof gt('path', a)[0].getAttribute('d') == 'string') if (gt('path', a)[0].getAttribute('d').indexOf('M21,') == 0) { yt6.autoplay = false } else yt6.autoplay = true
		if (yt6.btn.autoplay.__dataHost && yt6.btn.autoplay.__dataHost.__data.pressed) { yt6.autoplay = true } else yt6.autoplay = false
	      }
	    }

	  // check the current state of these buttons
	  if (check_(autoplay1[n], autoplay, pn)) { //console.log('active')
	    if (text == 'shuffle' || (text == 'autoplay' && !autoplay1[n][pn][pn].previousSibling)) {
	      yt6[text] = true;
	      autoplay2 = {}; delete autoplay2[n]
	      if (autoplay1[n+1] && text == 'autoplay') if (autoplay1[n][pn][pn].nextSibling.firstChild.firstChild) { yt6.shuffle = true } else yt6.shuffle = false
		...
		if (text == 'autoplay') if (yt6.btn.autoplay[pn] && typeof yt6.btn.autoplay[pn].getAttribute('class') == 'string' && yt6.btn.autoplay[pn].getAttribute('class').indexOf('style-grey-text') > -1) { yt6.autoplay = !yt6.autoplay; yt6.btn.autoplay.click() } else { yt6.autoplay = false }
		if (text == 'shuffle') {
		  //if (gt('path', yt6.btn.autoplay)[0] && typeof gt('path', yt6.btn.autoplay)[0].getAttribute('d') == 'string' && gt('path', yt6.btn.autoplay)[0].getAttribute('d').indexOf('M21,') == 0) { yt6.autoplay = !yt6.autoplay; yt6.btn.autoplay.click() }
		  if (yt6.btn.autoplay.__dataHost && !yt6.btn.autoplay.__dataHost.__data.pressed) { yt6.autoplay = !yt6.autoplay; yt6.btn.autoplay.click() }
		}
	      } else yt6.autoplay = false

	      if (yt6.shuffle == true && yt6.btn && yt6.btn.shuffle && yt6.btn.shuffle[pn] && typeof yt6.btn.shuffle[pn].getAttribute('class') == 'string' && yt6.btn.shuffle[pn].getAttribute('class').indexOf('style-grey-text') > -1) { yt6.shuffle = !yt6.shuffle; yt6.btn.shuffle.click() } else yt6.shuffle = false
	      //yt6.autoplay = false
	      //yt6.shuffle = false
	    }
...
} else if (location.href.indexOf('list=') > -1) yt6.autoplay = true

    if (yt6.mobile || yt6.ytm) {
	var autoplay

	if (yt6.ytm) { autoplay2 = []; autoplay2[0] = gid('queue') }
	if (yt6.mobile) { autoplay2 = []; autoplay2[0] = (!yt6.mobile) ? yt6.pls : (yt6.pls || ((location.href.indexOf('list=') > -1)) ? {} : null ) }
	if (!autoplay2[0]) { yt6.autoplay = false } else {
	  yt6.autoplay = true
	  if (!yt6.ytm && yt6.player1.media.firstChild && yt6.player1.media.firstChild.name == '0') {
	    if (yt6.x && !yt6.swapped) {// != 1
	      try { yt6.player1.hideControls() } catch(e) {}
	      switch_players(); yt6.swapped = 1
	      if (yt6.autoplay) try {
		p.stopVideo()
	   ...
	   if (typeof fv == 'string' || p.tagName == 'EMBED') {
		...
		if (yt6.flash.forced) {
		  $waitUntil(function(){ var p = yt6.p; if (p && p.nodeName == 'EMBED') { return true } },
			...
			var bm0 = gid('bm0')
			var p = yt6.p
			var s = (p && typeof p.getPlayerState == 'function') ? gpst(p) : 0
			var z = yt6.osw
				if (z.getAttribute('id') != 'player') {
				  var z = z.firstChild;
				}
...
if (typeof p.getPlayerState != 'function' && typeof p.tagName == 'EMBED' && yt6.age.check() ) {
  ...
  if (start != false) set_controls(12)
  ...
  //if (yt6.document_fragment && yt6.pls) autoplay = yt6.autoplay = true
		  ...
		  if (z) {
			...
			try { z.destroy() } catch(e){ if (z.parentNode) z.parentNode.removeChild(z) }
			  try {
			    ...
			    p.setAttribute('class', p.getAttribute('class').replace('forced html5player','')); p.style.visibility = 'visible'
			  } catch(e){}
		    } else {
...
function getReferenceObjects() {
	...
	var z = gt('YTD-TWO-COLUMN-BROWSE-RESULTS-RENDERER', 1), y, x, s
	...
	yt6.pl_fix = 0
	if (z && z.length > 0) { y = z[0].parentNode
	if ((y && y.firstChild.tagName == 'YTD-TWO-COLUMN-BROWSE-RESULTS-RENDERER') || !gid('mep_init') ) {
	  if (y) { x = y.toString(); if (x == '[object DocumentFragment]') { yt6.document_fragment = true; try { y = document.querySelector('#secondary'), s = z[0]['__shady_native_children']; if (y && s && s.length && s[s.length-1] == y) { z[0].__shady_native_removeChild(s[s.length-1]) } } catch(e){} }}
	  yt6.pl_fix = 1
	  for(i=0;i<z.length;i++) if (z[i]) {
	    x = gt('ytd-page-manager', 1)[0], y = z[i].parentNode
	    if (x) {
	      x.appendChild(y)
	    } else {
  ...
  if (!yt6.ytm) {
    ...
    yt6.mhp = (!(yt6.body2 && yt6.layout == 16)) ? gid('masthead-positioner') || gid('logo') || gid('masthead-logo') || gid('ytm-home-logo') : gid('logo') || gid('masthead-logo')
  } else {
      yt6.osw = gt('ytmusic-player', 1)[0]
      yt6.mhp = gt('ytmusic-nav-bar', 1)[0]
    }
  ...
  find_playlist()
  yt6.pm = gt('ytd-page-manager', 1)[0]
  yt6.wsb = gid('watch7-sidebar')
  if (!yt6.wsb || (yt6.body2 && yt6.layout == 16))
    if (yt6.pls) yt6.wsb = gid('secondary')
    if (!yt6.wsb) yt6.wsb = gid('related') || gid('sidebar') || gid('secondary') || gc('side-panel style-scope ytmusic-player-page')[0]
  if ((yt6.navigation || yt6.loaded == 5 || yt6d.init) && yt6.layout == 16 && !yt6.ytm && !yt6.mobile && yt6.wsb && yt6.wsb.id == 'related' && !yt6.wide && yt6.pls && gid('secondary'))// && yt6.wallpaper
    yt6.wsb = gid('secondary')
  ...
  if (yt6.mobile) {
    yt6.top = yt6.inf = gt('ytm-single-column-watch-next-results-renderer', 1)[0] || gt('ytm-pivot-bar-renderer', 1)[0]
  }
  ...
  if (yt6.osw.getAttribute('id') == 'player' && !yt6.ytp.embed) {
	...
	//if (z) z.style.display = 'none'
	z = gt('iron-overlay-backdrop', 1)[0]
	if (z) z.style.display = 'none'
	z = gt('ytd-consent-bump-lightbox', 1)[0]
	if (z) z.style.display = 'none'
	var z = gt('ytd-consent-bump-renderer', 1)
	...
	for (i=0;i<l.length;i++) {
	  ...
	  if (l[i].getAttribute('id') == 'info') yt6.inf = l[i]
	...
	var l = gt('YTD-MINIPLAYER', 1)[0]
	if (l) yt6.mpb = l

	var z = gt('ytd-watch-flexy', 1)[0] || gt('ytd-watch-grid', 1)[0] || gt('ytd-watch', 1)[0]

	if (z && (
		(typeof z.getAttribute('style') == 'string'  && z.getAttribute('style').indexOf('--ytd-watch-flexy-') > -1)
		|| (z.hasAttribute('flexy') || z.hasAttribute('flexy_') || z.hasAttribute('is-currently-flexible_') || z.hasAttribute('flexy-fit-to-video_') || z.hasAttribute('flexy-v2_') || z.hasAttribute('flexy-v2-extended_') || z.hasAttribute('flexy-small-window_'))
		 )
	   ) {


	  z = (z.tagName.indexOf('-GRID') > -1) ? 'grid' : 'flexy'
	  yt6.flexy = z
	  if (z == 'grid' && gt('style', yt6)[0] && gt('style', yt6)[0].innerHTML.indexOf('.ytd-app #page-manager.ytd-app') == -1)
	    gt('style', yt6)[0].innerHTML = gt('style', yt6)[0].innerHTML +'.ytd-app #page-manager.ytd-app { margin-top: 52px !important; }'

	  var l = gc('style-scope ytd-watch-'+z)
	  for (i=0;i<l.length;i++) {
	    if (l[i].getAttribute('id') == 'player') yt6.osw = l[i]
	    if (l[i].getAttribute('id') == 'alerts') wna = l[i]
	    if (l[i].getAttribute('id') == 'messages') yt6.wna2 = l[i]
  ...
  if (yt6.skeleton || (yt6.layout == 16 && !yt6.mobile && !yt6.wna)) {
    ...
    yt6.top = gid('player')
    if (!yt6.ytp.embed) {
      yt6.inf = yt6.con = yt6.man = gid('info-container') || gt('ytd-app', 1)[0]
  ...
  if (!(yt6.tbg && yt6.tbg.parentNode) || yt6.mobile) { // || yt6.document_fragment - on mobile, we either create a duplicate of the tbg object on every new video or yt will wipe it(?) -- we'll get rid of the duplicate ourselves below
    var z = document.createElement('div')
    z.id = (yt6.layout !== 12) ? 'theater-left' : 'theater-background'

    if (yt6.ytm) {// || yt6.layout == 16

	  var a = gc('song-media-controls style-scope ytmusic-player')[0]
	  if (a) {
	    if (player() && yt6.p && (gpst(yt6.p) == -1 || gpst(yt6.p) == 5)) {
	      a.style.position = 'relative'; a.parentNode.insertBefore(a, a.parentNode.firstChild)
	    } else {
	        a.style.position = ''
	      }
...
function update_TimeStampLinks() {
  ...
  if (yt6.osw.getAttribute('id') != 'player') {
	...
	var z = getElementsByAttribute(document,"a","class","yt-simple-endpoint style-scope yt-formatted-string")
	var y = getElementsByAttribute(document,"a","class","yt-core-attributed-string__link yt-core-attributed-string__link--display-type yt-core-attributed-string__link--call-to-action-color"); if (y && y.length) { if (z) { z.push.apply(z, y) } else z = y }
    }
  ...
  for(i = 0;i<z.length;i++){
	...
	var x1 = "var yt6 = gid(\'snarls_player\'); if (yt6) if (yt6.x && yt6.player1 && yt6.player1.media && yt6.player1.media.currentTime) { yt6.player1.media.currentTime = "
	var x2 = "if (yt6.original && yt6.original.parentNode && yt6.original != yt6.p) try { yt6.original.stopVideo() } catch(e){}; "
	if (timecode.indexOf('yt.www.watch.player.seekTo\(') != -1) {
	  z[i].setAttribute("onclick", x1 + timecode.split('player.seekTo\(')[1].split('\)')[0] + " } else { " + timecode.split('\;')[0] + " }; " + x2 + timecode.split('\;')[1] + ";")

	} else {
	    if (timecode.split('&t=')[1] && z[i].getAttribute('href') && location.href.indexOf(timecode.split('&')[0]) != -1) {
	      z[i].setAttribute("onclick", x1 + timecode.split('&t=')[1].split('s')[0] + " }; " + x2 +" return false;")
	    }
	 }
      }
    }
...
function wide_view() {
  ...
  if (yt6.flexy) {
    var z = gid('player-full-bleed-container') //  <--  player-wide-container  <--  player-theater-container
    var y = pcont()
...
yt6d.mep_renew = function() {
	...
	if (!yt6.x && yt6.mobile && yt6.blocked_m) switch_players()
	...
	if ( yt6.fmts_fallback.A.all.indexOf(yt6.userprefV[0]) == -1) { //ev_log('V??'+(yt6.userprefV[0] !== yt6.userprefA[0]) + (yt6.fmts_fallback.A.all.indexOf(yt6.userprefV[0]) ) + (yt6.failed_itags.indexOf(yt6.userprefA[0]))  )//yt6.userprefA[0] !== yt6.userprefV[0] ||
	  pool0 = clone(yt6.userprefV)
	  ...
	  if (x != 'all') {
	    ...
	    pool0 = clone(yt6.userprefA); //pool0.push(18)//; pool0.push(17)
	    pool1 = clone(yt6.fmts_fallback.A)
	    pool2 = clone(yt6.fmts_fallback.A.uniq[yt6.prefer_fmt])
	    pool2.push.apply(pool2, yt6.fmts_fallback.A.revers[x]); //pool2.push(18)//; pool2.push(17)
	  }
	...
	if (!yt6.age.sc && !yt6.age.dl)
	  ...
	  for(j=index;j<fmt_pool.length;j++){
	    ...
	    if (find && z) {
	      ...
	      if ( ( (yt6.autoplay && (yt6.pls || yt6.mobile || yt6.ytp.embed)) || (yt6d.init && autoplay())) && (yt6.x || (!yt6.x && v_(yt6.p) && v_(yt6.p).src && v_(yt6.p).src.indexOf('http') == 0) || hid() || !yt6d.previous.linx.length) ) {
		z.setAttribute('checked','checked'); z.checked = 'true'
		yt6.player1.setSrc(yt6.linx[itagx])
		if (1 * itagx != 1 * yt6.userprefV[i] && !yt6d.init) {
		  no_default(itagx, 'V'); if (!gid(mep + '_sourcechooser_' + yt6.userprefV[i])) { yt6.fmt_bak2 = clone(yt6.fmt_bak || 1 * yt6.userprefV[i]) }
		}
		z.click()
		try { yt6.player1.media.load() } catch(e){}
		...
		if (yt6.x && typeof yt6.player1.play == 'function') {
		  try {
		    if (yt6.player1 && yt6.player1.media) {
		      ...
		      yt6.sync_timer = 0; yt6.player1.media.timer = 0

		      var step = 1500, threshold = 8*step, xo //12000
		      yt6d.timers.t1 = 0; yt6d.timers.t2 = 0; var counter = 0

		      if (typeof yt6.autoplay_trigger != 'function')
		      yt6.autoplay_trigger = function(t, itagx) { yt6.at++//, counter, stc, step, threshold)

			var ret = false, stuck = false, stuck2 = 0, date1 = new Date(), time1 = Math.floor(date1.getTime() / 1000), date2, time2;
			if (typeof z == 'undefined' || (typeof z != 'undefined' && z != t)) z = t

			function klikk(t, z) {
				try {
				  if (gid(mep + '_sourcechooser_' + yt6.current)) t = gid(mep + '_sourcechooser_' + yt6.current)
				  if (yt6.player1.media.src == pseudoSrc && t && t.parentNode) yt6.player1.setSrc(t.value)
				  t.click()
				} catch(e){ if (z) { z.click(); yt6.player1.isLoaded = true } else yt6.player1.isLoaded = false }
				return t
			}

			$waitUntil(function(){ counter = (counter + step)

			  if (yt6.player1.media.loaded || ret) { return true }
			    else {
			      if (hid()) {
				if (yt6d.timers.t1 < 3) {
				setTimeout(function(){
				  if ( (hid() && (!yt6.player1.media.loaded || !yt6.player1.isLoaded)) ) {
				  try {
				    if (yt6.player1.media.paused && !yt6.player1.media.currentTime) try { gc("mejs-button mejs-playpause-button")[0].click() } catch(e){}
				    if (yt6d.timers.t2 < 3) {
				    setTimeout(function(){
				      if (!yt6.player1.media.loaded) {
				        yt6.sync_timer++
					if (yt6.sync_timer > 1) { var x = 0; //yt6.player1.media.timer = 0
					  if ( hid() && !yt6.player1.media.currentTime &&//!stuck && 
						(   ( !(yt6.failed_itags.length && yt6.player1.media.loaded && yt6.player1.media.paused))//yt6.sync_timer % 3 == 2 && 
						 || (!yt6.player1.media.loaded && !yt6.player1.media.paused && yt6.sync_timer % 2 == 1)   )//%%2==1
					      ) { var x = ( (!yt6.player1.media.loaded && !yt6.player1.media.paused)) ? 1 : 2
					    if (!yt6.player1.media.loaded) { clear_mep(yt6.player1) } else x = 0; //ev_log('pt0'+ x) !stuck && 
					  }

					  if ( x && ((hid() && yt6.sync_timer % 3 == 1 && yt6.sync_timer > 3) || (!yt6.player1.isLoaded && !yt6.player1.media.loaded)) ){//|| yt6.player1.media.src == pseudoSrc) {//x &&  % 2 == 1 !xo &&
					    if ((!yt6.player1.media.loaded && !yt6.player1.media.paused) || yt6.player1.media.src == pseudoSrc) {
						t = klikk(t, z); //ev_log('ld0'+xo)
					    } else if (!yt6.player1.media.loaded) { yt6.player1.load() }

					  } else if (yt6.limit >= yt6.retry) { if (!yt6.player1.media.loaded) {// && yt6.sync_timer % 2 == 3) {
						yt6.player1.isLoaded = false }; yt6.player1.play() //} else { }//yt6.player1.pause()
					      //} else { yt6.player1.media.play() }
					    }
					  ...
					  if (!hid() && yt6.player1.media.loaded) { yt6.player1.play() } }


				      yt6d.timers.t2--
				    }, (step/2) ); yt6d.timers.t2++ }//700
				  } catch(e){ yt6.player1.play() }
				  } else {
				    }

				  yt6d.timers.t1--
				}, (step/2) ); yt6d.timers.t1++ }//700
			      } else { if (!yt6d.hid) yt6.sync_timer++
				  if (yt6.sync_timer > 3 && yt6.sync_timer % 2 == 1) {
				    if ((!yt6.player1.media.loaded || (yt6.player1.media.loaded && !yt6.player1.media.paused)) && !yt6.player1.media.currentTime) {
				      clear_mep(yt6.player1); //ev_log('pt1')
				    }
				    t = klikk(t, z)
				  }
				}
			    ...
			    date2 = new Date()
			    time2 = date2.toLocaleString(); try { time2 = time2.substring((time2.split(':')[0].lastIndexOf(' ')+1), time2.length).split(' ')[0] } catch(e) {}
			    //if (hid()) ev_log('T='+ time2)//counter/1000 +'::'+ 
			    time2 = Math.floor(date2.getTime() / 1000); //ev_log('past='+ Math.abs(time2 - time1))
			    stuck = (yt6.mobile && hid() && Math.abs(time2 - time1) > 1 * step / 1000 ) ? true : false; //ev_log('::'+ stuck)
			    time1 = time2

			    if (counter >= threshold) { //var l = (Array.isArray(yt6.yt_otf) && yt6.yt_otf.length) ? (yt6.limit - yt6.yt_otf.length) : clone(yt6.limit)
			      counter = 0; yt6.sync_timer = (!yt6.player1.media.loaded) ? 1 : -1; stuck2 = 0; //if (l && (threshold / 1000) > l) yt6.sync_timer =  0; //Math.floor(l - (threshold / 1000));
			      if (!yt6.player1.media.loaded) if (!yt6.player1.isLoaded) { yt6.player1.load() } else { yt6.player1.media.load() }
				if (yt6.limit >= yt6.retry) { yt6.player1.pause(); //ev_log('try again '+yt6.errcount +' '+ yt6.title); //yt6.player1.media.timer = 0; 
				  var i = null, u = clone(yt6.fmts_fallback.A[yt6.prefer_fmt]); u.push.apply(u, u.reverse()); u.push(18)
				  if (yt6.audiosauce && u) {
				    for(i=u.indexOf(yt6.audiosauce); i<u.length; i++) if (yt6.failed_itags.indexOf(i) == -1 && u[i] && u[i] != 1 && gid(mep + '_sourcechooser_' + i)) {
				      t = gid(mep + '_sourcechooser_' + i); break
				    }
				  }
				  yt6.autoplay_trigger(t, i || yt6.current)//, 0, 0, step, threshold)
				  ret = true; return true
				}
			    }

			    if (stuck) { stuck2++; //ev_log('S'+yt6d.timers.w)
			      if (yt6.mobile && hid()) yt6d.timers.w++
			    } else {}; yt6.stuck = stuck
			...
			function(){ yt6.at--
			  ...
			  function(){ var t0 = yt6.player1.media.currentTime
				var fit = (Array.isArray(yt6.failed_itags) && yt6.failed_itags.length) ? true : false

				if ( yt6.at2 && ( yt6.yt6_length < 4 || yt6.yt6a_length == 1 || !(t0 > yt6.ct) || (ret && !yt6.player1.media.paused && !yt6.player1.media.loaded) ) ) {
				  if ( yt6.x && ( yt6.at2 == 'A13' || (yt6.at2 == 'A13' && yt6.player1.media.pastTime == t0) ||  (!yt6.player1.media.paused && !(t0 > yt6.ct)) )) {//|| yt6.yt6_length < 4 || yt6.yt6a_length == 1 || 
				    yt6.ct = (t0 + (Math.random() * (0.09 - 0.03) + 0.5) ); yt6.player1.setCurrentTime(yt6.ct)
				    yt6.at2 = 'A14';
				  } else yt6.at2 = 'A13'
				      if (!yt6.player1.media.loaded) { yt6.player1.isLoaded = false;  };//if (yt6.at2 == 'A13') { yt6.player1.media.load() }
				      t = klikk(t, z)
				      //if (yt6.player1.media.paused ||!yt6.player1.media.loaded)
				      if (yt6.player1.media.paused || yt6.at2 == 'A13') yt6.player1.play()
				    //}

				} else {
				    if ( !yt6.player1.media.loaded) {
				      if (counter == step) { yt6d.timers.w++
					yt6.player1.media.load()//yt6.player1.isLoaded = false; yt6.player1.play()
				      } //else 
					if (yt6.player1.media.paused) { yt6.player1.play() }
				      yt6.at2 = 'A12' 
				    } else { yt6.at2 = 'A11'
					yt6.player1.media.play(); yt6.player1.play()
				      }
				  }
				  stuck = false; yt6.stuck = false

				  //ev_log('\n'+ yt6.at2 +' '+ yt6.player1.media.loaded +' '+yt6.player1.media.currentTime+' '+yt6.navigation+'/'+yt6.mobile_nav+'/'+yt6d.timers.w)
			    if (!ret) counter = 0
			  },250,2500)
			}, step, threshold)
			...
			yt6.at = (typeof yt6.at == 'number') ? yt6.at : 0


			yt6.player1.play()
			if (0 >= yt6.at) { yt6.autoplay_trigger(z, itagx)//, 0, 0, step, threshold)
			} //else
			try { yt6.player1.media.play() } catch(e){}
	...
	if (!found) { for(i=0;i<yt6.fmts_fallback.V.all.length;i++) {
	  ...
	  }; if (i == yt6.fmts_fallback.V.all.length-1 && !found && yt6.mobile && hid()) { yt6.loaded_vid = 'XXXXXXXXXXX'; try { gid('prebtn').click() } catch(e){} }//yt6.title = clone(yt6d.previous.title) || ''; 
	}; no_default(itagx, 'V') }
	...
	find_the_source()
	  ...
	  if (sc) for(i=0;i<sc.firstChild.children.length;i++){
	    ...
	    try { if (!yt6.player2.media.loaded) yt6.player2.media.load() } catch(e) {}
      ...
      if (yt6.layout == 16 && !yt6.ytm && !yt6.mobile && yt6.pls && yt6.newin && (yt6.age.blocked || yt6.age.count)) {
		//open_outside_of_playlist()
	...
	yt6.age.audio = clone(yt6.audio)
      ...
      if (yt6.layout == 16 && yt6.newin && yt6.pls && !(yt6.p && gpst(yt6.p) > -1) ) {
	...
	if (z) {
	  ...
	  set_controls(14); autoplay(true)
	  if (yt6.x) {
	    $waitUntil(function(){ var z = set_controls(15)[1]; if (z && typeof z.playMedia == 'function') return true; },
		  function(){ try { var z = set_controls(16)[1]; if (z && autoplay(false)) { z.playMedia(); z.parentNode.paused = false } } catch(e){} },
		  500,4000)
	  }
	}
      ...
      if (yt6.mobile && typeof yt6.speed_bak == 'number' && yt6.player1 && typeof yt6.player1.getCurrentTime == 'function') {
	var counter = 0, step = 100, threshold = 2000
	$waitUntil(function() { counter = (counter + step)
	    if (counter >= threshold || (yt6.player1 && typeof yt6.player1.getCurrentTime == 'function' && yt6.player1.getCurrentTime() > 0)) { return true } },
	  function() { slowmd()
	  }, step, threshold)
      }
	...
	var z = gt('embed', gid('movie_player_to_dispose'))[0] || gt('object', gid('movie_player_to_dispose'))[0]
...
function gpst(p) { return (p && typeof p.getPlayerState == 'function') ? p.getPlayerState() : -1 }

function gmhp() { var mhp; try { mhp = (yt6.mhp) ? ((yt6.layout != 16 || yt6.ytm) ? yt6.mhp.offsetHeight : yt6.mhp.parentNode.parentNode.offsetHeight) : 0 } catch(e) { if (yt6.mobile) mhp = yt6.mhp.offsetHeight }; return mhp }
...
// onYouTubePlayerAPIReady() { }
		...
		function scrollToCurrentVideo() {
			...
			var y = gt('ytm-playlist-panel-header', 1)[0]
			if (y) { y.style.position = 'fixed'; y.style.width = '100%' }
			var height, height = (yt6.p && yt6.p.offsetHeight) ? yt6.p.offsetHeight : 0
			var z = gt('ytm-playlist-controls', 1)[0]
			if (z) { z.style.position = 'fixed'; z.style.right = '0px'; if (y) z.style.top = y.getBoundingClientRect().bottom + 'px'; z.style.zIndex = 1 }

			var windowheight = parseInt(window.innerHeight || document.documentElement.clientHeight || yt6.body.clientHeight)

			var pl_item = (yt6.pls) ? gt('ytm-playlist-panel-video-renderer', yt6.pls)[0] : null
			if (!yt6.pl_item && location.href.split('&index=')[1]) { yt6.pl_index = 1 * location.href.split('&index=')[1].split('&')[0].split('#')[0] - 1 }

			// -2 to keep the upcoming entry visible while searching for blocked videos !
			yt6.pl_index_m = (pl_item) ? (yt6.pl_index - Math.ceil(windowheight / pl_item.offsetHeight) + (5 + 1 - 0) + Math.ceil(height / pl_item.offsetHeight)) : 0
			...
			if (pl_item && typeof yt6.pl_index_m == 'number' && yt6.pl_index_m > 0) {
			  ...
			  try { yt6.pls_top = 1 * pl_item.firstChild.firstChild.href.split('&index=')[1].split('&')[0].split('#')[0] } catch(e){}
			  var height = pl_item.offsetHeight;//79//document.querySelector('#items.playlist-items [thumbnailwidth]').scrollHeight;
			  var list = gc('playlist-content section')[0] || gc('ytm-playlist-panel-renderer-v2')[0] || gt('ytm-playlist-engagement-panel', 1)[0]
			  if (list) { 
				...
				function(){
				  var z = (screen.height >= screen.width) ? gc('compact-media-item-headline')[yt6.pl_index_m - yt6.pls_top] : gt('ytm-app', 1)[0], y = gid('player-container-id');// focus on the playlist item currently being played or the player itself
				  if (y) y.className = (z == gt('ytm-app', 1)[0]) ? 'player-container' : 'player-container sticky-player'
				  try { z.scrollIntoView(true) } catch(e){}
				},700,4900);
				//gt('ytm-playlist-panel-video-renderer', list)
				if (debug) 
				ev_log('Index: ' + yt6.pl_index_m +
				'\nTop: ' + yt6.pls_top +
				'\nHeight: ' + height +
				'\nDistance: ' + (yt6.pl_index_m - yt6.pls_top) +
				'\nPixels: ' + (height * (yt6.pl_index_m - yt6.pls_top)) +
				'\nList: ' + list.tagName +' '+ CustomEvent);
				if (list) list.scrollTop = height * (yt6.pl_index_m - yt6.pls_top)
				//set_controls()
			  }
			} else return void 0
...
function pl_item(update) {


  yt6.vid = video_id(update)[0]
  ...
  var z = gid('playlist') || gid('queue')
  if (yt6.layout == 16 && yt6.pls && z && z.id == 'playlist' && typeof z.className == 'string' && z.className.indexOf('ytd-watch') == -1) {
    z = gt(z.tagName, 1)
    for(i=0;i<z.length;i++) if (z[i].className.indexOf('miniplayer') == -1) { z = z[i]; break }
  }

    if ((z && z.style.display != 'none' && !z.hasAttribute('hidden')) || yt6.mobile) {
      if (!yt6.ytm) {
	if (!yt6.mobile) {
	  var z = gt('YTD-PLAYLIST-PANEL-SUPPORTED-ITEMS', yt6.pls) //document. may include miniplayer items
	  if (!(z && z[0])) z = gt('YTD-PLAYLIST-PANEL-VIDEO-RENDERER', yt6.pls)
	} else {
	    var z = (yt6.pls) ? yt6.pls : document; z = gt('ytm-playlist-panel-video-renderer', z)
	  }
      } else { var z = gt('ytmusic-player-queue-item', z) }

      if (z && z[0]) {
	var mix = (yt6.pls) ? yt6.pls.querySelectorAll('#playlist-action-menu') : null
	for(i=0;i<z.length;i++) {
	  if (z[i]) {
	    if (!yt6.ytm) {
	    var zi = gt('A', z[i])[0]
	    if (zi && zi.getAttribute('href') != null) {
	      var x = vID(zi.getAttribute('href')).split('&')[0].split('#')[0]
	      if (!yt6.ytm) {
		index = (zi.getAttribute('href').split('&index=')[1]) ? 1 * zi.getAttribute('href').split('&index=')[1].split('&')[0].split('#')[0] - 1 : 0
		if (i == 0 && yt6.layout == 16) {
		  yt6.pl_set = index
		}
	      }
	      if (zi.innerHTML.indexOf('/watch?v=' + yt6.vid) != -1 || (mix && mix[0] && !mix[0].firstElementChild) && c[1] && c[1].video_id == x || yt6.vid == x ) {
		var y = (index + 1)
		...
		if (typeof y == 'number') { yt6.pl_index = y - 1 } else { if (y == 'â–¶' && typeof yp == 'number') { yt6.pl_index = yp } }
		...
		if (y) {
		  y = gt('ytmusic-item-thumbnail-overlay-renderer', y)[0]
		  if (y) {
	    ...
	    if (i == z.length -1) yt6.pl_last = z[i].cloneNode(true)
	  }
	}

	if (typeof y != 'number') {
	    if (typeof yt6.pl_index == 'number') {
	      y = (!yt6.pl_next_blocked) ? (1 * yt6.pl_index - 0) : (1 * yt6.pl_index - 0 + 1)
	    }
	}
	  ...
	  var index = y, yy = y, xx
	  if (yt6d.playlist) { yt6d.playlist.current = (yt6d.playlist.list && location.href.indexOf(yt6d.playlist.list) > -1) ? y : null; yt6d.playlist.next = null }
	  var yr = new RegExp('&index=' + (y + 1));//[^0-9]
	  var yr2 = new RegExp('&index=' + (y + 2))
	  for(i=0;i<z.length;i++) {
	    var zi = gt('A', z[i])[0], blocked = false, img, meh = '//s.ytimg.com/yts/img/meh_mini-vfl0Ugnu3.png'
	    if (zi && zi.parentNode) {
	      img = gt('img', zi)[0]
	      if (img) {
		xx = (z[i].data && z[i].data.thumbnail && z[i].data.thumbnail.thumbnails)
		if (xx && xx.length && typeof xx[0].url == 'string' && xx[0].url.indexOf(meh) > -1) blocked = 1
		if (!blocked && img.lazyData && Array.isArray(img.lazyData.sources) && typeof img.lazyData.sources[0].url == 'string' && img.lazyData.sources[0].url.indexOf(meh) > -1) blocked = 2
		if (!blocked && typeof img.src == 'string' && img.src.indexOf(meh) > -1) blocked = 3
	      }
	      if ( zi.getAttribute('href') != null) {
		if ( ((!yt6.pl_next && zi.getAttribute('href').match(yr) != null) || (yt6.pl_next && yt6.pl_next_blocked)) ) {
		  yt6.pl_next = zi
		  yt6.pl_next_blocked = (blocked) ? true : false// || yt6.pl_next_blocked
		}
	      }
	      if (!yt6.pl_nnext && zi.getAttribute('href') != null && zi.getAttribute('href').match(yr2) != null) {
		yt6.pl_nnext = zi
	      }
	    }
	    ...
	    if (yt6d.playlist)
	    if (yt6d.playlist.current == (y - 1 + 1)) {
	      if (zi && zi.parentNode) {
		if (zi.getAttribute('href').split('&index=')[1]) { index = zi.getAttribute('href').split('&index=')[1].split('&')[0].split('#')[0] } else continue
		if (!isNaN(1 * index) ) { 
		  if (typeof yt6d.playlist.items[index] !== 'object') yt6d.playlist.items[index] = {}
		  if (!yt6d.playlist.items[index].href) yt6d.playlist.items[index].href = clone(zi.getAttribute('href'))

		  yt6d.playlist.items[index].blocked = (blocked) ? true : false; //if (blocked) { yt6.test = img; console.log(blocked +' '+ index) }
	  ...
	  if (yt6d.playlist) {
	    var l = yt6d.playlist.items, i = (Array.isArray(l) && l.length && l[l.length-1] && typeof l[l.length-1].href == 'string' && l[l.length-1].href.split('&index=')[1]) ? 1 * (l[l.length-1].href.split('&index=')[1].split('&')[0].split('#')[0]) - 0 : 0, next = false

	    for(i=i;i > 0;i--) if (l[i]) {
	      if (l[i] && l[i].href && typeof l[i].href == 'string') {
		if (l[i].href.indexOf(yt6.vid) == -1) {
		  var pl_next_blocked = (l[i].blocked) ? true : false
		  if (!pl_next_blocked) { if (i >= (y + 1) ) { yt6d.playlist.next = i }
		    yt6d.playlist.items[i].blocked = false
		  } else { yt6d.playlist.items[i].blocked = true }

		  if (i == (y + 2) && yt6.pl_next_blocked) {
		    if (!yt6d.playlist.items[i-1].blocked) { yt6d.playlist.items[i-1].blocked = true; if (yt6.pl_nnext) yt6.pl_next = clone(yt6.pl_nnext) }
		  }
		}
	      } else if (!l[i]) { l[i] = {}; l[i].href = ''; l[i].link = {} }
	    }

	    if (yt6.pls) {//yt6.mobile && 
	      if (!yt6d.playlist.next || yt6d.playlist.next == yt6d.playlist.current) {
		i = gc('playlist-panel-subhead')[0]
		if (i && i[yt6.txt]) {
		  try {
		    i = (1 * i[yt6.txt].split('/')[0].split('â€¢')[1]); if (i !== yt6d.playlist.current) { yt6d.playlist.current = (i - 1) };  //i = (i + 1)
		    if (typeof i == 'number') { if (i > yt6d.playlist.current && !(yt6d.playlist.items[i] && yt6d.playlist.items[i].blocked) && !yt6.pl_next_blocked) { yt6d.playlist.next = i } else { yt6d.playlist.next = (i + 1) } }
		  } catch(e){}
		}
	      }
	      try {
		var aye = (yt6d.playlist.next - yt6d.playlist.current)
		y = getElementsByAttribute(gt('lazy-list', yt6.pls)[0],'ytm-playlist-panel-video-renderer','aria-selected','true'); if (y && y[0]) { y = y[0]
		x = y.previousElementSibling
		if (x) {
		  var xi = 1
		  while (x.previousElementSibling && yt6d.playlist.items[(yt6d.playlist.current-xi)].blocked) { x = x.previousElementSibling; xi++ }
		  x = gt('a', x)[0]; if (x) { yt6.pl_prev_btn = x; yt6.pl_previous = x }
		} } else {  }
		y = getElementsByAttribute(gt('lazy-list', yt6.pls)[0],'ytm-playlist-panel-video-renderer','aria-selected','true'); if (y && y[0]) { y = y[0]
		x = y.nextElementSibling
		if (x) {
		  var xi = 1
		  while (x.nextElementSibling && yt6d.playlist.items[(yt6d.playlist.current+xi)].blocked) { x = x.nextElementSibling; xi++ }
		  x = gt('a', x)[0]; if (x) { yt6.pl_next_btn = x; yt6.pl_next = x }
		} } else {  }
	      } catch(e){}
	    }
	  }

	  y = (yt6d.playlist && typeof yt6d.playlist.prev == 'number') ? 1 * (yt6d.playlist.prev) : yy
	  if (!yt6.mobile && !(yt6.pl_previous && yt6.pl_previous.getAttribute('href').indexOf('&index=' + (y-2)) != -1)) {
	    var yr = new RegExp('&index=' + (y-1));//[^0-9]
	    for(i=0;i<z.length;i++) {
	      var yi = gt('A', z[i])[0]
      ...
      } else if (yt6d.playlist) {
	  if (!yt6d.playlist.current && yt6.pl_index) yt6d.playlist.current = (1 * yt6.pl_index)
	  if (!yt6d.playlist.next || yt6d.playlist.current == yt6d.playlist.next) { yt6d.playlist.next = (yt6d.playlist.current + 1) }
	}
      if (yt6d.playlist && typeof yt6d.playlist.current == 'number') {
	var x = yt6d.playlist.items
	if (x) for (i=(yt6d.playlist.current-1);i>=0;i--) if (x[i] && !x[i].blocked) { yt6d.playlist.prev = i; break }
      }
    }

  if (offset) {
    var playlist_scroller = gclass('playlist-items')[0]
    if (playlist_scroller) {
	if (yt6.layout == 16 && playlist_scroller.nextSibling && playlist_scroller.nextSibling.tagName == 'IRON-LIST' && playlist_scroller.nextSibling.id == 'items') {
	  var playlist_scroller = yt6.playlist_scroller = playlist_scroller.nextSibling
	}
	playlist_scroller.scrollTop = offset
    }
  }
...
function fix_playlist() {
  ...
  var pl_index, p = player(), p = yt6.p, playlist_scroller, z = null, pn = 'parentNode'
  ...
  if (playlist.id.indexOf('watch') == -1) { // new layout

    if (!yt6.mobile) { z = gc('playlist-items')
      if (z) { if (z[0]) for (i=(z.length-1);i>=0;i--) { if (z[i] && z[i][pn] && z[i][pn][pn] && typeof z[i][pn][pn].className == 'string' && z[i][pn][pn].className.indexOf('-miniplayer') == -1) { z = z[i]; break }}; if (!z[pn]) z = undefined; }
	} else z = playlist[pn][pn][pn]

    playlist_scroller = yt6.playlist_scroller = z
	...
	if (!yt6.ytm) {
	  var z = gc('style-scope ytd-playlist-panel-renderer')
	} else var z = gt('ytmusic-player-queue-item', 1)
	return z
      }


      if (!yt6.ytm) {
	if (typeof yt6.pl_index == 'number') { pl_index = clone(yt6.pl_index) } else { 
	  pl_index = location.href.split('&index=')[1]; if (pl_index) pl_index = 1 * pl_index.split('&')[0].split('#')[0] - 1
	}
	pl_index = (!isNaN(pl_index)) ? pl_index : null
	var z = gid('publisher-container')
	if (z) {
	  z = z.lastChild
	  if (z) { z = z.getElementsByClassName('index-message')[0] || gt('yt-formatted-string', z)[0]
	    if (z) {
		if (z.tagName == 'SPAN') {
		  if (!pl_index) pl_index = 1 * z[yt6.txt].split(',').join('').split('/')[0] - 1
		  yt6.pl_length = 1 * z[yt6.txt].split(',').join('').split('/')[1] - 1
		} else {
		    if (!pl_index) pl_index = 1 * z.firstChild[yt6.txt] - 1
      ...
      if (!pl_index && p && typeof p.getPlaylistIndex == 'function') {
	pl_index = p.getPlaylistIndex()
	yt6.pl_i = JSON.parse(JSON.stringify(p.getPlaylistIndex()))
	if (pl_index == 0) playlist_scroller.scrollTop == 64
      }


      if (typeof pl_index == 'number') {

	yt6.pl_index = pl_index

	if (yt6.mobile) {
		if (!(!yt6.x && gpst(yt6.p) != 2))
	...
	if (yt6.ytm) {
	  ...
	  playlist_scroller.scrollTop = 57 * yt6.pl_index
		...
		x = gt('ytd-playlist-panel-video-renderer', yt6.playlist_scroller),
		query = 'querySelector'; try { if (!(x && x[0].querySelector('#index'))) query = '__shady_native_querySelector' } catch(e){ query = '' }

	    if (query && !(typeof yt6.pl_index == 'number' && z && z.indexOf('&index=') != -1 && 1 * z.split('&index=')[1].split('&')[0].split('#')[0] == yt6.pl_index - 1 + 1)) {
		...
		if (yt6 && yt6.playlist_scroller) {
		  if (x && x[0]) {
		    var start, end
		    start = (x[0][query]('#index').innerHTML || 0) * 1;
		    end = (x[ (x.length || 0)-1][query]('#index').innerHTML || (x.length + 1)) * 1;
		...
		start = (x[0][query]('#index').innerHTML || 0) * 1; if (isNaN(start)) start = 1
		end = (x[ (x.length)-1][query]('#index').innerHTML || (x.length + 1)) * 1; if (isNaN(end)) end = (start + 221)
      ...
      yt6.scrollT = (playlist_scroller) ? playlist_scroller.getElementsByClassName('yt-uix-scroller-scroll-unit')[0] : null
      if (yt6.scrollT) {
	yt6.scrollT = yt6.scrollT.getAttribute('data-index');
	var z = gclass('currently-playing')
	if (z && z[0]) {
          yt6.pl_index = z[0].getAttribute('data-index');
	  var y = z[0][pn].children || z[0][pn].childNodes
	  for(i=0;i<y.length;i++){
	    if (y[i] == z[0]) { yt6.pl_next = y[i+1]; break }
	  }
	  playlist_scroller.scrollTop = (!yt6.shuffle) ? 61 * (yt6.pl_index - yt6.scrollT - 2) : 61 * (i)
	  yt6.pl_next = (!yt6.shuffle) ? getElementsByAttribute(z[0][pn],'li','data-index', (1 * yt6.pl_index)+1 )[0] : yt6.pl_next
	  if (yt6.pl_next) {
	  ...
	  yt6.pl_previous = getElementsByAttribute(z[0][pn],'li','data-index', (1 * yt6.pl_index)-1 )[0]
	  if (yt6.pl_previous) {
...
function getScrollbarWidth() {
  ...
  if (!outer) {
    ...
    outer.style.width = (((yt6 && yt6.offsetWidth) || 99) + 1) + 'px';
  ...
  if (outer && !inner) {
    ...
    try { var widthWithScroll = (inner.offsetWidth + 0); } catch(e) { var widthWithScroll = (widthNoScroll + 16) }
...
function wallpaper(){
  ...
  if (typeof $ == 'function') $(function(){
    ...
    var maxWidth = parseInt(window.innerWidth || document.documentElement.clientWidth || yt6.body.clientWidth) - yt6.sb - 1, windowwidth = maxWidth, ww0 = (windowwidth + yt6.sb)
    var width
    ...
    var mep = gid(mep_x('mep_')), bm0 = gid('bm0'), pc = (yt6.layout == 16) ? pcont() : yt6.api, ptc = gid('player-full-bleed-container')
    if (pc) {
    ...
    if (bm0) {
      bm0.style.backgroundColor = (yt6.wallpaper || yt6.cin) ? 'transparent' : 'rgb(16, 16, 16)'
    ...
    if (yt6.wallpaper == true && !yt6.wide) {
	  ...
	  if (!yt6.ytp.embed) {
	    ...
	    if (yt6.mobile) { imgs = gc('video-thumbnail-container-compact center') } else
	    if (yt6.ytm) { imgs = gt('yt-img-shadow', 1) } else
	    imgs = gt('ytd-thumbnail', 1)
	  }

        if (imgs && imgs[0]) {
	  for(i=0;i<imgs.length;i++) {
	    if (!yt6.ytp.embed) {
	      var a = gt('img', imgs[i])[0]
	      var pn = 'parentNode'; if (a && a.parentNode && a.parentNode.toString() == '[object DocumentFragment]') pn = '__shady_native_parentNode'
	      if (a && a.tagName == 'IMG' && a.src != '' && a[pn] && (!yt6.mobile && (a[pn][pn] && a[pn][pn][pn] && (a[pn][pn][pn][pn] === null) || (a[pn][pn][pn][pn] && a[pn][pn][pn][pn].tagName != 'YTD-GUIDE-ENTRY-RENDERER')) || (yt6.mobile))  ) {
    ...
    else if (yt6.wide && yt6.cin) yt6.cin.style.display = ''
    ...
    if (yt6.layout == 16 && !yt6.mobile && !yt6.ytm) {
      yt6.cin = gid('cinematics')
      if (yt6.cin && yt6.cin.parentNode) {
	yt6.cin.style.display = (!yt6.wallpaper || yt6.cin.style.display == 'none') ? 'none' : ''
	var t = (yt6.wide && typeof yt6.wallpaper != 'string') ? gid('cinematics-full-bleed-container') : gid('cinematics-container')
	t.appendChild(yt6.cin)
	if (!yt6.cin.style.display) { backImage = ''; backSize = ''; backPosition = ''; backRepeat = ''; }
      }
      var ptc = $('#player-full-bleed-container')
      if (ptc) {
    ...
    if (yt6.layout == 16) {
      var z = gid('secondary-inner'), grid = (yt6.flexy == 'grid' && (yt6.size == 'default' || (yt6.size !== 'default' && gid('primary-inner') && typeof yt6.x == 'string' && 1*(yt6.w.replace('px','')) > gid('primary-inner').offsetWidth))) ? true : false
      if (z) { var y = gid('secondary')
	z.style.width = (yt6.wallpaper) ? '422px' : ''
	z.style.position = (yt6.wallpaper && !yt6.wide) ? 'absolute' : ''
	//z.style.marginTop = (yt6.wallpaper && !yt6.wide && (yt6.size != 'default' || !yt6.pls)) ? ((!chat) ? (1 * yt6.h.replace('px','') + 24) +'px' : yt6.h +'px') : ''
	if (y) {//if (y) if (yt6.wallpaper) 
	  y.style.top = (!yt6.wide) ? (1 * yt6.h.replace('px','') + 24) + 'px' : '' //y.style.marginTop = (!yt6.wide && yt6.size != 'defalult') ? (1 * yt6.h.replace('px','') + 24) + 'px' : ''
	  if (!yt6.wide) { y.style.marginTop = '' } else y.style.marginTop = '24px'
	} //else y.style.marginTop = ''

	  if (yt6.pls && yt6.wallpaper && yt6.size != 'default' && typeof yt6.wallpaper != 'string') yt6.pls.style.marginTop = ''///
	  if (yt6.wsb) {
	    if ((yt6.size == 'default' && !yt6.wide) || (yt6.pls && yt6.wide)) { //if (yt6.pls || !yt6.wide || (yt6.pls && yt6.wide)) { 
	      yt6.wsb.style.marginTop = (yt6.pls || ww0 < 1000 || grid) ? '' : (-1 * yt6.h.replace('px','')) + (-1 * 24) + 'px'//((yt6.pls && yt6.wide) || (yt6.size == 'default' && !yt6.pls) || ww0 < 1000) ? '' : (1 * yt6.h.replace('px','')) + (1 * 24) + 'px'
	    } else {
		if (!(yt6.wide && !yt6.pls)) {										//(1 * yt6.h.replace('px','') + 24) +'px'
		  yt6.wsb.style.marginTop = ( (!yt6.pls) || !yt6.wide) ? ( !(yt && yt.config_ && yt.config_.LOGGED_IN) ? '' : '10px') : (1 * yt6.h.replace('px','') - 24) +'px' // '10px' :
		} else yt6.wsb.style.marginTop = '20px'
	      }
	  }
	  //if (yt6.pls) yt6.pls.style.marginTop = (yt6.wallpaper || (!yt6.wallpaper && yt6.size == 'default')) ? '' : ((!chat) ? (-1 * yt6.pls.style.marginTop.replace('px','') - 24) +'px' : yt6.pls.style.marginTop) //yt6.h
	  if (yt6.wsb && yt6.pls) {
	    if (yt6.wsb.id == 'secondary') {
	      if (y) {
	        yt6.pls.style.marginTop = ( !yt6.wide && ww0 >= (1000 + yt6.sb) && yt6.size == 'default') ? -1 * yt6.h.replace('px','') - 24 - 0 + 'px' : ((!yt6.wide) ? '' : '20px')
	      }
	    } else yt6.pls.style.marginTop = (yt6.wide) ? '20px' : ''
	  }
...
function mute_ad(p) {
	...
	if ((ads0 && ads0 != '0:00' && p && p.tagName != 'EMBED') || ads1) {
	  ...
	  var f = (p && p.tagName == 'DIV' && typeof p.getDuration == 'function') ? p.getDuration() : 0

	  if (yt6.mobile)
	  if ( typeof yt6.mobile_nav === 'undefined' && //(yt6.x || (yt6.mute_on)) && 
	       (   (!ads0 || (ads0 && yt6.real_media_duration && Math.abs(ads0 - yt6.real_media_duration) > 1.5) )
		&& f
	       ) && ( Math.abs(ads0 - f) > 1.5&& Math.abs(yt6.real_media_duration - yt6.loaded_media_duratin) > 1.5 && !(browserName == 'Firefox' && yt6.mobile) ) ) { ads0 = f } //f >= 1.5 &&



	  if ( (yt6.x || yt6.vid == yt6.loaded_vid)
		&& (ads0 || ads1) && yt6.linx && yt6.linx.length && !yt6.blocked  //) {//yt6.ad_ == ads0 || ads1)
		&& ( (!yt6.ad_skipped && yt6.ad_ != ads0)
		     || (yt6.ad_ > 1 && 
			  ( Math.abs(yt6.real_media_duration - yt6.ad_) > 1.5 || 
			    (1.5 >= Math.abs(yt6.real_media_duration - yt6.ad_) && Math.abs(yt6.loaded_media_duration - yt6.ad_) > 1.5) ||
			    (yt6.ad_ == yt6.loaded_media_duration && yt6.ad_ == Math.round(yt6.real_media_duration) && Math.abs(yt6.ad_ - yt6.real_media_duration_) > 1.5)
			) )
	     )     ) {//yt6.ad_ == ads0 || ads1)

	    var dur = !(yt6.ad_ > 1 && 1.5 >= Math.abs(yt6.real_media_duration - yt6.ad_) && Math.abs(yt6.loaded_media_duration - yt6.ad_) > 1.5)
		? (yt6.real_media_duration || yt6.loaded_media_duration)
		: yt6.loaded_media_duration
	    //console.log(ads0 +' '+yt6.loaded_media_duration +' '+ yt6.pre_ad +' '+ yt6.real_media_duration +' '+ yt6.real_media_duration_m)


	    if ( (( (( (yt6.pre_ad == '?' && !yt6.live) || !yt6.ads_off) && (yt6.loaded_media_duration && (!isNaN(1 * yt6.real_media_duration_m) && !(yt6.mobile && !yt6.real_media_duration_m) && Math.abs(1 * yt6.real_media_duration_m - yt6.loaded_media_duration) > (ads0 || 1.5) && 
			((browserName == 'Firefox' && yt6.mobile && Math.abs(ads0 - yt6.real_dur) > 1.5) || 1.5 >= Math.abs(1* yt6.real_media_duration_m - (yt6.real_media_duration)) )
		    )))
		  || Math.abs(yt6.loaded_media_duration - ads0) > 1.5 || yt6.ytm 
		  ) && ( Math.abs(yt6.real_media_duration - ads0) > 1.5 || (browserName == 'Firefox' && yt6.mobile && Math.abs(yt6.loaded_media_duration - yt6.real_dur) > 1.5) || (!yt6.ads_off && Math.abs(1 * yt6.real_media_duration_m - yt6.loaded_media_duration) > 1.5) )
		 ) || (yt6.live && ads0 && (1.5 >= Math.abs(yt6.loaded_media_duration - ads0) || (f && typeof p.getCurrentTime == 'function' && p.getCurrentTime() > yt6.loaded_media_duration)) )
	       ) {
		...
		if ( (!yt6.navigation || yt6.ytm || yt6.mobile) &&
		     //(yt6.change == true || typeof yt6.change == 'undefined') &&
		      (
			(yt6.pre_ad == '?' && !yt6.real_media_duration_ && yt6.mute_on && !yt6.ad_skipped) || 
			(yt6.real_media_duration_ === yt6.real_media_duration && 
				(!isNaN(1 * yt6.real_media_duration_m) && yt6.real_media_duration_m > 0 && (yt6.real_media_duration_m != yt6.ad_duration || shorts()) &&
				(!(yt6.live && yt6.real_media_duration_m === yt6.real_media_duration)) &&
				( (Math.abs(1 * yt6.real_media_duration_m - yt6.ad_duration) > 1.5) && Math.abs(1 * yt6.loaded_media_duration - yt6.ad_duration) > 1.5) )//?
			)
			|| (yt6.live && yt6.p.getCurrentTime() > 0 && 1.5 >= Math.abs(yt6.p.getDuration() - yt6.p.getCurrentTime()) )//ads0 &&    (ads0 -
		      )
		  ) {// mute the ad
		  if ( !(yt6.live && !yt6.x && yt6.ads_off) && p && typeof p.isMuted == 'function') {
		    if ( (yt6.x || (!yt6.x && yt6.pre_ad)) && !(yt6.ytm && yt6.ytp.fullscreen))
		      try {
			if (yt6.mute_on && !yt6.ad_muted) { p.mute(); yt6.ad_muted = true }
		      } catch(e) { if (!p.isMuted()) yt6.ad_muted = false }
		  }
		  yt6.pre_ad = true;   if (yt6.ad_ === null) yt6.ad_ = ads0
		  if (yt6.ads_off) {
			...
			if (ct < 120) { //ev_log('!!??A')
			  yt6d.ad = 1
			  //if (!yt6.mobile) load_from_page_source(true); //yt6d.mep_reload()
			}
		    }
		  } else if (f && Math.abs(ads0 - f) > 36 && yt6.mobile_nav) yt6.mobile_nav = false

		} else {
		    if (yt6.loaded_vid == yt6.vid) yt6.real_media_duration_ = (yt6.ads_off) ? clone(yt6.real_media_duration) : null // define a second variable merely to delay muting one more cycle
		    yt6.pre_ad = '?'
		  }


		//console.log('Preemptive video ad = ' + yt6.pre_ad)


	    } else {
		if ( ( (yt6.real_media_duration && 1.5 >= Math.abs(yt6.real_media_duration - ads0)) ) || ( yt6.ad_muted && 1.5 >= Math.abs(yt6.real_media_duration - yt6.loaded_media_duration) ) ) { // conditions to unmute
		  if (yt6.pre_ad) if (!yt6.x && vID(yt6.vid) && yt6.p && gpst(yt6.p) != -1) yt6.p.playVideo()
		  yt6.pre_ad = false
		  if (!yt6.x //|| (yt6.layout == 16 && !yt6.mobile && !yt6.ytm && hid())
		  ) if (typeof p.isMuted == 'function' && yt6.ad_muted && !(yt6.mobile && yt6.x && hid()) ) {
		...
		} else if (yt6.mobile && !yt6.mobile_nav && !yt6.loaded_media_duration && yt6.real_dur && yt6.real_dur == yt6.real_media_duration && yt6.real_media_duration_m && Math.abs(yt6.ad_duration - yt6.real_dur) < 1) { yt6.loaded_media_duration = clone(yt6.real_media_duration_m) }
	      }

	    if (yt6.ads_noskip) {
	      if (yt6.pre_ad == false && !(ads0 == yt6.ad_duration && yt6.real_media_duration && yt6.real_dur == yt6.real_media_duration && Math.abs(yt6.real_dur - ads0) > 1.5))
	      if ( (!yt6.x || yt6.mobile_nav) && !(!yt6.ads_off && yt6.mute_on) ) yt6.loaded_media_duration = ads0;
	    }

	  } else { //delay one cycle
	      if (!yt6.pre_ad && yt6.vid == yt6.loaded_vid) yt6.ad_ = ads0
	      if (!yt6.x && hid()) try { if (p.getCurrentTime() < 0.1) p.playVideo() } catch(e){}
	    }
...
function buildObject(ytplayer, ios){
  ...
  if ( !c[0] || (!(yt6.status == 'unplayable' && yt6.reason) ) ) {
	...
	//if (window.ytplayer.config.args.video_id != video_id()[0]) {
	  yt6.age.v = 1
	  missing_source = ageless_verification(undefined, ios)
	//}
      }
    } else { yt6.age.v = 2; missing_source = ageless_verification(undefined, ios); if (yt6.mobile) ajax1() }
  ...
  if ((yt6.layout == 16 || yt6.body2) && video_title()[1] && !yt6.ytm && !yt6.skeleton && !(c[1] && (c[1].errorcode == 150 || c[1].errorcode == 101))) {
    ...
    if ((yt6.layout == 16)// && yt6.vid != yt6.loaded_vid && !(c[1] && c[1].video_id && c[1].video_id == yt6.vid))
     || (yt6.layout == 12 && missing_source)) test_4()

  }


  if (yt6.mobile && yt6d.ad) { //ev_log('!!??A')
    //location.href = window.location.href
  }

  if (yt6.layout == 12 && !hid() && (yt6.blocked || yt6.status == 'unplayable' || yt6.status == 'error') && gid('bm0')) { // movie player will be wrecked, move to safe place
  ...
  if (( ( !(yt6.layout == 12 && typeof yt6.audio == 'string' && hid() && yt6.player2 && yt6.player2.media && yt6.player2.media.loaded == 1) || yt6.body2) && // do not start another build-up if audio is already set correctly and is playable
  ...
  if (( ( (yt6.layout == 12 && (yt6.blocked || (yt6.flash.forced)) ) //old layout should only ever get a pass here if the video is blocked
	...
	if (yt6.xhr.async && yt6d.previous.linx.length) {
	  ...
	  if (yt6.change != 0 && !yt6d.source) {
	    ...
	    if (!yt6.ytm && !(yt6.layout == 12 && hid() )) if (!z) { return false } //else { console.log(' the build-up needs to happen after the response to the asynchronous call arrived, so leave now with a negative response to stop further actions ') }
...
*/
	...
	if (typeof yt6.player1.setSrc == 'function') {
	  clear_mep(yt6.player1)
	} else try { gid('player1').src = pseudoSrc } catch(e){}
      }
  ...
  var html = [new Date().toLocaleString(),
	...
	'<button id="hide-links" class="snarl-button yt-uix-button-text" onclick="var a, b, c, panel = gt(\'panel-container\', 1)[0];'+
	'if (panel) panel.style.opacity = (panel.style.opacity != \'0.99\') ? \'0.99\' : \'1\';'+
  ...
  var ft = [args.url_encoded_fmt_stream_map, args.adaptive_fmts || yt6.adaptive_fmts ],
      fn, a_r, ad = 0, ad2, dur, dur2, durA1 = {}, durA2 = {}, durL1 = [], durL2 = [], ad_links = [], avg1, avg2, avgx, durA1k, durA2k, length_seconds = args.length_seconds

  durA1.A = []; durA2.A = []; yt6.eidA = []
  var live = (Array.isArray(ft) && ft[1]) ? (ft[1].match('yt_live_broadcast') || ft[1].match('yt_premiere_broadcast')) : -1; if (live) { yt6.live = '&sq='; yt6.live_ = 1 } else { yt6.live = false; yt6.live_ = 0 }



	function alt_linx(_index, _href, lsec, dur, eid) {
	  var z = linx[_index]
	  if (typeof _href == 'string' && _href.indexOf('googlevideo.com/') > -1 && ( _href.indexOf('&alr=') == -1 || ( yt6.ytp && ((typeof yt6.ytp.A == 'string' && yt6.ytp.A.indexOf(_href) > -1) || (typeof yt6.ytp.V == 'string' && yt6.ytp.V.indexOf(_href) > -1)) ) ) && ((z && z != _href) ) ) {	// || (Math.abs(lsec - dur) >= 1.5)	|| (!(!z && yt6.mobile) && itag(_href) >= 103)
	      if (typeof z == 'string' && yt6.real_eid && z.indexOf(yt6.real_eid) > -1 && linx[(1000 + 1 * _index)] && _href && _href.indexOf(yt6.real_eid) == -1) {
	  ...
	  } else { //console.log('new or duplicate '+_index + _href.indexOf('&alr=') +' '+(z && z!=_href))
	      return _index
	    }
	}
  ...
  for (i in ft) {
	...
	if (!qs.itag) { continue }
	if (!qs.url) {
	  if (z[j] == yt6.ytp.V) { qs = yt6.ytp.Vobj; if (!qs) continue; ok = true } else
	  if (z[j] == yt6.ytp.A) { qs = yt6.ytp.Aobj; if (!qs) continue; ok = true } else
	    {
	...
	var href = unescape(qs.url).replace('http:', '').replace('https:', '')
	var pot = ''
	if (yt6.pot && typeof yt6.pot == 'string') {
	  pot = (href.indexOf(yt6.pot) > -1) ? true : false
	  if (!pot) {
	    if (href.indexOf('&pot=') > -1) { //href = href.split('&pot=')[0] + (href.split('&pot=')[1] || '').split('&')[1] + yt6.pot; pot = true
	    } else href = href + yt6.pot
	  }
	}

	// the ump=1 parameter makes the content unplayable in progressive download mode, so set the value to 0
	if (href.indexOf('&ump=1') > -1) { href = href.replace('ump=1','ump=0') } //new RegExp('[^l]mt=([0-9]*)\&', 'gm')

	// set n-parameter to unthrottle yt a/v data traffic
	if (!ok && typeof yt6d.ndec == 'function' && qs.n && qs.n.length > 14) { href = href.replace(qs.n, yt6d.ndec(qs.n)) }
	...
	if (!yt6.age.dl && !yt6.age.sc) {
	  if (typeof yt6.ytp.dur != 'number') {
	    ...
	    dur2 = (typeof yt6.ytp.dur == 'number' && typeof yt6.ad_duration == 'number' &&
		...
		{
		  linx[(2000 + 1 * qs.itag)] = href; //console.log('video \n'+ yt6.ytp.V)
		  // change the link to the same video source ytplayer is using right now
		  //linx[qs.itag] = clone(yt6.ytp.V); href = clone(yt6.ytp.V)
		}
	    }
	  ...
	  if (yt6.ytp.A && qs.itag == itag(yt6.ytp.A) && yt6.ytp.A.indexOf(href) == -1) {
	    if ( (dur2 || (!dur2 && !avgx)) && html.toString().indexOf(yt6.ytp.A) == -1 && (Math.abs(yt6.ytp.dur - dur) < 1.5 || yt6.ytp.dur === 0) ) {
	      linx[(2000 + 1 * qs.itag)] = href; //console.log('audio \n'+ yt6.ytp.A)
	      // change the link to the same audio source ytplayer is using right now
	      //linx[qs.itag] = clone(yt6.ytp.A); href = clone(yt6.ytp.A)
	    }
		...
		if (!(yt6.ads_eid && yt6.ytp.V.indexOf(yt6.ads_eid) > -1) && Math.abs(yt6.ytp.dur - dur) < 1.5) {
		  if (linx[(1000 + 1 * itag(yt6.ytp.V))]) {
		    linx[(2000 + 1 * itag(yt6.ytp.V))] = clone(linx[(1000 + 1 * itag(yt6.ytp.V))])
		    // change the link to the same audio source ytplayer is using right now
		    //linx[itag(yt6.ytp.V)] = clone(yt6.ytp.V);
	...
	if (eid) {
	  eid = eid.split('&')[0].split('%26')[0]
	  if (yt6.eidA.indexOf(eid) == -1) yt6.eidA.push(eid)
	}



	if (dur && ((yt6.ads_eid && href.indexOf(yt6.ads_eid) > -1) || yt6.live || (avgx && ((yt6.mobile && yt6.ads_eid1 && yt6.ads_eid2) || yt6d.init) ) )) {
	  if (avgx && linx.length && yt6.ads_eid1 !== eid && !(yt6.real_eid && eid == yt6.real_eid) ) {

	  } else if (!shorts() && !(yt6.real_eid && eid == yt6.real_eid) && Math.abs(yt6.real_media_duration - dur) > 1.5) {
	      if (eid && yt6.pre_ad) {
		yt6.ads_eid = eid
		var fn = 'Advertisement'; yt6.ad_duration = dur
...
//ev_log( avgx +' avg1='+avg1+'_A='+ Math.abs(avg1 - dur)+'_avg2='+avg2+'_B='+Math.abs(avg2 - dur) )
	    if ( //!(eid && durA1.eid && durA1.edi != eid) &&
		 (!avg1 || (typeof avg1 == 'number' && Math.abs(avg1 - dur) < 1.5 && !(avg2 && Math.abs(avg2 - dur) < 1.5) ) ) ) {
	      durA1.A.push(dur); durL1[qs.itag] = href
	      durA1.eid = (eid) ? eid : durA1.eid; yt6.ads_eid1 = clone(durA1.eid); //ev_log('A '+qs.itag +' '+ dur)// +' '+ eid)
	    } else {
	        durA2.eid = (eid) ? eid : durA2.eid; yt6.ads_eid2 = clone(durA2.eid); //ev_log('B '+qs.itag +' '+ dur)// +' '+ eid)
	  ...
	  if ((length_seconds || (p && typeof p.getDuration == 'function' && !(yt6.ytm && (yt6.flash.forced || p.tagName == 'EMBED')) ))  ) {
	    ...
	    if ( ( yt6.real_media_duration > 0
		 ...
		 ) || (yt6.live && dur) || !yt6.ads_eid1 || (yt6.blocked_m && !hid())
		) {
	      
	      if (durA1.eid) {
		if ( (!yt6.real_dur && !yt6.real_media_duration_m) || (yt6.mobile && hid() && yt6.real_dur === null) ||
			( (yt6.real_dur || yt6.loaded_media_duration) && yt6.real_media_duration_m && Math.abs((yt6.real_dur || yt6.loaded_media_duration) - yt6.real_media_duration_m) < 1.5 && Math.abs((yt6.real_dur || yt6.loaded_media_duration) - dur) < 1.5) 
		   ) {
		  yt6.real_dur = (!isNaN(yt6.real_media_duration_m) && Math.abs(yt6.real_media_duration_m - yt6d.previous.duration) >= 1.5) ? ( yt6.real_media_duration_m - ((dur && dur.toString().split('.')[1]) ? 1*('0.'+ dur.toString().split('.')[1]) : 0) ) : dur
		  yt6.real_eid = clone(durA1.eid)
		  var ad_links = durL2; ad = (!avgx) ? 2 : 1

		  if (!yt6.live) {
		    if (yt6.real_media_duration == null || yt6.real_media_duration == yt6.ad_duration || (Math.abs(yt6.real_media_duration - yt6.ad_duration) < 1.5 && yt6.real_dur && Math.abs(yt6.real_dur - yt6.ad_duration) >= 1.5)) {
		      if (yt6.real_media_duration != yt6.ad_duration) { yt6.real_media_duration = clone(yt6.real_dur) } else yt6.real_media_duration = clone(yt6.real_media_duration_m)
		    }
		  } else try { yt6.real_media_duration = yt6.p.getDuration() } catch(e){}

		} else if (avgx) { var ad_links = durL1, ad = 1 } else { ad2 = 1 }
	      }
	    } else {
		if ( Math.abs(avg1 - dur) > 1.5 && (Math.abs(dur - (yt6.real_dur || 0)) > 1.5) ) { //!avgx && ad != 1   (yt6.mobile && yt6.blocked === 0) || 
		  var ad_links = (!yt6.blocked_m) ? durL2 : durL1; ad = (!yt6.blocked_m) ? 2 : 1
		  yt6.real_dur = dur; ad2 = ad
		} else {
		    var ad_links = (ad2 != 2 && !(yt6.blocked_m && hid())) ? durL1 : durL2; if (!yt6d.init) { ad = (ad2 != 2 && !(yt6.blocked_m && hid())) ? 1 : 2 } else yt6.real_dur = dur
		  }
	     }

	//ev_log(avgx +' end: '+ ad +' '+ yt6.real_dur + ' '+ dur)


	    for(k=0;k<Math.min(ad_links.length, 100);k++) {
	      for(l=0;l<linx.length;l++) if (linx[l]) {
		  if (durA1.A[k]) durA1k = durA1.A[k]; if (durA2.A[k]) durA2k = durA2.A[k]
		  var   diff1 = Math.abs(dur - durA1k),
			diff2 = Math.abs(dur - durA2k),
			diff1_2 = Math.abs(avg1 - durA2k),
			diff2_1 = Math.abs(avg2 - durA1k)


	          if ( linx[l].indexOf('&title=Advertisement') == -1 || live) {

		    if ( (ad == 1 && (durA1.eid && linx[l].indexOf(durA1.eid) > -1)) && ( (j == (z.length-1) && (diff2_1 > 36 || (yt6.mobile && !yt6.blocked_m && diff2_1 > 1.5))  ) ) ||
			 (ad == 2 && (durA2.eid && linx[l].indexOf(durA2.eid) > -1)) && ( (j == (z.length-1) && diff1_2 > 36) )
		       )
		     {
		    ...
		    a_r = true; if (linx[l].split('dur=')[1]) yt6.ad_duration = 1*(linx[l].split('dur=')[1].split('&')[0])
		    if (ad == 1) { yt6.ads_eid = clone(yt6.ads_eid1); if (yt6.ads_eid2) yt6.real_eid = clone(yt6.ads_eid2) }
		    if (ad == 2) { yt6.ads_eid = clone(yt6.ads_eid2); if (yt6.ads_eid1) yt6.real_eid = clone(yt6.ads_eid1) }
		    //break; break;
		     }
	          }
	      }
	    }; //if (j == (z.length-1)) ev_log('AD: '+ ad +' / '+ yt6.ads_eid2 +'"' + (yt6.ads_eid2 == yt6.ads_eid))
	  }

	if (href == '') continue; // make a failed extraction result in a zero length array to try again later
	  ...
	  if (a_r.length) for(k=1;k<a_r.length;k++){
        ...
        var fn = (fn != 'Advertisement') ? yt6.fn = fn || document.title || args.title : fn //+ '-' + qq).toLowerCase()
        //         .replace(/[!"&'().:[\]|]/g,'')
        //         .replace(/ /g,'-')
        //         .replace(/-+/g,'-')
	var index;
	...
	if (!qs.ok && !(Array.isArray(yt6d.previous.eid) && yt6d.previous.eid.indexOf(eid) > -1) && href.indexOf('acont%3Ddubbed') == -1) {
	  if ( !(linx[qs.itag] && linx[qs.itag].indexOf('&title=Advertisement') == -1 || href.indexOf(yt6.real_eid) == -1)
	    ...
	    linx[index = alt_linx(qs.itag, href, length_seconds, dur, eid)] = href //} else ev_log(qs.itag +' '+ Math.abs(dur - (yt6.real_dur || 0)) )

	  } else {

	      linx[index = alt_linx(qs.itag, href, length_seconds, dur, eid)] = linx_bak.split('&title=')[0]
	  ...
	  if (qs.itag == '278') {//!==
        //} else {
	      ...
	      linx[index = alt_linx(241, href, length_seconds, dur, eid)] = href

	    } else {

		linx[index = alt_linx(241, href, length_seconds, dur, eid)] = linx_bak.split('&title=')[0]
	...
	var audio
	if (!yt6.audiox) {// set audio source from first-choice links only, except on dubbed tracks
	  if ( !(pot && href.indexOf(yt6.pot) == -1) && (
		(linx.indexOf(href) < 1000 && href.indexOf('acont%3Ddubbed') == -1) || (linx.indexOf(href) >= 1000 && href.indexOf('acont%3Doriginal') > -1) )) {
	    if ((browserName != 'IE' && browserName != 'Edge')) {
		if (qs.itag == '139' || qs.itag == '140' || qs.itag == '171' || qs.itag == '251' ) { audio = http + href; yt6.real_eid = eid } //yt6.userprefA.splice(0,0,1*qs.itag) }
	    } else if ( qq.indexOf('DASH AAC')) { audio = http + href; yt6.real_eid = eid } // if M$ or not yet defined
	  }
	} else audio = yt6.audiox
...
'			    };'+
'			} else {'+
'			    if (p.getAttribute("flashvars") == null) {'+
'			      if ( gpst(p) == "1") {'+
'				var p1load = 1;'+
'				v.pause();'+
'			      } else {'+
...
'			};');
	  ...
	  var fn_ = encodeURIComponent(fn)
          ...
          var itag_ = itag(href)
	  if (itag_ == 241) itag_ = 278; if (itag_ == 132) itag_ = 160
          var size = href.match(/[&\?]clen=([0-9]+)&/i); var sizeq = ''
          if ((typeof size != 'undefined') && (size !== null)) {
            size = parseInt(size[1],10);
	    size = calculate_file_size(size)
            var y = 25, m;
	    ...
	    if (yt6.yt_otf.length && x.indexOf('p ') > -1 && yt6.yt_otf.indexOf(itag_) == -1) yt6.afmts.push(1*itag_)
	      ...
	      if (href.match('/yt_+([a-z])+_broadcast/g') && (m == 'V' || m == 'A') && yt6.yt_otf.indexOf(itag_) == -1) {//m == 'V'
		m = itag_; if (m == 241) m = 278; if (m == 160) { m = 132; yt6.yt_otf.push(160) }; if (m == 278) yt6.yt_otf.push(241); yt6.yt_otf.push(m)
	      }
	  ...
	  if (typeof qq.split(" ")[1] != 'undefined') { 
            if (typeof j != 'number') {
              html.push(
                '<a name="' + (index || qs.itag) +'" class="'+ link_class +'" href="' + http + href + '&title=' + fn_ +'" onclick="' + rp(onclic) + '"' + sizeq + ' download="' + fn + '.' + qq.split(" ")[1].toLowerCase() + '">' + qq + size + '</a>'
              );
            } else {
                html.splice(
                  j+1, 0, '<a name="' + (index || qs.itag) +'" class="'+ link_class +'" href="' + http + href + '&title=' + fn_ +'" onclick="' + rp(onclic) + '"' + sizeq + ' download="' + fn + '.' + qq.split(" ")[1].toLowerCase() + '">' + qq + size + '</a>'
                );
              }
            ...
            var fn = fn.split(" - " + qq.split(" ")[0] + " " + qq.split(" ")[2])[0]
              ...
              if (typeof j != 'number'){
                html.push(
                  '<a name="' + (index || qs.itag) +'" class="'+ link_class +'" href="' + http + href + '&title=' + fn_ +'" onclick="' + rp(onclic) + '"' + sizeq + ' download="' + fn + '">' + qs.itag + size + '</a>'
                );
              } else {
                  html.splice(
                      j+1, 0, '<a name="' + (index || qs.itag) +'" class="'+ link_class +'" href="' + http + href + '&title=' + fn_ +'" onclick="' + rp(onclic) + '"' + sizeq + ' download="' + fn + '">' + qs.itag + size + '</a>'
                  );
                }
            }
	  }//href?
...
if (args.dashmpd) {
  ...
  for (i in z) {
	...
	for (j=0;j<html.length;j++) {
	  if (html[j].indexOf("itag=160") > -1 || html[j].indexOf('href="' + protocol() + 'undefined') != -1) {
		...
		if (href.match('/source\/yt_+([a-z])+_broadcast/g')) { yt6.live = (yt6.live) ? yt6.live : '&sq=' } else yt6.live = false
  ...
  if (!yt6.aspect_ratio) {
    var x = null
    var h_orig = gt('head', 1)[0].innerHTML.match(/og:video:height([^(]+)/)
...
if (yt6.oldbrowser) {
  ...
  yt6.linx = []
  yt6.linx = linx
  for(i=0;i<1999;i++) if (Array.isArray(yt6d.mediaUrlText) && yt6d.mediaUrlText[i]) yt6.linx[i] = clone(yt6d.mediaUrlText[i])
  yt6.html = html
  yt6.href = href
  ...
  yt6.args = args
    ...
    if (yt6.linx.length && !linx.length) linx = yt6.linx // WTH  #1?
    if (html.length && !yt6.html.length) yt6.html = html // WTH  #2?

  yt6.xhr.abort = false
  var first; for(first=0;first<linx.length;first++) if (linx[first]) break;
...
function check_links(i) {
  ...
  xhr[i] = new XMLHttpRequest(); xhr[i].id = i; //if (Array.isArray(durL1) && durL1.length) { xhr[i].durL1 = durL1 }; if (Array.isArray(durL2) && durL2.length) { xhr[i].durL2 = durL2; ev_log('durL2') }
  xhr[i].onerror = function(ev) { yt6.xhr.abort = true }
  xhr[i].onreadystatechange = function() {
    var i = this.id, j, type = this.getResponseHeader('content-type'), length = this.getResponseHeader('content-length'); //console.log(i +' - '+type+' - '+length+' - '+ this.status +' - '+ this.readyState )
    if (this.status == 403) { 
      if (!yt6.mobile) { for(j=0; j<yt6.linx.length; j++) if (xhr[j] && xhr[j].id) { xhr[j].abort() }; //ev_log('?? '+i); yt6.xhr.abort = true;
	return void 0
      }
    }
    if ( yt6.xhr.abort) { this.abort(); return void 0 }//ev_log('?_ '+i + type);  || (type == 'text/plain' && !length)
    if (this.readyState >= 2 && type && length) {
      if (this.readyState >= 2 && type.indexOf('text') > -1 && length && yt6.linx[i]) {
	xhr[i].abort()
	if (yt6.mobile) {
	xhr[i] = new XMLHttpRequest(); xhr[i].id = i
	xhr[i].onreadystatechange = function() { var i = this.id
	  if (this.responseText && this.responseText.indexOf('http') == 0) {//this.readyState == 2 && this.status == 200 && 
	    if (yt6.xhr.oops.indexOf(i) == -1) {
	      var z = this.responseText + ((yt6.linx[i].split('&title=')[1]) ? '&title=' + yt6.linx[i].split('&title=')[1] : '');
	      yt6.linx[i] = z; yt6.xhr.oops.push(i); yt6d.mediaUrlText[i] = z; if (yt6.at > 2) yt6.at = 0; //ev_log('OOPS-'+i)
	    }
	  } else if (this.status == 403) {
	      var j; for(j=0; j<yt6.linx.length; j++) if (xhr[j] && xhr[j].id) { xhr[j].abort() }; return void 0
	    }
	  if (yt6.xhr.oops.length) { //ev_log('*'+i); if (i == yt6.xhr.oops.length-1) ev_log('--> '+ yt6.xhr.t +' '+ yt6.xhr.oops.length )
	    if (yt6.xhr.t != 2 && (i == yt6.linx.length-1 || i == yt6.linx.length-1001) ) { // ev_log('REDO')//yt6.xhr.oops.length && 
	      try { yt6.at = 3; yt6.player1.media.pause() } catch(e){}
	      yt6.xhr.t = 2; buildObject(window.ytplayer); redo_dl_button(  yt6.args,  yt6.html,  yt6.href); yt6d.mep_up(); yt6.at = 0; yt6.failed_itags = []; yt6d.mep_renew()
	    } //else ev_log('??'+yt6.xhr.t +'_'+yt6.xhr.oops.length +'_'+ (i == yt6.linx.length-1 || i == yt6.link.length-1001) )
	  }
	}
	xhr[i].open('GET', yt6.linx[i], true)
	xhr[i].setRequestHeader("Range", "bytes=0-2000")
	xhr[i].send();
	}
      }
      if (bm3 && (i < 103 || (i >= 1000 && i < 1103)) ) { var a = getElementsByAttribute(gid('bm3'),'a','name', i)
	if (a && a.length) for(j=0;j<a.length;j++) { var size = calculate_file_size(length)
	  if (a[j] && a[j].title.indexOf(' AV ') == -1 && typeof a[j].href == 'string' &&
		(  (typeof yt6.linx[i] == 'string' && a[j].href.split('//')[1].indexOf(yt6.linx[i].split('//')[1].substring(0,400)) > -1)
		//|| (typeof yt6.linx[(i + 1000)] == 'string' && a[j].href.split('//')[1].indexOf(yt6.linx[(i + 1000)].split('//')[1].substring(0,400)) > -1)
	    )   ) {
	    a[j].setAttribute('title', size +' '+ a[j].title); a[j].setAttribute('aria-label', size +' '+ a[j].getAttribute('aria-label'))
	  }
	}
      }
    }
    if (this.status == 200) this.abort()
  }

  xhr[i].open('POST', linx[i], ((i >= first) ? true : false) )
  if ( i >= 103 && !(i >= 1000 && i < 1103)) 
  xhr[i].setRequestHeader("Range", "bytes=0-1")
  try { xhr[i].send() } catch(e) { xhr[i].abort() }

}

  if (!yt6d.mediaUrlText.length) {
    //check_links(first)
    for (i = first; i<yt6.linx.length; i++) { first = 0
      if ( !yt6.xhr.abort && linx[i] && !(Array.isArray(yt6.yt_otf) && yt6.yt_otf.length && yt6.yt_otf.indexOf(i) > -1) ) check_links(i)
    }
  }



  var error /*= (yt6.mobile && !yt6d.init && typeof yt6.error == 'string' && yt6d.error != yt6.error && !isNaN(yt6.error.split('---')[1])) ? clone(yt6.error) : ''

  if (error) { yt6d.error = error; ev_log('reload'); 
    delete yt6.error
  } else ev_log('nope '+ (yt6d.error != yt6.error) )
*/

  if ((yt6.ytm || error) && !yt6.errcount) setTimeout(function(){
    var c = conf('args')



    if (c[1] && ( !(c[1].adaptive_fmts || c[1].url_encoded_fmt_stream_map) || !linx.length || !html.length || error )) {
	//console.log('repeat\n'+linx.length +'/'+yt6.linx.length +'---'+html.length+'/'+yt6.html.length +'\n'+yt6.href+'\n\nENC = '+ c[1].url_encoded_fmt_stream_map +'\n\nADF = '+ c[1].adaptive_fmts); 
      setTimeout(function(){ yt6.errcount = 1
	var built = buildObject(window.ytplayer)
	if ((yt6.xhr.async && !!built) || (!yt6.xhr.async && video_title()[1]) || yt6.ytm) {
	  redo_dl_button(  yt6.args,  yt6.html,  yt6.href)
	  yt6d.mep_up(); yt6.at = 0
	  yt6d.mep_renew(); //ev_log('G '+ yt6d.error +'/'+ yt6.error )
	}
      }, 2000)
    }
  }, 1000)
  ...
  //ev_log('built!:'+yt6.vid +'__'+yt6.loaded_vid)
  if (yt6.loaded_vid != yt6.vid) { if (yt6.blocked !== 0) { yt6d.current.video_id = clone(yt6.vid) } //else c[1].video_id = clone(yt6.vid);
    if (yt6.linx.length > 1) {  }//yt6.loaded_vid = clone(yt6.vid) }
  }
  ...
  if ( !error && yt6.loaded_vid != yt6.vid &&
       (yt6.xhr.async && (yt6.xhr.completed ||
	( (c[0].loaded_from != 'source' && (c[1] && (c[1].url_encoded_fmt_stream_map || c[1].adaptive_fmts)) ||
      ...
      (!yt6.xhr.async) || yt6.ytm ) { yt6.loaded_vid = clone(yt6.vid); return true }
    else if (yt6.mobile) {
	if (yt6.blocked_m) { return true  } else
	  if (yt6.loaded_vid != yt6.vid) {
	  } else { //ev_log('no video data yet')
	      return false
	    }
    } //else console.log('no video data yet')
...
if (gid("bm1")) {
  ...
  //gid("bm1").parentNode.removeChild(gid("bm1")) }
    ...
    if (z != yt6) {
      ...
      if (!gid('bm1')) { yt6.document_fragment = true
	try {
	  z.__shady_native_appendChild(dw)
	  var newcontainer = document.createElement('div'), p = gid('movie_player')
	  newcontainer.id = 'container'
	  gt('ytd-player', 1)[0].__shady_native_appendChild(newcontainer)
	  newcontainer.setAttribute('class','style-scope ytd-player test')
	  var fragmented = (newcontainer.previousElementSibling) ? newcontainer.previousElementSibling : null
	  if (fragmented && fragmented.getAttribute('id') == 'container') {
	    if (p && p.parentNode == fragmented) newcontainer.appendChild(p)
	    newcontainer.appendChild(fragmented)
	    newcontainer.removeChild(fragmented)
	  }
	} catch(e){}
	if (!gid('bm1')) z.parentNode.insertBefore(dw, z.parentNode.lastChild)
      }
    } else z.insertBefore(dw, gid('video-hide') || z.firstChild)
  ...
  yt6.select_fmt = function(fmt) {
    ...
    if (b) { b.setAttribute('checked','checked'); b.checked = 'true' }
    yt6.prefer_fmt = fmt
...
if (typeof html.splice != 'function') return void 0;
  ...
  var b = browserName.toLowerCase(), path = 'https://cdn.jsdelivr.net/gh/snarly/yt6@b28cb18eb6c76d5d92c045f6b73f3971983f2bfd/images/browserIcons/'
  if (b == 'brave') browserIcon = '<img style=&quot;width: 96px; height: 112px&quot;  src=&quot;'+ path +'brave-browser-icon.svg&quot;>'
  if (b == 'vivaldi') browserIcon = '<img style=&quot;width: 112px; height: 128px&quot; src=&quot;'+ path +'20190912144835_Vivaldi_web_browser_logo.svg&quot;>'
  if (b == 'kiwi') browserIcon = '<img style=&quot;width: 128px; height: 128px&quot; src=&quot;'+ path +'kiwi_logo_circle.svg&quot;>'
  if (b == 'yandex') browserIcon = '<img style=&quot;width: 96px; height: 128px&quot; src=&quot;'+ path +'yandex.svg&quot;>'
  if (b == 'ecosia') browserIcon = '<img style=&quot;width: 128px; height: 128px&quot; src=&quot;'+ path +'ecosia.png&quot;>'
  if (b == 'duckduckgo') browserIcon = '<img style=&quot;width: 96px; height: 128px&quot;  src=&quot;'+ path +'duckduckgo-icon.svg&quot;>'
  if (b == 'comodo dragon') browserIcon = '<img style=&quot;width: 96px; height: 96px&quot; src=&quot;'+ path +'comodo-dragon.png&quot;>'
  if (b == 'edge') b = 'edgium'
  if (b == 'ie') b = 'edge'

  if (b.indexOf( 'chromium') > -1) browserIcon = '<img style=&quot;width: 112px; height: 112px&quot;  src=&quot;'+ path +'20170506102119_Chromium_Logo.svg&quot;>'
  if (!browserIcon) {
  ...
  yt6d.UAString = b.split('&quot;').join('"').split(output_log).join(yt6d.log)

  html.push(
   '<b><div id="sp_title">' + unescape(title) + '</div></b>' +
   'Links will expire on <br>' + expire_date()[1] + '<br><br>' +

   '<div id="yt6-switches">'+//; if (yt6.pls && yt6.pl23) yt6.adsp = (yt6.pl_index + 1)
   '<div style="inline-block">Preferred format in case <'+ ((e) ? "a" : "div") +' href="#" id="linkcurrent" onclick="(function() { msg_box0(\'User-Agent\',\''+ b +',\'black\',\'transparent\'); var z = gid(\'bm3\'); if (z) { z.style.height = \'0px\'; z.style.visibility = \'hidden\' } })(); return false" style="color: red; text-decoration: none;'+ ((e) ? "" : " display: inline-block;") +'" title="Click to see current User-Agent string" aria-label="Click to see current User-Agent string"><span>' + browserName + '</span></'+ ((e) ? "a" : "div") +'> is having trouble playing one back:<br>'+
...
yt6.switches = function() {
  ...
  yt6.select_fmt()
  function stuff(a) {
    var z = gid('yt6-switches'); if (z && z.parentNode) try { z.appendChild(a) } catch(e){}
  }
  ...
  dw.type = 'checkbox'
  stuff(dw)
  var onclic = "var yt6 = gid('snarls_player'); if (this.checked) { yt6.mute_on = true } else { yt6.mute_on = false }; if (yt6.p && typeof yt6.p.mute == 'function' && !(yt6.ytm && yt6.p.tagName == 'EMBED')) { if (!yt6.mute_on) { try { var b = v_(yt6.p); if (b) { b.volume = 1 }; yt6.pre_ad = '?'; yt6.p.setVolume(100 * b.volume); yt6.p.unMute(); yt6.ad_muted = false; yt6.original.unMute() } catch(e){} } };"
  dw.setAttribute('onclick', onclic)
  if (yt6.mute_on) {
    dw.setAttribute('checked','checked')
  } else {
  ...
  yt6.add_subs = yt6.add_subs || 'en,hu,de'

  if (!gid('translate_caps')) {

  var cw = document.createElement('div')
  cw[yt6.txt] = 'Auto-Translate to'
  stuff(cw)
  cw.setAttribute('class','snarl-button yt-uix-button-text')
  cw.setAttribute('style','color: black; display: inline-block; padding: 0 4px 0 0')
  cw.style = 'display: inline-block; padding: 0 4px 0 0'
  var dw = document.createElement('input')
  dw.id = 'translate_caps'
  dw.value = yt6.add_subs
  stuff(dw)
  dw.setAttribute('style','width: 60px; color: black;')
  dw.style = 'width: 60px; color: black;'
  var onclic = "var t = gid('tcap_on'); if (t) try { t.click() } catch(e) { FireEvent2(t, 'click') }"
  var onkeyup = "var yt6 = gid('snarls_player'), t = this, u = gid('tcap_on'); if (yt6 && event.keyCode == 13) { if (t && typeof t.value == 'string') { yt6d.add_subs = clone(t.value); yt6.add_subs = clone(t.value) } else yt6d.add_subs = clone(yt6.add_subs); if (u && u.parentNode) { if (u.checked || (t && t.value)) { if (u.hasAttribute('checked')) u.removeAttribute('checked'); u.checked = false } else { u.setAttribute('checked','checked'); u.checked = true }; u.click() } };"
  cw.setAttribute('onclick', onclic)
  dw.setAttribute('onclick', onclic)
  dw.setAttribute('onkeyup', onkeyup)
  //dw.setAttribute('class','snarl-button yt-uix-button-text')
  var dw = document.createElement('input')
  dw.id = 'tcap_on'
  dw.type = 'checkbox'
  stuff(dw)
  var onclic = "var yt6 = gid('snarls_player'), t = gid('translate_caps'); if (this.checked) { if (t && t.value) { yt6d.add_subs = clone(t.value); yt6.add_subs = clone(t.value) } else { yt6d.add_subs = clone(yt6.add_subs); if (this.hasAttribute('checked')) this.removeAttribute('checked'); this.checked = false } } else { yt6d.add_subs = '' };"
  dw.setAttribute('onclick', onclic)
  if (yt6d.add_subs) {
    dw.setAttribute('checked','checked')
  } else {
  ...
  } else { gid('translate_caps').value = yt6.add_subs }
  ...
  var onclic =
	...
	"	  if (p && p.tagName == 'EMBED' && gpst(p) >= 1) { return true } else {}"+
	"	},"+
...
//window.open( "' + protocol() + '//www.youtube.com/supported_browsers", "_blank").focus() ')
  ...
  if (!gid('bm3')) {
	...
	bc = (!yt6.mobile) ? gt('YTD-PAGE-MANAGER', 1)[0] : gid('bm1')
	if (bc) {
  ...
  try {
  var mw = (browserName == 'Firefox' || browserName == 'Edge') ? '255px' : '235px'
  bm3.height = parseInt(gid('bm2').offsetHeight) + expire_date()[2]
  bm3.setAttribute('style','cursor: default; font-size: 13px; color:black; display:block; visibility:hidden; position:fixed; left:0%; top:48px; max-width:'+ mw +'; height:' + bm3.height + 'px; margin-top:0px; margin-right:0px; background:#FFFFFF; opacity:1; padding:2px 2px 2px 2px; border:1px solid #DDD; z-index: 2147483648; overflow-y:hidden')
  var z = bm3.style
  z.cursor = 'default'; z.fontSize = '13px'; z.color = 'black'; z.display = 'block'; z.visibility = 'hidden'; z.position = 'fixed'; z.left = '0%'; z.top = '48px'; z.maxWidth = mw; z.height = bm3.height + 'px'; z.marginTop = '0px'; z.marginRight = '0px'; z.background = '#FFFFFF'; z.opacity = '1'; z.padding = '2px 2px 2px 2px'; z.border = '1px solid #DDD'; z.zIndex = '2147483648'; z.overflowY = 'hidden'
  ...
  if (a && b) {
	...
	for(i=0;i<l.length;i++) {
	  if (yt6.mobile)
		...
		if (this.href0) this.href = this.href0
	    }, false);
...
//i1.ytimg.com/i/gsZadWjuuN2dEhI0mZfVfQ/mq1.jpg?v=531525b4
  ...
  var onclic = function(){
    ...
    //var mhp = (yt6.mhp) ? ((yt6.layout != 16 || yt6.ytm || (yt6.mobile && !(yt6.mhp.parentNode && yt6.mhp.parentNode.parentNode))) ? yt6.mhp.offsetHeight : yt6.mhp.parentNode.parentNode.offsetHeight) : 0
    var mhp = gmhp()
    ...
    if (yt6.mobile) {
	if (!yt6.blocked_m && yt6.api && typeof yt6.api.hasAttribute == 'function' && yt6.api.hasAttribute('playable')) yt6.age.check() //yt6.api.removeAttribute('playable')
	var z = gid('player-container-id'); if (z) if (z.className == 'player-container') { scrollToCurrentVideo() }
    }
    ...
    if  (video_title()[1] && window.ytplayer &&
	 ...
	 (!(yt6.wna && yt6.wna.parentNode && yta && (yta.parentNode == yt6.wna || yta.parentNode.parentNode == yt6.pls)) ||
	  !gid('remove-sp') ||
	  !gid('controls-sp'))
	)
      {
	...
	if (yt6.mobile) { // && !(!yt6.x && gpst(yt6.p) != 2)) {
	  if (!restore_cp(yt6.pls)) if (!gid('remove-sp') || !gid('controls-sp')) set_controls(18)
	} else set_controls(19)
    ...
    if (bm3.style.visibility === "visible") { 
      ...
      bm3.style.height = '0px'
        ...
        var windowheight = parseInt(window.innerHeight || document.documentElement.clientHeight || yt6.body.clientHeight)
        if (yt6.ytm && gt('ytmusic-player-bar', 1)[0]) windowheight = (windowheight - gt('ytmusic-player-bar', 1)[0].offsetHeight)
        var csspopupheight = bm3.height = Math.min(windowheight, bm3.scrollHeight)

        if (csspopupheight > (windowheight - expire_date()[2]) || (yt6.md && !yt6.mobile)) { 
	...
	if (bm3.scrollHeight < 10 && typeof yt6d.UAString == 'string') { msg_box0('User-Agent', yt6d.UAString, 'black', 'transparent'); redo_dl_button(  yt6.args,  yt6.html,  yt6.href); }
      }
  ...
  var c = conf('args')
  if (yt6.flash.forced && (yt6.status == 'ok' || yt6.ytm)) {
  ...
  if (yt6.mobile) {
    var panel = gt('panel-container', 1)[0]
    if (panel) panel.style.opacity = '0.99'
  }
...
function p1mends() {
  var s = (!yt6.x) ? gpst(yt6.p) : 0, z = ((yt6.x && yt6.player1 && yt6.player1.media && yt6.player1.media.currentTime && (yt6.player1.media.duration - yt6.player1.media.currentTime)) || (yt6.player2 && yt6.player2.media && yt6.player2.media.currentTime && (yt6.player2.media.duration - yt6.player2.media.currentTime))
	|| (typeof s == 'number' && s > 0 && (yt6.p.getDuration() - yt6.p.getCurrentTime())) )
  z = (typeof z == 'number' && z < 10) ? true : false
  return z
}



function mobile_playlist_run(upcoming) {
	var x, y, z, a, b, u = (upcoming == 'prev') ? 1 : 0;
							    if (yt6.pls) {
							      z = gc('playlist-controls-primary')[0]
								if (z) {
								z = gt('c3-material-button', z)[1-u]
							        if (z) {
								  z = z.getElementsByClassName('c3-material-button-button')[0]
								} else z = gc('c3-material-button-button')[3-u]
							      } else z = gc('c3-material-button-button')[3-u]

							    } else {
								z = gc('player-controls-middle center')[0]
								if (z) { try { z = (u) ? z.firstChild : firstChild.nextSibling.nextSibling } catch(e){ z = null } } else if (u) { mp.previousVideo('0') } else mp.nextVideo('0')
							      }
							    try { //if (yt6.pls.tagName == 'YTM-PLAYLIST-ENGAGEMENT-PANEL') yt6.adsp = (yt6.pl_index - 1)

							      //yt6.pl_next_btn = null
							      var loc0 = clone(yt6.loaded_vid),
								a = (!yt6.navigation && typeof loc0 == 'string' && location.href.indexOf(loc0) > -1 && typeof yt6d.playlist[upcoming] == 'number' && ( (!u && yt6d.playlist.next > yt6.pl_index) || (u && yt6.pl_index >= yt6d.playlist.prev) ) && yt6d.playlist.items[ yt6d.playlist[upcoming] ] && !yt6d.playlist.items[ yt6d.playlist[upcoming] ].blocked  ) ? true : false
								...
								if (!y) {
								  ...
								  y.id = 'nextbtn'
								  y.href = yt6d.playlist.items[(yt6d.playlist[upcoming])].href
								  yt6.appendChild(y)
								} else
								  y.setAttribute('href', yt6d.playlist.items[(yt6d.playlist[upcoming])].href);

								//if (browserName != 'Firefox')
								  yt6.pl_next_btn = y
								//if (yt6d.playlist.items[(yt6d.playlist.current)].href.indexOf(yt6.vid) > -1) { yt6d.playlist.current = clone(yt6d.playlist.next) }
							      }

								//function pl23c() { try { gt('button', gc('playlist-entrypoint-background-protection')[0])[0].click() } catch(e){} }
								...
								if (y && typeof y.href == 'string') { y.click() } else

								if (yt6.pl_next && !yt6.pl_next_blocked) { yt6.pl_next.click() } else try { yt6.pl_next_btn = null; yt6.pl_prev_btn = null; gt('button', gt('ytm-playlist-engagement-panel', 1)[0])[0].click() } catch(e){ mp.playVideoAt((1*yt6.pl_index)+1) }

							    } catch(e) { if (u) { yt6.pl_previous.click() } else yt6.pl_next.click() }//if (z) { z.click() } else if (yt6.pl_next_btn) { yt6.pl_next_btn.click() } else if (yt6.pl_next && !yt6.pl_next_blocked) { yt6.pl_next.click() } }
...
function pbtn() {
	...
	if (yt6.mobile) {
	  z = gid('prebtn')
	  if (!z) z = document.createElement( (!(yt6.mobile && (browserName == "Firefox")) ? "a" : "a") )//yt6.pl_last ||  || browserName == "Brave"
	  z.id = 'prebtn'
	  z.href = '#'
	  if (yt6) yt6.appendChild(z); z.setAttribute('class','ytp-ad-skip-button ytp-button'); if (z) z.style.display = 'none'; z = null
	  z = gid('prebtn')
	}
	return ((z && z.parentNode) ? z : null)
}
...
;
    ...
    delete js
loadCSS( ((yt6.cdn.indexOf('cdn.rawgit') == -1) ? yt6.cdn : '//rawcdn.githack.com/snarly/yt6/') + '407f4a4c332ed2f7c7219ddeadf7fa211ea998d9/mediaelementplayer.css',function(){})
    ...
    var itag1;
					...
					function media_error_handler(me, at) { ev = '1error'; //ev_log(ev +' '+ yt6.current+'_'+ yt6.errcount +'_'+ me.networkState +' '+yt6.failed_itags.indexOf(yt6.current))
					  ...
					  if (me.networkState == 1 || me.networkState == 3) {
					    ...
					    var A_V = [], A_ = [], mep = mep_x("mep_"), current = null
						...
						if (sauce[i] != undefined) {
						  var z = 1 * (sauce[i].id.split('_sourcechooser_')[1]) - 0
						  if (!isNaN(z)) current = z
						  z = (current) ? current : 0
						  ...
						  if ((z && sauce[i].checked) || sauce[i].checked === true) {
						    yt6.current = current; //if (!at) current = null
					    ...
					    if (!yt6.current) yt6.retry++
					    //if (current && current != yt6.current) if (!yt6.x) yt6.errcount = 0
					    ...
					    function decryption_failure(){ ev_log('df')
						...
						if (yt6.errcount > 0 && yt6.limit == 1) yt6.errcount = 3
						...
						if ( !gid('ytassetsjs') ||
							...
							(1 + 1 * proxies.length) >= yt6.errcount
						      ) || (yt6.errcount < 2 && yt6.err2 && !me.loaded && !yt6.player2.media.loaded)
						   ) {
							ajax1(true)
							yt6.error = ''; if (yt6.failed_itags2 < 5) { yt6.failed_itags = []; yt6.errcount = 0; yt6.retry = 0; }
							var built = buildObject(window.ytplayer, false)
							if ((yt6.xhr.async && !!built) || (!yt6.xhr.async && video_title()[1]) || yt6.ytm) {
							  redo_dl_button(  yt6.args,  yt6.html,  yt6.href)
							  yt6d.mep_up(); yt6.at = 0; yt6.at2 = ''; yt6.current = clone(yt6.userprefV[0]); //yt6.failed_itags = []
							  var counter = 0; yt6d.timers.w = 0
							  if (yt6d.update_in_progress) { yt6.failed_itags = []; yt6.errcount = 0; yt6.failed_itags2 = 1; delete yt6d.update_in_progress }
							  yt6d.mep_renew()
							  //if (typeof yt6.autoplay_trigger == 'function') { yt6.autoplay_trigger() } else yt6.player1.play()
							}
						    ...
						    if (t4 != null && t4.innerHTML != ''){ //
						      var dls = gid('bm3')
						      dls = (dls) ? gt('a', dls) : null
						      var z = gt('a', t4);
						      var lchk = (z[0]) ? getElementsByAttribute(gid('bm3'),'a','name',z[0].getAttribute('name'))[0] : null
						      if (z[0] && lchk && z[0].getAttribute('href') != lchk.getAttribute('href').split('&title')[0]){ //
							for(k=0;k<z.length;k++){
					    ...
					    var sauce = sauce || getElementsByAttribute(gid('yt6-links') || document,'input','name', mep + '_sourcechooser'), audiosauce = []
					    ...
					    }; yt6.yt6a_length = audiosauce.length

					    var limit = (yt6.userprefV[0] != yt6.userprefA[0] && !yt6.audiosauce) ? sauce : audiosauce
					    if (limit && limit.length) {
					      limit = yt6.limit = (limit.length - 0)
					      if (1 > limit) { if ((yt6.userprefV[0] == yt6.userprefA[0] || yt6.audiosauce)) { //limit = yt6.limit = Math.max(1, (sauce.length - 1));
						if (!yt6.audiosauce) { yt6.fmt_bak = clone(yt6.userprefV[0]); yt6.fmt_bak2 = clone(yt6.userprefV[0]) }
						if (typeof yt6.audiosauce != 'number') yt6.audiosauce = clone(yt6.userprefV[0])
					      } } else yt6.player1.isLoaded = false//{ k = getElementsByAttribute(gid('alt-links') || document,'input','name', mep + '_sourcechooser'); if (k.length) limit = limit - k.length }
					    } else limit = 11
					    yt6.limit = limit


					    //if (1 >= limit && typeof yt6.current == 'number' && typeof yt6.A_[yt6.current] == 'string') { yt6.errcount = 1; }//switch_players()


					    if (yt6.live) limit = 2 * limit
					    ...
					    if ( yt6.retry >= limit && yt6.failed_itags2 < 5) { yt6.retry = 0
					      if (yt6.failed_itags2 < 2) { yt6.failed_itags = []
						yt6.failed_itags2++; decryption_failure(); return void 0
					      } else {
						  yt6.failed_itags2 = 5
						}
					    }

					    if ( yt6.errcount < 2 && yt6.retry < limit && !(typeof yt6.failed_itags2 == 'number' && yt6.failed_itags2 >= 5) && !(yt6.retry >= Math.round(limit / 4) && yt6.failed_itags2 > 1 && yt6.failed_itags.length >= 4)
					       ) {
					      if (sauce[i]) { sauce[i].removeAttribute('checked'); sauce[i].checked = '' }; 
					      if (!(yt6.md && hid() && (Array.isArray(yt6.yt_otf) && typeof itag(me.src) == 'number' && typeof yt6.yt_otf[itag(me.src)] != 'undefined'))) me.pause()


						function uniq(a) {
						    var seen = {};
						    return a.filter(function(item) {
						        var z = (( (yt6.failed_itags2 < 3 && yt6.md && hid() && (item == 18 || item == 22 || item == 43)) //||
						...
						function failed_itags(a) { try { var seen = {}, mep = mep_x('mep_');
						    return a.filter(function(item) {
						        var z = ( !item || seen.hasOwnProperty(item) || item == 1 || item == 0 || !gid(mep + '_sourcechooser_' + item)
								) ? false
								 : (seen[item] = true)
							return z
						    }); } catch(e){}
						...
						//console.log(Math.round(sauce.length / 1) - A_V.length - A_.length +' - '+ yt6.current)
					      var fmt = 'all', fallback, T, fbu = yt6.fmts_fallback_uniq = []
					      if ( !yt6.audiosauce &&
						   !(yt6.failed_itags.includes(600) && yt6.failed_itags.includes(599)) &&
						   ( !yt6.fmts_fallback.A.all.includes(itag(me.src)) )) {//yt6.userprefA[0] !== yt6.userprefV[0] ||

						if (yt6.prefer_fmt == 'webm') fmt = 'dash'
						if (yt6.prefer_fmt == 'dash') fmt = 'webm'
						if (!yt6.errcount && fmt == 'all') {
						  fbu = uniq(yt6.fmts_fallback.V.uniq[yt6.prefer_fmt])
						  fallback = clone(yt6.fmts_fallback.V[fmt])
						} else {
						    //if (yt6.failed_itags2 < 2 && yt6.retry < 2) {
						    //  fbu = uniq(yt6.fmts_fallback.V.revers[yt6.prefer_fmt])
						    //  fallback = clone(yt6.fmts_fallback.V[fmt])
						    //} else {
						        fbu = uniq(yt6.fmts_fallback.V.uniq[yt6.prefer_fmt])
							fbu.push.apply(fbu, uniq(yt6.fmts_fallback.A.uniq[yt6.prefer_fmt]))
							if (fmt == 'dash') {
						...
						if (yt6.md && !yt6.md && yt6.x && hid() && !yt6.audiosauce) {// <--!
						  while(fbu.indexOf(18) > -1) fbu.splice(fbu.indexOf(18), 1)
						  fbu.splice(fbu.indexOf(22), 1)
						  while(fallback.indexOf(18) > -1) fallback.splice(fallback.indexOf(18), 1)
						  fallback.splice(fallback.indexOf(22), 1)
						}

						fbu.push.apply(fbu, fallback)

						fbu.push.apply(fbu, yt6.fmts_fallback.A.revers[yt6.prefer_fmt])
						fbu.push.apply(fbu, yt6.fmts_fallback.A.revers[fmt])
						var x = yt6.userprefV[0]
					      } else {
						  if (yt6.prefer_fmt == 'webm') fmt = 'dash'
						  if (yt6.prefer_fmt == 'dash') fmt = 'webm'
						  try { fbu = //((!yt6.errcount && fmt == 'all') || yt6.audiosauce) ? uniq(yt6.fmts_fallback.A.uniq[yt6.prefer_fmt]) :
						    uniq(yt6.fmts_fallback.A.revers[((fmt == 'dash')?'aac':fmt)]) } catch(e) { fbu = [] }//uniq()
						  //if (fmt) {
						    fbu.push.apply(fbu, yt6.fmts_fallback.A.revers['all'])
						    //fbu.push(18); fbu.push(17)
						    limit = yt6.limit = (limit + 1)
						  //}
						  var x = yt6.userprefA[0]

						  if (yt6d.init && yt6d.init == yt6.vid) delete yt6d.init
						}
						yt6.fmts_fallback_uniq = fbu

						var start, itag_ = ( limit.length < 3 || !yt6.failed_itags.length) ? 1*itag(me.src) : yt6.fmts_fallback_uniq[(yt6.fmts_fallback_uniq.indexOf(1 * yt6.failed_itags[yt6.failed_itags.length-1]) + (yt6.kc || 1) )], dash; //!yt6.failed_itags[yt6.failed_itags.length-1] || 

						var k = (yt6.fmts_fallback_uniq.indexOf(itag_ || yt6.userprefV[0]) < uniq(yt6.fmts_fallback.V.uniq[yt6.prefer_fmt]).length) ? yt6.fmts_fallback_uniq.indexOf(itag_ || yt6.userprefV[0]) : 0, kc = clone(yt6.kc) || 0; //if (kc > k) k = (kc < yt6.fmts_fallback_uniq.length - 1) ? kc : kc - 1; ev_log('KC='+k)
						//if (yt6.live && k && yt6.failed_itags.indexOf(yt6.fmts_fallback_uniq[k+1]) == -1) { k = k + 1; console.log(yt6.fmts_fallback_uniq[k+1]) }
						for(k = k; k<yt6.fmts_fallback_uniq.length; k++) {
						  itag_ = 1*(yt6.fmts_fallback_uniq[k])
						  if (yt6.failed_itags.indexOf(itag_) > -1) { kc = k; //var z = failed_itags(yt6.failed_itags)
						    yt6.kc = kc
						  }; dash = gid(mep_x('mep_') + '_sourcechooser_' + itag_); if (!dash) yt6.failed_itags.push(itag_); if (itag_ == 1 || !dash) continue
						  if (limit.length < 2 || (typeof itag_ == 'number' && !isNaN(itag_) )) {
						    var start = k; break
						  } else {
						      if (yt6.prefer_fmt == 'all' || yt6.prefer_fmt == 'dash') {
							if (yt6.fmts_fallback_uniq.lastIndexOf(itag_) > -1 && yt6.fmts_fallback_uniq.lastIndexOf(itag_) < yt6.fmts_fallback_uniq.lastIndexOf(18)) {
							  k = 1*(yt6.fmts_fallback_uniq.lastIndexOf(18)-1)
							}
						...
						}; //ev_log(itag_+'KC='+yt6.kc+'/'+yt6.failed_itags.indexOf(itag_)+'$$'+yt6.current+'/'+yt6.failed_itags.indexOf(yt6.current))
						...
						//if (typeof itag_ != 'number') itag_ = yt6.userprefV[0]
					      ...
					      var start = start || ((yt6.failed_itags.indexOf(itag_) == -1) ? (yt6.fmts_fallback_uniq.indexOf(itag_)) : (yt6.fmts_fallback_uniq.lastIndexOf(itag_) + 1));
						...
						if ( (qual[itag_] && qual[itag_]['m'].indexOf('webm') > -1 && yt6.prefer_fmt == 'dash') ||
						  ...
						  if (yt6.failed_itags2 == 1 || yt6.failed_itags2 == 2) {
						    ...
						    for(k=Math.max(j,0);k<yt6.fmts_fallback_uniq.length;k++){
						      var itag_ = yt6.fmts_fallback_uniq[k]

						      var dash = gid(mep_x('mep_') + '_sourcechooser_' + itag_)
						      if (yt6.live && dash && itag_ < 103) continue
						      if (!dash || yt6.failed_itags.indexOf(itag_) > -1) {
							if (!yt6.fmts_fallback_uniq.includes(itag_)) { yt6.failed_itags.push(itag_); if (itag_ == 132) yt6.failed_itags.push(160); if (itag_ == 160) yt6.failed_itags.push(132); if (itag_ == 278) yt6.failed_itags.push(241); if (itag_ == 241) yt6.failed_itags.push(278)
							...
							if (!(yt6.failed_itags.length > 1 &&
							  ...
							  yt6.failed_itags.push(0); break
						        } else if (!yt6.failed_itags.includes(itag_)) { yt6.failed_itags.push(itag_); if (itag_ == 132) yt6.failed_itags.push(160); if (itag_ == 160) yt6.failed_itags.push(132); if (itag_ == 278) yt6.failed_itags.push(241); if (itag_ == 241) yt6.failed_itags.push(278) }
						      }
						    }
						    if (!(yt6.failed_itags2 > 1 && yt6.A_[itag_] )) { yt6.retry++; //ev_log('retry '+yt6.retry +' '+itag_)
...
if ((yt6.userprefV[0] == yt6.userprefA[0] || yt6.audiosauce)) if (typeof yt6.audiosauce != 'number') yt6.audiosauce = clone(yt6.userprefV[0])
						  ...
						  if (me.currentTime > 2) { yt6.decoding_error = true; yt6.autoplay = true }


						  var link_to_load
						  if (yt6.linx[itag_]) {
						    link_to_load = yt6.linx[itag_]
						    if (yt6.live && typeof yt6.live == 'number') { //console.log(dash); console.log(link_to_load)
						      link_to_load = dash.value = link_to_load + '&sq=' + yt6.live
						    }
						    yt6.player1.setSrc( link_to_load )
						  }
						  if (yt6.current && yt6.current == itag_ && yt6.failed_itags.length && yt6.failed_itags.indexOf(yt6.current) > -1) { yt6.userprefV_bak.push(yt6.current) } //add the current source's itag to srcbak if it has already been tried once and shows up in this error block again

						  try { if ((AV(itag_) || A(itag_)) && !yt6.player2.media.paused) player2.pause() } catch(e){}

						  //ev_log('play_r ' +itag_+'--'+yt6.audiosauce ); //
						  try { yt6.current = itag_; dash.click() } catch(e){ yt6.player1.load() }

						    no_default(itag_, 'V'); if (A(itag_)) no_default(itag_, 'A')

						    if (yt6.audiosauce && itag_ < 103) {
							if (yt6.userprefV.indexOf(itag_) > -1) yt6.userprefV.splice(yt6.userprefV.indexOf(itag_), 1)
							if (yt6.userprefA.indexOf(itag_) > -1) yt6.userprefA.splice(yt6.userprefV.indexOf(itag_), 1)
						    }


							if (!yt6.at) yt6.at = 0; if ((me.paused || !me.currentTime) && (yt6.live || yt6.autoplay)) { //ev_log('C1 ')
							  yt6.player1.play()
							} else { me.play() }
						  ...
						  if ( ((yt6.retry >= limit && yt6.failed_itags2 >= 5) || itag_ == 1)) decryption_failure()
					        }

					    } else { //ev_log('no playable sources '+ yt6.x + ' ? ' + yt6.encrypted +' ' + yt6.errcount)
						var p = player(), p = yt6.p
						  ...
						  if (a && b && b.children.length > 0) {
							...
							for (k=0;k<a.children.length;k++){
							  if (a.children[k] && b.children[l] && a.children[k].name == b.children[l].name) {
						...
						if (typeof yt6.errcount == 'undefined') yt6.errcount = 0
						if (yt6.errcount >= 3) {
						  no_default(itag_, 'V'); yt6.player1.media.loaded = false; //yt6.player1.isLoaded = false; 
						  decryption_failure(); if (yt6.player1) if (yt6.x) { yt6.player1.showControls(true) } else { yt6.player1.hideControls(false) }; yt6.failed_itags = []; //ev_log('should not switch '+ yt6d.update_in_progress ); yt6.retry = 0; 
						} else { yt6.errcount = (yt6.x && yt6.failed_itags.indexOf(current) > -1) ? yt6.errcount + 1 : 0; yt6.failed_itags.splice(yt6.failed_itags.indexOf(yt6.current),1) }; //hand_axe();


						if ( yt6.errcount > 1) {// || (2 * proxies.length)

						  if (!yt6.swapped && !yt6.mobile && (html5_fail() || yt6.html5_fail) ) {
							...
							if (yt6.x && (yt6.loaded == 5 || yt6.mobile || yt6d.init)) { //!window.yt6_swapped
							  if (!yt6.xhr.t) {
							    if (yt6.errcount > 1) {
							      switch_players(); try { yt6.p.playVideo() } catch(e){}; window.yt6_swapped = 1
							    } //else { yt6.autoplay_trigger(dast, itag_) }
							  } else delete yt6.xhr.t
						  ...
						  if (yt6.blocked_m && !yt6.current) { var z = gid('prebtn'); if (z) z.click() }
						}
					      };
					...
					function media_error_handler2(me){ ev = '2error'; //console.log(ev +' '+yt6.err2+' '+yt6.err2count +' '+ yt6.current)//+(yt6.retry < yt6.limit) +' '+me.networkState);
					  ...
					  if (yt6.err2count < 30 && itag(yt6.player1.media.src) >= 103 && yt6.retry < yt6.limit && (me.networkState == 1 || me.networkState == 3)) {
						...
						function() { Seek = 0; yt6.player1.play(); me.play() },250,2500);
					      } else { //var src = clone(me.src)
						  //clear_mep(yt6.player2); yt6.player2.setSrc(src);
						  Seek = 0;
						  yt6.player2.load(); yt6.player2.media.load();
						  if (yt6.autoplay) { yt6.player1.play(); yt6.player2.media.play() }
						}
					    }
		...
		function A(itag_) { return (yt6.A_[itag_] || (itag_ >= 103 && yt6.fmts_fallback.A.all.indexOf(itag_) > -1) ) }
		function V(itag_) { return (yt6.V_[itag_] || (itag_ >= 103 && yt6.fmts_fallback.V.all.indexOf(itag_) > -1) ) }
		function AV(itag_) { return (yt6.A_V[itag_] || itag_ < 103 ) }

		function chk1(me, cx) { return ( !yt6 || (yt6 && !yt6.navigation && (yt6.player1 && (yt6.timer == 999999999 || me.src == pseudoSrc || yt6.player1.media.src != me.src || cx)) ) ) ? true : false }
		function chk2(me, cx) { return ( !yt6 || (yt6 && !yt6.navigation && (yt6.player2 && (yt6.timer == 999999999 || me.src == pseudoSrc || yt6.player2.media.src != me.src || cx)) ) ) ? true : false }

		yt6.ct = 0
		yt6.speed = (typeof yt6.speed == 'number') ? yt6.speed : 1
		yt6.loop = {}
		var ev, Srcto, sync_timer = 1, pastTime
		var pause_count = 0
		yt6.Seek = null
		var Seek = yt6.Seek
		var Delay = [0]
		...
		$waitUntil(function(){ var z = (typeof MediaElementPlayer == 'function') ? true : false; if (z) return z }, function() {

		yt6.player1 = new MediaElementPlayer('#player1',{
		  ...
		  success: function(me) { $('#audio-type').html( me.pluginType);
					addEL(me, 'loadstart', function() { ev = '1loadstart'; yt6.brands()//if (yt6.newvideo) ev_log(ev); //console.log(ev)
					  yt6.navigation = false
					  pause_count = 0
					  if (chk1(me))
					    return void 0;
					  ...
					  if (yt6.x) {
					    ...
					    if (gpst(yt6.p) == 5) try { yt6.p.stopVideo() } catch(e) {} // ads may be playing now even if gpst reports 5
					    if (yt6.mobile) { var x = gid('player-control-container'); if (x) x.setAttribute('hidden','') } else try { yt6.ytp.speed() } catch(e){}
					      ...
					      $waitUntil(function(){ var s = gpst(yt6.p); if (s == 2 || s == -1 || (s == 5 && !(yt6.ytp.embed && yt6d.init))) { return true } },
						function() {
						  if (!yt6.x && !yt6d.init) try {// fetching the links might pause the yt player -- kick it back on
						    if (shorts()) {
							...
							yt6.p.stopVideo(); yt6.p.playVideo(); v_(yt6.p).play()
						      }
					 	  } catch(e){}
						},400,2000);
					      }
					  ...
					  if (yt6.md && browserName == 'Firefox' && hid()) Seek = 0
					  if (yt6.mobile) { $waitUntil(function() { if ( (yt6.mobile_nav && !yt6.navigation && me.loaded) || ( !(yt6.wna && yt6.wna.parentNode && yt6.wna.firstChild && yt6.wna.firstChild.id == 'yt-alert-message')) ) { restore_cp(yt6.pls); return true } }, function() { $waitUntil(function() { if (yt6.pre_ad == false && !yt6.navigation && !yt6.ad_skipped) { return true } }, function() { var z = gt('ytm-custom-control', 1)[0]; if (z) z.click() },500,2000);  },1000,4000) } else if (yt6d.init) set_controls(20)//if (yt6.mobile_nav) yt6.mobile_nav = false; 
					  var sauce, ads, bm3 = gid('bm3'), mep = gid(mep_x('mep_')), a, b, c = false, d = false
					  ...
					  if (ads && b && !(yt6.layout == 16 && yt6.blocked))
					  for (i=0;i<yt6.linx.length;i++){ 
					    if (yt6.linx[i])
					    for (j=0;j<ads.length;j++){
					      if (ads[j] && ads[j].href) {
						c = false //((yt6.ytp.V && ads[j].href.indexOf(decodeURIComponent(yt6.ytp.V)) > -1) || (yt6.ytp.A && ads[j].href.indexOf(decodeURIComponent(yt6.ytp.A)) > -1)) ? true : false
						if ( c || (yt6.linx[i].indexOf('&title=Advertisement') > -1 && (ads[j].href.indexOf(yt6.linx[i].split('&title=Advertisement')[0]) > -1 || ads[j].href.indexOf('&title=Advertisement') > -1) ) ) { //console.log('Dumping ads into the alt-links container: ' + yt6.linx[i])
						  if (!c) { if (yt6.linx[i].indexOf('&title=Advertisement') == -1)
						    ads[j].href = ads[j].href.split('&title=')[0] + '&title=Advertisement' } else { d = true }
					  ...
					  if (sauce) {
						...
						if (z) for (j=0;j<z.length;j++){
						  if (!z[j]) break;
						  if (yt6.ads_eid || d) if (z[j].href && (z[j].href.indexOf(yt6.ads_eid) > -1 || (yt6.ads_eid1 && z[j].href.indexOf(yt6.ads_eid1) == -1) || (yt6.ads_eid2 && z[j].href.indexOf(yt6.ads_eid2) == -1)) ) {
						    var dur = z[j].href.split('&dur=')[1] || z[j].href.split('?dur=')[1]; if (dur) dur = (1 * dur.split('&')[0])
						    if (typeof dur == 'number' && Math.abs((yt6.real_dur || yt6.real_media_duration) - dur) >= 1.5) z[j].href = z[j].href.split('&title=')[0] + '&title=Advertisement'
						...
						if (z && z.length) for (j=z.length-1;j>-1;j--) if (z[j] && z[j].junk) b.removeChild(z[j])
					      ...
					      if (a.children) yt6.yt6_length = (a.children.length / 2)
					      if (b.children) yt6.alt_length = (b.children.length / 2)
					    }
					  }
					});
					addEL(me, 'error', function() { media_error_handler(me) });//var at = (yt6.mobile && yt6.at2 == 'A12') ? 1 : 0; if (at) yt6.at2 = ''; 
					addEL(me, 'loadedmetadata', function() { ev = '1loadedmetadata'; //ev_log(ev)
					  if ( chk1(me) )
					    return void 0;
					  ...
					  var prev_itag = (me.loaded_itag && itag(me.src) && me.loaded_itag != itag(me.src)) ? clone(me.loaded_itag) : clone(yt6.userprefV[0]); yt6.prev_itag = prev_itag
					  ...
					  if (mep) if (A(yt6.current)) {
						...
						if (yt6.newvideo) {
						  if (!yt6.mobile) {
						    me.setCurrentTime(0)
						  } else me.currentTime = 0; me.pastTime = 0
					    ...
					    if (itag_ && (1 * itag_ != yt6.userprefA[0] || 1 * itag_ != yt6.userprefV[0])) {
					      if (!yt6.no_default && !yt6.audiosauce) {
						if ( !(typeof yt6.fmt_bak2 == 'number' && (gid(mep.getAttribute('id') + '_sourcechooser_' + yt6.fmt_bak2) && yt6.yt_otf.indexOf(yt6.fmt_bak2) > -1)) ) { //(!yt6.newvideo || yt6d.init) &&
						  if (typeof yt6.fmt_bak2 == 'number') { if (!gid(mep.getAttribute('id') + '_sourcechooser_' + yt6.fmt_bak2)) { itag_ = (1* yt6.fmt_bak2); } else if (yt6.fmt_bak != prev_itag) { yt6.fmt_bak = itag_ } else yt6.fmt_bak2 = null }
						  ...
						  if (yt6.yt_otf.indexOf(prev_itag) > -1) { yt6.fmt_bak = prev_itag }
						}
					      } else {
						  no_default(itag_, 'V'); no_default(itag_, 'A'); if (yt6.A_[itag_]) delete yt6.audiosauce
						}
					    }
						...
						if (!yt6.no_default && ( !(itag_ == 18 && ( (yt6d.init && (yt6.userprefV.toString() == '397,244,134,396,243,133,43,18' || yt6.userprefV.toString() == '396,243,133,43,18'))  ||  (yt6.mobile && (yt6.fmt_bak || !yt6.fmt_bak)      ) )  ) )) {
						  if ( yt6.fmts_fallback.V[yt6.prefer_fmt].indexOf(itag_) > -1) {
						    ...
						    if (typeof yt6.fmt_bak2 == 'number') {
						      if (!gid(mep.getAttribute('id') + '_sourcechooser_' + yt6.fmt_bak2)) { x = (1* yt6.fmt_bak2); } else if (yt6.fmt_bak != prev_itag) { yt6.fmt_bak = itag_ } else yt6.fmt_bak2 = null
						    } else x = (1 * x)
						    if (!isNaN(x)) { //console.log('x '+itag_ +' '+qual[itag_]['a'] +' '+ qual[qual[itag_]['a']] +' '+ qual[qual[itag_]['a']]['av1'] +' '+ ' = ' + x )
						      if (yt6.userprefV.indexOf(1 * x) > -1) yt6.userprefV.splice(yt6.userprefV.indexOf(1 * x), 1) // remove problematic format from preference list
						      yt6.userprefV.unshift(1 * x); delete yt6.userprefV[20] // push the new one to the front
						      if (yt6.yt_otf.indexOf(prev_itag) > -1 || x == prev_itag) { yt6.fmt_bak = prev_itag } // otf exception, prepare to revert to on next vid
						    }
						  }
					  ...
					  if (mep && (yt6.fullscreen || (!yt6.ytp.embed && mep.offsetWidth == windowwidth && mep.offsetHeight == windowheight )) ) {
					    yt6.fullscreen = true
					    me.style.width = '100%'
					    me.style.height = '100%'
					    me.style.left = '0px'
					  ...
					  if (!yt6.fullscreen) {
					    ...
					    if (yt6.size == 'theater' && yt6.newvideo) aspect(yt6.size)
					  }
					  if (yt6.encrypted) { var z = gid('encrypted_signatures_warning'); if (z) z.style.display = 'none' }
					});
					addEL(me, 'loadeddata', function() { ev = '1loadeddata'; //ev_log(ev)
					  if ( chk1(me) )
					    return void 0;
					  ...
					  if (yt6.newvideo || yt6.ytp.strCt2) { yt6.newvideo = true
					    if (yt6.ytp.strCt2 && yt6.ytp.strCt2 > yt6.ytp.strCt) { yt6.ytp.strCt = clone(yt6.ytp.strCt2); yt6.ytp.strCt2 = 0 }
					    if ((yt6.md || yt6.x_) && hid() && yt6.p && yt6.p.parentNode && yt6.p.tagName != 'EMBED' && typeof yt6.p.getCurrentTime == 'function') {
					      try { var ct = yt6.p.getCurrentTime()
						if (typeof ct == 'number') {
					    ...
					    if ((me.currentTime || yt6.ct) && me.currentTime != yt6.ct)
					    yt6.player1.setCurrentTime(yt6.ct)

					  } else {

						if ((me.currentTime || yt6.ct) && me.currentTime != yt6.ct) me.currentTime = clone(yt6.ct) //if (!me.currentTime && yt6.ct)
					  ...
					  if (yt6.x) {
					    ...
					    if (!(yt6.player2.media && yt6.player2.media.paused)) { if (yt6.V_[itag(me.src)]) { me.play() }//to escape stuttering freeze up at the start of playback
					      else { Seek = 4; gid('player2').pause() }
					    }

					  } else yt6.player1.hideControls(false)
					});
					addEL(me, 'play', function() { var itag_ = itag(me.src); ev = '1play'; //ev_log(ev);
					  if ( chk1(me, (yt6 && player2 && hid() && yt6.diff > 0.6 && me && me.currentTime > 0 && !(yt6.V_[itag_] && player2.paused))) ) {
					    return void 0 }
					  if (yt6.x) {
						...
						if ( yt6.retry < (yt6.limit || 8) &&
						     (!AV(itag_) && !A(itag_) && ( V(itag_) || (Seek != 4 && player2.src == yt6.audiox) ) )
						   ) {

						  var r2 = (!yt6.err2count || yt6.err2count < 30) ? true : false

						  if (typeof player2.src == 'string' && (yt6.linx.indexOf(player2.src.replace(protocol(),'')) > -1 || yt6.age.blocked)) {

						  } else if (r2 && yt6.retry < (yt6.limit || 8) && player2.src != yt6.audiox && ((yt6.x && hid()) || (yt6.player2 && yt6.player2.media && !yt6.player2.media.loaded) )) { //m2 !yt6.live && 
						  ...
						  if (r2 && me.loaded && player2.paused && ((yt6.audiox && player2.src == yt6.audiox) || (!AV(itag_) && !A(itag_)) ) ) {
						  ...
						  if ( !yt6.live && r2 &&
							...
							!(yt6.md && hid() && browserName == 'Edge' && (Array.isArrax(yt6.yt_otf) && typeof itag_ == 'number' && typeof yt6.yt_otf[itag_] != 'undefined')) // Edge for Android needs a javascript error here (intentional typo .isArrax) to not enter infinite loop on yt_otf links on background play
						     ) {
						    if (typeof yt6.diff == 'number' && (yt6.diff > 0.3 || me.currentTime == 0 )) {
						    $waitUntil(
						      function() {
							yt6.diff = Math.abs(parseFloat(me.currentTime - player2.currentTime))
						        if ((yt6.diff > 0.3 && yt6.sync_timer < 8) || !V(itag_)) { return true }
							  else {
							    if (yt6.newvideo) {
							      if (yt6.player2 && yt6.player2.media && typeof yt6.player2.setCurrentTime == 'function' && V(itag_)){
								me.p = gc('mejs-button mejs-playpause-button')[0]
								if (me.p && yt6.player2.media.paused && itag(me.src) >= 103) {
								  yt6.player2.media.play()
								} else if (me.paused) {
								    me.play()
								  }
					...
					//		    if (Seek == 5) { Seek = 2; }//return void 0 }
							...
							yt6.newvideo = false
						      ...
						      if (yt6.md && hid() && yt6.player2) { yt6.ct = clone(yt6.player2.media.currentTime) } else// && yt6.ct != player2.currentTime
						      if (Seek === null && yt6.Seek === null &&
							yt6.Seeked2) { yt6.Seeked2 = false; Seek = 0 } else if (player2.paused && yt6.diff > 0.3 && V(itag_)) me.play()//(player2.paused) ? true :  // <-- to escape infinite loop

						    }
						  }

						    yt6.promise = true; var playPromise2 = me.play(); yt6.pt = yt6.player1.getCurrentTime(); // AV or A

						    if (playPromise2 && typeof playPromise2.then == 'function') {
						      if (typeof me.pp2 != 'function') {
							me.p = gc("mejs-button mejs-playpause-button")[0]
							me.pp2 = 'yt6.player1.media.pp2 = function(){ if (yt6.md && hid()) return void 0; var src2 = me.src;\
						    ...
						    yt6.promise = true; var playPromise = me.play(); yt6.pt = yt6.player1.getCurrentTime(); // AV or A
...
\
							function very_simple_playback_duh(){\
							  if (yt6.x && me == yt6.player1.media) { if (yt6.md && hid()) return void 0; me.pp.ok = true;\
							    \/\*&& me.loaded && !me.currentTime) me.play();\*\/\
								...
								$waitUntil(function(){ if (me.loaded) { return true } else { if (!yt6.navigation) { me.load(); setTimeout(function(){ me.play() },700) } } }, function(){\
								  if (me.paused || (!me.paused && ( me.currentTime == me.pastTime || (me.currentTime).toFixed(6) == yt6.pt.toFixed(6) ) )) {\/\*(me.pastTime + 0.01).toFixed(6)\*\/\
								...
								if ((!me.loaded || (!me.paused && Math.abs(player2.currentTime - me.currentTime) > 3) || (Seek != 3 && me.currentTime && yt6.ct == me.currentTime && yt6.ct == yt6.pt && yt6.pt == me.pastTime) ) && me.timer < 2) {\
								  if (!yt6.navigation && me.paused) { if (yt6.at) { yt6.no_default = true };\
								    me.load();\
								  } else { me.timer = (typeof me.timer == "number") ? (me.timer + 1) : 0 }\
								} else if (!hid()) { me.timer = (typeof me.timer == "number") ? (me.timer + 1) : 0 };\
								if (me.timer > 4) { me.timer = 0;\
								  var src = yt6.player1.media.src; if (!yt6.failed_itags.length) { clear_mep(yt6.player1) } else { };\
							  	  yt6.player1.setSrc(src); if (!yt6.failed_itags.length) { yt6.player1.load() } else { yt6.player1.play() };  /*if (!me.loaded) media_error_handler(me)*/;\
								};\
								if (!yt6.live && me.currentTime == me.pastTime) { me.timer = (me.timer + 1) };\
								me.pp.ok = false;\
							      };\
							  }\
							};\
\
							playPromise.then(function () { if (me.currentTime > 0) { if (!me.paused) yt6.newvideo = false; } else if (hid()) me.play();\
							  \/\*console.log("Playing...")\*\/;\
							  yt6.ct = (1 * yt6.ct) || 0;\
							  if (yt6.x || yt6.audiox) {\
							    \/\*if ( (!me.pp.ok || (hid() && !me.currentTime)) && (me.paused || (!me.paused && (me.currentTime == yt6.pt || (me.currentTime).toFixed(6) == (me.pastTime + 0.1).toFixed(6)) )) ) {\*\/\
							  ...
							  \/\*if (yt6.fmts_fallback.V.all.indexOf(itag(src)) > -1) { no_default(itag(src), "V") } else no_default(itag(src), "A"); try { yt6.player1.media.play() } catch(e){}\*\/; \
						          if ( \/\*(!me.pp.ok || (hid() && !me.currentTime) ) &&\*\/ (yt6.x || yt6.audiox)) {\
					    ...
					    if (!me.paused && !yt6.live) { var ae = document.activeElement, aud = yt6.A_[itag_]

					      if (!hid()) if (!yt6.player1.controlsAreVisible) {
						if (me.currentTime) yt6.player1.showControls(true)
					        if (typeof player2.loaded != 'number') {
						  if (!yt6d.init) if (  ae.tagName != 'BODY' && (ae.tagName != 'VIDEO' || me.currentTime < 0.5) && (me.currentTime < 0.5 || (!aud && !(typeof ae.id == 'string' && ae.id.indexOf('mep_') == 0)))  ) { yt6.player1.hideControls(true) } //else 
						  if (!yt6d.init && !yt6.md && me.currentTime < 0.5) yt6.player1.hideControls(false)
					        }
					      } else if (!aud && !!(yt6.player2 && yt6.player2.media && yt6.player2.media.loaded)) yt6.player1.hideControls(true) // touchscreen bigplay
					      if (yt6.mobile && typeof player2.loaded == 'number') if (aud) player2.loaded = true
					    }

					  } else if (!me.paused) { me.pause() }


					  if (yt6.speed && (yt6.newvideo || !hid())) player2.playbackRate = me.playbackRate = yt6.speed;
					  if (yt6.player1.options.loop1 && yt6.player1.options.alwaysShowControls == false) {
					    gc('mejs-loop-start')[0].style.visibility = 'hidden'
					    gc('mejs-loop-end')[0].style.visibility = 'hidden'
					  }
					});
					addEL(me, 'pause', function() { var itag_ = itag(me.src); ev = '1pause'; //ev_log(ev)
					  if ( chk1(me, (yt6 && hid() && yt6.diff > 0.6)) )
					    return void 0;
					  if (hid() && ((Seek != 3 && me.currentTime < me.duration) || (Seek == 3 && yt6.player1.options.loop1)) ) {
					    if (yt6.x) {
					      if ( (((yt6.x && hid()) || 0.3 >= yt6.diff) && !(browserName == 'Yandex' && pause_count)) || player2.currentTime == 0) {// 0.3 >= yt6.diff condition is needed to start from the lock screen
						yt6.Seeked2 = (yt6.V_[itag_]) ? true : yt6.Seeked2;
						...
						if (browserName == 'Yandex' && me.paused && yt6.V_[itag_] ) {
						  if (player2.loaded && me.loaded_itag != itag(player2.src)) { //if (!(yt6.A_V[itag_] && pause_count) || player2.loaded)
						    try { yt6.player2.play() } catch(e) { me.play() } } else me.play()
						  pause_count++; if (pause_count > 1) pause_count = 0
						  //ev_log('player1 resuming playback on hidden tab '+ pause_count +' '+yt6.diff)
						}
						if (yt6.md && hid())
						  if (!yt6.V_[itag_]) { Seek = 4 } else { yt6.Seeked2 = false }
					      } else if (browserName == 'Yandex') { pause_count++; if (pause_count > 44) pause_count = 0; if (yt6.player2) Seek = 1 }
					    }
					    if (( !(Seek == 3 || yt6.navigation) && yt6.retry < (yt6.limit || 8) && yt6.player2) || !me.loaded) return void 0// && !(yt6.md && yt6.newvideo && hid())
					  }
					  if (yt6.x) {
					...
					addEL(me, 'timeupdate', function() {
					  ...
					  //} else { Seek = 0; yt6.Seek = 0; return void 0 }

					  if (yt6.mobile && typeof yt6.speed_bak == 'number' && me.currentTime) slowmd()
					  ...
					  //}
					  if (typeof yt6.err2 == 'number' && yt6.err2 < 0) try {
					    if (isNaN(yt6.player2.media.duration - yt6.player2.media.currentTime)) { yt6.err2--; if (yt6.err2 < -10) yt6.err2 = 0 }
					  } catch(e){}
					  yt6.Seek = Seek
					  yt6.loop.on = yt6.player1.options.loop1
					...
					addEL(me, 'ended', function() { ev = '1ended'; //ev_log(ev +yt6.pt +'/'+ me.pastTime +'/'+ yt6.ct+'/'+ me.currentTime); console.log(ev +' - '+yt6.player2.media.currentTime+'/'+yt6.player2.media.duration)
					  if ( chk1(me) )
					    return void 0;
					  if (yt6.age.blocked) {
					    if ( !(yt6.linx[yt6.player1.media.loaded_itag] && yt6.linx[yt6.player1.media.loaded_itag].replace(protocol(),'') == yt6.player1.media.src.replace(protocol(),'')) ) {
					      ...
					      if (z && z.firstChild && z.firstChild.lastChild && z.firstChild.lastChild != z.firstChild.firstChild) {
						swap_player()
						if (autoplay(false)) { me.currenTime = player2.currentTime = 0; yt6.player1.play() }
						return void 0
					      }
					    }
					  }
					  //if (yt6.mobile && typeof me.pastTime == 'number' && me.pastTime > 0 && me.pastTime < 6 && Math.abs(me.duration - yt6.ct) < 0.6 && Math.abs(me.duration - me.currentTime) < 0.6) { me.pastTime = 0; yt6.failed_itags.push(me.loaded_itag); media_error_handler(me); return void 0 }// !yt6.pt && ev_log('error: jumped to end'); 
					  if (!yt6.live) {
					  if (yt6.player1.options.loop1) {
					    var loop = (yt6.x && hid()) ? true : false
					    try { yt6.player1.pause(); yt6.player2.pause(); Seek = 1;
						...
						try { hid('v'); mp.nextVideo(); mp.playVideoAt((yt6.pl_index + 1)); yt6.ytp.loaded_vid = clone(yt6.vid);
						  return void 0
						} catch(e){}
					      }
					      find_playlist()
					      if ( (!yt6.navigation && autoplay(false) ) ){//|| (hid() && yt6.autoplay && typeof yt6.ad_skipped == 'number') ) { 
					        if ( !(yt6.V_[itag(me.src)] && player2.currentTime == 0) || (yt6.player2 && yt6.player2.media && yt6.player2.media.currentTime != 0) ) {
						  if (!yt6.body2 && yt6.layout == 12 && yt6.x && hid()) { // mobile sleep mode
						    try {
						  ...
						  if (z && z[0]) {
							...
							//try { yt6.player1.media.currentTime = player2.currentTime = 0 } catch(e) { yt6.player1.media.currentTime = 0 };
							  if (z[i+1]) {
								...
								if (yt6.blocked && yt6.fullscreen) { swap_player(); yt6.player1.exitFullScreen(); yt6.fullscreen = false; yt6.s = {}; yt6.fullscreen12 = 1 }
							    ...
							    if (hid() && yt6.layout == 162 && yt6.x && yt6.md && yt6.pls && !yt6.mobile) {
						      ...
						      $waitUntil(function(){ pl_item(); var y = yt6.pl_index, zi = yt6.pl_next; if ((typeof y == 'number' && zi) || ((hid() || yt6.mobile) && typeof yt6.p.playVideoAt == 'function')) { return true } },
						      function(){ var y = yt6.pl_index, zi = yt6.pl_next;
							    ...
							    if (yt6.layout == 16 && yt6.blocked && yt6.pls && !yt6.ytm) {
							  ...
							  if (yt6.mobile) {
							    mobile_playlist_run('next'); return void 0
							  }
								...
								if (mp == yt6.p) {
								    ...
								    var a = 0, b = 5; if (typeof mp.getPlayerState == 'function') {
								      a = mp.getCurrentTime(); b = gpst(mp); if (b == 5) { mp.stopping = false; FireEvent2(mp, 'mouseup'); }
								    }
						...
						if (yt6.live && yt6.live_ !== 2 && typeof yt6.live == 'number') { yt6.live = (yt6.live + 1)
						  ...
						  if (typeof player2.src == 'string') me.src2 = player2.src.split('&sq=')[0] + '&sq=' + yt6.live
						    ...
						    me.src1 = me.src; clear_mep(me); //try { me.src2 = yt6.player2.media.src } catch(e){}
						  }
						yt6.live_ = 1
						try { yt6.player1.setSrc(me.src1); //yt6.player1.media.load();
						  if (me.loaded_itag >= 103) { //yt6.player1.media.pause()
						    yt6.player1.play() } else { Seek = 0; me.pause() }
						} catch(e){}
						try { Seek = 0; yt6.player2.media.currentTime = 0
						  yt6.player2.setSrc(me.src2)
						  yt6.player2.media.load(); yt6.player2.media.pause()
						} catch(e){}
					      }
					      resync_live()
					    }
					});
					addEL(me, 'playing', function() { ev = '1playing'; yt6.error = ''; //ev_log(ev +' '+yt6.pt +'/'+ me.pastTime +'/'+ yt6.ct+'/'+ me.currentTime); console.log(ev +' '+yt6.ct)
					  if ( chk1(me) )
					    return void 0;
					  me.timer = 0
					  if (yt6.decoding_error) { delete yt6.decoding_error } else if (yt6.err2) {
					    if (typeof me.hideControls !== 'function') { me.hideControls = function() { if (!yt6.player1.options.alwaysShowControls) setTimeout(function(){ yt6.player1.hideControls(false) }, 10000) }; me.hideControls() } else delete me.hideControls
					  } //else if (typeof yt6.err2 != 'undefined') ev_log('?_'+yt6.err2)
					  if (yt6.V_[itag(me.src)]) {
					    if (typeof yt6.err2 != 'number') yt6.err2 = (yt6.player2 && yt6.player2.media && typeof yt6.player2.media.load == 'function' && yt6.player2.media.loaded !== true) ? -1 : null
					    if (player2.paused) try { yt6.player2.play() } catch(e){}//Seek = 1; //!yt6.live && 
					  }
					  if (Seek == 1 && !hid() && (!yt6.mobile || (typeof me.currentTime == 'number' && me.currentTime > 1)) ) {
					    if (Math.abs(yt6.player1.getCurrentTime() - player2.currentTime) < 0.6) { Seek = (yt6.player2 && yt6.V_[itag(me.src)]) ? 2 : null }
					  } else if (!me.currentTime && !hid()) { if (yt6.player2 && yt6.V_[itag(me.src)]) yt6.player2.setCurrentTime( me.currentTime ); if (yt6.promise) delete yt6.promise }
					  if (yt6.mobile) {
					    if (hid() || !yt6d.hid) if ( ( !(me.currentTime > yt6.ct)) ) {
					    } else { yt6d.timers.t1 = 0; yt6d.timers.t2 = 0 }
					  } else { yt6d.timers.t1 = 0; yt6d.timers.t2 = 0 }
					  //if (yt6.A_V[itag(me.src)]) {
					    //if ( !yt6.pt && !me.pastTime && !yt6.ct && !me.currentTime && typeof yt6.autoplay_trigger == 'function') { yt6.autoplay_trigger() }//!(yt6.mobile && hid()) && 
					    //else if (!player2.paused) { Seek = 4; player2.pause(); me.play() }
					  //}
					});
					addEL(me, 'seeked', function() { ev = '1seeked'; //ev_log(ev); console.log(ev)
					  if ( chk1(me, (yt6 && !yt6.newvideo && yt6.x && hid())) )
					    return void 0;
					  if (yt6.speed) try { yt6.player2.media.playbackRate = me.playbackRate = yt6.speed; } catch(e){}
					  if (yt6.x && hid() && ((me.currentTime < me.duration && Seek != 3) || (Seek == 3 && yt6.player1.options.loop1)) ) { if (yt6.player2) { Seek = 1 }; me.play(); }//if (yt6.player2.media.paused) yt6.player2.play() }
					  if (me.currentTime > me.duration) yt6.player1.media.currentTime = me.currentTime = player2.currentTime = 0;
					  if (yt6.player2) if ( Seek != 4 && (yt6.audiox || (!yt6.A_V[itag(me.src)] && me.src != yt6.player2.media.src) ) ) {
					    if (me.paused) {
					      yt6.player2.setCurrentTime( me.currentTime )
					        ...
					        if (Seek != 3 && Seek != 0 && (Math.abs(me.currentTime - player2.currentTime) > 0.3 || (hid() && me.currentTime < 0.1) )) {
						  Seek = 1; //case of seeking without hitting pause
						  if (yt6.Seeked2 && !yt6.oldbrowser) yt6.Seeked2 = false
						  if (hid() && me.currentTime < 0.1) yt6.Seek = 2
						};
						...
						if (Seek == 1 && yt6.Seek != 6 && ( !(yt6.md && hid()) || (me.currentTime < 0.1) ) )
					    ...
					    if (!(yt6.mobile && hid()) && me.currentTime == 0 && player2.currentTime == 0 && yt6.ct > 0) yt6.ct = 0
					  }
					});
					addEL(me, 'volumechange', function() {
					  if ( chk1(me, !(yt6 && yt6.x)) )
					    return void 0;
					  if (yt6.player2) try {
					...
					addEL(me, 'waiting', function() {
					  if ( chk1(me, !(yt6 && yt6.x)) )
					    return void 0;
					  if (yt6.mobile) if (yt6.at > 0) { yt6d.timers.w++
					    if (yt6d.timers.w > 4) {
						if (yt6d.timers.w > 20) yt6d.timers.w = 0
						if (yt6d.timers.w % 3 == 0 && itag(me.src) >= 103) { //ev_log('W*ait'+yt6.at)
						  //media_error_handler(me)
						} else //if (yt6d.timers.w % 4 == 0) { } else {
						    if (me.loaded) yt6d.timers.w = 0; //}
					    }
					  }
					});
					addEL(me, 'abort', function() { ev = '1abort'; //ev_log(ev)
					  if ( chk1(me) )
					    return void 0;
					  if (yt6.player2 && typeof yt6.player2.media.loaded == 'number') { var ct = me.currentTime; //me.currentTime = player2.currentTime = 0
					    ...
					    try { yt6.player2.media.loaded = true } catch(e){ player2.loaded = true }
					  }
					  if (yt6.mobile && hid()) {
					  ...
					  sync_timer = clone(yt6.sync_timer); pastTime = clone(me.pastTime)
					  me.aborted = true
					});
			}
		});//player1
	if (typeof srcto == 'undefined') {
		...
		yt6.player2 = new MediaElementPlayer('#player2',{
		  ...
		  success: function(me) { $('#audio-type').html( me.pluginType); 
					addEL(me, 'abort', function() { ev = '2abort'; //ev__log(ev)
					...
					addEL(me, 'error', function(e) { media_error_handler2(me) });
					addEL(me, 'loadedmetadata', function() { ev = '2loadedmetadata'; //ev_log(ev); console.log(ev)
					  if ( chk2(me) )
					    return void 0;
					  //if (yt6.live) { me.setCurrentTime(0); yt6.ct = 0 }
					  if (!yt6.live && (me.duration === Infinity || isNaN(me.duration)) ) { media_error_handler2(me) }
					});
					addEL(me, 'loadeddata', function() { ev = '2loadeddata'; //ev_log(ev); console.log(ev)
					  if ( chk2(me, !gid('player1')) )
					    return void 0;
					  me.loaded_vid = video_id()[0]; me.loaded_itag = itag(me.src)
					  if (yt6.live) return void 0
					  if ( ( yt6.newvideo ||
						(hid() && ( (!yt6.md && yt6.layout == 16)) ) ||
						(yt6d.init && (yt6d.init == yt6.player1.media.loaded_vid || yt6d.init == yt6.vid))
					     ) ) {
					    me.loaded = 1; if (yt6.x) if (yt6.V_[yt6.player1.media.loaded_itag]) { me.currentTime = yt6.ct = yt6.player1.media.currentTime } //yt6.mobile || 
					  }

					  if (yt6.x) if (yt6.V_[yt6.player1.media.loaded_itag]) { //yt6.mobile || 
					    if (Math.abs(yt6.player1.media.currentTime - me.currentTime) > 0.3 ) {
					      yt6.player2.media.currentTime = me.currentTime = yt6.ct = yt6.player1.media.currentTime;
					    }
					  }
					...
					addEL(me, 'timeupdate', function() {
					  ...
					  if (!yt6.live) {
					    ...
					    //if (yt6.navigation && me.paused && !yt6.player1.media.paused) { yt6.Seeked2 = true; yt6.player1.media.pause() }
					  }
					});
					addEL(me, 'seeked', function() { ev = '2seeked'; var itag_ = itag(me.src); //ev_log(ev); console.log(ev +' '+ me.currentTime +'/'+me.duration)
					  if ( chk2(me, (Seek == 0 || (me && yt6 && yt6.player1 && yt6.player1.media && yt6.player1.media.src == me.src) || itag_ < 103) ) )
					    return void 0;
					  if (!yt6.x && typeof me.loaded != 'number' && yt6.p && yt6.p.tagName == 'DIV') { try { yt6.p.seekTo(me.currentTime); return void 0 } catch(e){} }
					  if (!hid() && (me.duration > me.currentTime && !(yt6.player1.media.currentTime > me.duration))) {
					    if ((browserName == 'IE' || browserName == 'Edge') && !yt6.player1.media.paused) yt6.Seeked2 = false
					    if (yt6.x && me.currentTime.toFixed(2) != yt6.player1.media.currentTime.toFixed(2)) {

					      try { yt6.player1.media.currentTime = me.currentTime;} catch(e) {}
						if (!yt6.Seeked2) {
						  if (yt6.diff > 0.3) {
						    hid('h'); Seek = 1; me.pause(); hid('v')
						  } 
						} else {
						    //yt6.player1.media.currentTime = yt6.ct = me.currentTime
						    if (!me.paused)
						    $waitUntil(function(){ if (yt6.player1.media.paused) { return true } else {
							if (yt6.Seek != 1) {
							  if (hid()) { yt6.Seek = 1 } else Seek = 1;
							  yt6.player1.play()
							} else if (hid()) { yt6.Seek = 2 } else Seek = 2;
						      }
						    },
						    function(){ if (hid()) { yt6.Seek = 1 } else Seek = 1;
						      yt6.player1.play(); ////yt6.Seek = 1
						      yt6.Seeked2 = false;
						    },200,200)
						  }
					    ...
					    if (!yt6.navigation)
					    if (Seek == 1 && (me.loaded === true || hid())) {
					      Seek = 2
					      //if ((!yt6.newvideo && !yt6.Seeked2) && !yt6.oldbrowser) { me.pause();  }//; Seek = null
					      if (V(itag_)) {
						if ((me.paused && (!yt6.Seeked2 || (yt6.player1.options.loop1 && yt6.loop.start >= me.currentTime))) || yt6.oldbrowser) if (me.loaded) me.play()
						if (yt6.player2.isLoaded && !hid()) {
						  $waitUntil(
						  function(){ if (!me.paused) return true },
						  function(){ if (yt6.x) { yt6.player1.play() } else { yt6.player2.pause() }},250,1250)
						}
					      }
					...
					addEL(me, 'ended', function() { ev = '2ended'; //ev_log(ev); console.log(ev +' '+ yt6.player1.media.currentTime)
					  if ( chk2(me) )
					    return void 0;
					  if (yt6.age.blocked) {
					    if ( !(yt6.linx[yt6.player1.media.loaded_itag] && yt6.linx[yt6.player1.media.loaded_itag].replace(protocol(),'') == yt6.player1.media.src.replace(protocol(),'')) ) {
						...
						if (autoplay(false)) { me.currenTime = yt6.player1.media.currentTime = 0; yt6.player1.play() }
						return void 0
					      }
					    }
					  }
					  ...
					  if (!yt6.live) {
					  if (yt6.player1.options.loop1) {
					    var loop = ((yt6.x && hid()) && hid()) ? true : false
					    try { yt6.player1.pause(); yt6.player2.pause(); Seek = 1
					      yt6.player1.media.currentTime = me.currentTime = yt6.player2.media.currentTime = player2.currentTime = yt6.loop.start
					    } catch(e) {
					        yt6.player1.media.currentTime = me.currentTime = yt6.loop.start
					    ...
					    if (loop) { yt6.player1.play() }
					      ...
					      if ( yt6.autoplay && yt6.pls &&
						   (	( yt6.player1.media.duration < 300 && yt6.player1.media.currentTime > 4)
							|| (yt6.player1.media.duration >= 300 && yt6.player1.media.currentTime > yt6.player1.media.duration / 60)
							|| yt6.player1.media.duration < 40 || yt6.player1.media.currentTime < 1
						   ) &&
						   (	( hid() && (yt6.md || yt6.player1.media.duration - yt6.player1.media.currentTime == 0))
							|| (yt6.speed > 1 && Math.abs(me.currentTime - yt6.player1.media.currentTime) > 1)
						   )
						) {
						clear_mep(yt6.player1)
						clear_mep(yt6.player2)
					      }
					      if (yt6.ytp.embed) { var mp = original(yt6.p), bt = clone(yt6.browser_tab)//browser_tab must be set to visible!
						try { hid('v'); mp.nextVideo(); mp.playVideoAt((yt6.pl_index + 1)); yt6.ytp.loaded_vid = clone(yt6.vid);
						  return void 0
					      ...
					      find_playlist()
					      if ( (!yt6.navigation && autoplay(false) ) ){//|| (hid() && yt6.autoplay && typeof yt6.ad_skipped == 'number') ) { 
					        if (!(yt6.V_[itag(yt6.player1.media.src)] && me.currentTime == 0) ) {
						  if (!yt6.body2 && yt6.layout == 12 && yt6.x && hid()) {
						    try {
						      yt6.p.playVideoAt((1*yt6.pl_index) + 1)
						      if (yt6.player1.media.volume) {
							//yt6.x_ = clone(yt6.player1.media.volume)
					      ...
					      } else { me.pause(); yt6.player1.pause() }
					    }
					  } else {//live broadcast
					      function resync_live(){
						if (yt6.live && yt6.live_ !== 1 && typeof yt6.live == 'number') { yt6.live = (yt6.live + 1)
						  var z = gid('yt6-mpd')
						  if ( z && yt6.live > z.sq ) { z.innerHTML = 'STREAM last segment = ' + yt6.live; z.sq = clone(yt6.live) }
						  if (typeof yt6.player1.media.src == 'string') yt6.player1.media.src1 = yt6.player1.media.src.split('&sq=')[0] + '&sq=' + yt6.live
						  if (typeof me.src == 'string') yt6.player1.media.src2 = me.src.split('&sq=')[0] + '&sq=' + yt6.live
						  yt6.live_ = 2
						} else {
						    //yt6.player1.media.src1 = yt6.player1.media.src; yt6.player1.media.src2 = me.src
						  }
						try { Seek = 0; yt6.player2.media.currentTime = 0
						...
						try { yt6.player1.setSrc(yt6.player1.media.src1); //yt6.player1.media.load();
					      ...
					      if (yt6.player1.media.paused || yt6.live_ !== 1 ) { resync_live() } //else yt6.player1.media.currentTime = player2.duration
					    }
					  } else if (yt6.x) { //yt6.audiox
						   if (hid() || (parseFloat(yt6.player1.media.duration - yt6.player1.media.currentTime) > 0.03 && parseFloat(yt6.player1.media.currentTime / me.currentTime).toString().split('.')[1].substring(0,4) < '0'+ 100 * yt6.speed) ) {
							yt6.player1.play()
							$waitUntil(function(){if (yt6.player1.media.paused) return true},
							  function(){ Seek = 2; yt6.player1.play() },200,600)
							...
							if (gpst(yt6.p) == 1) { me.play() }
						     }
						   }
					});
					addEL(me, 'pause', function() { ev = '2pause'; //ev_log(ev); console.log(ev)
					  if ( chk2(me, yt6.live) ) // it's better to return without taking any action on live steams
					    return void 0;
					  //if (hid() && ((Seek != 3 && me.currentTime < (me.duration-1)) || (Seek == 3 && yt6.player1.options.loop1) || (!yt6.x && yt6.p.tagName == 'DIV' && yt6.ytp && yt6.ytp.v && typeof yt6.ytp.v.currentTime == 'number' ) ) ) {
					  ...
					  if (yt6.x || (player() && typeof yt6.p.getPlayerState != 'function')) {
					    ...
					    if (yt6.x) {
					      if (Seek != 3 && hid() && (((!yt6.player1.media.paused || yt6.live) && me.duration - me.currentTime < 1) || yt6.player1.media.duration - yt6.player1.media.currentTime < 1 )) {
						if (yt6.player1.media.currentTime == yt6.player1.media.duration && me.currentTime == yt6.player1.media.duration) {
						  ...
						  //ev_log(yt6.at + ' %%3  '+ yt6.player1.media.currentTime +' / '+ yt6.player1.media.duration)
						}
					      if (Seek == 4) { //console.log('AV format selected, separate audio paused')
					        yt6.player1.play()
					      } else if (!(Seek == 1 && !yt6.Seeked2) && !yt6.md && !hid()) {
						  //if (!yt6.md) { yt6.player1.pause() } // pausing via space, infinite loop
					        }
					    }
					    if ((Seek != 4 && !yt6.player1.media.paused) || (Seek == 2 && me.duration != me.currentTime && !(yt6.player1.media.currentTime > me.duration)) ) {
					      if (!yt6.player1.media.paused) { Seek = (!yt6.navigation) ? 2 : 1 } else Seek = null
					    };
 					  } else {
					      if ( typeof yt6.p.getPlayerState == 'function' && !yt6.x ) try { yt6.player2.pause() } catch(e){}
					    }
					});
					addEL(me, 'play', function() { ev = '2play'; //ev_log(ev); console.log(ev); //console.log(yt6.ct +' '+ me.currentTime +' '+yt6.player1.media.currentTime)
					  if ( chk2(me, (yt6 && yt6.retry >= 8)) )
					    return void 0;
					  if (yt6.A_V[itag(yt6.player1.media.src)] && yt6.x) {
					    if (Seek != 4) { Seek = 4; me.pause(); yt6.player1.play() } //else Seek = 2
					  } else if (!yt6.x_) {
					      if (yt6.x) {
						Seek = 2
						if (!yt6.A_V[itag(yt6.player1.media.src)]) {
						  if (me.src != yt6.player1.media.src) {
						    if (!yt6.player1.media.paused || yt6d.init) {
						      //if (yt6.diff != 0) me.loaded = 1
						      if (typeof me.loaded == 'number') {
							me.loaded = true; //Seek = 1;
							if (!yt6.player1.media.paused) yt6.player1.pause(); //Seek = 1
							...
							$waitUntil(function(){ if (yt6.newvideo == false) { return true } else {
							    ...
							    try {
							      yt6.player1.media.currentTime = me.currentTime = yt6.player2.media.currentTime = player2.currentTime = yt6.ct = ct //yt6.ct = 0
							    } catch(e) {
							    ...
							    if (Math.abs(yt6.player1.media.currentTime - me.currentTime) > 0.3) {
							      if (!(yt6.md && hid())) { Seek = 1 } else yt6.Seek = 1
					...
					addEL(me, 'playing', function() { ev = '2playing'; //ev_log(ev); console.log(ev)
					  if ( chk2(me) )
					    return void 0;
					  yt6d.timers.t1 = 0; yt6d.timers.t2 = 0
					  if ( yt6.x) {
					    if (yt6.player1.media.paused ) {
					      if (hid()) {
					...
					addEL(me, 'volumechange', function() {
					  if ( chk2(me) )
					    return void 0;
					  if (yt6.x) {
					      if (me.volume != yt6.player1.media.volume) try {
...
if (me_flash_[0] != undefined) {
  ...
  if (yt6.age.check()) { autoplay() } else set_controls(21)
} else {
    yt6d.mep_renew()
    //resize_layers( yt6.w, yt6.h )
  }
...
//al=en&f6=8&f5=30
//v23
//SOCS=CAESNQgDEitib3FfaWRlbnRpdHlmcm9udGVuZHVpc2VydmVyXzIwMjMwOTI2LjA1X3AwGgJlbiACGgYIgNbyqAY; CONSENT=PENDING+700; PREF=tz=Europe.Budapest&f6=400&f7=100
...
//https://www.youtube.com/embed/aC4BC-Hxq9g?controls=0&rel=0&disablekb=1&showinfo=0&modestbranding=0&html5=1&playsinline=0&start=0&end=0&iv_load_policy=3&autoplay=0&loop=0&nocookie=false&enablejsapi=1&widgetid=1
  ...
  //if (yt6.size == 'default') yt6.tbg.style.backgroundColor = "transparent"
      ...
      if (yt6.mobile) { var s = null;
	try { yt6.s = (yt6.xhr.async) ? player().getPlayerSize() || {} : {}
	  s = yt6.p.getBoundingClientRect()
	  if (s.height && s.height > yt6.s.height && !(!yt6.fullscreen && Math.abs(screen.height - s.height) < 3)) yt6.s.height = s.height
	} catch(e) {}
	  if (yt6.xhr.async && yt6.s && yt6.s.width && yt6.s.height) {
	    w = yt6.s.width; h = yt6.s.height
	  } else {
	      var z = gid('player-container-id'); if (z) {
		w = z.offsetWidth + 'px'
		h = (z.offsetHeight || z.offsetWidth / (16/9)) + 'px'
	      }
	    }
	try { gid('bm5').onclick = tipping } catch(e){}
      }
  ...
  if (!bm0) {
	...
	} else bc = pcont() || gc('player-api')[0] || gc('player-size')[0] || gid('player-api')
    ...
    var bg = (yt6.wallpaper || yt6.cin) ? 'transparent' : 'rgb(16, 16, 16)'
...
if (yt6.ads_eid || linx[1140] || linx[1018]) { var a = 0, b = 0
  for (i=0;i<3000;i++) {
    if (linx[i]) {
      a = (a + i)
      if (linx[i].indexOf('&title=Advertisement') > -1 || (yt6.ads_eid && linx[i].indexOf(yt6.ads_eid) > -1)
	 ) { //ev_log('A1-'+i)
	if (linx[i].indexOf('&title=Advertisement') == -1 && (yt6.ads_eid && linx[i].indexOf(yt6.ads_eid) > -1)) { linx[i] = linx[i] + '&title=Advertisement' }//ev_log('A2-'+i)
	b = (b + i); adv[i] = clone(linx[i])
      }
    }
  }
  if (a && b) {
    for (i=0;i<2999;i++) if (adv[i]) {
      if ( ( (linx[(1000 + i)] && linx[(1000 +i)].indexOf('&title=Advertisement') == -1) ||
	     (linx[(i)] && linx[(i)].indexOf('&title=Advertisement') > -1)
	   )
	) { //ev_log('A3-'+i)
	if (linx[(1000 + i)]) { //ev_log('A4-'+i)
	  linx[i] = linx[(1000 + i)]
	} else if (linx[i] && linx[i].indexOf('&title=Advertisement') > -1) linx[i] = (yt6d.init && !yt6.live) ? linx[i].split('&title=Advertisement').join('&title=') : undefined
	linx[(1000 + i)] = adv[i]
      }
    }
    adv = null
  ...
  function Q(i) {
    if (qual[i] && qual[i]['t']) return qual[i]['t']
    if (i >= 1000) { var j = (1*(i.toString().slice(-3))); if (qual[j] && qual[j]['t']) return qual[j]['t'] } else return null
  }

  for (i=0;i<1000;i++) {//linx
    var z = getElementsByAttribute(p1,'source','name',i)[0];
    if (linx[i] && i != 278) {
      if ( (i < 103 || !(yt6.encrypted && (linx[i].indexOf('&sig=') == -1) ) ) && // || linx[i].indexOf('&alr=') == -1)
	 (linx[i].indexOf('&title=Advertisement') == -1)
      ) {
	...
	//if ( yt6.ytp && ((typeof yt6.ytp.V == 'string' && yt6.ytp.V.indexOf(linx[i]) > -1) || (typeof yt6.ytp.A == 'string' && yt6.ytp.A.indexOf(linx[i]) > -1)) ) continue
	if (yt6.mobile) { js.name = i } else
	if (1000 > i) {
	  if (linx[i].indexOf('&alr=') > -1 || i < 103 ) { js.name = i } else { js.name = i.toString().slice(-3) }//'alt-'+ 
	} else {
	    if (linx[i].indexOf('&alr=') > -1) { js.name = i.toString().slice(-3) } else { js.name = i.toString().slice(-3) }//'alt-'+ 
	  }
	if ( Q(i) ) {
	  if (i < 103) {
	    AV[i] = "itag=" + i
	    if (Q(i).indexOf('WebM') != -1) { js.type = 'video/webm'; js.title = Q(i).replace("WebM","")} 
	    if (Q(i).indexOf('MP4') != -1) { js.type = 'video/mp4'; js.title = Q(i).replace("MP4","")}
	    if (Q(i).indexOf('FLV') != -1) { js.type = 'video/x-flv'; js.title = Q(i)}
	    if (Q(i).indexOf('3GP') != -1) { js.type = 'video/3gp'; js.title = Q(i)}
	  }
	  if (Q(i).indexOf("DASH") > -1) {
	    js.type = 'video/mp4'
	    if (Q(i).indexOf("AAC") === -1) {
	      js.title = Q(i).replace("H.264",""); V[i] = "itag=" + i
	    } else {
		js.title = Q(i).replace("DASH",""); A[i] = "itag=" + i
	      }
	  };
	  if ((i >= 103) && (Q(i).indexOf("WebM") > -1)) {
	    js.title = Q(i).replace("WebM","")
	    if ((Q(i).indexOf("Vorbis") === -1) && (Q(i).indexOf("Opus") === -1)) {
  ...
  if (linx.length == 0) {//dummy sources
    var k = ['video/mp4','video/webm']; if (yt6.reload != 10) { yt6.loaded_vid = '...........'; yt6.navigation = false }
    for (i=0;i<k.length;i++) {
      var js = document.createElement('source')
      js.type = k[i]
      js.src = pseudoSrc
...
if (ytplayer && ytplayer.config && ytplayer.config.args) {
  ...
  if (ytplayer.config.args.ttsurl && unescape(ytplayer.config.args.ttsurl) != 'undefined' && !yt6d.srt.rpt) {
	...
	if (xhr4.readyState == 4 && xhr4.status == 200 && xhr4.responseText) {
	  ...
	  if (k == ttsurl.length-1) { var l = sref[1]
		...
		var tlang_codeA = lang_codeA
		if (yt6d.add_subs) { tlang_codeA = tlang_codeA + ',' + tlang_codeA + ',' + yt6.add_subs; tlang_codeA = tlang_codeA.split(",") }//',hu,en,nl,fr,de,it,ja,ko,pt,ru,es'
      ...
      try { if (!shorts()) xhr4.send('') } catch(e){}
  ...
  if (!gid('controls_bak')) yt6.switches()
  yt6.mep = 'up'
   ...
   if (yt6.flash.forced && window._spf_state && window._spf_state['history-url'] == window.location.href) {
    ...
    var code = "$waitUntil(function(){ if (typeof jQuery == 'function' && typeof $ == 'function' && typeof MediaElementPlayer == 'function') { yt6.loaded = 3; window['status'] = yt6.loaded; return true } else {  }}," +
		...
		//" else { jQuery(document).ready(function($) { $('#version').html( mejs.version);" + mep_run.toString().replace("function mep_run() {",'') + 			    ") }"+
		 ...
		 "},200,5000);" +
		"if (yt6 && !yt6d.src) { yt6.tmp = gt('script', yt6)[0]; yt6d.src = (yt6.tmp && yt6.tmp.src) ? clone(yt6.tmp.src) : yt6.src }; "
...
if (z) z.style.display = 'none'
  ...
  if (p && p.tagName == 'EMBED' && (p.getAttribute('src') == '' || (yt6.layout == 16 && !(p.parentNode && p.parentNode.id)) )) {
    ...
    if (api_id != 'player-api' && api_id != 'player-container' && api_id != 'conatianer') {
      if (yt6.layout != 16) {
	yt6.api = gid('player-api')
      } else yt6.api = (!yt6.ytp.embed) ? (gt('ytd-player', 1)[0] || pcont()) : gid('player')
  ...
  if ( ( p && ((typeof p.getAttribute('flashvars') == 'string' && typeof p.getPlayerState != 'function' && !z) || ((p.tagName == 'EMBED' || p.tagName == 'OBJECT') && typeof p.getPlayerState == 'function' && z)))
	...
	if ( !yt6.x && (!p || (p && p.tagName == 'DIV' && yt6.html5_fail)) ) {
	  try { switch_players() } catch(e){}
	    ...
	    $waitUntil(function(){var p = player(), p = yt6.p; if (p && typeof p.getPlayerState == 'function') return true }, function(){ set_controls(23) }, 1000,10000)
	  }
   ...
   if (yt6.mobile) try { gid('player').setAttribute('loading','false') } catch(e){};
  ...
  if (yt6.flash.forced) {
    ...
    //if (yt6.p && yt6.p.tagName == 'EMBED' && (hid() || yt6.p.getAttribute('src') == '') ) yt6.p.setAttribute('src', yt6.flash.swfbin4)
		...
		buildloop: function(player, controls, layers, media) {
			...
			var 
				...
				.click(function() {
					...
					try { yt6.p.setLoopVideo(player.options.loop1) } catch(e){}
				})
				...
				$waitUntil(function(){if (gc('mejs-time mejs-currenttime-container')[0]) return true},
				  function(){
					...
					<input class="loop-start" value="00:00" style="display: inline-block; height: 44%; padding: 3px 0px 3px 0px; text-align: center; font-size: 11px; width: ' + (gc('mejs-currenttime')[0].offsetWidth || 40) +'px; background-color: white; color: black;" onkeydown="event.stopPropagation();" onkeyup="if (event.keyCode == 13) set_loop(\'start\');" aria-label="Set Loop-Start" title="Set Loop-Start">\
					</input></div>')
					...
					<input class="loop-end" value="' + controls.find('.mejs-duration').html() +'"style="display: inline-block; height: 44%; padding: 3px 0px 3px 0px; text-align: center; font-size: 11px; width: ' + (gc('mejs-duration')[0].offsetWidth || 40) +'px; background-color: white; color: black;" onkeydown="event.stopPropagation();" onkeyup="if (event.keyCode == 13) set_loop(\'end\');" aria-label="Set Loop-End" title="Set Loop-End">\
					</input></div>')
...
(function($) {
    ...
    loadScript( yt6.cdn + "7cfbf5750a18406e43188a4ea5f0257d6c0002f3/mep-ceeb1a7.js", jq1) 
		...
		$waitUntil(
		  ...
		  function(){
			...
			if (p && !(yt6.ytm && p.tagName == 'EMBED')) {
			  ...
			  if (z && spacebar) z.dispatchEvent(spacebar); //if (hid() && !(yt6.layout == 16 && !yt6.mobile && !yt6.ytm && yt6.speed > 2)) yt6.player1.play()
			}
	...
	var mep_reload = yt6d.mep_reload = function(){ //ev_log('mr:'+ yt6.reload +'_'+ yt6.mobile_nav)

	    var c = conf('args'), p = player(), p = yt6.p, x = (window.yt6_swapped || yt6.swapped)

	    if (!yt6.age.blocked && !yt6.blocked_m) { yt6.loaded = 1; window['status'] = yt6.loaded }
	    yt6.change = true
	    yt6d.source = false
	    yt6.xhr.oops = []
	    yt6d.mediaUrlText = []
	    ...
	    yt6.real_dur = null
	    yt6.ads_eid = ''; yt6.ads_eid1 = ''; yt6.ads_eid2 = ''; yt6.real_eid = ''; yt6.eidA = []


	    if (yt6.layout == 12 && typeof yt6.x_ == 'number') { try { yt6.player1.setVolume(yt6.x_) } catch(e){}; yt6.x_ = null }

	    if (yt6.layout == 16 && !yt6.ytm) {

	        if (x === 1) try { delete x; if (!yt6.x) switch_players() } catch(e){}
		...
		yt6.navigation = true
		yt6.ytp.V = ''; yt6.ytp.A = ''; yt6.ytp.dur = ''
		if (typeof yt6.fmt_bak == 'number' && yt6.fmt_bak == yt6.prev_itag) {
		  if (yt6.userprefV.indexOf(yt6.fmt_bak) > -1) yt6.userprefV.splice(yt6.userprefV.indexOf(yt6.fmt_bak), 1)
		  yt6.userprefV.unshift(yt6.fmt_bak); delete yt6.userprefV[20]; if (!yt6.audiosauce) { delete yt6.fmt_bak }
		}
		if (!yt6.age.sc && !yt6.age.dl) yt6.ttsurl = null
		yt6d.srt.rpt = false
		...
		yt6.pl_fix = 0
		if (location.href.indexOf(yt6.vid) == -1) yt6.ads_noskip = 0
		...
		if (yt6d.mreload) delete yt6d.mreload
		...
		if (yt6.layout == 16) if (bm0 && bm0.parentNode.parentNode.tagName.indexOf('MINIPLAYER-BAR') > -1) try {// && !yt6.document_fragment
		...
		if (yt6.mobile) {
		  if (!yt6.change && yt6.loaded_vid == '...........') yt6.change = 0;
		  if (yt6.reload != 10) yt6.loaded_vid = '.'
		}
...
//if (p && p.tagName == 'EMBED') if (typeof p.getPlayerState == 'function') { return true } else { console.log('?::'); p.setAttribute('src',''); p.style.display = 'none'; p.setAttribute('src', yt6.flash.swfbin4); }
			...
			function() {
			  ...
			  if (yt6.flash.forced && yt6.flash.call == 'flash reload B' && (p1 || hid()) ) {
			    ...
			    $waitUntil(function(){
				    ...
				    if (yt6.flash.timer == 0 && hid() && p1 && p1.getAttribute('id') == 'movie_player' && p1 == p) {
				    ...
				    if (p1) {
				      ...
				      //if (hid()) gid('movie_player_to_insert').appendChild(p1)
				    }
					...
					gid('movie_player_to_dispose').appendChild(p)
				      ...
				      if (p1) {
					//if (!hid()) { p1.setAttribute('id','movie_player') } else { p1.setAttribute('src', yt6.flash.swfbin4); p1.style.display = 'block' }
				      }
					...
					//if (bm0.parentNode.getAttribute('id') == 'movie_player_to_insert') {
					  $waitUntil(function(){
					    ...
					    if ((p && p.nodeName == 'EMBED' && p.getAttribute('class') == 'forced flashplayer') || (hid() && p1 && gpst(p1) == 1)) return true },
					  function(){
	        ...
	        } else if (!yt6.ytp.broken && yt6.layout == 16) { // turning off flash, back to html5 player again
		...
		//if (hid()) yt6.player1.media.currentTime = yt6.player2.media.currentTime = player2.currentTime = yt6.ct = 0
		yt6.player1.media.pause()
		//if (hid()) 
		yt6.player1.media.currentTime = 0; yt6.ct = 0; player2.currentTime = 0
		var l = gc('mejs-overlay mejs-layer')[0]; if (l) l.style.display = 'none'
	      } catch(e) {
	...
	$waitUntil(function(){
	  ...
	  function(){
	    ...
	    if (yt6.mobile && !yt6.at2 && yt6.autoplay) ajax1(true)
		...
		//try { yt6.player1.media.currentTime = yt6.ct = 0 } catch(e) { yt6.ct = 0 }
	    ...
	    } else { if (yt6.mobile && hid()) { //ev_log('no media source? '+yt6.vid+'**'+yt6.loaded_vid)
		yt6.loaded_vid = '.'; yt6.nav2 = true; } }
		...
		$waitUntil(function(){
		  ...
		  if (p && typeof p.getPlayerState == 'function') var s = p.getPlayerState()
		    ...
		    } else if (!(yt6.flash.forced && hid() && !(yt6.layout == 12 && yt6.blocked)) && bm0 && z != bm0.parentNode) {
	  ...
	  if (yt6.ad_muted && yt6.p && typeof yt6.p.isMuted == 'function' && !yt6.p.isMuted()) yt6.ad_muted = false
...
if (typeof yt6.fnCheckLocation != 'number') {
  ...
  if (!yt6.body) yt6.body = gt('body', 1)[0]
//requesting new page
...
if (typeof Polymer != 'undefined') {
  if (!yt6.body.snarls_watchdog) try {
	...
	if (yt6 && (!hid() || yt6.ytm) && mutation.type == 'attributes' && (yt6.ytm || (!yt6.ytm && mutation['target'].getAttribute('video-id') == yt6.vid))  )
 	$waitUntil(function() {
  ...
  //potluck
  if (!yt6.pot && typeof yt6.potObj == 'object') for (i in yt6.potObj) { var pot, o = yt6.potObj[i]
    if (typeof o == 'string') {
      if (!pot && o.match(/^[A-Za-z0-9_\-=%]+$/g)) { if (o.length > 135) { pot = '&pot='+ o; yt6.pot = pot; break } }
    }
  }
...
yt6.body.spfdone = function(e) {
	...
	var yt6 = gid('snarls_player'), vid = yt6.vid
        if (vid == video_id()[0]) { set_controls(24); try { unhide(gid('bm0')) } catch(e){}; return void 0; } // returning to the same video
...
yt6.body.yt_navigate_finish = function() {
			...
			if (p && !p && typeof p.getVideoUrl == 'function' && p.tagName == 'DIV') 
			try {
			  var c = conf('args'),
			  ...
			  yt6.x_ = (yt6.x && hid()) ? clone(yt6.player1.media.volume) : false
			  //if (!yt6.x || yt6.x_) { if (yt6.pls && yt6.autoplay && gpst(p) != 1) p.playVideo() } else p.pauseVideo()
			...
			if (!(yt6.loaded_vid && location.href.indexOf(yt6.loaded_vid) > -1))
	...
	$waitUntil(function(){ var c = conf('args'); if ((yt6.title != document.title || (c[1] && !(c[1].title && yt6.title == c[1].title))) && !(yt6.mpb && yt6.api && yt6.api.id && yt6.mpb.querySelector('#'+yt6.api.id) && typeof yt6.mpb.querySelector('#'+yt6.api.id).className == 'string' && yt6.mpb.querySelector('#'+yt6.api.id).className.indexOf('ytd-player') > -1 ) ) return true},
	    function() {
		if (!yt6.x) {
		  if (typeof yt6.brake == 'function' && yt6.pre_ad !== true) { yt6.brake() } else
			    if (!yt6.mobile) {
			    }
		  //if (vID(yt6.vid) && yt6.p && gpst(yt6.p) != -1) yt6.p.playVideo()
		}
		if (typeof yt6.p.getPlayerSize == 'function') {
		  var a = yt6.p.getPlayerSize(); if (typeof a.heigth == 'number') yt6.h = clone(a.height) + 'px'; if (typeof a.width == 'number') yt6.w = clone(a.width) + 'px'
		}
		if (!yt6.ytp.fullscreen && !yt6.fullscreen) {
			      var a = (gid('aspect')) ? gid('a_width').value + 'px' : yt6.w, b = (gid('aspect')) ? gid('a_height').value + 'px' : yt6.h
			      resize_layers(a, b, false)
		}
	},500,5000)
}
...
yt6.body.yt_navigate_start = function() {
	if (yt6) {
	  if (yt6.player1) yt6.player1.isLoaded = false
	}
}
...
if (yt6.mobile) {
  ...
  navigation.oncurrententrychange = function(){ //mobile nav
	yt6.mobile_nav = true; var bm0 = gid('bm0')
	if (location.href.indexOf('/watch') == -1) { relocate_mep(true) } //else { if (bm0 && yt6.api && bm0.parentNode != yt6.api) { if (yt6.x) try { switch_players(); switch_players(); yt6.p.pauseVideo() } catch(e){} } }
  }
  //loadScript('https://m.youtube.com/yts/jsbin/mobile-c3-vfln8aGGz/mobile-c3.js', function(){ })
}
	...
	strPrevHash = "",
	strAds0,
	cur_vid = "", prev_vid = "", ppre_vid = "", cvid0 = "",
	ivo = "", ad_skipped;
    ...
    loadScript( //((yt6.cdn.indexOf('rawcdn.githack') == -1) ? yt6.cdn : '//cdn.jsdelivr.net/gh/snarly/yt6@')
	yt6.cdn.replace('snarly/yt6','lrsjng/jquery-qrcode') +'bf58382a988feb7343e40fcd34a3c8af859adc20/dist/jquery-qrcode.min.js', function(){ //githack refused to serve it 
  ...
  // end of touchemulator
	...
	set: function(target, key, value) {
		...
		if (key == 'document_title' && value != yt6.previous_title && yt6d.ended && hid() && yt6.layout == 16 && yt6.player1 && yt6.player1.media) {
		  yt6d.ended = false
		  if (yt6.p && typeof yt6.p.getPlayerState == 'function') {
		    //try { yt6.p.pauseVideo() } catch(e){}
		  }
		...
		if (key == 'orientation' && yt6.mobile) {
		  if (value != yt6d.orientation) {
		    var z = (yt6.pls && screen.height >= screen.width) ? gc('compact-media-item-headline')[yt6.pl_index_m - yt6.pls_top] : gt('ytm-app', 1)[0] // focus on the playlist item currently being played or the player itself
		    try { z.scrollIntoView(true) } catch(e){}
		  }
		}
	    }
	...
	function cd(n) { //ev_log('cd '+ n +' '+ yt6.navigation)
	  if (yt6 && typeof yt6.change == 'number') {
	    yt6.change++; //ev_log('++'+yt6.change)
	  } else { //ev_log('?')
	      if (   (!yt6.navigation && !(yt6.title.split(' ').join('') != document.title.split(' ').join('') && (yt6.strLocation != window.location.href) && yt6.change === true) )
		  || ( (yt6.title.split(' ').join('') != document.title.split(' ').join('') && (yt6.strLocation != window.location.href) && yt6.change === true) )
		  || yt6.loaded < 4
		 ) {
	        yt6.change = n
	      }
	...
	function mod_title(a, x){
	  var y = (yt6.title.length > 0 && yt6.title.substring(yt6.title.length-1, yt6.title.length) == '`') ? true : false;  //ev_log(yt6.sT+'/'+sameTitles+'_'+a +'\nmod'+x+'_'+y);
//	  if (Array.isArray(a) && a[0] && !a[1] && !a[2] && !a[3] && a[4] ) { } else 
//if (!y && sameTitles != 4) { sameTitles++; return false }
	  if (sameTitles >= 4) sameTitles = 0; 
	  yt6.title = (y) ? yt6.title.substring(0, yt6.title.length-1) : yt6.title + '`'
	}
	...
	var p = player(), p = yt6.p, c = conf('args'), p1 = gid('player1'), gone_mobile_playlist
	...
	if (!yt6.observed && yt6.body && yt6.body.snarls_watchdog) {
	  if (!yt6.ytm) {
	    var z = (yt6.flexy) ? 'ytd-watch-'+yt6.flexy : 'ytd-watch'
	    try { yt6.body.snarls_watchdog.observe( gt(z, 1)[0], {attributes: true, attributeFilter: ['video-id'] }); yt6.observed = true } catch(e) { yt6.observed = false }
	  } else { var z = gc('byline style-scope ytmusic-player-bar complex-string')[0];//if (Polymer.Async._twiddle) {
	...
	if (yt6.ytm) { var z = gid('bm1'); if (z && z.parentNode && z.parentNode.id != 'layout') { gt('ytmusic-app-layout', 1)[0].insertBefore(z, gt('ytmusic-app-layout', 1)[0].firstElementChild); z.style.right = '80%'; z.style.left = '10%' }
	z = gid('music-player-wrapper'); if (z && z.style.display == 'none') z.style.display = 'block'
	}
	...
	} else if (yt6.mobile && yt6.pls && !yt6.x && !(yt6.wna && yt6.wna.parentNode && yta && (yta.parentNode == yt6.wna || yta.parentNode.parentNode == yt6.pls)) && !(gpst(p) != 2) ) {
	...
	if (p && p.tagName == 'DIV') {
	  if (!(yt6.ytp.v && yt6.ytp.v.parentNode)) {
	    yt6.ytp.v = v_(yt6.p)
	  } else if ( !yt6.ytm && !yt6.mobile && gpst(p) != 0) {
	...
	try { yt6.s = (yt6.xhr.async) ? p.getPlayerSize() || {} : {}
	  var s = p.getBoundingClientRect()
	  if (s.height && Math.abs(s.height - yt6.s.height) > 1) { yt6.s.height = s.height }
	} catch(e) { yt6.s = yt6.s || {}
	  if (yt6.ytp.v && yt6.ytp.v.parentNode) {
	    yt6.s.width = yt6.ytp.v.parentNode.offsetWidth || yt6.ytp.v.offsetWidth
	    yt6.s.height = yt6.ytp.v.parentNode.offsetHeight || yt6.ytp.v.offsetHeight
	  }
	}
	if (yt6.s) if (!yt6.s.width && !yt6.s.height && s && !s.width && !s.height && gpst() == -1) { yt6.s.z = true } else yt6.s.z = false//yt6.s.width = clone(yt6.w); yt6.s.height = clone(yt6.h); 
	if ( (yt6.mobile && yt6.x && hid() && browserName != 'Firefox' && (yt6.mute_on || yt6.pre_ad)) ) {// ff mobile is too slow on page change in the background, keep the original player unmuted till the alt-player is ready to take over
	...
	if (yt6.mobile) {
	  ...
	  if (z) z.className = (!yt6d.orientation || yt6d.orientation == 180) ? 'player-container sticky-player' : 'player-container'
	  z = gc('upsell-dialog-lightbox')[0]
	  if (z) z.style.display = 'none'
	  z = gc('consent-bump-lightbox')[0]
	  if (z) z.style.display = 'none'
	  if (yt6.body && yt6.body.hasAttribute('modal-open-body')) yt6.body.removeAttribute('modal-open-body')
	  if (yt6.blocked_m && p) p.style.display = 'block'
	} else if (yt6.layout == 16 && !yt6.ytm) {
	    var z = ['ytd-consent-bump-lightbox','iron-overlay-backdrop','yt-upsell-dialog-renderer']
	    for (i=0;i<z.length;i++) { var y = gt(z[i], 1)[0]; if (y) y.style.display = 'none' }
	  }


	var ads, ads0, ads1, adsp, adclass, modern = '', prebtn;
	...
	if (yt6.mobile) {
	  ...
	  gone_mobile_playlist = (yt6.mobile && !yt6d.init && (!yt6.navigation || yt6.navigation) && watch && location.href.indexOf('list=') > -1 && !yt6.pls && c[1] && typeof (c[1] && c[1].list) == 'string' && !(c[1] && c[1].list).split('"')[1]) ? 1 : 0;

	  if ((yt6.pls && yt6.pls.tagName == 'YTM-PLAYLIST-ENGAGEMENT-PANEL') || (yt6.pl23 && gone_mobile_playlist) ) {
	    if (typeof yt6.adsp == 'number') {
	      if ( yt6.adsp < 5) { if (p1mends()) yt6.adsp++ } else {
		yt6.adsp = null; adsp = gt('ytm-playlist-engagement-panel', 1)[0]; adsp = (adsp && watch) ? gt('button', adsp)[0] : null; if (adsp) adsp.click(); adsp = null }
	    } else { yt6.adsp = 1 }
	  }
	}
	...
	if ( (!yt6.navigation || yt6.ytm || hid()) && p && !(yt6.mpb && yt6.mpb.hasAttribute('active')) ) { // check for in-video ad
	  ...
	  if (!yt6.ads_off) ads0 = null
        ...
        if (yt6 && (!yt6.navigation || (yt6.age.sc && yt6.age.dl)) && gc('mejs-clear')[0]) {
	  var x = (yt6.original && yt6.original.parentNode && yt6.original != p) ? yt6.original : '', z = [p, x]
	  if ((yt6.x || x) && bm0) {
	    for(i=0;i<2;i++) if (z[i]) { if (typeof z[i].getPlayerState == 'function' && !(!yt6.x && z[i] == p)) {
	      var s = z[i].getPlayerState()
	      if (s == 1 || s == 3) try { z[i].pauseVideo(); z[i].getElementsByClassName('video-stream html5-main-video')[0].pause(); z[i].seekTo(yt6.yt_ct) } catch(e) {}
	    }}
	  }
	...
	ads = gc('videoAdUiSkipButton')[0]; if (ads && (!yt6.x || yt6.ytm || (yt6.x && yt6.md && hid()) )) {
	  yt6.ads_noskip = 0
	  ads.click()
	...
	ads = gc('ytp-ad-player-overlay-layout')[0] || gc('ytp-ad-player-overlay')[0]; ads1 = ads
	if (!ads) {
	  ads = gc('playability-status-dismiss-button')[0]
	  if (ads) {
	    ads = gt('c3-material-button', ads)[0]
	    if (ads) ads = ads0 = ads.getElementsByClassName('c3-material-button-button')[0]
	  } else
	      ads0 = gc('ytp-preview-ad')[0] || gc('ytp-ad-preview-container')[0]
	}

	//if (adsp && !yt6.blocked_m) ads = adsp // && !ads



	if (ads && yt6.mobile && !yt6.x && yt6d.init) {
	  delete yt6d.init; switch_players()	// so an ad-struck mobile ui would not trash us on the second video
	} else
	if ( (ads && ads.lastChild && ads != ads0 && !(yt6.ads_noskip_m == 1 && !hid() )) || gone_mobile_playlist ) {
	  ads = gc('ytp-ad-skip-button-container')[0] || gc('ytp-skip-ad')[0];
	  if (ads) {
	    ads = gt('button', ads)[0]
	    if (ads) {
	      adclass = ads.className; if (adclass == 'ytp-ad-skip-button-modern ytp-button') modern = '-modern'
	      if (modern || adclass == 'ytp-ad-skip-button.ytp-button') {
		if ((!hid() || yt6.mobile_nav !== 0) && yt6.ad_skipped < 3) { ad_skipped = 0 }
	      } else if (yt6.mobile && !gone_mobile_playlist) { ads = null; yt6.ad_skipped = 0; }
	    }
	  } else {
		ads0 = gc('ytp-preview-ad')[0] || gc('ytp-ad-preview-container')[0]
		if (ad_skipped && !gone_mobile_playlist) { yt6.ads_noskip = (!yt6.live && !ads0) ? 1 : (yt6.ads_noskip + 1) }
	    }
	  if (!ads) ads = gc('ytp-ad-skip-ad-slot')[0] || gc('ytp-preview-ad')[0] || gc('ytp-ad-preview-container')[0] // unskippable = ' ytp-ad-preview-container-detached' || 'ytp-ad-toggle-button ytp-ad-instream-user-sentiment-dislike-button')[0]
	  if (yt6.mobile)
	  if ((!ads && !adsp) || !gid('prebtn')) {
		// yt may "forget" to put the playlist structures on the page, this is one way to fix it
		ads = pbtn()
		if (yt6.mobile && yt6.ads_noskip != 2 && (gone_mobile_playlist || (yt6.pls && yt6.pls.parentNode && yt6.pls.parentNode.parentNode && !yt6.pls.parentNode.parentNode.parentNode)) ) { if (typeof yt6.mobile_nav != 'undefined') yt6.mobile_nav = false; if (!yt6.x || (yt6.x && yt6.player1 && yt6.player1.media && yt6.player1.media.loaded && yt6.player1.media.currentTime)) yt6.ads_noskip_m = 0 }
	  } else { if (yt6.ads_noskip_m == 2 && yt6.pls) yt6.ads_noskip_m = 0; if (adsp && !yt6.blocked_m) ads = adsp }

	}

	if (yt6.mobile_nav && ads && ads0 && !yt6.navigation) yt6.mobile_nav = false


	if ( yt6.ads_noskip < 5 &&
	    ( !(yt6.mobile_nav && (yt6.ads_noskip < 2 )) || (yt6.mobile && yt6.ad_skipped === 3 && ads && ads.id != 'prebtn')
	    ) &&//|| gone_mobile_playlist
	    (
	     ( ((yt6.ads_noskip_m !== 1) || (yt6.live && ads && (yt6.ad_skipped == 3 || (yt6.ads_noskip) || (!yt6.ads_noskip && !yt6.ads_noskip_m)) )  ) && //!(yt6.mobile && yt6.ads_noskip_m == 1)) && 
		(ads && (ads != ads0 || (ads == ads0 && yt6.loaded_vid == yt6.vid && Math.abs(yt6.real_media_duration - yt6.loaded_media_duration) > 0.6) )
	       )
		|| (yt6.live && ads && ads != ads1 && typeof p.getCurrentTime == 'function' && p.getCurrentTime() > 0 && 1.5 >= Math.abs(p.getDuration() - p.getCurrentTime()) )
	     )  || yt6.ad_skipped == 3
		|| (adsp && !yt6.blocked_m)
	    )
	   ) {
	  ...
	  if (ads != ads0 && !adsp && !modern && ads0 && ads0.className && !(typeof ads0.className == 'string' && ads0.className.indexOf('-preview-') > -1)
	     ) { ads = gc('ytp-ad-skip-button ytp-button')[0] }
	  ...
	  if (ads) {
		...
		if (ads != ads0 || modern) {
		  prebtn = gclass('ytp-ad-text ytp-ad-preview-text'+ modern)[0]; if (yt6.ad_unskippable) { prebtn = ads; delete yt6.ad_unskippable }
		} else { prebtn = (yt6.mobile && hid()) ? yt6.body : gid('prebtn') }

	      if (prebtn) {

		var evtest = function(e) { if (e && typeof e.pageY == 'number') yt6d.mouseEvent = e; }
		...
		prebtn.click(); //if (gone_mobile_playlist) { ev_log('skip1-'+((prebtn==gid('prebtn'))?'1':'0') )
		...
		try {
		  ...
		  if (1 >= yt6.linx.length) {
		    ...
		    $waitUntil(function(){ var vid = ''; if (yt6.p && typeof yt6.p.getVideoUrl == 'function') vid = vID(yt6.p.getVideoUrl()); if (vid && location.href.indexOf(vid.split('&')[0]) > -1) return true },
		      function() {
			if (hid()) yt6.p.playVideo()
		      },1000,6000)
		  }
		} catch(e){ yt6.ads_noskip_m = 1 }

		//if (!(yt6.mobile && yt6.ad_skipped == 3)) {

		  yt6.ads_noskip_m = (( !gone_mobile_playlist || yt6.ads_noskip > 2 ) ) ? 1 : 2
		  yt6.ads_noskip = (yt6.ads_noskip + 1)
		  //if (gone_mobile_playlist && yt6.ads_noskip > 2 && yt6.ads_noskip_m == 1) yt6.ads_noskip = 0

		//} else 
		if (yt6.mobile && yt6.ad_skipped == 3 && yt6.ads_noskip != 2) { yt6.ads_noskip_m = 3 }; yt6.ad_skipped = 1


		if (yt6.mobile && !hid())
		  $waitUntil(function() { if (restore_cp()) return true }, function() { set_controls(25) }, 1000, 3000)//scrollToCurrentVideo()

	      } else yt6.ad_unskippable = true // missing the ad-skipper button?
	      }

	    } else { if (yt6.mobile) { yt6.ads_noskip_m = 1 } else yt6.ads_noskip = (yt6.ads_noskip + 1) }

		              $waitUntil(function(){var p = player(), s
				if (p && !(yt6.ytm && p.tagName == 'EMBED') && typeof p.getPlayerState == 'function') {
				  var s = p.getPlayerState()
				  if (s == 2 || s == -1) { return true } else try { if (s == 3) { ; return true } else { p.pauseVideo() } } catch(e){}//p.playVideo()
				}
			      },function() { yt6.p.seekTo(yt6.p.getCurrentTime()); if (!yt6.x && hid()) yt6.p.playVideo()
				  if (!yt6.x) { ; try { v_(yt6.p).playbackRate = clone(yt6.speed) } catch(e) { yt6.ytp.speed() }//yt6.p.playVideo()
				    if (!yt6.ytp.fullscreen && !yt6.mobile) {
				      var a = ( !(yt6.mobile && ( (yt6.player1 && yt6.player1.isfullScreen) || (p1 && p1.style.width == '100%' && p1.style.height == '100%'))) && !(yt6.mobile && !ast && !yt6.fullscreen) ) ? ( (gid('a_width')) ? gid('a_width').value + 'px' : ((!yt6.fullscreen) ? yt6.w : screen.width + 'px') ) : mep.offsetWidth + 'px', b = ( !(yt6.mobile && ( (yt6.player1 && yt6.player1.isfullScreen) || (p1 && p1.style.width == '100%' && p1.style.height == '100%'))) && !(yt6.mobile && !ast && !yt6.fullscreen) ) ? ( (gid('a_height')) ? gid('a_height').value + 'px' : ((!yt6.fullscreen) ? yt6.h : screen.height + 'px') ) : mep.offsetHeight + 'px'
				      if (a != '0px' && b != '0px') resize_layers(a, b, false)
				    }
				  } else if (yt6.autoplay && !yt6.ad_skipped && location.href.indexOf(yt6.loaded_vid) > -1) { yt6.player1.media.play() } //else if (yt6.mobile && typeof yt6.change != 'boolean') mep_reload()
				}, 100,5000)

	     if (yt6.linx.length && ( yt6.live || (yt6.yt6_length === 1 && yt6.alt_length > yt6.yt6_length))) {
		$waitUntil(function() { if ( (yt6.yt6_length === 1 && yt6.alt_length > yt6.yt6_length) || (((ad_skipped === 0 && yt6.ad_skipped > 1) || yt6.live) && yt6.real_media_duration > 0 && typeof yt6.loaded_media_duration == 'number' && (yt6.loaded_media_duration - yt6.real_media_duration) > 36) ) { var z = gid('prebtn'); if (z) z.click(); return true } }, function() { yt6d.mep_reload() },500,7000)
	     }

	    //if (!yt6.x || (yt6.layout == 16 && !yt6.mobile && !yt6.ytm && hid())) try { p.unMute(); yt6.ad_muted = false } catch(e) {}
	    if (yt6.x) {
		  if ( !yt6.live && typeof p.isMuted == 'function') {
		    if (!(yt6.ytm && yt6.ytp.fullscreen))
		      try {
			if (yt6.mute_on) { 
			  if (yt6.layout == 16 && !yt6.mobile && !yt6.ytm && hid()) {
			    yt6.pre_ad = true
			  } // else
	    ...
	    //yt6.ad_skipped = 1
	      ...
	      if (yt6.ad_skipped == 3) { if (yt6.mobile_nav) yt6.mobile_nav = false
		if (yt6.ads_noskip_m) delete yt6.ads_noskip_m; yt6.ad_skipped = 4; //console.log('not skippable this time, get back to fast forwarding')
	      } else if (yt6.live) yt6.ads_noskip++
	    }

	} else {

	    ads = gc('ytp-preview-ad')[0] || gc('ytp-ad-preview-container')[0] || (yt6.pre_ad === true)

	    if (ads && ((strAds0 != ads0) || yt6.live || yt6.ytm || (yt6.loaded_vid == yt6.vid && yt6.ad_ && Math.abs(yt6.real_media_duration - yt6.ad_) > 0.6)  )){//- yt6.loaded_media_duration

		yt6.ads_noskip = (!hid() || (Math.abs(yt6.real_media_duration - yt6.ad_duration) > 1.5 && yt6.real_media_duration > 250)) ? (yt6.ads_noskip + 1) : 4

	      if ( !(yt6.mobile && (yt6.blocked_m || yt6.mobile_nav || (yt6.s && yt6.s.z)) //hid()
		    ) && !yt6.shuffle
		    &&  (!(p && p.tagName == 'DIV' && typeof p.getCurrentTime == 'function' && 1.5 >= Math.abs(p.getCurrentTime() - p.getDuration()) ))//not if the video ended
		    &&  ( (!hid() && 2 > yt6.ads_noskip && !yt6.ytm)
		          || ( (hid() || yt6.ytm) && 2 > yt6.ads_noskip)
			)
		) {
		...
		try { //ev_log('skip2')
			...
			for(i=0;i<pobj.length;i++) if (pobj[i] && typeof pobj[i].getVideoUrl == 'function') {
			  try { ytvid = vID(pobj[i].getVideoUrl()) } catch(e) { continue }
			  if (typeof ytvid == 'string') {
			    vid = ytvid.split('&')[0].split('#')[0]
			    yt6.vid = vid
			    break
			  }
			}
			if (!vid) vid = video_id(true)[0]; ytvid = vid
		    try {
		      if (ytvid && location.href.indexOf(ytvid) == -1) {
			window.history.pushState({}, yt6.title, location.href.split(yt6.vid)[0] + ytvid + location.href.split(yt6.vid)[1] )
		      }
		    } catch(e){}
			...
			$waitUntil(function(){var p = player(), s
			  if (p && !(yt6.ytm && p.tagName == 'EMBED') && typeof p.getPlayerState == 'function') {
			...
			},function() { yt6.p.seekTo(yt6.p.getCurrentTime()); if (!yt6.x) yt6.p.playVideo()// && hid()
			    if (!yt6.x) { ; try { v_(yt6.p).playbackRate = clone(yt6.speed) } catch(e) { yt6.ytp.speed() }//yt6.p.playVideo()
				    if (!yt6.ytp.fullscreen && !yt6.mobile) {
				      var a = ( !(yt6.mobile && ( (yt6.player1 && yt6.player1.isfullScreen) || (p1 && p1.style.width == '100%' && p1.style.height == '100%'))) && !(yt6.mobile && !ast && !yt6.fullscreen) ) ? ( (gid('a_width')) ? gid('a_width').value + 'px' : ((!yt6.fullscreen) ? yt6.w : screen.width + 'px') ) : mep.offsetWidth + 'px', b = ( !(yt6.mobile && ( (yt6.player1 && yt6.player1.isfullScreen) || (p1 && p1.style.width == '100%' && p1.style.height == '100%'))) && !(yt6.mobile && !ast && !yt6.fullscreen) ) ? ( (gid('a_height')) ? gid('a_height').value + 'px' : ((!yt6.fullscreen) ? yt6.h : screen.height + 'px') ) : mep.offsetHeight + 'px'
				      if (a != '0px' && b != '0px') resize_layers(a, b, false)
				...
				var b = v_(yt6.p); if (b) { b.volume = 1; p.setVolume(100 * b.volume);b.playbackRate = clone(yt6.speed) }//(typeof yt6.ytp.vol_b == 'number') ? clone(yt6.ytp.vol_b) : 
				delete yt6.ytp.vol_b; if (!yt6.x) try { yt6.p.unMute(); yt6.ad_muted = false; yt6.pre_ad = false } catch(e) {}
			    }; if (!yt6.mobile) { bestfit() } else if (location.href.indexOf(yt6d.loaded_vid) > -1) { pl_item(true); if (typeof yt6.change != 'boolean') {  } }//mep_reload()

			  }, 200,5000)

			//if (!yt6.linx.length) { yt6d.mep_reload() }



		} catch(e){}
	      } else {
		  if ( ads && yt6.p && yt6.p.tagName == 'DIV' && typeof yt6.p.getPlayerState == 'function') {
		    var b = v_(yt6.p); if (b) {
		      yt6.ytp.vol_b = (b.volume > 0.1 && !(p && p.isMuted()) ) ? clone(b.volume) : 1
		      if (yt6.ads_off) {
			b.playbackRate = 16; yt6.pre_ad = '?'; if (yt6.mute_ad) try { p.mute(); yt6.ad_muted = true } catch(e){}
			var c = conf('args'), s = gc('ytp-ad-skip-button-container')[0] || gc('ytp-skip-ad')[0]
			b.volume = 0; if (yt6.pre_ad === true) b.currentTime = 9999//ev_log('skip3')
			if (!yt6.live && yt6.ads_noskip_m && yt6.ads_noskip > 3 && yt6.ads_noskip % 2 == 1) {
			  if (s) { yt6.ads_noskip_m = 0; yt6.ads_noskip = 0 } else { s = gid('prebtn'); if (s && yt6.ads_noskip < 5) s.click() }
			}
		    } };
		    if ( (yt6.x && !yt6.retry && yt6.player2 && yt6.player2.media && yt6.player2.media.loaded && ((yt6.ads_off && !yt6.x) || (yt6.x && yt6.ad_muted)) && gpst(yt6.p) > 1)
			 || (!yt6.x && yt6.live)
		       ) { yt6.p.playVideo() }
		    if (yt6.x && yt6.mobile && hid() && yt6.autoplay && yt6.limit >= yt6.retry && yt6.player1 && yt6.player1.media && !yt6.player1.media.currentTime) try { yt6.player1.media.play() } catch(e){}
		    var brake = function() {
		      if (yt6.pre_ad || typeof yt6.ytp.vol_b == 'number') { var p = (yt6.p && yt6.p.parentNode) ? yt6.p : player() //(yt6.mobile && ad_skipped == 3) ||	//ad_skipped == 3 || 
			if (p && typeof p.getPlayerState == 'function') { yt6.ad_skipped = 3
			  var b = v_(p); if (b) { b.volume = 1 || clone(yt6.ytp.vol_b); p.setVolume(100 * b.volume); b.playbackRate = clone(yt6.speed); delete yt6.ytp.vol_b };//if (typeof yt6.ytp.vol_b == 'number') 
			  $waitUntil(function(){ var brake = yt6.brake
			  if (yt6.pre_ad == false || location.href.indexOf(yt6.vid) == -1) return true }, function() { if (yt6.live) yt6.ads_noskip = 0
			    if (!yt6.live) { yt6.ads_noskip = 0; yt6.ad_skipped = 0 }; if (brake) { removeEL(p, "onStateChange", brake, false); delete yt6.brake }//
if (!mep) mep = gid(mep_x('mep_'))
			    //if (!yt6.ytp.fullscreen && !yt6.mobile) {
				      var a = ( !(yt6.mobile && ( (yt6.player1 && yt6.player1.isfullScreen) || (p1 && p1.style.width == '100%' && p1.style.height == '100%'))) && !(yt6.mobile && !ast && !yt6.fullscreen) ) ? ( (gid('a_width')) ? gid('a_width').value + 'px' : ((!yt6.fullscreen) ? yt6.w : screen.width + 'px') ) : mep.offsetWidth + 'px', b = ( !(yt6.mobile && ( (yt6.player1 && yt6.player1.isfullScreen) || (p1 && p1.style.width == '100%' && p1.style.height == '100%'))) && !(yt6.mobile && !ast && !yt6.fullscreen) ) ? ( (gid('a_height')) ? gid('a_height').value + 'px' : ((!yt6.fullscreen) ? yt6.h : screen.height + 'px') ) : mep.offsetHeight + 'px'
			      if (a != '0px' && b != '0px') resize_layers(a, b, false)
			    //}
			  ...
			  if (!yt6.x && (yt6.ads_off || yt6.pre_ad == false) && gpst(p) > 1) p.playVideo()
			}; yt6.pre_ad = false
		    ...
		    if (yt6.ads_off) {
		      //if (!yt6.brake) {
			yt6.brake = brake
		        if (yt6.pre_ad) { addEL(yt6.p, "onStateChange", brake, false) }// && (3 > ad_skipped || yt6.ads_noskip >= 3)
			yt6.pre_ad = '?'
		      //}
		    } else if (typeof yt6.brake == 'function') yt6.brake()

		  }
		}
	    } else if (yt6.ad_skipped === 0 && ad_skipped >= 3) {
		    if (typeof yt6.brake == 'function') yt6.brake()
		}
	  ...
	  strAds0 = ads0
	    ...
	    if (!yt6.navigation && !yt6.mobile_nav && (!yt6.linx.length) && yt6.reload != 10 && !(yt6.mobile && hid() && document.title.substring(0,10) == '- YouTube') && !(yt6.player1 && yt6.player1.media && yt6.player1.media.loaded && (location.href.indexOf(yt6.player1.media.loaded_vid) > -1 || (yt6.navigation && yt6.reload === 0)) )) { //ev_log('skip0_'+yt6.blocked_m) // || yt6.yt6_length == 1	 
		yt6.reload = 10; mep_reload()
	    }
	...
	ads = gid('player-ads'); if (ads) { ads.style.display = (yt6.ads_off) ? 'none' : '' };
	if (yt6.layout == 16 && !yt6.ytm) {
	  var z = ['ytd-promoted-sparkles-web-renderer','ytd-merch-shelf-renderer','ytd-ad-slot-renderer']
	  for(i=0;i<z.length;i++) {
	    ads = gt(z[i], 1)[0];
	    if (ads) { if (yt6.ads_off) { ads.setAttribute('hidden','') } else if (ads.hasAttribute('hidden')) ads.removeAttribute('hidden') }
	  }
	  if (yt6.flexy != 'grid') { ads = gid('panels'); if (ads) { ads.style.display = (yt6.ads_off) ? 'none' : '' } }

	};
	if (yt6.mobile) {
	  ads = gt('ytm-promoted-sparkles-web-renderer', 1)[0]; if (ads) { ads.style.display = (yt6.ads_off) ? 'none' : '' }
	  ads = gt('ytm-companion-slot', 1)[0]; if (ads) { ads.style.display = (yt6.ads_off) ? 'none' : '' }
	}
...
//if (yt6.browser_tab == 'hidden' && (typeof yt6.change == 'number' || yt6.change == false)) ev_log('CHA='+yt6.change+'/LOA='+yt6.loaded)
//if (yt6 != null) if (yt6.loaded >= 4 || ((yt6.blocked || yt6.change === 1) && yt6.loaded < 4)) {
if (yt6 != null)
if (yt6.loaded >= 4
     || (yt6.loaded < 4 && 
	 (yt6.blocked //|| (!yt6.blocked && !yt6.blocked_m && yt6.ytp && yt6.ytp.video_id && location.href.indexOf(yt6.ytp.video_id) == -1)
	))
     || (typeof yt6.change == 'number' && yt6.change % 4 == 3)
   ) {


	if (p) {

	  if (!yt6d.init && !yt6.x && yt6.player2)
	  try {
	  ...
	  if (typeof z == 'number') {
	    if (yt6.mobile && (z == 5)) { p.playVideo() } //stopped
	    var z = 'playerState_' + z
	  } else { var z = 'playerState_null' }
	...
	if (!yt6.navigation && yt6.pre_ad === true && yt6.ad_duration != 0 && yt6.ad_muted && !yt6.ad_unmute && gc('ytp-time-duration')[0] && yt6.loaded_media_duration && (1*yt6.loaded_media_duration.toString().toHHMMSS().split('.')[0].split(':').join('') - 1*gc('ytp-time-duration')[0][yt6.txt].split(':').join('') > 3)) {
	  if (yt6.flash.forced) {
	    yt6.ad_muted = false
	    yt6.pre_ad = false
	    yt6.ad_duration = 0
	...
	if (yt6.swapped == 1 && ((yt6.player1 && yt6.player1.media && !yt6.player1.media.paused) || (yt6.player2 && yt6.player2.media && !yt6.player2.media.paused)) ) try { yt6.Seek = 3; yt6.player1.pause(); yt6.Seek = 3; yt6.player2.pause(); yt6.Seek = 3 } catch(e){}
	...
	if (c[0]) {
	  ...
	  if (c[1] && location.href.split('list=')[1] && !c[1].list) {
	    ytplayer.config.args.list = location.href.split('list=')[1].split('&')[0].split('/')[0]; clear_pls(clone(ytplayer.config.args.list))
	  }
  ...
  var pn = (yt6.api && !yt6.document_fragment) ? yt6.api.parentNode.parentNode : pcont()
//ev_log('.')
if (p) {

  yt6.ytp.api = (yt6.layout == 16 && yt6.api && yt6.api.id == 'container') ? pn : yt6.api

  var z = p.getAttribute('class')
  if (typeof z == 'string') {
    var y = (!yt6.ytm) ? z.indexOf('ytp-fullscreen') : yt6.ytm.hasAttribute('player-fullscreened_')
    if (yt6.ytm) y = (y) ? 1 : -1
    if (y > -1 && !(p.tagName == 'DIV' && typeof p.isFullscreen == 'function' && !p.isFullscreen()) ) { //console.log('yt fullscreen on')
      yt6.ytp.fullscreen = true
	  if (yt6.api) {

	    yt6.ytp.marginTop = 0
	    if (yt6.layout == 16 && !yt6.mobile && !yt6.ytm) {
	      try { yt6.ytp.marginTop = (gt('YTD-PAGE-MANAGER', 1)[0].currentStyle || window.getComputedStyle(gt('YTD-PAGE-MANAGER', 1)[0], null)) } catch(e){}
	    }
	...
	if (yt6.ytm) { p1.style.left = '0px'; p1.style.top = '0px' }
      ...
      if (yta && yta.parentNode != wna) wna.insertBefore(yta, wna.firstChild)


      if (!yt6.x && yt6.ytp.fullscreen && yt6.ytp.api.parentNode.id == 'player-full-bleed-container')
      try {
	...
	if (yt6.ytp.fullscreen) {
	  yt6.ytp.fullscreen = false; yt6.s = {}
	  if (typeof yt6.pstyle == 'string') {
	    if (p) {
		var a = ['width','height']
		for (i=0;i<a.length;i++) { z = a[i]
		  if (p.style[z] && yt6.pstyle.split(z + ': ')[1] && yt6.pstyle.indexOf(z +': '+ p.style[z]) == -1)
		    yt6.pstyle = yt6.pstyle.split(z + ': ')[0] + z + ': ' + p.style[z] +';'+ yt6.pstyle.split(z +': ')[1].split(';')[1]
		}
		p.setAttribute('style', yt6.pstyle)
	    }
	    delete yt6.pstyle
	  }
	  aspect(yt6.size)
  ...
  } else if (yt6.size == 'default') { if (yt6.tbg.style.backgroundColor != 'transparent') yt6.tbg.style.backgroundColor = 'transparent'
    } else if (!ast && typeof yt6.w == 'string' && !isNaN(yt6.w.split('px')[0]) && typeof yt6.h == 'string' && !isNaN(yt6.h.split('px')[0])) { resize_layers(yt6.w, yt6.h) }
  ...
  if (yt6.mpb.hasAttribute('active')) { // Opera error handling
    ...
    if (mpb && p.getAttribute('class').indexOf('ytp-player-minimized') > -1 && yt6.p.parentNode == pcont()) {
      ...
      mpb.insertBefore(p, mpb.firstChild)
		...
		//var pn; if (yt6.mobile) { pn = document.activeElement; if (pn) { pn = pn.parentNode; if (pn) { pn = pn.parentNode; if (pn) { pn = pn.parentNode; if (pn) { pn = pn.parentNode }}}}}
//ev_log(document.activeElement.tagName +' '+ document.activeElement.id)
		if (!(yt6.body2 && yt6.layout == 12) && !shorts())
		if ( ( watch && ((yt6.flexy && !yt6.navigation) || (yt6.mobile && !(yt6d.hid && yt6.pre_ad) && (yt6.at || document.activeElement.tagName == 'BODY'))) ) ) if ( (!(yt6.fullscreen && !yt6.x) || (yt6.fullscreen && yt6.ytp.fullscreen && yt6.x)) && mep && (mep.style.width != '100%' || mep.style.height != '100%')) {

		  if (yt6.autoplay && yt6.pls) {
		     var z = gclass('playlist-items')[0]; // yt-scrollbar-dark style-scope ytd-playlist-panel-renderer
		     if (yt6.layout == 16 && z && z.nextSibling && z.nextSibling.tagName == 'IRON-LIST' && z.nextSibling.id == 'items') {
		       z = z.nextSibling
		     }
		     if (z) {
			  ...
			  //if (gc('index-message style-scope ytd-playlist-panel-renderer')[0] && gc('index-message-wrapper style-scope ytd-playlist-panel-renderer')[0] && !gc('index-message-wrapper style-scope ytd-playlist-panel-renderer')[0].hasAttribute('hidden')) fix_playlist();
			   ...
			   if (z.innerHTML.indexOf('/watch?v=' + yt6.vid) != -1) {// || z.innerHTML.indexOf('>â–¶</span>') !== -1) {
		  ...
		  var ww, x, y, pn = (yt6.mobile) ? yt6.api : ((yt6.api) ? yt6.api.parentNode.parentNode : pcont()) // && !(yt6.document_fragment || (gid('bm1') && gid('bm1').parentNode !== yt6.mhp))
		  if (yt6.api && yt6.size == 'default') if (!yt6.ytp.fullscreen) {
		    if (!(yt6.mpb && yt6.mpb.hasAttribute('active'))) {

		      var y = ((yt6.html5_fail && bm0 && Math.abs(bm0.offsetHeight - pn.offsetHeight) > 1) || (bm0 && Math.abs(bm0.offsetHeight - pn.offsetHeight) > 1)) ? clone(bm0.offsetHeight) : clone(pn.offsetHeight)
		      ...
		      var z = ((yt6.osw.style.top) ? '; top: ' + yt6.osw.style.top : '') + ((yt6.mobile) ? '; background-color: transparent' : '')
		      if (!(yt6.mobile && (!y || (yt6.s && yt6.s.z)) )) { yt6.osw.setAttribute('style', 'height: ' + y + 'px; left: ' + yt6.osw.style.left + z); } else yt6.age.check()
		    ...
		    if (yt6.pls && !yt6.mobile && (ww < 1000 || !(gt('ytd-watch-'+yt6.flexy, 1)[0] && gt('ytd-watch-'+yt6.flexy, 1)[0].hasAttribute('is-two-columns_'))) ) {
		      if (yta && yta.parentNode.parentNode != yt6.pls) yt6.pls.firstElementChild.insertBefore(yta, yt6.pls.firstElementChild.firstElementChild)
		    }

		    if (yt6.osw.w && (yt6.osw.offsetWidth && ((windowwidth + yt6.sb) < 1000) )) yt6.osw.style.width = (yt6.osw.w || yt6.osw.offsetWidth) + 'px'; //console.log(yt6.osw.style.height +' '+ pn.id +' '+ pn.offsetHeight +' '+ bm0.offsetHeight)
		    ...
		    if (yt6.w && ( !(yt6.wide && yt6.w == ww + 'px') || (yt6.wide && yt6.ytp.fullscreen && yt6.x) ) && !(yt6.mpb && yt6.mpb.hasAttribute('active') && yt6.w == p.parentNode.offsetWidth + 'px') && typeof yt6.w.replace == 'function') {
		      var z = (!yt6.mobile && !(yt6.mpb && yt6.mpb.hasAttribute('active'))) ? gid('player-container-inner') : pn
...
//console.log(yt6.inf.offsetWidth +' '+ yt6.w +' '+yt6.h +' '+yt6.w.replace('px','') / yt6.h.replace('px',''))
		      ...
		      var s = yt6.s
		      var x = (yt6.mobile && (yt6d.orientation === 0 || yt6d.orientation == 180)) ? (s.width / s.height) : 0;

		      if ( (yt6.mobile && x && Math.abs(s.height - yt6.h.replace('px','')) > 2 && !(x < 1 && (yt6.w.replace('px','') / yt6.h.replace('px','')) < 1) ) ||
			  ( (yt6.navigation && !hid()) ||
			  ((yt6.wide && 
			...
			if (yt6.size == 'default' && yt6.mpb && yt6.mpb.hasAttribute('active')) w = Math.min(pn.offsetWidth, 1 * yt6.w)

			if (yt6.fullscreen && (!yt6.player1 || (yt6.player1 && yt6.player1.isFullScreen)) ) {

			  yt6.w = screen.width + 'px'; yt6.h = screen.height + 'px'
			...
			if (!yt6.wide) {
			  if ( (!yt6.mobile && 1 * yt6.h.replace('px','') - 0 > Math.round(((wh - yt6.mhp.offsetHeight - 8) / 100 >>0) * 80) )  
			      || yt6.mobile
			     ) {
			    var z = (!yt6.mobile) ? z.offsetHeight : s.height
			    yt6.h = (z) ? z + 'px' : yt6.h
			  }
			...
			if (yt6.mobile) {
			  ...
			  var y = gt('ytm-playlist-panel-header', 1)[0]
			  var z = gt('ytm-playlist-controls', 1)[0]
			  var x = (y) ? y.getBoundingClientRect().bottom : 0; if (z) z.style.top = x + 'px'
			  x = (yt6.mhp) ? Math.abs(yt6.mhp.offsetHeight + 1*yt6.h.replace('px','')) : (x - 48)
			  if (y) { y.style.position = 'fixed'; y.style.width = '100%'; y.style.top = x + 'px' }
			}

		      } else {

			  if (yt6.inf && yt6.inf.offsetWidth != (2 * yt6.osw.style.left.replace('px','') + 1 * yt6.w.replace('px','')) )
			  if (yt6.aspect_ratio >= 1) {
			    if (yt6.aspect_ratio > 1 && yt6.osw.style.left != '0px') { yt6.osw.style.left = '0px' }
			  } else if (yt6.flexy != 'grid' && yt6.osw.style.left != (yt6.inf.offsetWidth - 1 * yt6.w.replace('px','')) / 2 + 'px') {
			...
			//if (yt6.mpb.tagName == 'YTD-MINIPLAYER' && yta.parentNode.parentNode.parentNode.getAttribute('class').indexOf('miniplayer') > -1) 
			var wna = yt6.wna2, ww = ww || parseInt(window.innerWidth || document.documentElement.clientWidth || yt6.body.clientWidth) - yt6.sb;
			if (yt6.pls && typeof yt6.pls.ww == 'number') ww = yt6.pls.ww
			//if (!yt6.pls && yta && yta.parentNode != wna) wna.insertBefore(yta, wna.firstChild)
			if (yta)
			if (yt6.flexy && (ww < 1000 || !(gt('ytd-watch-'+yt6.flexy, 1)[0] && gt('ytd-watch-'+yt6.flexy, 1)[0].hasAttribute('is-two-columns_'))) && yt6.pls && yt6.pls.firstElementChild) {
			  if (yta != yt6.pls.firstElementChild.firstElementChild) yt6.pls.firstElementChild.insertBefore(yta, yt6.pls.firstElementChild.firstElementChild)
			} else if (wna && wna.parentNode && yta != wna.firstChild) { wna.insertBefore(yta, wna.firstChild) }
...
//if (p) console.log('poffw: '+ p.offsetWidth + ', scrw: ' + screen.width + ', poffh: ' + p.offsetHeight + ', scrh: ' + screen.height + ', mepoffw: '+ mep.offsetWidth + ', mepoffh: ' +  mep.offsetHeight)
	...
	var autoscale,
	windowwidth = parseInt(window.innerWidth || document.documentElement.clientWidth || yt6.body.clientWidth) - yt6.sb,
	windowheight = parseInt(window.innerHeight || document.documentElement.clientHeight || yt6.body.clientHeight) - gmhp() - 8;
	if (yt6.layout == 12) autoscale = gid('placeholder-player')
	if (!autoscale) {
	  autoscale = gid('test_poster')//(gid('player-api')) ? gid('player-api').parentNode : null;
	  if (autoscale) { autoscale.width = windowwidth; autoscale.height = windowheight } else getScrollbarWidth()
	}


	if ( autoscale && gc('mejs-clear')[0] &&
	    (
	      (
		...
		&&
		(p && !(p.offsetWidth == screen.width && p.offsetHeight == screen.height))
		&& 
		(mep && !(mep.offsetWidth == screen.width && mep.offsetHeight == screen.height))
	    )
	   ) {


	    if (!yt6.skeleton)
	    if (autoscale.id == 'test_poster') {
	      autoscale.owdiff = Math.abs(autoscale.width - (yt6.ow || 0))
	      autoscale.ohdiff = Math.abs(autoscale.height - (yt6.oh || 0))
	      if ( (typeof yt6.w == 'string' && typeof yt6.h == 'string' && autoscale.owdiff > 1 || autoscale.ohdiff > 1)
		 ) {
		yt6.ow = (1 * autoscale.width); yt6.oh = (1 * autoscale.height)
		if (!yt6.ytp.embed) { if (yt6.w && yt6.h) resize_layers(yt6.w, yt6.h ) } else aspect(yt6.size)
	      }
	    } else {}//old
	    ...
	    if (yt6.fullscreen != true && mep != null && (
		   (!yt6.mobile && mep.offsetWidth != screen.width && mep.offsetHeight != screen.height && yt6.size != 'media')
		 || (!yt6.ytp.embed && mep.offsetWidth == windowwidth && mep.offsetHeight == windowheight )
	       )){ //console.log('p1 fullscreen on A')
		...
		if (webgl) {
	      ...
	      if (!yt6.x && yt6.wide && yt6.ytp.fullscreen) resize_layers(yt6.w, yt6.h)
	...
	if (yt6.p && typeof yt6.p.getLoopVideo == 'function') {
	  if (yt6.player1.options.loop1) {
	    if (!yt6.p.getLoopVideo()) yt6.p.setLoopVideo(true)
	  }
	}
      }
	...
	if ( bm0 && yt6.fullscreen == true && p1 && p1.style.width != '100%' && p1.style.height != '100%' && !yt6.fullscreen12 && !(yt6.mobile && yt6.player1 && yt6.player1.isFullScreen) ) { //console.log('p1 fullscreen off')

	  if (!(yt6.player1 && yt6.player1.isFullScreen)) {

	    yt6.fullscreen = false; yt6.s = {}
	    if (yt6.pstyle) {
		if (p && !yt6.x) p.setAttribute('style', yt6.pstyle)
		delete yt6.pstyle
	    }
	    if (!yt6.ytp.fullscreen) {
		  ...
		  if (yt6.mobile) { aspect(yt6.size) } else { resize_layers(bm0.style.width || yt6.w, bm0.style.height || yt6.h) }
		}
	    }
	    ...
	    if (p) {
	      ...
	      p.style.height = bm0.style.height
            ...
            if (yt6.x && bm0 && p1 && p1.style.width == '100%' && p1.style.height == '100%' && !yt6.fullscreen12 && !yt6.ytp.fullscreen && !(yt6.mobile && shorts()) ) { //console.log('p1 fullscreen on B')
	...
	if (yt6.mobile) {
	  ...
	  if (typeof screen.orientation.onchange != 'function' && window.matchMedia("(orientation: portrait)")) {
		...
		if (yt6d) {
		  if (yt6d.orientation === 0 || yt6d.orientation) { // portrait changes to landscape when values are 90, -90 or 270
		    yt6d.orientation = (screen.orientation.angle == 'number') ? clone(screen.orientation.angle) : ((typeof window.orientation == 'number') ? clone(window.orientation) : 90) //-90 (w.o) == 270 (s.o.a)
		  } else if (screen.orientation.angle === 0 || window.orientation === 0 || typeof yt6d.orientation != 'number') {
		      yt6d.orientation = 0
		    }
		}
		if (yt6) {
		  if (yt6.fullscreen) {
		    ...
		    if (yt6.md) { p1.style.top = ''; p1.style.left = ''; yt6.fullscreenMD = true }
		  } else {
		      if (document.activeElement.parentNode.parentNode.id != 'aspect') { resize_layers(screen.width +'px', screen.height +'px'); aspect(yt6.size) }
		      if (yt6.mobile && yt6.pls) { scrollToCurrentVideo(); set_controls(26) }
		    }
	  ...
	  if (!watch && location.href.indexOf('youtube.com/results?') > -1 && gpst(p) != 5) { p.stopVideo() } // stop ads during search
	...
	if (yt6.tbg) {
	  if (yt6.tbg.offsetWidth != yt6.tbg.width || yt6.tbg.wallpaper != yt6.wallpaper) {
	    yt6.tbg.width = clone(yt6.tbg.offsetWidth); yt6.tbg.wallpaper = clone(yt6.wallpaper)
	    //if (yt6.wide && typeof yt6.wallpaper != 'string') { yt6.tbg.setAttribute('hidden','') } else if (yt6.tbg.hasAttribute('hidden')) yt6.tbg.removeAttribute('hidden')
	  }
	  if (yt6.wallpaper) { yt6.cin = yt6.cin || gid('cinematics'); if (yt6.cin && yt6.cin.firstChild) yt6.cin.firstChild.style.aspectRatio = ''
	    if (yt6.wide && yt6.cin && yt6.cin.parentNode) {
	      if (yt6.cin.parentNOde != yt6.tbg) yt6.tbg.insertBefore(yt6.cin, yt6.tbg.firstChild)
	      if (typeof yt6.wallpaper != 'string' && yt6.cin.style.display == 'none') yt6.cin.style.display = ''
	    }
	  }
	}
	...
	if (!yt6.wide && !shorts()) {
	  var z = gt('ytd-player', 1)[0]
	  if (z) {
	    z.style.height = !(yt6.fullscreen || yt6.ytp.fullscreen) ? yt6.h : z.parentNode.parentNode.offsetHeight + 'px'
	    z.style.width = !(yt6.fullscreen || yt6.ytp.fullscreen) ? yt6.w : z.parentNode.parentNode.offsetWidth + 'px'
	  }
	}
...
if ((yt6.ytp.embed || yt6.layout == 16) && !yt6.ytm && p &&
  ...
  if (z.getCurrentTime() > 0 && gpst(z) == 0) {
	...
	if (yt6.pls && !yt6.navigation) {
	  ...
	  function() { var p = player(), p = yt6.p;
	    ...
	    if ((!yt6.shuffle) || yt6.layout == 12) {
	      if (yt6.pls) {
		try { yt6.pl_next.click() } catch(e) { mp.nextVideo('0') }
	      } else mp.nextVideo('0')
	    } else {
		if (p == mp) {
		  if (yt6.pre_ad) { mp.playVideoAt((1*yt6.pl_index)+1) || mp.nextVideo('0'); } else try { mp.seekTo(mp.getDuration()); mp.playVideo()} catch(e) { mp.nextVideo('0')}
		} else {
		    try {
	    ...
	    $waitUntil(function(){ var s = -1; if (!(yt6.ytm && player() && yt6.p.tagName == 'EMBED')) s = gpst(yt6.p); if (s != -1 && s != 1) return true }, function(){ if (!yt6.x) try { yt6.p.playVideo() } catch(e){} },1000,6000)
	  },250,1500)
	}
...
if ( ( !yt6.ytm && !yt6.flash.delay && (yt6.flash.forced || (p && p.tagName == 'EMBED' && p.getAttribute('class') == 'forced flashplayer')) )
  ...
  if (!yt6.navigation && ((!yt6.x && p && typeof p.getPlayerState == 'function' &&  ( (gpst(p) == 0 && p.getCurrentTime() >= p.getDuration()))  )) )
    if (autoplay()) {//(yt6.x && yt6.player1.media.paused && yt6.loaded_media_duration && yt6.ct >= yt6.loaded_media_duration - 1) || 
						  ...
						  if (z && z[0]) {
						    ...
						    var z = gid('playlist')
						    if (z && z.style.display != 'none') {
						      var z = gt('YTD-PLAYLIST-PANEL-SUPPORTED-ITEMS', 1)
						      if (!z[0]) z = gt('YTD-PLAYLIST-PANEL-VIDEO-RENDERER', 1)

						      if (z && z[0]) {
							var mix = (yt6.pls) ? yt6.pls.querySelectorAll('#playlist-action-menu') : null //gclass('flex style-scope ytd-playlist-panel-renderer x-scope ytd-menu-renderer-0')
							for(i=0;i<z.length;i++) if (z[i]) {
							  var zi = gt('A', z[i])[0]
							  if (zi && zi.getAttribute('href') != null) {
							    var x = vID(zi.getAttribute('href')).split('&')[0]
							    if (z[i].innerHTML.indexOf('/watch?v=' + yt6.vid) != -1 || ((mix && mix[0] && !mix[0].firstElementChild) || z[i].parentNode.hasAttribute('selected')) && c[1] && c[1].video_id == x ) { //(mix[0] && mix[0].hasAttribute('hidden')
								if (gid('bm0') && yt6.x) {
								  yt6.x = true
								} else {
								    yt6.x = false
								  }
								var y = zi.getAttribute('href').split('&index=')[1].split('&')[0].split('#')[0] - 0 + 1
								if (typeof y == 'number' || y == 'â–¶') break
							    }
							  }
							}
						        if (y) {
						          var next_blocked = null
...
if (yt6.flash.forced && p && p.tagName == 'EMBED') {
  ...
  if (u) for(var i in u.childNodes) {
	...
	//if (x.stopping > 0 && !(yt6.ytm && x.tagName == 'EMBED') && gpst(x) == 1) try { x.pauseVideo(); v_(x).pause() } catch(e) {}
	if (x.stopping > 0) {
	  if (p)
	  if (p.style.display != 'inline-block' || p.getAttribute('src') != yt6.flash.swfbin4) {
	  ...
	  if (!(yt6.ytm && x.tagName == 'EMBED') && gpst(x) == 1) try { x.pauseVideo(); v_(x).pause() } catch(e) {
	    if (x.firstChild) {
	      var y = v_(x)
...
if (yt6.layout == 16 && yt6.mpb && !yt6.ytm) {
	...
	bm0.style.overflow = 'visible'
	  ...
	  try {
	    ...
	    yt6.p.parentNode.appendChild(yta)
	  } catch(e){}
	}
	if (yt6.x) {
      ...
      if (yt6.size == 'default') {
	var z = (yt6.api) ? yt6.api.parentNode.parentNode : pcont() // && !yt6.document_fragment
	...
	if (bm0 && bm0.parentNode.getAttribute('class') && bm0.parentNode.getAttribute('class').indexOf('miniplayer') > -1) //bm0.parentNode.parentNode.tagName.indexOf('MINIPLAYER') > -1 || 
	  try {
	    ...
	    var wna = yt6.wna2 //(!(yt6.blocked && yt6.layout == 16)) ? yt6.wna : yt6.wna2
	    wna.insertBefore(yta, wna.firstChild)
...
if (yt6.flexy && yt6.pls) {
  ...
  if (parseInt(window.innerWidth || document.documentElement.clientWidth || yt6.body.clientWidth) - yt6.sb >= 1000 && !!(gt('ytd-watch-'+yt6.flexy, 1)[0] && gt('ytd-watch-'+yt6.flexy, 1)[0].hasAttribute('is-two-columns_'))) {
	...
	resize_layers(yt6.w, yt6.h)
	if (yta) wna.insertBefore(yta, wna.firstChild)
    }
  } else if (wna && wna.firstChild == yta) {
	if (yta) wna.insertBefore(yta, wna.firstChild)
	//yt6.pls.firstElementChild.insertBefore(yta, yt6.pls.firstElementChild.firstElementChild)
    }
}
  ...
  if (yt6.mobile && yt6.autoplay && hid() && yt6.pre_ad) { yt6.pls = null; if (yt6.ad_skipped) delete yt6.ad_skipped }

  if (yt6.spf == true) { yt6.spf = true } else { yt6.spf = false // if (!(yt6.mobile && yt6.autoplay && hid() && yt6.pre_ad))

		var c = conf('args'), _nav; cvid0 = null 
		if (p && typeof p.getVideoUrl == 'function') { cvid0 = vID(p.getVideoUrl()); if (typeof cvid0 == 'string') { cvid0 = cvid0.split('&')[0].split('#')[0] } else cvid0 = '' } else cvid0 = ''

		if (!cur_vid) cur_vid = clone(yt6.vid)
		if (prev_vid !== cur_vid && (prev_vid != yt6d.pprevid)) ppre_vid = prev_vid
		prev_vid = cur_vid


		_nav = (yt6.loaded_vid && location.href.indexOf(yt6.loaded_vid) == -1 && ( !(yt6.blocked_m && yt6d.current.video_id == yt6.loaded_vid) || !(yt6.blocked_m && yt6d.current.video_id == yt6d.previous.video_id) || yt6d.previous.video_id == yt6.loaded_vid || yt6d.pprevid == yt6.loaded_vid ) && cvid0 && cvid0.indexOf(yt6.loaded_vid) == -1) ? true : false
	...
	if ((yt6.layout == 16 && !yt6.mobile) || yt6.ytp.embed) {
		  ...
		  if (yt6.vid === '' && shorts()) yt6.vid = cur_vid
		  if (!yt6.ytm && prev_vid == cur_vid) {
		    //if (yt6d.previous.video_id && yt6d.previous.video_id != prev_vid) 
		      prev_vid = clone(yt6d.pprevid) || ppre_vid
		  }


	} else {

		cur_vid = clone(yt6.vid)


		  if (yt6d.previous.video_id) {//!yt6.ytm && 
		    if (prev_vid !== cur_vid && ppre_vid) prev_vid = ppre_vid
		  }

	  }
var navi0 = _nav,
	navi1 = ( ((yt6.mobile && video_id()[0] != prev_vid) || !watch || _nav  ) && yt6d.current.video_id != prev_vid),
	n2a = ( !(yt6.blocked_m && yt6d.current.video_id == yt6.loaded_vid) ) ? true : false,
	n2b = (!yt6.blocked_m && yt6d.current.video_id == yt6d.previous.video_id) ? true : false,
	n2c = (yt6d.previous.video_id == yt6.loaded_vid) ? true : false,
	n2d = (yt6d.pprevid == yt6.loaded_vid) ? true : false,
	n2e = (cvid0 && cvid0.indexOf(yt6.loaded_vid) == -1) ? true : false,
	navi2 = (yt6.mobile && yt6.loaded_vid && //!(hid() && yt6.loaded_vid == yt6.vid) &&
			     ( n2a || n2b || n2c || n2d
			     ) && n2e //|| (n2a && n2b && n2c && !navi0)) // in case ads f*ck up the update // && !(yt6d.current.video_id == yt6d.previous.video_id && yt6d.previous.video_id == yt6d.pprevid)
			   ),
	navi3 = ( ( _nav &&
			      (
				!(yt6.mobile && yt6.loaded_vid && location.href.indexOf(yt6.loaded_vid) > -1) &&
				 cur_vid != prev_vid
			      ) || !watch
			     ) && yt6d.current.video_id != prev_vid
			   )
;

		if (	( ((yt6.mobile && video_id()[0] != prev_vid) || !watch || _nav || (browserName != 'Firefox' && document.title.substring(0,10) == '- YouTube') ) && yt6d.current.video_id != prev_vid)
			|| (yt6.mobile && yt6.loaded_vid && 
			     ( n2a || n2b || n2c || n2d
			     ) && n2e // in case ads f*ck up the update
			   )
			|| ( ( _nav &&
			      (
				!(yt6.mobile && yt6.loaded_vid && location.href.indexOf(yt6.loaded_vid) > -1) &&
		    ...
		    if (yt6d.pprevid && (!yt6.mobile || (!(yt6.mobile && hid()) && yt6d.previous.video_id && yt6d.previous.video_id != prev_vid )) ) {
		      prev_vid = clone(yt6d.pprevid); if (yt6d.previous.video_id) yt6d.pprevid = clone(yt6d.previous.video_id)
		    } 

		  if (yt6.mobile) {
		    if (!yt6.navigation_delay && yt6.loaded_vid && (n2a || yt6d.current.video_id == yt6d.previous.video_id || n2c || n2e) && p && typeof p.getVideoUrl == 'function' && vID(p.getVideoUrl()).indexOf(yt6.loaded_vid) == -1) {
		      if (n2a && n2b && n2c && !n2e && n2f) { }//pbtn()
		      yt6d.previous.video_id = prev_vid //clone(yt6d.pprevid)
		      if (typeof yt6.title == 'string' && (cur_vid == prev_vid || (typeof yt6.change == 'number' && ((yt6.loaded >= 4 && yt6.change % 4 == 1) || (yt6.loaded < 4 && yt6.change % 4 == 3)) ) )) mod_title([n2a,n2b,n2c,n2d,n2e],1)//yt6.title = 'Â§@';
		      if (typeof yt6.navigation_delay == 'number') { yt6.navigation_delay++ } else yt6.navigation_delay = 1; //ev_log('delayed '+yt6.title)
		    } else if (yt6.navigation_delay % 3 == 0) { if (!hid()) scrollToCurrentVideo() }
		  } else {
		      if (yt6d.previous.video_id && yt6d.previous.video_id != prev_vid) yt6d.pprevid = clone(yt6d.previous.video_id) //if (yt6d.previous.video_id) yt6d.pprevid = clone(yt6d.previous.video_id)
		      if (prev_vid != yt6d.current.video_id) yt6d.previous.video_id = (!yt6.blocked && typeof prev_vid == 'string') ? prev_vid.substring(0,11) : clone(yt6d.pprevid);

		    }
		  yt6d.current.video_id = cur_vid

		} else _nav = false



		if (yt6.ytm && (document.title == 'YouTube Music' || document.title == location.href) && (c[1] && cur_vid == yt6.vid) ) {
		  var z = gc('content-info-wrapper style-scope ytmusic-player-bar')[0]
		  if (z) z = gt('yt-formatted-string', z)[0]
...
//sameTitles++; if (!sameTitles) yt6.title = clone(document.title) + sameTitles; yt6.sT = sameTitles } else//mod_title() if (yt6.sT !== sameTitles) { yt6.title = clone(document.title) }; 
    if ( (yt6.title != document.title && document.title != location.href && yt6.title != '- YouTube') || yt6.strLocation != window.location.href || !watch || (yt6.mobile && yt6d.previous.video_id == cur_vid && cur_vid != yt6.vid && yt6d.previous.title != document.title) ) {// || yt6.change != yt6.title )document.title = clone(yt6.title); 

      if (c[0] && !(yt6.mpb && yt6.mpb.hasAttribute('active')) ) {

		if (!c[0]) { gc('clear')[0].setAttribute('id','ytp-conf-null'); };

		if (location.href == protocol() + '//music.youtube.com/') yt6d.previous.video_id = cur_vid // only to avoid unnecessary video reload upon switching back from miniplayer to normal

	var YT = yt6.title.split(' ').join(''), DT = document.title.split(' ').join('')

	//check title of document first
	if ( (yt6.title
		&& (
		( YT != DT || yt6.strLocation != window.location.href)
		&& document.title != 'YouTube' && location.href != protocol() + '//music.youtube.com/'
		&& (!(yt6.mobile && yt6.navigation && hid() && (document.title == '- YouTube' || (YT.substring(0, YT.length-1) == DT.substring(0, DT.length-1) ))  ) || (yt6.mobile && yt6.mobile_nav) )
		&& !(yt6.ytm && yt6d.previous.video_id == cur_vid)
	     ) || (!yt6.ytm && !yt6.blocked && yt6.strLocation == window.location.href && location.href.indexOf(yt6d.current.video_id) > -1 && yt6d.current.video_id != yt6.loaded_vid)
	     ) || yt6.ytp.embed) {


//ev_log('*'+ (yt6.title.split(' ').join('') != document.title.split(' ').join('')) +' '+ (yt6.strLocation != window.location.href) +' '+yt6.change)
	  if (yt6.md && !yt6.blocked_m  && !hid() && location.href.indexOf(yt6.loaded_vid) == -1 && !isNaN(yt6.change % 4)) { var _nav = true }
	  ...
	  if (yt6.mobile) {
	    if (!c[1].video_id) c[1].video_id = cur_vid
	    z = cur_vid
	  } else {
	      var z = gt('ytd-watch-'+yt6.flexy, 1)[0] || gt('ytd-watch', 1)[0]
	      if (z && z.video_id != yt6.vid) { z = z.getAttribute('video-id'); delete c[1].video_id }; if (typeof z != 'string') z = cur_vid //prev_vid//= undefined
	    }
	  ...
	  if (c[1] && !c[1].video_id && yt6d.current.video_id) { // == undefined
		...
		if ((yt6.blocked_m && yt6.blocked !== 0) || yt6.x_) { document.title = clone(document.title); yt6.loaded_vid = clone(yt6.vid) }//for delayed age-unblocking
	    }
	  ...
	  if (c[1] && c[1].video_id &&
		...
		( (c[1].video_id.substring(0,11) != yt6.vid || (!yt6.mobile && !yt6.ytp.embed && cur_vid != prev_vid) || yt6.blocked_m || _nav )
		  ...
		  && (typeof yt6.change != 'number' || yt6.ytp.embed)
		) || yt6.blocked || yt6.ytm || yt6.nav2
		  || (typeof yt6.change == 'number' && ((yt6.loaded >= 4 && yt6.change % 4 == 1) || (yt6.loaded < 4 && yt6.change % 4 == 3)) )
	      )
	     ) {
	    ...
	    if (!(yt6.md && hid()) && _nav && !yt6.blocked_m && location.href.indexOf(yt6.loaded_vid) == -1) { yt6.navigation = true }


	    if (yt6.ytm && yt6.ytp.fullscreen) {
	      if (typeof yt6.ad_ == 'number' && Math.abs(yt6.ad_ - yt6.real_media_duration) > 1) {
	    ...
	    if (yt6.nav2) delete yt6.nav2 //remove broken nav loophole
	    if (yt6.mobile) {
	      if (!yt6.ad_unskippable && yt6.mobile_nav) if (typeof yt6.change != 'string' || (typeof yt6.title == 'string' && yt6.title.indexOf(yt6.change) != 0)) {
		if (yt6.pre_ad || yt6.ad_skipped >= 1) {
		  var z = gc('mejs-overlay-error')
		  if (z[0]) {
		    z[0][yt6.txt] = 'Ad hogging the sources';
		    z[0].parentNode.style.setProperty('display','block','')
		  }
		}
		yt6.change = video_title()[0]
	      } else if (ad_skipped > 0 && typeof yt6.ad_skipped == 'number' && YT.substring(0, YT.length-1) == DT.substring(0, DT.length-1)) { yt6.mobile_nav = 0 }

	      if (yt6.mobile_nav && watch) yt6.mobile_nav = false
	    }


	    if (((yt6.blocked || yt6.blocked_m
		   || (yt6.mobile && !yt6.navigation && !(yt6.mobile_nav && (ad_skipped || yt6.pre_ad)) && yt6.mobile_nav !== 0)
		   || !(yt6.player1 && yt6.player1.media && yt6.player1.media.loaded_vid && yt6.player1.media.loaded_vid.substring(0,11) == c[1].video_id.substring(0,11) && yt6.loaded_vid == yt6.player1.media.loaded_vid)  // condition to avoid a second reload caused occasionally by the slowness of the setTimeout approach
		 ) && watch
		   && document.title != yt6.title
		   && (!(yt6.ytm && (typeof yt6.ad_ == 'number' && Math.abs(yt6.ad_ - yt6.real_media_duration) > 1) && yt6.loaded_vid == yt6.vid) || yt6.blocked)
		) || (yt6.ytp.embed && document.title != yt6.title)
	       ) {

		if (yt6.mobile) {
		  if (_nav && cvid0 && hid() && cur_vid != cvid0) { yt6.vid = cvid0; cur_vid = cvid0; ppre_vid = prev_vid }//&& !yt6.blocked_m
		  if (hid()) if (ppre_vid && cur_vid != prev_vid && ppre_vid != yt6d.pprevid && ppre_vid != cur_vid) { yt6d.pprevid = clone(yt6d.previous.video_id); yt6d.previous.video_id = ppre_vid }
		}

		yt6.navigation = true; yt6.live = false
		yt6.navigation_delay = 0
		yt6.ads_noskip_m = 0
		...
		if (yt6.xhr.t) delete yt6.xhr.t
		yt6d.previous.loaded_vid = clone(yt6.loaded_vid)
		yt6d.previous.duration = clone(yt6.real_media_duration)

		if (yt6.mobile && hid()) {
		  if (!yt6.blocked_m && _nav && cvid0 && cur_vid != cvid0) { yt6.vid = cvid0; prev_vid = ppre_vid }
		  //if (browserName != 'Firefox' && yt6.x && yt6.speed < 2 && yt6.player1 && typeof yt6.player1.getCurrentTime == 'function') { yt6.speed_bak = clone(yt6.speed); yt6.speed = 2 }
		}
		yt6d.current.video_id = clone(yt6.vid);
		yt6d.previous.video_id = cur_vid
		yt6d.pprevid = prev_vid

		//ev_log('NAV '+hid()+':'+ad_skipped+'\n'+yt6.title.substring(0,10) +'\n'+document.title.substring(0,10)+'~'+yt6.title.substring(yt6.title.length-1, yt6.title.length)+'\n'+     ((n2a)?'A+':'A-')+((n2b)?'B+':'B-')+((n2c)?'C+':'C-')+((n2d)?'D+':'D-')+((n2e)?'E+':'E-')+((yt6.loaded_vid == yt6.vid)?'F+':'F-') )  //yt6.player1.media.loaded_itag +' '+ document.title.substring(0,10) +' '+yt6.title)//+' navi0='+navi0+'/'+_nav +' navi1='+navi1 +' navi2='+navi2+' navi3='+navi3)// +'\nyv='+ yt6.vid+'/cv='+cur_vid+'/pv='+prev_vid+'/pvi='+yt6d.previous.video_id+'/ppvi='+yt6d.pprevid+'/cvi='+yt6d.current.video_id+';;')

		if (yt6.loaded_vid != yt6.vid) yt6.loaded_vid = '...........'
		...
		yt6.strLocation = window.location.href;
		yt6.strHash = window.location.hash;
		yt6.pl_next_btn = null; yt6.pl_prev_btn = null //these would trigger a full page reload after the location change
		...
		// if subtitles are selected, prefer the chosen language from now on till they're turned off
		if (yt6.player1 && yt6.player1.options && Array.isArray(yt6.player1.options.startLanguage) && yt6.player1.options.startLanguage[0]) yt6.player1.options.startLanguage[2] = true
		...
		if (yt6.blocked && video_id(true)[0] != prev_vid){
		  ...
		  //xhr2.done = false;
		  if (!yt6.age.dl && !yt6.age.sc) {
		    if (yt6.player1) { try { if (yt6.V_[itag(yt6.player1.media.src)]) clear_mep(yt6.player1) } catch(e) { } }
		    if (yt6.player2) { try { if (yt6.V_[itag(yt6.player2.media.src)]) clear_mep(yt6.player2) } catch(e) { } }
		  }
		    yt6.reload = 15
		    ...
		    if (bm0 && ((c[1] && typeof c[1].video_id == 'string') || yt6.ytm || yt6.ytp.embed)) {
		        //ev_log('04 - Regular page change 16 ' +'//'+ c[1].video_id)//+strPrevLocation
			...
			if (c[1] && (c[1].video_id.substring(11) || yt6.ytm && document.title == 'YouTube Music') || yt6.ytp.embed) {
			  ...
			  if (yt6.ytm && c[1].video_id.substring(11) == 'ytm' ) {//== yt6.vid
			    ...
			    //Encrypted videos on Music subdomain may need a second data refresh. Check if a previously watched links have been picked up again. (method not 100% tho)
			    if (yt6.ytm && video_title()[1] && strPrevLocation == location.href && (yt6.prev_media.includes(yt6.audio) || yt6.ytm)) { yt6.reload = 11
		...
		if (yt6.mobile && (yt6.blocked_m) && (yt6.navigation || yt6.mobile_nav)) { ytplayer.config.args.video_id = undefined; var z = gid('prebtn'); if (z) z.click() }
		if (yt6.mobile && yt6.mobile_nav === 0 && typeof yt6.change == 'string') { cd(1); yt6.mobile_nav = 1 } else
		...
		if (p && p.tagName == 'EMBED' && yt6.original && yt6.original.parentNode && yt6.original.parentNode.getAttribute('id') == 'movie_player_to_dispose' && typeof yt6.original.getPlayerState != 'function' ) { gid('movie_player_to_dispose').appendChild(yt6.original.cloneNode(false)); gid('movie_player_to_dispose').appendChild(p.cloneNode(false)); yt6.ytp.broken = true }
		  ...
		  if (watch && !(yt6.mpb && yt6.mpb.hasAttribute('active')))
		    //ev_log('//cd(4)')
		  if ((typeof yt6.loaded_vid == 'string' && (c[1] && yt6.loaded_vid.indexOf(c[1].video_id) == -1) || location.href.indexOf(yt6.loaded_vid) == -1) ) { //ev_log('NAV22')
		    if (yt6.layout == 16 && !yt6.blocked && !yt6.blocked_m && !yt6.ytm) {
		      if (!yt6d.hid) yt6.nav2 = true; //ev_log('NAV23')
		    }
		  }
	      ...
	      if (yt6.mobile) { if (yt6.blocked_m) yt6.loaded_vid = clone(yt6.vid) }
	      if (typeof yt6.loaded_vid == 'string' && (c[1] && typeof c[1].video_id == 'string' && yt6.loaded_vid.indexOf(c[1].video_id.substring(0,11)) == -1)) { //ev_log('05 - args '+yt6.loaded_vid +' '+c[1].video_id)
		yt6d.current.video_id = video_id()[0]; c[1].video_id = clone(yt6.vid); yt6.vid = clone(yt6d.previous.video_id); mod_title([n2a,n2b,n2c,n2d,n2e],2); setTimeout(function(){ mep_reload() }, 500)
	      } else if ( !(yt6.mpb && yt6.mpb.hasAttribute('hidden')) )
		if (location.href.indexOf(yt6.loaded_vid) == -1)
		  if ( !(cvid0 && location.href.indexOf(cvid0) == -1) || yt6.blocked_m) {
		    //ev_log(yt6.navigation +'?')
		    if ((!yt6.navigation && !yt6.mobile) || yt6.mobile_nav) { cd(2) } else { mep_reload() }
		  } else {
		      //ev_log('hmmm '+ad_skipped +'/'+ yt6.ad_skipped +'/'+yt6.ads_noskip_m)
		      if (typeof yt6.change == 'number') { yt6.change++ } else
		      if (yt6.mobile) cd(1)// && hid()
		    }
		...
		if (window.ytplayer.config == null) { gc('clear')[0].setAttribute('id','ytp-conf-null'); };
	      ...
	      if (yt6.mobile) {
		if (yt6.autoplay)
		if (!yt6d.init && (!yt6.navigation || yt6.navigation) && location.href.indexOf('list=') > -1 && 
		     (!yt6.pls || (c[1] && typeof (c[1] && c[1].list) == 'string' && !(c[1] && c[1].list).split('"')[1])) && (yt6.ads_noskip_m == 2 || yt6.ads_noskip_m == 3)) {
		  //ev_log('CL-A:_'+ yt6.navigation +'_'+ ((c[1] && c[1].list) ? c[1].list.split('"')[1] :'') )
		  if (watch && gid('prebtn')) { gid('prebtn').click(); yt6.ads_noskip_m = 0 }
		} else {
		    if (yt6.ads_noskip_m == 3) delete yt6.ads_noskip_m
		    //ev_log('CL-B:_'+ yt6.navigation +'_'+ ((c[1].list.split('"')[1]) ? '1':'0') )
		  }
	      }
	    }
...
//watch title
	    ...
	    if (document.title != 'YouTube') cd(3)
	  }



    } else if (!(yt6.layout == 12 && !video_title()[1])) { //console.log('miniplayer mode')
	if (!window.ytplayer) window.ytplayer = {}
	...
	if (!window.ytplayer.config.args && yt6.args != window.ytplayer.config.args) {//console.log('when does this occur?')
	    ...
	    autoplay(true); set_controls(27)
	}
      }
    } else {//first stage of location change check
      }


 	if (yt6.mobile) {
	if ((ad_skipped === yt6.ad_skipped) || 1 >= ad_skipped) {
	  if (typeof yt6.ad_skipped == 'number') {
	    if (yt6.ad_skipped > 1) {
	      if (!yt6.x && yt6.ads_noskip == 3) restore_cp()// && !hid()
	      yt6.ad_skipped = 1
	    } else if (yt6.ad_skipped == 1) {
		if (ad_skipped > 1) { pl_item(true) } else if (ad_skipped === 1) yt6.ad_skipped = 0
	      } else if (yt6.ad_skipped === 0 && ad_skipped) {

		    restore_cp(yt6.pls); if (ad_skipped) ad_skipped = 0

		  if (!yt6.navigation && //ad_skipped > 1 && 
			yt6.mobile_nav) yt6.mobile_nav = false

		  if (!p || (p && p.tagName == 'DIV' && typeof p.getDuration == 'function' && Math.abs(p.getDuration() - yt6.real_media_duration) < 1.5) ) {
		    if (ad_skipped) { yt6.ads_noskip = 0; ad_skipped = 0 }
		  }
	...
	if ( !ad_skipped || (!ad_skipped && yt6.ad_skipped == 1) || yt6.ad_skipped > 1) {
	  if (ad_skipped != yt6.ad_skipped) restore_cp(); ad_skipped = clone(yt6.ad_skipped)//!hid() && 
	}
	  ...
	  var c = conf('args')
	  if ((document.title != '- YouTube' || (document.title == '- Youtube' && sameTitles)) && (document.title != 'YouTube' || (c[1] && c[1].title && yt6.title != unescape(decodeURIComponent(c[1].title.split('+').join(' '))))  )) {
	    var mobt = (yt6.mobile && hid() && yt6.x && (yt6.ct || yt6.sT) && yt6.title.indexOf(document.title) == 0 && 1 >= Math.abs(yt6.title.length - document.title.length)) ? true : false// || sameTitles
	    if (( typeof yt6.title == 'undefined'
		 || ( !mobt &&
		( (yt6.title && yt6.title != document.title && !(yt6.ytm && document.title == 'YouTube Music' && document.title.indexOf('music.youtube.com/') > -1))
		    ||
		  (!(yt6.ytm && location.href.indexOf('https://music.youtube.com/watch') == -1) && yt6.strLocation != window.location.href)
		)
		 
	       ) ) && !(mobt && sameTitles > 3) ) {
	      //ev_log('yt6.title: ' + yt6.title + ' --> ' + document.title)
	      ...
	      yt6.strLocation = window.location.href;
	      if (yt6.ytm) {
		if (yt6d.current.video_id != cur_vid) { //console.log('previous: '+yt6d.previous.video_id + ' current: '+yt6.vid)
		    if (yt6d.previous.video_id) yt6d.pprevid = clone(yt6d.previous.video_id)
		    yt6d.previous.video_id = (!yt6.blocked && typeof cur_vid == 'string') ? cur_vid.substring(0,11) : yt6d.pprevid; //if (yt6d.current.lsig) 
		}
	      }
	      if (yt6.layout == 16 && ((!yt6.ytm && yt6d.previous.video_id != cur_vid && cur_vid != yt6.vid && yt6d.previous.title == document.title) || mobt) ) {
		sameTitles = sameTitles + 1
	      }; //ev_log('sT='+sameTitles)
	      if (typeof document.title == 'string' && document.title +'4' == yt6d.previous.title) { if (yt6.ytm) { mep_reload() } }
	    } else {
		if (yt6d.previous.title == document.title) {
		  sameTitles++
		  if (sameTitles > 3) { //ev_log('the previous and the current video have identical titles')
		    yt6d.previous.video_id = cur_vid
		    yt6.title = yt6.title + sameTitles
		    sameTitles = 0
		  }
		  //if (yt6.mobile) { restore_cp(yt6.pls) }//; mod_title([n2a,n2b,n2c,n2d,n2e],3)
		} else {
		    if (yt6.mobile) {
		      if (!yt6.blocked_m && !yt6d.init && yt6.vid == yt6.loaded_vid && !ad_skipped && !yt6.ad_skipped && !yt6.ads_noskip && !yt6.ads_noskip_m) {//( hid()) && yt6.mobile_nav ||
			if (watch) if (typeof yt6.change != 'boolean') {
			  if (typeof yt6.change == 'number') {
			    //ev_log('!')
			  } else cd(1)
			} //else if (yt6.change == true && yt6.reload !== 0 && !yt6.blocked_m && hid() && yt6.title) { yt6.change = yt6.title; yt6.title = '`' + yt6.title }
		      } else if (yt6.sT != sameTitles) sameTitles = 0
		      if (yt6.blocked_m && yt6.reload !== 0 && yt6.ads_noskip < 4 
			    && !(yt6.player1 && yt6.player1.media && yt6.player1.media.loaded && ( (yt6.navigation && yt6.reload === 10)) )//location.href.indexOf(yt6.player1.media.loaded_vid) > -1 ||
			 ) { yt6.reload = 0; if (!yt6.navigation && location.href.indexOf(yt6d.current.video_id) > -1 && yt6d.current.video_id != yt6.player1.media.loaded_vid) { yt6.ads_noskip++ }
			     mep_reload() }//yt6.mobile_nav = false;  && yt6.reload != 10
		    } else sameTitles = 0;
		    if (yt6.ytm) yt6.change = clone(yt6.vid)
		  }
	      }
	  }
...
} else { //ev_log('!$ '+yt6.change +' '+ location.href.indexOf(yt6.loaded_vid))
	try {
	  if ( !(yt6.blocked === 0 && yt6.blocked_m) && (typeof yt6.change == 'number' && yt6.change % 4 == 1 && (yt6.loaded_vid && location.href.indexOf(yt6.loaded_vid) == -1)) ) {//yt6.change === true || 
	    if ( !(yt6.loaded >= 4 && ad_skipped && yt6.ad_skipped)) {
		yt6.loaded = 4; mod_title([n2a,n2b,n2c,n2d,n2e],4); yt6.change = false; //yt6.navigation = false; yt6.nav2 = true; //yt6.loaded_vid = ''; //!yt6.blocked_m &&  //yt6.change === true && 
		//ev_log('broken nav')
		//if (hid()) if (gid('prebtn')) { gid('prebtn').click() }
		try {
		  if (yt6.pl_next_btn) { yt6.pl_next_btn.click() } else
		    if (yt6.pl_next && !yt6.pl_next_blocked) { yt6.pl_next.click() }
		} catch(e) { //ev_log(e)
		    if (yt6.vid != cvid0 || location.href.indexOf(yt6.loaded_vid) == -1) try { //ev_log('broke '+yt6.loaded)
		      window.history.pushState({}, yt6.title, location.href.split(yt6.vid)[0] + cvid0 + location.href.split(yt6.vid)[1] )
		      yt6.vid = cvid0; yt6d.current.video_id = cvid0
		    } catch(e){}
		  }
	    }
	  } else { if (!yt6d.init) cd(2)
	      if (yt6.pls && yt6.pl23) { pl_item() }
	    }//cd(0)
	} catch(e){}
	if (gc('alerts-wrapper')[0]) gc('alerts-wrapper')[0].removeAttribute('id')
  };//player script present
  ...
  yt6d.proxy.document_title = (typeof Proxy == 'function') ? window.document.title : clone(window.document.title)
	...
	if (yt6.mobile) try { navigation.oncurrententrychange = null } catch(e) {}
      },
      intIntervalTime
      )//fnCheckLocation
  ...
  if (!gid('jquery.js')) {
    loadScript( yt6.cdn + "3c7a377bfc6698037e51c88cee0ffc210c24cd3b/jquery.js", jq0);
  }
...
function restore_cp(scroll) {
  if (typeof scroll == 'object' && scroll && scroll.parentNode) scrollToCurrentVideo()
  var yta = gid(yt_alert_message)
  if (!(yt6.wna && yt6.wna.parentNode && yta && (yta.parentNode == yt6.wna || yta.parentNode.parentNode == yt6.pls))) { set_controls(28); return true }
}
...
function ytsubtitle2srt( d, track_srclang, mejs_language_code, translated) {
  ...
  var z = gid('subtitles_header'); if (z) z.innerHTML = '<br>SubRip/WebVTT subtitles:'
...
function resize_layers(w,h,me_aspect){ //console.log('resize '+w+' x '+h)
  ...
  if (yt6.size == 'default' && yt6.mpb && yt6.mpb.hasAttribute('active')) {
    if (bm0 && bm0.offsetHeight) {
      windowheight = Math.min(pn.offsetHeight, bm0.offsetHeight)
	} else windowheight = pn.offsetHeight
  }
  ...
  if (gid(yt_alert_message) && gid('aspect')) {
	...
	var x = (yt6.mobile) ? -1 * d + 25 : ((ww0 < 1000) ? 25 : 0)
	...
	if (!yt6.mobile && !(yt6.flexy && yt6.size != 'default' && ww0 < 1000)) {
	  x = parseFloat(c - d - e - 1)
	  if (x < 0 || yt6.ytm) x = 0
	  var pos = 'relative; left: ' + x + 'px;'
	} else {
	    if ( !(windowwidth < (gid(yt_alert_message).firstChild.firstChild.offsetWidth + e - 25)) || yt6.mobile) {
	      x = ( !(windowwidth < (gid(yt_alert_message).firstChild.firstChild.offsetWidth + e - 25)) && yt6.mobile) ? x - 5 : (x + 8)
...
if (yt6.size != yt6.prev_size) {
  ...
  //var noads = gid('player').innerHTML;onDownload(noads)
    ...
    var sp = (!shorts()) ? null : ((!yt6.mobile) ? gt('ytd-reel-video-renderer', 1)[0] : yt6.osw.parentNode.parentNode.parentNode )
...
function nop(){//    } else {
  ...
  if (z.parentNode.getAttribute('id') == 'placeholder-player' || yt6.ytp.embed) {
    ...
    var a_ = z; if (a_) var a = a_.cloneNode(false)//b.firstChild
      ...
      if (!yt6.ytm) { yt6.inf.style.setProperty('marginTop','',''); yt6.inf.removeAttribute('style') }
    }
  var c = gid('aspect') || (yt6.size !== 'default')
...
if (f != null) {
  ...
  if (yt6.api && yt6.api.parentNode) yt6.api.parentNode.style.width = '' // needed when changing from media size to theater size
  ...
  if (yt6.flexy) {
    ...
    var ptc = gid('full-bleed-container')
  ...
  if (bm0) bm0.style.backgroundColor = (yt6.cin) ? 'transparent' : 'rgb(16, 16, 16)'
  if (mep) mep.style.backgroundColor = (yt6.wallpaper) ? 'transparent' : ''
  api.width = w
  api.height = h
  if (!yt6.x) {
  ...
  var flashvars = player().getAttribute('flashvars')
  var chat = gt('ytd-live-chat-frame', 1)[0] || gid('chat')
...
if (!yt6.fullscreen || yt6.fullscreen == false || (ytp_class && ytp_class.indexOf('ytp-fullscreen') == -1)) {//scaling
  ...
  if (a.style != null) {
    ...
    //if (yt6.osw && yt6.flexy && !c && yt6.osw.offsetWidth >= w) yt6.osw.w = (ww0 < 1000) ? '' : w + 'px'
    a.style.height = h + 'px'
	...
	l = yt6.con
	inf = gt('ytd-watch-metadata', 1)[0]
	if (inf) inf.style.marginTop = ''
    }

    var sct = 0, pm = yt6.pm || gt('ytd-page-manager', 1)[0]; if (pm) sct = clone(pm.scrollTop)
    // wiping yt6.wsb.style will zero out pm.scrollTop value as well? need to restore
...
if (a.getAttribute('id') != 'player' || yt6.ytp.embed) {//console.log('pre-2016 layout')
    ...
    yt6.cin = gid('cinematics'); if (yt6.cin && yt6.cin.firstChild) yt6.cin.firstChild.style.aspectRatio = ''
	...
	z.style.top = ''
        e.width = windowwidth + 'px'
	a.style.backgroundColor = (yt6.wallpaper || yt6.cin || (p && p.tagName == 'EMBED')) ? 'transparent' : 'rgb(16, 16, 16)'

        if (l.offsetWidth < ww0) {
          a.style.left = api.left = -1 * w / 2 + 'px'
              if (w < windowwidth) {
	  ...
	  if (ww0 < 1000 && yt6.wsb) yt6.wsb.style.top = ''
...
if (ww0 < 1000 || !(gt('ytd-watch-'+yt6.flexy, 1)[0] && gt('ytd-watch-'+yt6.flexy, 1)[0].hasAttribute('is-two-columns_'))) {
	...
	if (yt6.cin && yt6.tbg && yt6.cin.parentNode != yt6.tbg) yt6.tbg.appendChild(yt6.cin)
	...
	if (c) {
	   ...
	   if (w < windowwidth) { //console.log('not wider than window  s-19')
		...
		if ( parseFloat(1 * e.marginLeft.replace('px','')) + l.offsetWidth - w > 0 ) {
		  ...
		  if (((ww0 >= 657) && (l.offsetWidth > windowwidth + yt6.sb)) ) {
			...
			if (Math.ceil(l.offsetWidth/854) == 1) {
			  ...
			  if (playlist) {
			    playlist.style.marginTop = -1 * (yh + MC) + 'px'
			      ...
			      if (yt6.wsb) yt6.wsb.style.top = (ww0 < 1000) ? '' : -1 * (yh + MC) + 'px'
			      //l.style.marginTop = ''; l.removeAttribute('style')
			    }
		}
		...
		if (l.offsetWidth < w) { //console.log('wider than base')
		  ...
		  //} else {
			...
			//} else {
			    ...
			    if (l.offsetWidth >= 1066 || windowwidth == l.offsetWidth) {
			      if (ww0 >= 1000) { var x = MC } else var x = 0
		    ...
		    if (((ww0 >= 657) && (b.offsetWidth > windowwidth)) ) {
...
if (yt6.flexy) {
  if (ww0 < 1000 || !(gt('ytd-watch-'+yt6.flexy, 1)[0] && gt('ytd-watch-'+yt6.flexy, 1)[0].hasAttribute('is-two-columns_'))) {
	...
	//yt6.inf.style.marginTop = '293px'
		...
		if (chat) if (yt6.wsb) yt6.wsb.style.top = (ww0 < 1000) ? '' : h + yh + MC + 'px'
	    ...
	    if (ww0 < 657) {
	      if (playlist) {
		yt6.inf.style.marginTop = (!yt6.flexy) ? h - 53 + 'px' : '48px'
		...
		if (l.offsetWidth >= 1066) {
		  ...
		  if (yt6.wsb) yt6.wsb.style.top = ''
			...
			yt6.inf.style.marginTop = (!yt6.flexy) ? '322px' : ''
	...
	if (ww0 < 657) {
	  if (playlist) {
	    ...
	    if (!yt6.flexy) yt6.inf.style.marginTop = '322px'
	  }
	  if (yt6.wsb) yt6.wsb.style.top = ''
	  if (!yt6.wide) {
	  ...
	  if (l.offsetWidth == 426) {
	    ...
	    z.style.top = '0px'
	    if (!c || yt6.wallpaper || yt6.cin || (p && p.tagName == 'EMBED')) {
		...
		if (!(w < windowwidth)) a.style.left = '-25px'
		  ...
		  z.style.top = '0px'
		    ...
		    if (MC == 3 && !playlist) { yt6.inf.style.marginTop = '' }
  ...
  if (yt6.flexy) {
	...
	if (!yt6.wide && yt6.top.getAttribute('id') == 'columns') {
	  var l = gc('style-scope ytd-watch-'+yt6.flexy)
	...
	if (c) {
	  ...
	  if (playlist) {
		...
		if (yt6.wide) {
		  if (ww0 > 881 && ww0 < 1000) playlist.style.marginTop = '16px'
	  ...
	  if (yt6.wide) {
	    ...
	    if (yt6.x && w >= windowwidth) a.style.left = '0px'
	      ...
	      if (w >= windowwidth ) yt6.osw.style.left = x + ((w - windowwidth) / 2) + 'px'
	    ...
	    if (playlist) {
	      if (ww0 >= 1000) { playlist.removeAttribute('style') } else playlist.style.marginTop = (yt6.wide) ? '16px' : '0px'
	    } else {
	    ...
	    // cloneNodes
	    var y =  ((a_) ? (yt6.inf.offsetWidth - a_.parentNode.offsetWidth) / 2 : 0) //(c) ?    : (x - w) / 2

	    yt6.osw.style.left = (yt6.aspect_ratio > 1 && Math.abs(yt6.aspect_ratio - yt6.w.replace('px','')/yt6.h.replace('px','')) < 0.2) ? '0px' : y + 'px'
		...
		if (playlist && ww0 >= (1000 + yt6.sb) && (windowwidth < (base + 24)) ) { e.marginLeft = -24 + 1 * (windowwidth - base) + 'px' } else
	...
	//	e.position = ''
	      ...
	      if (!yt6.wide && yt6.wsb.id == 'secondary') {// && yt6.pls
		var r = gid('related'); if (r) r.style.marginTop = ''
		yt6.wsb.style.marginTop = h + 'px'
		  if (ww0 < (1000 + yt6.sb)) {
		    if (w > windowwidth) {//>=
		      if (inf) inf.style.marginTop = (ww0 < 657) ? '384px' : ''
		      if (r) r.style.marginTop = (ww0 >= 657 && ww0 < 709) ? '' : ((ww0 < 657) ? '-384px' : -1 * h + 24 +'px')
		    } else {
			if (inf) inf.style.marginTop = (ww0 < 657) ? ((l.offsetWidth == 426 || (c && (inf.offsetWidth + 31) >= w)) ? '384px' : '72px') : ((w === windowwidth) ? h + 'px' : '')
			if (r) r.style.marginTop = (ww0 < 657 && (l.offsetWidth == 426 || (c && (inf.offsetWidth + 31) >= w)) ) ? '-384px' : ''
		      }
		  }

		if (yt6.pls) yt6.pls.style = ''
	      }


	    } else {
		if (gid('secondary')) gid('secondary').style.top = ''
	        e.marginLeft = '0px'
	        ...
	        if (ww0 >= 657 && (yt6.x || yt6.flash.forced)) yt6.osw.setAttribute('hidden','')
	...
	if (chat) {
	  if (!yt6.wide && yt6.pls) {
	    chat.style.top = (c || ww0 < 1000 || (yt6.pls && ww0 >= 1000)) ? '' : -1 * h - 24 +'px'
	  } else chat.style.top = (!c && !yt6.wide && ww0 >= 1000 && yt6.flexy != 'grid') ? -1 * h - 24 +'px' : ''
	}

	if (ptc) {
	  if (!yt6.x && !c && !yt6.ytp.fullscreen) ptc.style.top = '16px'
	  if (!yt6.wide && ww0 < 1000) ptc.style.top = ''
	}
  ...
  //2016-end
	...
	var otop = (yt6.mhp) ? (h + yt6.mhp.offsetHeight) : 0
	var s = (yt6.s && yt6.s.height) ? (yt6.s.height + ((otop) ? (otop - h) : 0) ) : otop
	var mob = gid('player-container-id'), v = v_(yt6.p)//yt6.api.parentNode
	if (yt6.api && mob) {
	  mob.style.maxHeight = ''
	...
	//	yt6.api.style.height = ''
		...
		height = Math.abs(h - mob.offsetHeight)
	...
	//	yt6.api.style.height = height + 'px'
	  ...
	  mob.style.maxHeight = h + 'px'
	  yt6.api.style.maxHeight = h + 'px'
	}

	var x = (!yt6.fullscreen && yt6.size != 'default') ? gid('player-container-id').offsetWidth : 0
	var top, left, oleft

	if (p1)
	if (yt6.aspect_ratio.toFixed(2) >= (w/h).toFixed(2)) {
	  top = (h - p1.style.height.replace('px','')) / 2 + 1 * (yt6.t || 0) + 'px'
	  left = (yt6.l || 0) + 'px'
	  oleft = ((x) ? (x - p1.style.width.replace('px','')) / 2 : 0) + 'px'
	} else {
	    top = (yt6.t || 0) + 'px'
	    left = (w - p1.style.width.replace('px','')) / 2 + 1 * (yt6.l || 0) + 'px'
	    oleft = '0px'
	  }
	if (p1) { p1.style.top = top; p1.style.left = left; bm0.style.left = oleft }
	if (v) { v.style.top = top; v.style.left = left; v.style.width = w + 'px'; v.style.heigth = h + 'px' }

	var y = gt('ytm-playlist-panel-header', 1)[0]
	if (y) { y.style.position = 'fixed'; y.style.width = '100%'; y.style.top = (yt6.size == 'default' && s) ? s + 'px' : (h + 44) + 'px' }
	...
	if (yt6.wna) {
	  ...
	  if (yt6.size != 'default' && otop) { yt6.wna.style.top = otop + 'px' } else { yt6.wna.style.top = s + 'px' }
	  otop = (otop + yt6.wna.offsetHeight); s = (s + yt6.wna.offsetHeight)
	}
	var height, height = (yt6.p && yt6.p.offsetHeight) ? yt6.p.offsetHeight : 0
	var z = gt('ytm-playlist-controls', 1)[0]
	if (z) { z.style.position = 'fixed'; z.style.right = '0px'; z.style.top = (yt6.size == 'defalult' && s) ? s +'px' : (otop || y.getBoundingClientRect().bottom) + 'px'; z.style.zIndex = 1 }

	if (yt6.blocked_m) {
	  z = gc('player-controls-background')[0]; if (z) z.setAttribute('hidden','')
	  z = gc('player-controls-middle center')[0]; if (z) z.setAttribute('hidden','')
	}
    }
  ...
  e.width = e.width.replace('px','') - 0 + 'px'
...
} else if (yt6.ytp.fullscreen && chat) { chat.style = ''; chat.removeAttribute('style') }//scaling


  if (yt6.layout == 16 && !yt6.mobile) {
    var ptc = gid('full-bleed-container'), c = gid('columns')
    if (c) { c.style.marginTop = (yt6.ytp.fullscreen && yt6.wide && ptc && ptc.offsetHeight) ? (screen.height - ptc.offsetHeight + 20) + 'px' : '' }
  }
...
if ((p1 != null) && (yt6.x)){
  ...
  if (z) {
	...
	y = ((typeof y == 'number' && y) || !yt6.api) ? y : Math.ceil(yt6.api.offsetHeight / 23); //0.9 + (h / 32.5) + (407 / h)
  ...
  if (yt6.ytp.embed && yt6.oldbrowser && yt6.p && yt6.p.tagName == 'EMBED') { yt6.osw.style.height = '0px' }
	...
	if (y) {//if (y) if (yt6.wallpaper) 
	  ...
	  if (yt6.wsb) {
	    if ((yt6.size == 'default' && !yt6.wide) || (yt6.pls && yt6.wide)) { //if (yt6.pls || !yt6.wide || (yt6.pls && yt6.wide)) { 
	      yt6.wsb.style.marginTop = (yt6.pls || ww0 < 1000) ? '' : (-1 * yt6.h.replace('px','')) + (-1 * 24) + 'px'//((yt6.pls && yt6.wide) || (yt6.size == 'default' && !yt6.pls) || ww0 < 1000) ? '' : (1 * yt6.h.replace('px','')) + (1 * 24) + 'px'
	    } else {
		if (!(yt6.wide && !yt6.pls)) {										//(1 * yt6.h.replace('px','') + 24) +'px'
		  yt6.wsb.style.marginTop = ( (!yt6.pls) || !yt6.wide) ? ( !(yt && yt.config_ && yt.config_.LOGGED_IN) ? '' : '10px') : (1 * yt6.h.replace('px','') - 24) +'px' // '10px' :
		} else yt6.wsb.style.marginTop = '20px'
      ...
      if (yt6.flexy == 'grid') {
	if (yt6.size == 'default') {// || (yt6.size !== 'default' && gid('primary-inner') && w > gid('primary-inner').offsetWidth)) {console.log(w +' '+ gid('primary-inner').offsetWidth)
	  if (gid('secondary')) gid('secondary').removeAttribute('style')
	  if (yt6.wsb) yt6.wsb.style = ''
	  if (yt6.pls) yt6.pls.style = ''
	} else {
	    //if (yt6.wide && h > windowheight)
	    //if (gid('secondary')) gid('secondary').style.top = top
	    var sr = gt('ytd-watch-next-secondary-results-renderer', yt6.top)[0]; if (sr) { sr.style.position = (yt6.wide) ? 'relative' : ''; sr.style.top = (windowwidth < 1000) ? '240px' : '' }
	    var tc =  gid('player-full-bleed-container'); if (tc) { tc.style.height = (yt6.wide) ? h + 'px' : ''; tc.style.minHeight = (yt6.wide) ? h + 'px' : '' }
	  }
	if (yt6.osw) yt6.osw.style.left = (yt6.osw.parentNode.offsetWidth - w) / 2 + 'px'
	var z = gt('ytd-watch-grid', 1)[0]; if (z) z.style.marginTop = (yt6.wide) ? '4px' : ''
      }



  if (pm && sct) pm.scrollTop = sct
...
function switch_players(iframe) {
	...
	if (p1) {
	  if (yt6.layout == 12) {
	    yt6.api = (!yt6.ytp.embed) ? gid('player-api') : gid('player')
	      ...
	      if (!yt6.mobile) {
		yt6.api = (!yt6.ytp.embed) ? ((!yt6.ytm) ? gt('ytd-player', 1)[0] || pcont() : gc('player-wrapper style-scope ytmusic-player')[0]) : gid('player')
	      }
	    }
	  if (yt6.api && yt6.api.getAttribute('id') == 'ytd-player') {
		var c = yt6.api.children;
  ...
  if ( !!bm0 && bm0.style.visibility === 'hidden') { // && !!p && p.style.visibility != 'hidden'
	...
	if (yt6.pre_ad !== true && yt6.ad_muted) {
	  ...
	  try { p.unMute(); yt6.ad_muted = false; p.setVolume(100 * b.volume) } catch(e) {}
	}
      } catch(e){}
...
function ythtml5_size() {
  ...
  if (!p) {
	...
	if (m && yt6.x) {
	  if (yt6.xhr.async && yt6.s && yt6.s.width && yt6.s.height) {
	    b.width = yt6.s.width + 'px'; b.height = yt6.s.height + 'px'
	  } else {
	      var z = gid('player-container-id'); if (z) {
		b.width = z.offsetWidth + 'px'
		b.height = (z.offsetHeight || z.offsetWidth / (16/9)) + 'px'
	      }
	    }
	}
...
function nop(){//    } else {
    ...
    var yt = v.style, mep = gid(mep_x('mep_')), sw = screen.width, sh = screen.height

    if (yt6.mobile && (yt6.ytp.fullscreen || (p && p.tagNaem == 'DIV' && typeof p.isFullscreen == 'function' && p.isFullscreen())) && mep && (sw != mep.offsetWidth || sh != mep.offsetHeight)) {
	sw = mep.offsetWidth; sh = mep.offsetHeight
    }


    var x = Math.abs(1 * b.height.replace('px','') - hdiff - v.style.height.replace('px','') - 0), fsws = (yt6.ytp.fullscreen && yt6.aspect_ratio - sw/sh >= -0.01) ? true : false

    if ( //(!yt6.x || yt6.player1.isLoaded !== false) &&
	(!yt6.navigation || (yt6.mpb && yt6.mpb.hasAttribute('active'))) )

    if (  (//(1 * b.width.replace('px','') - ((b.height.replace('px','') - hdiff) * yt6.aspect_ratio )) < 2)
	 (16/9 > (1 * b.width.replace('px','') / (b.height.replace('px','') - hdiff)) )
	|| (fsws)
       )  ) {
	v.style.width = (!yt6.ytp.fullscreen) ? b.width : ((yt6.size == 'default') ? sw + 'px' : clone(yt6.w))
	v.style.height = (!yt6.ytp.fullscreen) ? b.width.replace('px','') / yt6.aspect_ratio - 0 + 'px' : ((yt6.size == 'default') ? sw / yt6.aspect_ratio + 'px' : clone(yt6.h))
	v.style.left = (!yt6.ytp.fullscreen || (yt6.mpb && yt6.mpb.hasAttribute('active'))) ? '0px' : (sw - v.style.width.replace('px','')) / 2 + 'px'
	v.style.top = (!yt6.ytp.fullscreen || (yt6.mpb && yt6.mpb.hasAttribute('active'))) ? ((( 1 * b.height.replace('px','') - v.style.height.replace('px','') ) / 2) - (hdiff / 2)) + 'px' : (sh - v.style.height.replace('px','')) / 2 + 'px'
	if (webgl) {
	  if (!( (1 * b.height.replace('px','')) < (b.width.replace('px','') / (webgl.width / webgl.height)) )) {
 	    webgl.style.width = (!yt6.ytp.fullscreen) ? b.width : ((yt6.size == 'default') ? sw + 'px' : clone(yt6.w))
		...
		webgl.style.height = (!yt6.ytp.fullscreen) ? 1 * b.height.replace('px','') - hdiff + 'px' : ((yt6.size == 'default') ? sh + 'px' : clone(yt6.h))
	...
	v.style.width = (!fsws || m) ? ((b.height.replace('px','') - hdiff) * yt6.aspect_ratio ) + 'px' : ((yt6.size == 'default' || yt6.ytp.fullscreen) ? sw + 'px' : clone(yt6.w))
	v.style.height = (!fsws || m) ? (1 * b.height.replace('px','') - hdiff) + 'px' : ((yt6.size == 'default' || yt6.ytp.fullscreen) ? sh + 'px' : clone(yt6.h))
	v.style.left = (!fsws || m || (yt6.mpb && yt6.mpb.hasAttribute('active'))) ? ((b.width.replace('px','') - v.style.width.replace('px','') ) / 2) + 'px' : ((sw - v.style.width.replace('px','') ) / 2) + 'px'
	v.style.top = (!fsws || m || (yt6.mpb && yt6.mpb.hasAttribute('active'))) ? '0px' : ((screen.height - v.style.height.replace('px','') ) / 2) + 'px'
	if (webgl) {
	  webgl.style.height = (!fsws || m) ? 1 * b.height.replace('px','') - hdiff + 'px' : ((yt6.size == 'default' || yt6.ytp.fullscreen) ? sh + 'px' : clone(yt6.h))
	  webgl.style.width = ((webgl.style.height.replace('px','') - hdiff) * (webgl.width / webgl.height)) + 'px'
...
if (v) { var init = 0
  ...
  if (yt6.mobile && v.parentNode && v.parentNode.style.top != '0px') v.parentNode.style.top = '0px'
}
...
function aspect(a) {
  ...
  if (yt6.flash.forced) { //&& player() && player().parentNode.getAttribute('id') == 'movie_player_to_dispose') {
    ...
    if (!yt6.ytp.embed && bm0 && bm0.parentNode.getAttribute('id') == 'movie_player_to_insert') {
      if (yt6.layout != 16) {
        bc = gid('player-api')
      } else bc = (!yt6.ytm) ? gt('ytd-player', 1)[0] || pcont() : gc('player-wrapper style-scope ytmusic-player')[0]
  ...
  var playerwidth = (yt6.size != 'default' || (yt6.size == 'default' && wide_view())) ? Math.min( Math.round(((windowheight / 100 >>0) * 80) * yt6.aspect_ratio), windowwidth) : Math.min( Math.round(windowheight * yt6.aspect_ratio), windowwidth)
	if (yt6.size == 'default' && yt6.mpb && yt6.mpb.hasAttribute('active')) playerwidth = Math.min(pn.offsetWidth, 1 * yt6.w.replace('px',''))
...
//console.log('t2 '+a)
   ...
   var h = Math.round(h) + 'px'
	...
	var windowheight = parseInt(window.innerHeight || document.documentElement.clientHeight || yt6.body.clientHeight)
        ...
        if (yt6.size == 'default' && yt6.mpb && yt6.mpb.hasAttribute('active'))  {
          if (bm0 && bm0.offsetHeight) {
            windowheight = Math.min(pn.offsetHeight, 1 * yt6.h.replace('px',''))
          } else windowheight = pn.offsetHeight
        }
        var windowwidth = parseInt(window.innerWidth || document.documentElement.clientWidth || yt6.body.clientWidth)
	...
	if (!yt6.live && (h_pos.top > (windowheight - y - h.offsetHeight) || h_pos.top < (y + h.offsetHeight)) ) { return true } else return false
      ...
      dw.innerHTML = '<span><div id="fix_frame4" style="' + style + '">Fix<input onclick="if (yt6) if (yt6.size == \'custom\') { yt6.size = yt6.size_bak; this.checked = false; this.setAttribute(\'checked\',\'\') } else { yt6.size_bak = yt6.size; yt6.size = \'custom\'; this.checked = true; this.setAttribute(\'checked\',\'checked\') };" id="fixed-frame" type="checkbox"></input></div><input id="a_width" value="' + w.replace("px","") + '" style="color: black; display:inline-block; width:38px; height:13px; text-align:right" onkeyup="if (event.keyCode == 13) { yt6.w = gid(\'a_width\').value; yt6.h = gid(\'a_height\').value; if (1 * yt6.h > 9999) { yt6.h = gid(\'a_height\').value = 9999; gid(\'a_height\').setAttribute(\'value\', 9999) }; resize_layers(gid(\'a_width\').value + \'px\', gid(\'a_height\').value + \'px\', false); var st = clone(yt6.scrollTo); if (yt6.update_aspect()) window.scrollBy(yt6.scrollTo[1] - st[1], yt6.scrollTo[3] - st[3]) }" onfocus="yt6.update_aspect();"></input>x<input id="a_height" value="' + h.replace("px","") + '" style="color: black; display:inline-block;width:35px;height:13px;text-align:right" onkeyup="if (event.keyCode == 13) { yt6.w = gid(\'a_width\').value; yt6.h  = gid(\'a_height\').value; if (1 * yt6.h > 9999) { yt6.h = gid(\'a_height\').value = 9999; gid(\'a_height\').setAttribute(\'value\', 9999) }; resize_layers(gid(\'a_width\').value + \'px\',gid(\'a_height\').value + \'px\', false); var st = clone(yt6.scrollTo); if (yt6.update_aspect()) window.scrollBy(yt6.scrollTo[1] - st[1], yt6.scrollTo[3] - st[3]) }" onfocus="yt6.update_aspect()"></input>px</span>';
...
//console.log('d')
	...
	if (!(yt6.body2 && yt6.layout == 12)) {
	  w = (yt6.flexy && !yt6.wide && yt6.api ) ? pn.offsetWidth + 'px' : fix_Width() // && !(yt6.document_fragment || (gid('bm1') && gid('bm1').parentNode !== yt6.mhp))
	...
	if ( !yt6.ytp.fullscreen && ((yt6.flexy && yt6.wide) || (yt6.ytp.embed && windowheight < (1 * w.replace('px','') * yt6.aspect_ratio - 0)) ) ) {
	  h = (!yt6.ytp.embed) ? Math.round(((windowheight / 100 >>0) * 80)) + 'px' : windowheight + 'px' //w.replace('px','') / yt6.aspect_ratio + 'px'
	  w = windowwidth + 'px'
	}
	...
	if (yt6.mobile) {
	  if (yt6.xhr.async && yt6.s && yt6.s.width && yt6.s.height) {
	    w = yt6.s.width + 'px'; h = yt6.s.height + 'px'
	  } else {
	      var z = gid('player-container-id'); if (z) {
		w = z.offsetWidth + 'px'
		h = (z.offsetHeight || z.offsetWidth / (16/9)) + 'px'
	...
	if (!yt6.mobile && shorts()) {
	  var sp = gt('ytd-reel-video-renderer', 1)[0]
	  if (sp) {
	    w = sp.offsetWidth + 'px'
...
function deldiv(){
  ...
  if (typeof ($) !== 'undefined') {
    if (yt6.player1) try { yt6.timer = 999999999; clear_mep(yt6.player1); if (!yt6.mobile) exit(yt6.player1.media) } catch(e){}
    if (yt6.player2) try { yt6.timer = 999999999; clear_mep(yt6.player2); if (!yt6.mobile) exit(yt6.player2.media) } catch(e){}
  ...
  if (player() && yt6.p.lastChild) {
	...
	if (yt6.cin) {
	  yt6.cin.style.display = ''; yt6.cin.removeAttribute('style')
	  yt6.osw.insertBefore(yt6.cin, yt6.osw.firstChild)
	}
      }
      //z.style.top = ''
      //z.style[yt6.prop] = ''
    }
    if (yt6.wsb) { yt6.wsb.style = ''; yt6.wsb.removeAttribute('style') }
    if (yt6.osw) { yt6.osw.style = ''; yt6.osw.removeAttribute('style') }
  }
  ...
  if (yt6.mobile) {
    ...
    if (z) { z.style.display = ''; z.removeAttribute('style') }
      ...
      var z = ['ytd-consent-bump-lightbox','iron-overlay-backdrop','yt-upsell-dialog-renderer']
      for (i=0;i<z.length;i++) { var y = gt(z[i], 1)[0]; if (y) y.style.display = '' }
    }

  var z = gt('ytd-live-chat-frame', 1)[0] || gid('chat')
  ...
  var z = [ 'controls-sp','aspect','bm10','bm3','bm1','bm0','theater-left', yt_alert_message, 'alerts' ]
  for(i=0;i<z.length;i++){
    var y = gid(z[i])
  ...
  for(i=0;i < z.length;i++){
	...
	if (z[i] == 'player-container') {
      ...
      } else { y.width = ''; y.height = ''; y.left = ''; y.display = ''; };
  ...
  if (yt6.layout == 16 && yt6.osw && yt6.osw.getAttribute('id') == 'player') {
  ...
  if (yt6.flexy) {
    var z = gid('player-full-bleed-container')
  ...
  if (yt6.tbg && yt6.tbg.parentNode) yt6.tbg.parentNode.removeChild(yt6.tbg)

  yt6.loaded = 0; yt6d.loaded = 0; yt6.ytp = {}
  ...
  try { yt6d.body = gt('body', 1)[0] } catch(e){}
  yt6.body = null
...
function control_panel1() {
  ...
  z = gid('watch7-notification-area')
  if (z != null) {
  ...
  if (yt6.mobile) {
    ...
    if (!y) { //fix this f*ckup
	z = gid('error-container')
	if (z && !gc('page-ontainer')[0]) { z.className = 'page-container' }
	z = gc('page-container')[0]
	if (!z) {
	  z = document.createElement('div')
	  z.className = 'page-container'
	  y = gt('ytm-app', 1)[0]
	  if (y) y.insertBefore(z, y.firstChild)
	}
	z = gc('page-container')[0]
	if (z) {
	  y = document.createElement('ytm-watch')
	  z.appendChild(y)
	  y.setAttribute('class','')
	  z = document.createElement('div')
	  z.className = 'player-size player-placeholder'
	  y.appendChild(z)
	}
    }
  }
  ...
  if (yt6.mobile && gid('alerts')) { gid('alerts').style.position = 'fixed'; gid('alerts').style.zIndex = '2' }
  ...
  } else var span = gt('span', gid(yt_alert_message))[0]
  ...
  if (controls) {
    controls.innerHTML =  '<button class="play snarl-button yt-uix-button-text" style="display: inline-block; width: 52px; text-align:center; padding: 0 3px 0 3px;">play</button>'+
			    ...
			    ((yt6.ytp.embed) ? '<button class="playlist snarl-button yt-uix-button-text" style="padding: 0 4px 0 4px; right: 0px">list</button></div>' : '') +
                          ...
                          '</div>'
//+'<div><ytm-playlist-controls><div class="playlist-controls-primary"><c3-material-button class="icon"><button class="c3-material-button-button" disabled="" aria-label="Previous video"><div class="cbox"><c3-icon flip-for-rtl="false"><svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet"><path d="M6 6h2v12H6zm3.5 6l8.5 6V6z"></path></svg></c3-icon></div></button></c3-material-button><c3-material-button class="icon"><button class="c3-material-button-button" aria-label="Next video"><div class="cbox"><c3-icon flip-for-rtl="false"><svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet"><path d="M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z"></path></svg></c3-icon></div></button></c3-material-button></div><div class="playlist-controls-secondary"><c3-material-button class="button-renderer compact " data-style="[object Object]" data-icon-only="true" is-busy="false" aria-busy="false" disabled="false"><button class="c3-material-button-button" aria-label="Save playlist" aria-pressed="false"><div class="cbox"><c3-icon class="button-renderer-icon" flip-for-rtl="false"><svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet"><path d="M14 10H2v2h12v-2zm0-4H2v2h12V6zm4 8v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zM2 16h8v-2H2v2z"></path></svg></c3-icon><div class="button-renderer-text"></div></div></button></c3-material-button><c3-material-button class="button-renderer compact " data-style="STYLE_DEFAULT" data-icon-only="true" is-busy="false" aria-busy="false" disabled="false"><button class="c3-material-button-button" aria-label="Share"><div class="cbox"><c3-icon class="button-renderer-icon" flip-for-rtl="false"><svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet"><path d="M14 9V5l7 7-7 7v-4.1c-5 0-8.5 1.6-11 5.1 1-5 4-10 11-11z"></path></svg></c3-icon><div class="button-renderer-text"></div></div></button></c3-material-button></div></ytm-playlist-controls></div>'
  }
  ...
  var windowwidth = parseInt(window.innerWidth || document.documentElement.clientWidth || yt6.body.clientWidth) - yt6.sb // - 1
  if (yt6.layout == 16 && yt6.flexy && yt6.pls && (windowwidth < 1000 || !(gt('ytd-watch-'+yt6.flexy, 1)[0] && gt('ytd-watch-'+yt6.flexy, 1)[0].hasAttribute('is-two-columns_'))) ) yt6.pls.firstElementChild.insertBefore(gid(yt_alert_message), yt6.pls.firstElementChild.firstElementChild)
...
/* Grab the necessary DOM elements */
  ...
  var stage = stage
  var v = v; if (v == undefined) { var v = gc('video-stream html5-main-video')[0] }; yt6.vobj = v
  var p = player()
  var mep = gid(mep_x('mep_'))
  var bm0 = gid('bm0')
  var windowwidth = parseInt(window.innerWidth || document.documentElement.clientWidth || yt6.body.clientWidth) - yt6.sb;// - 1
  ...
  if (poster) {
    var poster_img = gt('img', poster)[0]
...
/* Position video */
  ...
  var a, b
  if (yt6.fullscreen || yt6.ytp.fullscreen) {
    a = (screen.width / screen.height > yt6.aspect_ratio) ? screen.width / yt6.aspect_ratio + 'px' : screen.width + 'px'
    b = screen.height + 'px'
  } else {
      a = (bm0) ? bm0.style.width : yt6.w
      b = (bm0) ? bm0.style.height : yt6.h
    }

  resize_layers( a, b, false )//slug1
  ...
  //if (yt6.layout == 16 && !yt6.ytm) aspect(yt6.size)
  //pl_item(true)
...
/* If a button was clicked (uses event delegation)...*/
  ...
  yt6.clicky = function(e){ yt6.controls_pushed = true
    ...
    if (className && typeof className == 'string') className = className.replace(' style-scope','').replace(' ytmusic-player-page','').replace(' ytmusic-browse-response','')
...
/* Check the class name of the button and act accordingly */    
	...
	try { yt6.player1.pause() } catch(e){}
 	  fix_playlist()
	  $waitUntil(function(){ var y = yt6.pl_index, zi = yt6.pl_next; pl_item(); if ((typeof y == 'number' && zi) || yt6.layout == 12 || yt6.mobile || !yt6.pls) { return true } },
	  function() { var p = player(), p = yt6.p;
	    if ( !(yt6.layout == 16 && yt6.blocked && !yt6.ytm) && p && typeof p.playVideoAt == 'function' && p.getAttribute('class') != 'forced flashplayer') { var mp = p }
	    else { var mp = yt6.original || original(yt6.p) }
	    try { yt6.navigation = true; yt6.ads_noskip = 0
	      if ((!yt6.shuffle) || (yt6.shuffle && yt6.layout == 16 && typeof mp.getPlaylist == 'function' && !(mp.getPlaylist() && mp.getPlaylist()[0])) || yt6.layout == 12 || yt6.mobile) {
		if (!yt6.mobile) {
		  if (yt6.pls && p.tagName != 'IFRAME') {
		    if (yt6.layout == 16 && yt6.blocked && !yt6.ytm) {
			...
			if (yt6.age.blocked) {
			  swap_player()
			    ...
			    if (typeof mp.getPlaylist == 'function' && (mp.getPlaylist() && mp.getPlaylist()[0])) {
			      //if (!yt6.pl_next_blocked) {
				try { mp.playVideoAt((yt6.pl_index - yt6.pl_set) + 1) } catch(e) { try { yt6.pl_next.click() } catch(e){ mp.nextVideo('0') } }
			      //} else mp.nextVideo('0')
			    } else {
				//if (!yt6.pl_next_blocked) {
				  try { yt6.pl_next.click() } catch(e){ mp.nextVideo('0') }
			  ...
			  if ('onclick' in yt6.pl_next) {
			    if ((browserName == 'Firefox' && yt6.body2) || (yt6.ytm && mp.getPlaylist() && mp.getPlaylist()[0])) {
		    ...
		    mobile_playlist_run('next')
		  }
	      } else {
		if (p == mp) {
		  mp.playVideoAt((1*yt6.pl_index)+1) || mp.nextVideo('0')
		} else {
		    try {
		      $waitUntil(function(){if (location.href.indexOf(yt6.vid) == -1) { return true } else {
			mp.stopping = false; FireEvent2(mp, 'mouseup'); mp.seekTo(mp.getDuration()); if (!yt6.ad_muted) mp.mute(); mp.playVideo(); mp.pauseVideo(); if (!yt6.ad_muted) mp.unMute();
	...
	try { yt6.player1.pause() } catch(e){}
	  ...
	  $waitUntil(function(){ var y = yt6.pl_index, zi = yt6.pl_next; pl_item(); if ((typeof y == 'number' && zi) || yt6.layout == 12 || yt6.mobile || !yt6.pls) { return true } },
	  function() { var p = player(), p = yt6.p;
	    if (p) //if ( !(yt6.layout == 16 && yt6.blocked && !yt6.ytm) && p && typeof p.playVideoAt == 'function' && p.getAttribute('class') != 'forced flashplayer') { var mp = p } else
	    { var mp = yt6.original || original(yt6.p) }
	    try { yt6.navigation = true; yt6.ads_noskip = 0
	    if (yt6.layout == 12 || yt6.mobile || yt6.ytp.embed) {
		if (!yt6.mobile) {
		  if (yt6.pls) {
		    if (!yt6.shuffle) {
		    try {
		    ...
		    mobile_playlist_run('prev')
		  }
	    } else {
	      var a = 5; if (typeof mp.getPlayerState == 'function') a = gpst(mp); if (a == -1) mp.pauseVideo()
		...
		if (yt6.layout == 16 && yt6.blocked && !yt6.ytm && p.tagName != 'IFRAME') {
							      $waitUntil(function(){var p = original(yt6.p); if (p) { return true } },
								function() {
								  //yt6.original.loadVideoByUrl(yt6d.previous.video_id || yt6d.init)
								  $waitUntil(function(){if (yt6.original && typeof yt6.original.nextVideo == 'function') { return true } },
	...
	if (( v && (v != stage || (v.getAttribute('name') != null && v.getAttribute('name').indexOf('me_flash') > -1))) ) {
	  ...
	  try { if (yt6.btn.play) yt6.btn.play[yt6.txt] = ncmd; if (yt6.btn.play2) yt6.btn.play2[yt6.txt] = ncmd; var x = gc('play snarl-button yt-uix-button-text')[0]; if (x) x.innerHTML = ncmd; var x = gc('play snarl-button yt-uix-button-text')[1]; if (x) x.innerHTML = ncmd } catch(e) {}
		...
		var m = window
			...
			if ((gpst(p) != 1) || (typeof p.getPlayerState != 'function' && yt6.btn.play[yt6.txt] == 'play')) {
		...
		var p = yt6.embed.player
		    if (p) {
		        if ((gpst(p) != 1) || (typeof p.getPlayerState != 'function' && yt6.btn.play[yt6.txt].innerHTML == 'play')) {
...
/* Reset all to default */
	case 'reset snarl-button yt-uix-button-text':
	  ...
	  var bw, bh, bv
	  if (!(!yt6.x && yt6.ytp.fullscreen)) {
	    bw = (bm0) ? bm0.style.width : yt6.w
	    bh = (bm0) ? bm0.style.height : yt6.h
	  } else {
		bw = (yt6.size == 'default') ? screen.width + 'px' : yt6.w
		bh = (yt6.size == 'default') ? screen.height + 'px' : yt6.h
	    }
	  bv = (bm0) ? bm0.style.visibility : 'hidden'

	  rz()

	  zoom = 1; rotate = 0;
	  if (!(yt6.layout == 16 && !yt6.ytm && yt6.blocked && p && p.tagName == 'EMBED')) {}// aspect(yt6.size)
	  if (yt6.x) {
  ...
  if (yt6.p) {
	...
	if ( (yt6.flash.forced && yt6.layout == 16) && ((z && z.indexOf('%26false') > -1) || (yt6.p.getAttribute('flashvars') && yt6.p.getAttribute('flashvars').indexOf('fmt_list=') == -1)) ) {
	  ...
	  if (z) {
	    z = gt('OBJECT', z)[0]
	    if (z && z.getAttribute('name') == 'me_flash') { z.parentNode.removeChild(z); set_controls(1) }
	  }
	}
    } else if (yt6.p.tagName == 'DIV') yt6.p.style[yt6.propName] = ''
  } else if (!player()) {
	me_flash_up(); set_controls(2)
    }
