	...
	return hasFlash
	  ...
	  var action_setconfig = function(){
		yt.setConfig = function (a){
		  var Ne=function(a){a.stopPropagation()};
...
else if("function"==b&&"undefined"==typeof a.call)return"object";return b}//ua

		function wa(a){return(0,window.encodeURIComponent)(String(a))};//g.Ka

		function da(a){return"array"==ca(a)}//g.va
		function vf(a,b,c){if(da(b))for(var d=0;d<b.length;d++)vf(a,String(b[d]),c);else null!=b&&c.push("&",a,""===b?"":"=",wa(b))};//encodeURIComponent(String(b)))} //Mg or g.zf
...
function video_id() {
  ...
  if (!(yt6.vid && yt6.vid.indexOf(vid[0]) != -1) && player() && typeof player().getVideoUrl == 'function') {
    yt6.vid = player().getVideoUrl().split('v=')[1] || player().getVideoUrl().split('v/')[1]
...
function alt_yt(vid) {
		...
		if (!vid) var vid = video_id()[0]
		  ...
		  if (window.ytplayer.config.html5 == false || (player().tagName == 'EMBED' && player().getAttribute('flashvars') != '' )) {
		    ...
		    if (z && z.name != 're-embed2' || (z.name == 're-embed2' && z.src.indexOf('embed/' + vid) == -1 && document.getElementById('video-hide').firstChild && document.getElementById('video-hide').firstChild.id.indexOf('movie_player') == 0)) {
		      if (yt6.vid != vid) {
...
function alt_yt_cleanup() {//console.log(player().getAttribute('name') + typeof yt6.block + '"'+yt6.block+'"'+yt6.age.done)
  ...
  //}
    ...
    var a = document.getElementById('movie_player0') || document.getElementById('video-hide').firstChild
...
//player().parentNode.insertBefore(player(), player().parentNode.firstChild)
      ...
      if (!yt6.ytg && window.ytplayer.config.args.video_id && window.ytplayer.config.args.video_id == yt6.vid && window.ytplayer.config.args.video_id == video_id()[0] && a && typeof a.getAttribute == 'function' && a.getAttribute('id') == 'movie_player' && player() && player().getAttribute('name')) {//console.log('1! ')//+player().getAttribute('name'))
...
//console.log('D')
	  ...
	  if (yt6.flashplugin() && (window.ytplayer.config.html5 == false || (player().tagName == 'EMBED' && yt6.age.t && (player().getAttribute('flashvars') == '' || typeof player().getPlayerState == 'function')) || (window.ytplayer.config.html5 == false && yt6.status != 'fail' && !(gc('video-stream html5-main-video')[0] && gc('video-stream html5-main-video')[0].getAttribute('controlslist') == 'nodownload' && !gc('video-stream html5-main-video')[0].getAttribute('src'))) )  ) {//console.log('basic');
	    ...
	    if (yt6.layout == 16) {
	      ...
	      if (!yt6.ytg && document.getElementById('movie_player') && ( player().tagName == 'EMBED' || document.getElementById('bm0') == null || (yt6.layout == 16 && ((yt6.status == 'fail' && yt6.reason) || yt6.re2 == true)) ) ) {
	        //console.log('F1')
		alt_yt(vid)
	...
	xhr3.onreadystatechange = function() { 
	  ...
	  if ((yt6.age.t || yt6.ytg || yt6.layout == 16) && xhr3.readyState == 4 && xhr3.status == 200 && xhr3.responseText) {// && xhr3.responseText.indexOf('status=fail') == -1) {
		...
		function(){ parse_video_info(xhr3.responseText);
		  var z = document.getElementById('unavailable-message');// || gclass('ytd-playability-error-supported-renderers')[0]
...
function me_flash_up(file, ib){
    ...
    js.setAttribute("data","//rawcdn.githack.com/johndyer/mediaelement/8adf73f1a2bec0b6867f83917ce8c491d01c1aa9/build/flashmediaelement-cdn.swf")
    js.innerHTML = '<param name="movie" value="' + encodeURIComponent('//rawcdn.githack.com/johndyer/mediaelement/8adf73f1a2bec0b6867f83917ce8c491d01c1aa9/build/flashmediaelement-cdn.swf') + '" />\
...
if ( (player() == null) || ((player() != null) && (typeof document.getElementById('movie_player').getPlayerState != 'function') && (gc("html5-video-container")[0]) && (gc("html5-video-container")[0].innerHTML == '')) ) {
  ...
  if (typeof ytplay0 == 'undefined') { //blank_fmp()
    ...
    document.getElementById("player-api").setAttribute('style','overflow: hidden;')
    if (document.getElementById("player-api").getAttribute('style') == 'overflow: hidden;' && yt6.layout != 16) {//normal
	...
	document.getElementById("player-api").firstChild.innerHTML = '<embed style="" wmode="transparent" type="application/x-shockwave-flash" src="https://s.ytimg.com/yts/swfbin/player-' + yt6.swfbin4 + '/watch_as3.swf" aria-label="YouTube Video Player" name="movie_player" id="movie_player" flashvars="'+correct_flashvars(window.ytplayer.config.args)+'" allowfullscreen="true" allowscriptaccess="always" bgcolor="#000000" height="100%" width="100%">';
      }
  ...
  var v = p
	...
	if (!yt6.x) {
		...
		if (me_flash_ != undefined){
		    ...
		    if (x) {
			  if ((document.getElementById(mep_x('me_flash_')) != null) && (yt6.x)) {
				...
				if (!flashvars[i].parentNode.paused) {
				  flashvars[i].parentNode.paused = true; try { flashvars[i].pauseMedia() } catch(e) {}
				}
			      }
			    }
		    }
	  ...
	  if (!yt6.x) {
		...
		if (me_flash_ != undefined) {
		    var x = gclass('mejs-shim')[0];
		    if (x) {
			  if (document.getElementById(mep_x('me_flash_')) && yt6.x) {
				  var v = document.getElementById(mep_x('me_flash_')); var stage = v;
				  if (v.style.width == '') v.style.width = bm0.style.width;
				  if (v.style.height == '') v.style.height = parseInt(bm0.style.height.replace('px','') - 30) + 'px';
				  if (v.style.top == '') v.style.top = '0px';
...
//      }
  ...
  var Mqch = function() {
	...
	if (player() && typeof player().getPlayerState == 'function') {
	  $waitUntil(
	    function() { if (player().getPlayerState() == 3) { return true } else { yt6.timer2++ } },
	    function() {
	      $waitUntil(function(){ if(yt6.timer2 == 3) { return true } else { yt6.timer2++ } },
		function() { yt6.aspect('media') }, 200,600)
	  },300,600)
	}
      } else {
	      $waitUntil(function(){ if(yt6.timer2 == 3) { return true } else { yt6.timer2++ } },
...
if (autoplay != null) {
  ...
  var autoplay2 = gclass('playlist-mix-icon yt-sprite');
    ...
    if (autoplay) {
      autoplay = yt6.tmp = autoplay.getElementsByTagName('YTD-TOGGLE-BUTTON-RENDERER')[0]
      if (autoplay) {
...
/*    var autoplay = gclass('style-scope ytd-toggle-button-renderer style-grey-text');//x-scope paper-icon-button-0 
	...
	if (yt6.tmp == autoplay[0].parentNode.parentNode.parentNode) {
	  yt6.tmp = yt6.tmp.getElementsByTagName('BUTTON');//PAPER-ICON-
	  if (yt6.tmp[0] == autoplay[0]) {
	    if (yt6.tmp[0].getAttribute('aria-pressed') == 'false') FireEvent(yt6.tmp[0], 'click'); 
...
//$waitUntil(function(){if(yt6.tmp[0].getAttribute('class').indexOf(' style-grey-text') != 0) return true},
  //function(){
	if (yt6.autoplay == false) FireEvent2(yt6.tmp[0], 'click');
...
*/
		...
		yt6.tmp.setAttribute('class', 'style-scope ytd-toggle-button-renderer style-default-active')
	      }
...
if (start != false){
  ...
  if ( pn == 'me_flash' || d.indexOf('%26false') > -1 && !yt6.x ){
    if ( ( (!mep || typeof fv == 'string') && typeof p.getPlayerState == 'function') || ( typeof p.getPlayerState == 'function' && typeof fv != 'string' && webgl  ) ){ //console.log('autoplay1');
	...
	if ((d == undefined) || (d.indexOf('%26true') > -1) && (!yt6.x)) { //console.log('autoplay4')
	  if ( (typeof p.getPlayerState == 'function') && ((typeof fv == 'string') || (webgl) || (!yt6.x)) ) { //console.log('autoplay5' + typeof d + d + yt6.x)
		...
		if ((yt6.autoplay || autoplay2[0]) && start) $waitUntil(function(){
		  ...
		  bm0.style.visibility = 'visible';
		  try { gc('video-stream html5-main-video')[0].pause() } catch(e) {};
		  if ((yt6.autoplay || autoplay2[0]) && start) {//console.log('01')
			...
			/*if (typeof player().getPlayerState == 'function' && yt6.layout == 16 || (navigator.userAgent.match(/Edge\/\d+/) != null || navigator.userAgent.match(/MSIE /) != null || navigator.userAgent.match(/Trident\//) != null)) {//console.log('03 '+player().getPlayerState())
			  ...
			  function(){//console.log('1 ' + player().getPlayerState())
				...
				$waitUntil(function(){ if (player().getPlayerState() == -1 || player().getPlayerState() == 2 || player().getPlayerState() == 3) return true },
				  function(){//console.log('3 ' + player().getPlayerState())
				    $waitUntil(function(){ if (yt6.player1.media.paused == true && document.getElementById('bm0') && yt6.x) return true },
			...
			} else*/  if (document.getElementById('bm0') && yt6.x) {
				  yt6.player1.play();
...
if (ytplayer.config.args) {
  ...
  for (i in ft) {
	...
	if (qq.indexOf("+") != -1) {
	  ...
	  if (isNaN(ads) && player() && typeof player().getDuration == 'function') var ads = player().getDuration()
	  ...
	  if (!isNaN(ads) && (ads != 0) && typeof player().getDuration == 'function') {
	    ...
	    if (gc('ytp-time-duration')[0]){
	      ...
	      ///if (ads0 != player().getDuration()) var ads0 = player().getDuration()
	        //console.log(ads +' '+ ads0 +' '+ yt6.ad_duration + yt6.ad_muted)
...
function mep_run() {
		...
		var player1 = yt6.player1 = new MediaElementPlayer('#player1',{
		  ...
		  pluginPath: '',
		  flashName: '//rawcdn.githack.com/johndyer/mediaelement/8adf73f1a2bec0b6867f83917ce8c491d01c1aa9/build/flashmediaelement-cdn.swf',//<-- no http: there!
		  ...
		  success: function(me) {  $('#audio-type').html( me.pluginType);
					...
					addEL(me, 'error', function(e) {//console.log('1error')
					  ...
					  if (me.networkState == 3) {
					    ...
					    if (yt6.retry < 5) { //typeof V[itag(me.src)] !== 'string'&& 
					      sauce[i].removeAttribute('checked'); sauce[i].checked = ''; yt6.player1.media.pause()
						...
						//player1.load();
						if (autoplay(true) && yt6.player1.media.paused) player1.play();
					      } else {
					...
					addEL(me, 'loadedmetadata', function() {//console.log('1loadedmetadata ' + yt6.player2.media.loaded)
					  ...
					  if (typeof yt6.A_[itag(yt6.player1.media.src)] == 'string') yt6.media = 'A'
					  if (typeof yt6.V_[itag(yt6.player1.media.src)] == 'string') yt6.media = 'V'
					  ...
					  if (!yt6.player2.media.loaded || yt6.player2.media.loaded == 1 || Seek == 0)
						...
						yt6.ct = player2.currentTime = me.currentTime = yt6.player1.media.currentTime = 0;
					      }
					  if (typeof yt6.A_[itag(yt6.player1.media.src)] == 'string' && mep) {
					    ...
					    if (z && z.nextSibling) z.nextSibling.setAttribute('style','text-decoration: underline')
						  ...
						  if (itag(yt6.player1.media.src) && 1 * itag(yt6.player1.media.src) != yt6.userprefA[0]) { yt6.userprefA.unshift(1 * itag(yt6.player1.media.src)); delete yt6.userprefA[20]; }
					  ...
					  if ((typeof this.videoWidth == 'number') && (typeof this.videoHeight == 'number')) {
					    ...
					    document.getElementById('player1').width = this.videoWidth;
					...
					addEL(me, 'loadeddata', function() {//console.log('1loaded');
					  ...
					  //gc('mejs-controls')[0].style = 'display: block; visibility: hidden;'
					  try { yt6.player2.setVolume( yt6.player1.media.volume ) } catch(e) {};
					...
					addEL(me, 'play', function() {//console.log('1play')
					  ...
					  var bn = gc('play yt-uix-button-text');
					  if (bn[0]) for(i=0;i<bn.length;i++) bn[i].innerHTML = 'pause';
					  if (  (typeof yt6.A_V[itag(yt6.player1.media.src)] != 'string' && typeof yt6.A_[itag(yt6.player1.media.src)] != 'string' &&
						 (typeof yt6.V_[itag(yt6.player1.media.src)] == 'string' || yt6.player1.media.src.indexOf('itag=278') > -1) 
						) || (typeof srcto != 'undefined' && Srcto == Audio) 
					     )  {
						  if (yt6.player2.media.paused) yt6.player2.media.play(); 
						  if (typeof yt6.A_V[itag(yt6.player1.media.src)] != 'string' && yt6.browser_tab == 'visible' && player2.duration != player2.currentTime && !(yt6.player1.media.currentTime > player2.duration)) {
						    yt6.diff = Math.abs(parseFloat(parseFloat(yt6.player1.media.currentTime) - parseFloat(yt6.player2.media.currentTime)));
						    if (yt6.diff > parseFloat(0.3) )
						    $waitUntil(//+ parseFloat(yt6.speed/10))
						      function() {
							yt6.diff = Math.abs(parseFloat(parseFloat(yt6.player1.media.currentTime) - parseFloat(yt6.player1.media.currentTime))); //console.log(yt6.diff);console.log(yt6.sync_timer);
								...
								try { yt6.player1.play() } catch(e){}; Seek = null; //me.play();
							...
							if (yt6.sync_timer > 5 && me.loaded) {
							  yt6.sync_timer = 0
							    ...
							    me.pause(); Seek = 1; yt6.player2.media.currentTime = yt6.player1.media.currentTime; //me.pause();
						          } catch(e) {}
						      },50,1200)

						  }
						} else {
						    if (typeof yt6.A_V[itag(yt6.player1.media.src)] == 'string' && Seek != 4) {
						      Seek = 4; yt6.player2.pause()
						    };
						    if (typeof yt6.A_[itag(yt6.player1.media.src)] == 'string') {//yt6.player1.media.src.replace('&ratebypass=yes','') === yt6.player2.media.src.replace('&ratebypass=yes','')) {
					...
					addEL(me, 'pause', function() {//console.log('1pause ' + Seek)
					  ...
					  if (player2) {
					    if (yt6.player1.media.src.replace('&ratebypass=yes','') != player2.src.replace('&ratebypass=yes','')) {
					      ...
					      //if (Seek === 0) { me.play() };
					      if (typeof yt6.A_V[itag(yt6.player1.media.src)] != 'string' && Seek != 1 && yt6.player1.media.playbackRate == player2.playbackRate) { yt6.player1.setCurrentTime(yt6.player1.media.currentTime) } else player2.playbackRate = yt6.player1.media.playbackRate;
					...
					addEL(me, 'ended', function() {//console.log('1ended')
					  if ((yt6 && yt6.timer == 999999999) || me.src == 'https://www.youtube.com/ptracking') {// || yt6.player1.media.currentTime > yt6.player1.media.duration) {
					    /*if (yt6.player1.media.currentTime > yt6.player1.media.duration) try {
					  ...
					  if (player1.options.loop1) { 
					    ...
					    if (typeof yt6.A_V[itag(yt6.player1.media.src)] == 'string') yt6.player1.play();
					    /*if (!isNaN(player2.duration)) {
					      player2.currentTime = player2.duration
					    }*/
					  } else {
					      Seek = 3; yt6.player1.pause();
					      /*if ((player2.currentTime > 0) && (!isNaN(player2.duration))) {
					        player2.currentTime = player2.duration
					      };*/
					      if (autoplay(false)) {
					        if (!(typeof yt6.V_[itag(yt6.player1.media.src)] == 'string' && player2.currentTime == 0) ) {
						...
						yt6.player1.media.src1 = yt6.player1.media.src; yt6.player1.media.src2 = player2.src;
						try {
						  yt6.player2.setSrc('https://www.youtube.com/ptracking'); yt6.player1.setSrc('https://www.youtube.com/ptracking');
						  yt6.player2.load(); yt6.player1.load();
						  yt6.player2.setSrc(yt6.player1.media.src2); yt6.player1.setSrc(yt6.player1.media.src1);
						  yt6.player2.load(); yt6.player1.load();
						  yt6.player1.play();
						} catch(e){}
					      }
					...
					addEL(me, 'playing', function() {//console.log('1playing')
					  if ((yt6 && yt6.timer == 999999999) || me.src == 'https://www.youtube.com/ptracking') { return void 0 };
					  if (typeof yt6.A_V[itag(yt6.player1.media.src)] == 'string' && !yt6.player2.media.paused )  {// && Srcto != Audio
					    player2.pause()
					  }
					});
					addEL(me, 'seeked', function() {//console.log('1seeked')
					  ...
					  if ( (typeof yt6.A_V[itag(yt6.player1.media.src)] != 'string' && yt6.player1.media.src.replace('&ratebypass=yes','') != player2.src.replace('&ratebypass=yes','')) || yt6.audiox) {
					    if (yt6.player1.media.paused) {
						  ...
						  Seek = 1; //case of seeking without hitting pause
					        ...
					        if (yt6.audiox) { player2.currentTime = yt6.player1.media.currentTime; }
					      };
					    if (typeof yt6.A_V[itag(yt6.player1.media.src)] != 'string' && Math.abs(parseFloat(parseFloat(player2.currentTime) - parseFloat(yt6.player1.media.currentTime))) > parseFloat(0.3) || me.src == 'https://www.youtube.com/ptracking') {
		...
		yt6.player2 = new MediaElementPlayer('#player2',{
		  ...
		  success: function(me) {  $('#audio-type').html( me.pluginType);
					addEL(me, 'error', function(e) {//console.log('player2 error: ' + me.networkState + ', media type: "'+ me.canPlayType(me.type) + '"')
					  if ((yt6 && yt6.timer == 999999999) || me.src == 'https://www.youtube.com/ptracking') { return void 0 };
					  if (me.networkState == 1 || me.networkState == 3 && yt6.retry < 10) {

					    yt6.retry++
					    yt6.player2.setSrc(yt6.player2.media.src);
					    Seek = 1;
					    yt6.player2.load();
					    if (!yt6.player1.media.paused) {
						yt6.player1.pause()
...
/*					  if (me.networkState == 1) {
					...
					addEL(me, 'seeked', function() {//console.log('2seeked')
					  ...
					  if (player2.duration != player2.currentTime && !(yt6.player1.media.currentTime > player2.duration)) {//ax
					    if (yt6.player2.media.currentTime.toFixed(2) != player2.currentTime.toFixed(2)) {
					      player2.currentTime = yt6.ct = yt6.player1.media.currentTime;
					    }
					    if (Seek == 1) {
					      Seek = null;
					      if (typeof yt6.A_V[itag(yt6.player1.media.src)] != 'string') {
						...
						if (yt6.browser_tab == 'visible') {
						  ...
						  function(){ if (yt6.x) { player1.play() } else { yt6.player2.pause() }},5,1000)
						}
					      }
					    } else {//console.log('2seeked-b')
						if ( (!yt6.player2.media.paused) && (player1.media.paused) && (yt6.x) ) {
						  player1.setCurrentTime( yt6.player2.media.currentTime )
						}
					      }
					  }//ax
					});
					addEL(me, 'ended', function() {//console.log('2ended')
					  if ((yt6 && yt6.timer == 999999999) || me.src == 'https://www.youtube.com/ptracking') {//} || yt6.player2.media.currentTime > yt6.player2.media.duration) {
					    /*if (yt6.player2.media.currentTime > yt6.player2.media.duration) try {
					        yt6.player1.media.currentTime = me.currentTime = yt6.player2.media.currentTime = player2.currentTime = 0
					        if (autoplay(false)) autoplay(true)
					    } catch(e) {};*/
						return void 0
					  ...
					  if (player1.options.loop1) { 
					    try { yt6.player1.pause(); yt6.player2.pause(); Seek = 1;
					      ...
					      Seek = 3; try { me.pause() } catch(e){}; player1.pause()
					      if (autoplay(false)) {
					        if (!(typeof yt6.V_[itag(yt6.player1.media.src)] == 'string' && player2.currentTime == 0) ) {
					          var z = gclass('yt-uix-scroller-scroll-unit')
						  if (z && z[0]) {
					      ...
					      function resync_live(){
						player1.media.src1 = player1.media.src; player1.media.src2 = player1.media.src;
						try {
						  yt6.player2.setSrc('https://www.youtube.com/ptracking');
						  yt6.player2.load();
					      ...
					      resync_live();
						   ...
						   if (Seek == 3 && parseInt(parseInt(yt6.player1.media.duration) - parseInt(yt6.player1.media.currentTime)) > parseInt(0.03) ) {//console.log(parseInt(parseInt(yt6.player1.media.duration) - parseInt(yt6.player1.media.currentTime)))
							...
							$waitUntil(function(){if(yt6.player1.media.paused) return true},
						     ...
						     if (player() && typeof player().getPlayerState == 'function' && player().getPlayerState() == 1) yt6.player2.play()
						   }
					});
					...
					addEL(me, 'play', function() {//console.log('2play')
					  ...
					  /*if (yt6.player2.media.currentTime.toFixed(2) != player2.currentTime.toFixed(2)) {
					    ...
					    Seek = 1; if (yt6.x) yt6.player1.play()
					  }*/
					  var player1_src = yt6.player1.media.src.replace('&ratebypass=yes','');
					  if (typeof yt6.A_V[itag(player1_src)] == 'string' && yt6.x) {
					    if (Seek != 4) { Seek = 4; yt6.player2.media.pause(); player1.play() } else Seek = 2
					  } else {
					      Seek = 2
					      if (yt6.x && typeof yt6.A_V[itag(yt6.player1.media.src)] != 'string') {
						if (yt6.player2.media.src.replace('&ratebypass=yes','') != player1_src) {
...
//}//player_null
  ...
  if (typeof js[0] == 'undefined' && player() && typeof player().getAttribute('flashvars') == 'string') {
    var js = document.createElement('object');
    js.id = 'me_flash';
    ...
    js.setAttribute("type","application/x-shockwave-flash");
    js.setAttribute("pluginspage","//www.macromedia.com/go/getflashplayer");
    js.setAttribute("src", "http://rawcdn.githack.com/johndyer/mediaelement/8adf73f1a2bec0b6867f83917ce8c491d01c1aa9/build/flashmediaelement-cdn.swf"); //githack.com site can't do handshake over 'https' with older browsers...
    ...
    js.setAttribute("data","http://rawcdn.githack.com/johndyer/mediaelement/8adf73f1a2bec0b6867f83917ce8c491d01c1aa9/build/flashmediaelement-cdn.swf")
                    //<!-- Image as a last resort -->
                    //<img src="myvideo.jpg" width="320" height="240" title="No video playback capabilities" />
  ...
  if (typeof js[0] != 'undefined') {
    ...
    z.name = 'movie'
    z.value = 'http://rawcdn.githack.com/johndyer/mediaelement/8adf73f1a2bec0b6867f83917ce8c491d01c1aa9/build/flashmediaelement-cdn.swf'
    js[0].appendChild(z)
    z.name = 'flashvars'
...
//}//cw
  ...
  if (player() && player().tagName == 'EMBED' && (player().getAttribute('src') == '' || (yt6.layout == 16 && !player().parentNode.id) )) {
    ...
    if (yt6.layout != 16) {
      player().setAttribute('src','https://s.ytimg.com/yts/swfbin/player-' + yt6.swfbin4 + '/watch_as3.swf')
    } else {
  ...
  if ( player() && (typeof player().getAttribute('flashvars') == 'string') && (typeof player().getPlayerState != 'function') && (document.getElementById(mep_x("mep_")) == null)) {
	...
	removeEL(player(), "onPlaybackQualityChange", Mqch, false);
	addEL(player(), "onPlaybackQualityChange", Mqch, false);
      },500,10000
    )
  } else {
	removeEL(player(), "onStateChange", Sync, false);
...
yt6.mep_up();
    ...
    loadScript( protocol() + yt6.cdn + "snarly/yt6/87742f58cf60d2991bb710ea0cbc9f3ba1e64cef/mep-ceeb1a7.js", jq1)
	...
	function playNext(){
		...
		$waitUntil(
		  ...
		  function(){
		      autoplay(true);
	  	      if (!yt6.x) {
			if (typeof p.getPlayerState == 'function' && p.getPlayerState() != 1) { p.playVideo(); p.playVideo() }
		      } else if (yt6.player1 && yt6.player1.media && yt6.player1.media.paused) {
			  var spacebar = new KeyboardEvent('keydown',{'keyCode':32,'which':32});
			  var z = document.getElementById(mep_x('mep_'))
			  if (z) z.dispatchEvent(spacebar); yt6.player1.play(); //console.log('ok')
			}
		  },500,2000);
...
//console.log(yt6.ad_duration +' '+ yt6.ad_muted)
	if (yt6.ad_duration != 0 && yt6.ad_muted == true && !yt6.ad_unmute && gc('ytp-time-duration')[0] && yt6.media_duration && (1*yt6.media_duration - 1*gc('ytp-time-duration')[0][yt6.txt].split(':').join('') > 1)) {//console.log('Ads running')
	  $waitUntil(
	    function(){
	      yt6.ad_unmute = true;
...
if (document.getElementById('unavailable-message') && document.getElementById('unavailable-message')[yt6.txt].replace(/(\r\n|\n|\r)/gm," ").split(' ').join('') != '') {
		...
		if (yt6.age.check() && video_id()[0] != yt6.vid) {
		  ...
		  if (yt6.age.done < 2) { //console.log('03 - Blocked vid '+ yt6.block + yt6.age.done);
		    ...
		    if (bm0 && window.ytplayer.config.args.video_id) {
			  ...
			  mep_reload();
			  if (yt6.age.done != 1) alt_yt_cleanup();
...
$waitUntil(
  function(){
	...
	if (yt6.flash == 1 && player().style.display != 'none') player().style.display = 'none'
  ...
  function(){ yt6.timer = 0; 
	if (yt6.flash == 1 && player().style.display == 'none') {
	  delete yt6.flash; player().style.display = 'block'; player().style.display = '';
	  $waitUntil(function(){if (typeof player().pauseVideo == 'function') return true },
	    function() { var bm0 = document.getElementById('bm0'); if (bm0 && bm0.style.visibility != 'hidden') player().pauseVideo() },100,5000)
player()
	}
  },500,7000)
...
if ( (me_aspect) && (  (document.getElementById(mep_x('mep_')) == null) || ((player().getAttribute('name') == 'me_flash') && (!yt6.x)) || ((document.getElementById(mep_x('me_flash_')) != null) && (yt6.x))  )  ) {
...
//console.log(w+' '+h+' '+p1.style.width+' '+p1.style.height)
    if (  (yt6.x) && (yt6.size == 'default') && ( (mep == null) || ((document.getElementById(mep_x('me_flash_')) != null)) )  ) {
...
//console.log( '4: ' + p1.style.top + p1.style.left + p1.style.width + p1.style.height);
	...
	if (yt6.size == 'theater'){
	  ...
	  if ( ((player().getAttribute('name') == 'me_flash') && (!yt6.x)) || ((document.getElementById(mep_x('me_flash_')) != null) && (yt6.x)) ) {
	...
	if (c) {//console.log('s-16');//aspect changer present
	  ...
	  if ( ((1 * tiny.marginLeft.replace('px','') >= 108) || (tiny.marginLeft == 'auto')) && (playlist) ) playlist.style.top = h + 10 + 'px'
	   ...
	   if (w < windowwidth) {//console.log('s-19');
		...
		if ( parseFloat(e.marginLeft.replace('px','').replace('-','')) + b.offsetWidth - w > 0 ) {//console.log('s-191 ' + b.offsetWidth + '  '+ w + ' ' + windowwidth +' '+ l.offsetWidth)
		  ...
		  l.style.marginTop = yh + 'px';
		    ...
		    if (Math.ceil(l.offsetWidth/854) == 1) { l.style.marginTop = -1 * h + 'px' } else {
			  ...
			  yt6.wsb.style.top = '-2px';
			  if (playlist) playlist.style.top = '-2px';
			}
		    }
		  }
			...
			if (w < l.offsetWidth) {//console.log('201')
			  e.width = api.left = (windowwidth - w) / 2 + 'px';
			    ...
			    if (l.offsetWidth >= 1066 || windowwidth == l.offsetWidth) {//console.log('202a')
			      if (windowwidth + getScrollbarWidth() >= 1000) { var x = 2 } else var x = 0
			      a.style.top = -1 * (h + x) + 'px'
		...
		} else {//console.log('s-203 ' + b.offsetWidth + '  '+ w + ' ' + windowwidth +' '+ l.offsetWidth)
		    if (Math.ceil(l.offsetWidth/854) == 1) { a.style.top = -1 * h + 'px'; } else a.style.top = '';
		    if (w < l.offsetWidth) {
		      e.width = api.left = (windowwidth - w) / 2 + 'px';
		    } else {
...
*/
	...
	if (!pa && document.getElementsByTagName('ytg-watch-footer')[0]) {alert('')
	  var div = document.createElement('div')
  ...
  if ( bm0.style.visibility === 'hidden') {
    ...
    if (p.id == 'movie_player') {
	  ...
	  if (typeof p.style.setProperty == 'function') {
	    ...
	    if (p.tagName == 'EMBED' && p.getPlayerState != 'function') p.style.visibility = 'hidden'
	  } else {
	      p.style.display = 'none'
	...
	if (typeof p.getAttribute('flashvars') == 'string') {
	  ...
	  if (typeof p.style.setProperty == 'function') {
	    ...
	    if (p.tagName == 'EMBED') p.style.visibility = 'visible'
	  } else {
	      p.style.display = ''
...
function control_panel1() {
  ...
  if (document.getElementById('remove-sp') == null) {
    ...
    remove.id = 'remove-sp';
    var remove_sp_innerhtml = '<button onclick="switch_players()" class="yt-uix-button-text" aria-label="Switch" title="Switch" style="padding: 0 1px 0 0"><img src="//s.ytimg.com/yts/img/HTML5_1Color_Black-vfl902gVJ.png" style="vertical-align:middle; height:12px; padding:0px""></img></button><button onclick="aspect()" class="yt-uix-button-text" aria-label="Resize" title="Resize">«↔»</button><br><button onclick="var z = window.prompt(\'Are you sure you want to quit? \(Exit options: 0-3\)\\n Cancel = Not now;\\n 0 = Remove script without page refresh;\\n 1 = Refresh page with classic layout;\\n 2 = Refresh page with new layout \(if supported\);\\n 3 = Visit page on Gaming subdomain;\', \'0\'); if (z && z != 0 && (z == 1 || z == 2 || z == 3)) { if (z == 2) document.cookie=&quot;PREF=f1=50000000&f5=10&f6=1004;path=/;domain=.youtube.com;expires=Session&quot;; if (z == 1) document.cookie=&quot;PREF=f1=50000000&f5=10;path=/;domain=.youtube.com;expires=Session&quot;; if (z == 3) { location.href = window.location.href.replace(\'www.youtube.com\',\'gaming.youtube.com\') } else location.href = window.location.href.replace(\'gaming.youtube.com\',\'www.youtube.com\') } else if (z == 0) deldiv()" class="yt-uix-button-text" aria-label="Remove" title="Remove">X</button><button id="audio_x" class="yt-uix-button-text" aria-label="External audio" title="External audio" style="padding: 0 1px 0 1px; right: 0px" onclick="if (yt6.player1 && yt6.player2 && typeof yt6.player2.load == \'function\') { var audio_x = window.prompt(\'Enter URL of any audio (or video) file across the net to use as background sound. Only plays alongside non-MSE-mode video-only sources.\', document.getElementById(\'no.2\').src); yt6.audiox = document.getElementById(\'no.2\').src = yt6.player2.media.src = audio_x || yt6.linx[yt6.userprefA[0]]; if (!audio_x) { yt6.audiox = null; delete yt6.audiox }; yt6.player1.pause(); yt6.player2.load() };">audio</button></div>'
...
/* Check the class name of the button and act accordingly */    
	...
	if (player() && typeof player().previousVideo == 'function') { player().previousVideo(); try { yt6.player1.pause(); yt6.player1.media.currentTime = yt6.player2.media.currentTime = 0 } catch(e) {} }
	break;
...
/* Toggle play functionality and button label */    
	...
	if ( v && (v != stage || (v.getAttribute('name') != null && v.getAttribute('name').indexOf('me_flash') > -1))) {
	  ...
	  if (!yt6.x && player() && typeof player().getPlayerState == 'function' && player().getPlayerState() > 2) { player().playVideo(); player().playVideo() }
	} else {
	    if (player().name != 're-embed2') {
		var p = player(); var m = window; //alert('0'+typeof p.getPlayerState)
		    //if (typeof p.getPlayerState == 'function') {
...
/* Reset all to default */
	case 'reset yt-uix-button-text':
	  ...
	  if (v != player()) {
	    ...
	    if ( (typeof player().getPlayerState == 'function') && (player().getAttribute('flashvars') == null) && (!yt6.x) ) {
