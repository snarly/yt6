...
for(var i=0;i<338;i++) if (qual[i]) qual[i]['s'] = ''
  ...
  yt6.fmts_fallback.V.webm = [,,272,315,,313,308,,271,303,,46,,170,248,,302,,45,,247,,44,,,219,218,168,246,245,244,,43,,243,,242,,278,,241,,43,,18,,22,,,,,251,172,171,,250,249,,258,256,141,140,139]
  yt6.fmts_fallback.V.h264 = [138,38,,,266,,,264,,,299,,37,,,137,,298,,22,,136,,78,59,,,,,,,135,,18,,134,,133,,132,,160,,18,,43,,22,258,256,141,,,,140,,,139,,,,,,251,172,171,250,249]
  yt6.fmts_fallback.A.webm = [,,,251,172,171,,250,249,,258,256,141,140,139]
  yt6.fmts_fallback.A.aac = [258,256,141,,,,140,,,139,251,172,171,250,249]
...
/*
	...
	function parse_video_info(arguments){ 
	  ...
	  for (i=0;i<yt6.args.length;i++) {
		...
		window.ytplayer.config.args.title = unicodeToChar(unescape(decodeURIComponent(z[1])))//.split('+').join(' ')
	      }
	  }
		  ...
		  success: function(me) {  $('#audio-type').html( me.pluginType);
					...
					addEL(me, 'error', function(e) {//console.log('1error')
					  ...
					  if (me.networkState == 3) {
					    ...
					    if (yt6.retry < 64 && document.getElementById('ytassetsjs')) {
...
/*					      var dash = document.getElementById(mep_x('mep_') + '_sourcechooser_242')//240p  VP9webm');
					...
					addEL(me, 'pause', function() {//console.log('1pause ' + Seek + ' ' + me.playing )
					  ...
					  yt6.Seeked2 = true; me.play(); return void 0 }
					  if (yt6.x) {
					...
					addEL(me, 'seeked', function() {//console.log('1seeked')
					  if ( (yt6 && yt6.timer == 999999999) || me.src == 'https://www.youtube.com/ptracking' )
					    return void 0;
					  if (yt6.speed) { player2.playbackRate = me.playbackRate = yt6.speed; }
					  if (yt6.browser_tab == 'hidden' && ((me.currentTime < me.duration && Seek != 3) || (Seek == 3 && player1.options.loop1)) ) { Seek = 1; me.play(); }
	  ...
	  if (ads0 && ads0 != '0:00' && !yt6.force_flash && p.tagName != 'EMBED') {
		...
		if (yt6.media_duration != ads0 && Math.abs(yt6.previous_media_duration - ads0) > 1.5) {
		  ...
		  //if (typeof mute_button != 'undefined') {
		    if (!p.isMuted()) { try { p.mute(); v_element.mute() } catch(e) { if (!p.isMuted()) yt6.ad_muted = false }; yt6.ad_muted = true }//mute_button.click()
		    yt6.pre_ad = true
		  //}
