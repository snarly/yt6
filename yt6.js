...
//console.log('2016 layout')
    var MC = (osName != 'Windows' && ((browserName != 'Firefox' && browserName != 'Edge') || browserName == 'Chrome' || browserName == 'Opera')) ? 2 : 3  //MC = chrome-based: 2px, mozilla-based: 3px
