...
function wallpaper(){
  ...
  if (typeof $ == 'function') $(function(){
    ...
    var mep = gid(mep_x('mep_')), bm0 = gid('bm0'), pc = (yt6.layout == 16) ? gid('player-container') : yt6.api, ptc = gid('player-theater-container')
    if (pc) {
...
function deldiv(){
  ...
  if (yt6.api && yt6.api.id == 'container') yt6.api.style.width = ''
