...
function correct_flashvars(a) { // prepare the flash player object's flashvars variable
  ...
  var uefsm_bak = (url_encoded_fmt_stream_map) ? clone(url_encoded_fmt_stream_map) : ''
...
// when in new layout, try this only outside of a playlist and with a html5 player 
	    ...
	    //} catch(e) { alert('01'); undo_iframe() }
	      ...
	      if (yt6.movie_player.tagName == 'IFRAME' && yt6.vid == vid) {//
...
if (player()) {
  ...
  var Sync = function(newState) {
	...
	if (newState == 1) {
	  playButton()
	  try { if (yt6.btn.play) yt6.btn.play.innerHTML = 'pause'; if (yt6.btn.play2) yt6.btn.play2.innerHTML = 'pause'; var x = gc('play snarl-button yt-uix-button-text')[0]; if (x) x.innerHTML = 'pause'; var x = gc('play snarl-button yt-uix-button-text')[1]; if (x) x.innerHTML = 'pause' } catch(e) {}
...
function getReferenceObjects() {
  ...
  yt6.wsb = document.getElementById('watch7-sidebar') || document.getElementById('related') || document.getElementById('sidebar') || document.getElementsByTagName('ytg-watch-sidebar')[0] || document.getElementById('secondary')
...
if (typeof $ == 'function') $(function(){
  ...
  var size = 200;
  var time = 0;
  var backImage = $wallp.css("background-image");
  ...
  var backPosition = $wallp.css("background-position");
	...
	if (!yt6.wallpaper || ypos > parseInt(window.innerHeight || document.documentElement.clientHeight || yt6.body.clientHeight) ) {
	  ...
	  backImage = 'none' //$wallp.css("background-image");
...
if (typeof ytplayer == 'undefined') var ytplayer = window.ytplayer
  ...
  if ( ytplayer && ytplayer.config && ytplayer.config.args && (typeof ytplayer.config.args.url_encoded_fmt_stream_map == 'undefined' || typeof ytplayer.config.args.adaptive_fmts == 'undefined' || ytplayer.config.args.adaptive_fmts == '') || (z && z.indexOf('//www.youtube.com/yts/jsbin/') != -1) ) {

    //var z = gc('ytassetsjs-0'); while (z && z[0]) z[0].parentNode.removeChild(z[0]);
if ((yt6.layout == 12) && !ytplayer.config.args.url_encoded_fmt_stream_map && !ytplayer.config.args.adaptive_fmts) { var pass = true } else var pass = false; // || yt6.force_flash
...
/*					      var dash = document.getElementById(mep_x('mep_') + '_sourcechooser_242')//240p  VP9webm');
					...
					addEL(me, 'pause', function() {//console.log('1pause ' + Seek + ' ' + me.playing )
					  ...
					  //playButton()
					  try { if (yt6.btn.play) yt6.btn.play.innerHTML = 'play'; if (yt6.btn.play2) yt6.btn.play2.innerHTML = 'play'; var x = gc('play snarl-button yt-uix-button-text')[0]; if (x) x.innerHTML = 'play'; var x = gc('play snarl-button yt-uix-button-text')[1]; if (x) x.innerHTML = 'play' } catch(e) {}
...
function switch_players() {
  ...
  if (yt6.btn.play) { yt6.btn.play.innerHTML = 'play'; try { gc('play snarl-button yt-uix-button-text')[1].innerHTML = 'play' } catch(e) {} }
  set_controls()
...
/* Check the class name of the button and act accordingly */    
	...
	try { yt6.player1.pause() } catch(e){}; //try {
 	  fix_playlist()
	  $waitUntil(function(){ var y = yt6.pl_index, zi = yt6.pl_next; if ((typeof y == 'number' && zi) || yt6.layout == 12) { return true } else pl_item() },
	  function() { var p = player(), p = yt6.movie_player;
	    ...
	    try { yt6.navigation = true
	    if ((!yt6.shuffle && !yt6.ytg) || yt6.layout == 12) { try { yt6.pl_next.click() } catch(e) { mp.nextVideo('0') } } 
else {
		if (p == mp) {
	...
	try { yt6.player1.pause() } catch(e){}; //try {
	  ...
	  function() { var p = player(), p = yt6.movie_player;
	    ...
	    try { yt6.navigation = true
	    if (yt6.layout == 12 || yt6.ytg) { try { yt6.pl_previous.click() } catch(e){ mp.playVideoAt(yt6.pl_index-1) || mp.previousVideo('0') } } else {
	...
	if (( v && (v != stage || (v.getAttribute('name') != null && v.getAttribute('name').indexOf('me_flash') > -1))) ) {
	  ...
	  if (!yt6.x && p && p.tagName != 'OBJECT' && typeof p.getPlayerState == 'function' && p.getPlayerState() > 2) try { p.playVideo(); p.playVideo() } catch(e) {}
		...
		var p = yt6.embed.player
		    if (p) {
		        if ((typeof p.getPlayerState == 'function' && p.getPlayerState() != 1) || (typeof p.getPlayerState != 'function' && yt6.btn.play.innerHTML.innerHTML == 'play')) {//alert(player().getPlayerState())
			  yt6.embed.play()
			  try { if (yt6.btn.play) yt6.btn.play.innerHTML = 'pause'; if (yt6.btn.play2) yt6.btn.play2.innerHTML = 'pause'; var x = gc('play snarl-button yt-uix-button-text')[0]; if (x) x.innerHTML = 'pause'; var x = gc('play snarl-button yt-uix-button-text')[1]; if (x) x.innerHTML = 'pause' } catch(e) {}
			} else {
			    yt6.embed.pause()
