		  ...
		  success: function(me) {  $('#audio-type').html( me.pluginType);
					...
					addEL(me, 'seeked', function() {//console.log('2seeked '+ Seek +' '+ player1.media.playing +' '+ player2.playing)
					  ...
					  if (player2.duration > player2.currentTime && !(yt6.player1.media.currentTime > player2.duration)) {//ax
					    ...
					    } catch(e) { console.log('yt6.player2.media.currentTime = ' + me.currentTime); yt6.Seeked2 = !yt6.Seeked2 }
						...
						} else { console.log(yt6.autoplay +' '+ me.paused +' '+ player1.media.paused); if (yt6.autoplay && (browserName == 'Edge' || browserName == 'IE')) { Seek = 1 } }
