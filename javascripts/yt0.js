...
if (typeof srcto == 'undefined') {\
		...
		success: function(me) {  $('#audio-type').html( me.pluginType);\
					...
					me.addEventListener('play', function() { Seek = 1 ; if ( (!player1.playing) && ( ((typeof player.getPlayerState != 'function') && (flashvars == null)) || ((document.getElementById('bm').style.visibility != 'hidden') && (flashvars != null)) ) ) { player1.play() } } );\
					me.addEventListener('loadeddata', function() { if (Seek !== 2) { Seek = 0; player1.pause() } else { } });\
}});\
}\
var Seek = null;\
