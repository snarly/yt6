...
//  var fcnm = rpt.match(/signature=([^(]+)/)[1]
  ...
  function fcobj(){
    var mch = rpt.match(fs)[0]; alert("rpt.match(fs)[0]="+mch); mch = mch.split('');alert(typeof mch)
  ...
  alert("rpt.match(fcobj()[0])="+rpt.match(fcobj()[0])+" ; fcobj()[1]="+fcobj()[1]+" ; rpt.match(fs)[0]="+rpt.match(fs)[0])
