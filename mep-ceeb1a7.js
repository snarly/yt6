		...
		keyActions: [
				{
						...
						action: function(player, media) {
								if (media.paused || media.ended) {
										if (yt6)
										if (!yt6.live && !(yt6.player2 && yt6.player2.media == media && yt6.player2.media.src.split('//')[1] == yt6.player1.media.src.split('//')[1] && typeof yt6.player1.play == 'function')) {
										  if ( yt6.Seek != 1 && !(yt6.player1 && yt6.player1.media && Array.isArray(yt6.A_V) && yt6.A_V[itag(yt6.player1.media.src)] && yt6.player1.media.paused && yt6.Seek == null) ) {
										    player.play()
										  } else { player.pause(); yt6.Seek = 1 }
										...
										if (yt6) {
										  ...
										  if (yt6.player1 && yt6.player1.media == media && yt6.player2 && yt6.player2.media && typeof yt6.player2.pause == 'function') { yt6.Seeked2 = false; yt6.Seek = 1; yt6.player2.pause() }
										  if (yt6.Seek == 2) yt6.Seeked2 = true
										}
								}
						}
				},
...
d = ytsubtitle2srt(d, track.srclang, mejs.language.codes[track.srclang], track.translated) //yt6
	...
	mejs.language = {
		codes:  {
			...
			'ar-AE':'Arabic (UAE)',
			'ar-Arab-AE':'Arabic (Arab) (UAE)',
			'ar-BH':'Arabic (Bahrain)',
			'ar-DZ':'Arabic (Algeria)',
			'ar-EG':'Arabic (Egypt)',
			'ar-EH':'Arabic (Western Sahara)',
			'ar-IL':'Arabic (Israel)',
			'ar-Arab-INT':'Arabic (Arab) (Int)',
			'ar-Latn-INT':'Arabic (Latin) (Int)',
			'ar-IQ':'Arabic (Iraq)',
			'ar-JO':'Arabic (Jordan)',
			'ar-KM':'Arabic (Comoros)',
			'ar-KW':'Arabic (Kuwait)',
			'ar-LB':'Arabic (Lebanon)',
			'ar-LEV':'Arabic (Levanti)',
			'ar-LY':'Arabic (Libya)',
			'ar-MA':'Arabic (Morocco)',
			'ar-MGB':'Arabic (Maghreb)',
			...
			'ar-YE':'Arabic (Yemen)',
			az:'Azerbaijani',
			'az-Cyrl-AZ':'Azeri (Cyrillic) (AZE)',
			'az-Latn-AZ':'Azeri (Latin) (AZE)',
			be:'Belarusian',
			...
			'de-NE':'German (Netherlands)',
			dv:'Divehi',
			'dv-MV':'Divehi (Maldives)',
			el:'Greek',
			'el-CY':'Greek (Greece)',
			'el-GR':'Greek (Greece)',
			'el-Latn-GR':'Greek (Latin) (GRC)',
			en:'English',
			...
			jv:'Javanese',
			'jv-Java':'Javanese (Java)',
			'jv-ID':'Javanese (ID)',
			'jv-Latn-ID':'Javanese (Latn) (ID)',
			ka:'Georgian',
			'ka-GE':'Georgian (Georgia)',
			kk:'Kazakh',
			'kk-KZ':'Kazakh (Kazakhstan)',
			'kk-Cyrl':'Kazakh (Cyrillic) (KAZ)',
			'kk-Latn':'Kazakh (Latin) (KAZ)',
			km:'Khmer',
			kn:'Kannada',
			'kn-IN':'Kannada (India)',
			ko:'Korean',
			...
			'ku-IQ':'Kurdish (Iraq)',
			'ku-Arab-IQ':'Kurdish (Arab) (IRQ)',
			'ku-Arab-IR':'Kurdish (Arab) (IRN)',
			'ku-TR':'Kurdish (Turkey)',
			ky:'Kyrgyz',
			'ky-KG':'Kyrgyz (Kyrgyzstan)',
			'ky-KZ':'Kyrgyz (Kazakhstan)',
			la:'Latin',
			'la-INT':'Latin (International)',
			'la-va':'Latin (Holy See)',
			lb:'Luxembourgish',
			'lb-BE':'Luxembourgish (Belgium)',
			...
			mn:'Mongolian',
			'mn-Mong-CN':'Mongolian (Mong) (CHN)',
			'mn-MN':'Mongolian (Mongolia)',
			'mn-Cyrl-MN':'Mongolian (Cyrillic) (MNG)',
			'mn-Latn-MN':'Mongolian (Latin) (MNG)',
			mr:'Marathi',
			'mr-IN':'Marathi (India)',
			ms:'Malay',
			'ms-BN':'Malay (Brunei)',
			...
			'my-zwgy-MM':'Burmese (zwgy) (MMR)',
			nb:'Norwegian (Bokmål)',
			'nb-NO':'Norwegian (Bokmål) (NOR)',
			ne:'Nepali',
			'me-IN':'Nepali (India)',
			'me-NP':'Nepali (Nepal)',
			nl:'Dutch',
			...
			'nn-NO':'Norwegian (Nynorsk) (NOR)',
			no:'Norwegian',
			'no-NO':'Norwegian (NOR)',
			ns:'Northern Sotho',
			'ns-CM':'Northern Sotho (CMR)',
			'ns-ZA':'Northern Sotho (South Africa)',
			ny:'Nyanja',
			or:'Odia',
			'or-IN':'Odia (India)',
			'or-Latn-IN':'Odia (Latin) (IND)',
			pa:'Punjabi',
			'pa-Arab':'Punjabi (Arab)',
			'pa-IN':'Punjabi (India)',
			'pa-PK':'Punjabi (Pakistan)',
			'pa-Arab-PK':'Punjabi (Arab) (PAK)',
			pl:'Polish',
			'pl-PL':'Polish (Poland)',
			ps:'Pashto',
			'ps-AF':'Pashto (Afghanistan)',
			pt:'Portuguese',
			'pt-002':'Portuguese (Africa)',
			...
			se:'Sami (Northern)',
			'se-FI':'Sami (Northern) (FIN)',
			'se-NO':'Sami (Northern) (NOR)',
			'se-SE':'Sami (Northern) (SWE)',
			sme:'Sami (Southern)',
			'sme-NO':'Sami (Southern) (NOR)',
			'sme-SE':'Sami (Southern) (SWE)',
			smj:'Sami (Lule)',
			'smj-NO':'Sami (Lule) (NOR)',
			'smj-SE':'Sami (Lule) (SWE)',
			smn:'Sami (Inari)',
			'smn-FI':'Sami (Inari) (FIN)',
			sms:'Sami (Skolt)',
			'sms-FI':'Sami (Skolt) (FIN)',
			sd:'Sindhi',
			'sd-Deva-IN':'Sindhi (India)',
			'sd-pk':'Sindhi (Pakistan)',
			'sd-Arab-pk':'Sindhi (Arab) (PAK)',
			'sd-Deva-pk':'Sindhi (Deva) (PAK)',
			si:'Sinhala',
			...
			sr:'Serbian',
			'sr-Cyrl-BA':'Serbian (Cyrillic) (BH)',
			'sr-Latn-BA':'Serbian (Latin) (BH)',
			'sr-Cyrl-ME':'Serbian (Cyrillic) (MNE)',
			'sr-Latn-ME':'Serbian (Latin) (MNE)',
			'sr-Cyrl-RS':'Serbian (Cyrillic) (SRB)',
			'sr-Latn-RS':'Serbian (Latin) (SRB)',
			st:'Southern Sotho',
			'st-LS':'Southern Sotho (Lesotho)',
			'st-ZA':'Southern Sotho (South Africa)',
			su:'Sundanese',
			'su-Sund':'Sundanese (Sund)',
			'su-Latn-ID':'Sundanese (Latin) (IDN)',
			'su-Sund-ID':'Sundanese (Sund) (IDN)',
			sv:'Swedish',
			'sv-AX':'Swedish (Åland Islands)',
			'sv-FI':'Swedish (Finland)',
			'sv-SE':'Swedish (Sweden)',
			sw:'Swahili',
			'sw-CD':'Swahili (DR Congo)',
			'sw-CD-KN':'Swahili (DRC, Kinshasa)',
			'sw-KE':'Swahili (Kenya)',
			'sw-SO':'Swahili (Somalia)',
			'sw-TZ':'Swahili (Tanzania)',
			'sw-UG':'Swahili (Uganda)',
			syr:'Syriac',
			'syr-SY':'Syriac (Syria)',
			'syr-TR':'Syriac (Turkey)',
			ta:'Tamil',
			'ta-IN':'Tamil (India)',
			'ta-Latn-IN':'Tamil (Latin) (IND)',
			'ta-LK':'Tamil (Sri Lanka)',
			'ta-MY':'Tamil (Malaysia)',
			'ta-SG':'Tamil (Singapore)',
			te:'Telugu',
			'te-IN':'Telugu (India)',
			'te-Latn-IN':'Telugu (Latin) (IND)',
			tg:'Tajik',
			'tg-TJ':'Tajik (Tajikistan)',
			'tg-Cyrl-TJ':'Tajik (Cyrillic) (TJK)',
			th:'Thai',
			'th-TH':'Thai (Thailand)',
			tk:'Turkmen',
			...
			'ts-ZW':'Tsonga (Zimbabwe)',
			tt:'Tatar',
			'tt-RU':'Tatar (Russia)',
			'tt-Cyrl-RU':'Tatar (Cyrillic) (Russia)',
			ug:'Uyghur',
			'ug-Latn':'Uyghur (Latin)',
			'ug-CN':'Uyghur (China)',
			'ug-Arab-CN':'Uyghur (Arab) (CHN)',
			'ug-Cyrl-KZ':'Uyghur (Cyrillic) (KAZ)',
			uk:'Ukrainian',
			'uk-UA':'Ukrainian (Ukraine)',
			'uk-Latn-UA':'Ukrainian (Latin) (UKR)',
			und:'unspecified language',
			ur:'Urdu',
			'ur-IN':'Urdu (India)',
			'ur-PK':'Urdu (Pakistan)',
			'ur-Latn-PK':'Urdu (Latin) (PAK)',
			uz:'Uzbek',
			'uz-UZ':'Uzbek (Cyrillic)',
			'uz-AF':'Uzbek (Afghanistan)',
			'uz-Cyrl-UZ':'Uzbek (Cyrillic) (UZB)',
			'uz-Latn-UZ':'Uzbek (Latin) (UZB)',
			vi:'Vietnamese',
			...
			'zh-MO':'Chinese (Macau)',
			'zh-Hans-MO':'Chinese (Simplified) (MAC)',
